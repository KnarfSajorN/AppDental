...
$tabla = mysqli_query($conn3, "SHOW TABLES LIKE 'RIAS_HistoriaJuventud'");
$nrowtabla = mysqli_num_rows($tabla);
if ($nrowtabla == 0) {
    $query = "CREATE TABLE `RIAS_HistoriaJuventud` ( 
...
foreach ($ArregloCamposAdicionales as $key => $value) {
    $Campo1 = mysqli_query($conn3, "show COLUMNS from RIAS_HistoriaJuventud WHERE Field = '$value';");
    $nrowCampo1 = mysqli_num_rows($Campo1);
    if ($nrowCampo1 == "0") {
        mysqli_query($conn3, "ALTER TABLE `RIAS_HistoriaJuventud` ADD `$value` TEXT NULL ");
    }
}
...
//echo "INSERT INTO RIAS_HistoriaJuventud (usuario_id,cliente_id,{$Campos},Familiograma_Archivo,Ecomapa_Archivo) VALUES ('$usuario_id','$cliente_id',{$Valores},'$Familiograma','$Ecomapa');";

$queryList = mysqli_query($conn3, "INSERT INTO RIAS_HistoriaJuventud (usuario_id,cliente_id,{$Campos},Familiograma_Archivo,Ecomapa_Archivo) VALUES ('$usuario_id','$cliente_id',{$Valores},'$Familiograma','$Ecomapa');") or die(mysqli_error($conn3));
...
$Recetario_Nombre_Historia = "RIAS_HistoriaJuventud";
...
echo "<script language='Javascript'> window.location='RIAS_Finalizado_Juventud.php?id=$Historia_id';</script>";
