...
*/
                                ...
                                <div class="tab-pane active" id="info">
                                    <form id="form-catalogo">
                                        ...
                                        <div class="row">
                                        <label for="" style="color:red;">** Para ocultar cualquier campo de la web, colocar 0**</label>  
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="valorconsulta" placeholder="valorconsulta"
                                                        name="datos[valorconsulta]"
                                                        ...
                                                        <div class="m-2 border border-maroon rounded">
                                                            <div class="mx-auto align-items-center center text-center" style="width: 100px; height: 100px;">
                                                                <?php if (
                                                                    ...
                                                                    $previsualizar = 'img'; ?>
                                                                    <img src="<?= $Base ?>uploads/<?= $_SESSION['ID_principal'] ?>/c_galeria/<?= $rowArchivos['archivo'] ?>" alt="" width="100" height="100">
