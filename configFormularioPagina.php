...
<script type="text/javascript">
    function mostrar(id) {
        var este = id;
        i=1;
        // for para ocultar todos los campos
        for ( i ; i <=50; i++) {
            $("#servicio"+[i]).hide();
...
$queryList=mysqli_query($conn3,"SELECT * FROM  configPaginas where id = $Pagina");
      ...
      <div class="box">
        ...
        <div class="box-body">
          ...
          <div class="col-md-12">
            ...
            <div class="col-md-12"><h4 class="card-title">-</h4></div>
        ...
        $queryDetalle=mysqli_query($conn3,"SELECT * FROM  configPaginaDetalle where idPagina = $Pagina order by id asc");
        ...
        while($rowDetalle=mysqli_fetch_array($queryDetalle))
        {
            ...
            $borrar = "<a  href='configBorrarCampo.php?Nombre_table=$name&Pagina=$Pagina&campo=$input_name'><i title='Borrar Campo' style='font-size: 18px;' class='fa fa-trash'> </i></a>";
...
<div class="col-md-12">
    ...
    <select id="status" name="status" class="form-control select2" onChange="mostrar(this.value);" style="width: 40%;">
      ...
      <option value="1">Campo de texto simple</option>
      <option value="2">Campo Numérico </option>
      <option value="9">Campo Fecha </option>
      <option value="3">Campo de texto Grande </option>
      <option value="10">Campo Imagen </option>
      <option value="4">lista desplegable de si o no </option>
      <option value="5">Lista Desplegable  </option>
      <option value="6">Selección Múltiple </option>
      <option value="7">Separador o Titulo de sección </option>
      <option value="8">Imagen Directa </option>
...
<div id="servicio1" class="element" style="display: none;">
    ...
    <div class="col-md-4">
      ...
      <label> Nombre del campo </label>
                ...
                <input  type="hidden" name="idPaginas"  value="<?php echo $Pagina?>">
                ...
                <div class="col-md-12">
                  <br><br>
                  <center><button type="submit" class="btn btn-block btn-primary btn-md"> <h2> <strong>  G u a r d a r  </strong> </h2> </button></center>
              </div>
