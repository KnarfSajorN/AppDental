...
<?php
                    ...
                    $resultado=mysql_query("SELECT * FROM  sdetalleoperexamen as dt, examenes_22 as ex where   dt.id_usuario = $idEmpresa and  dt.id_cliente = $idCliente and dt.idOperacion = $idOperacion AND dt.idProducto=ex.id order by dt.id");
...
<?php echo $pieF?>
      ...
      <div class="row no-print">
        <div class="col-xs-12">  
          <a href="imprimirExamen.php?idOperacion=<?php echo $idOperacion?>" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Imprimir</a>
