        ...
        <tbody>
          ...
          <div class="box-body">
            ...
            <div class="col-xs-12">
              ...
              echo '<img src="https://chart.googleapis.com/chart?chs=100x100&cht=qr&chl=' . $direccion . '&choe=UTF-8" title="Link to Google.com" />';
              ...
              <tbody>
                ...
                while ($Lista = mysqli_fetch_array($queryList)) {
                  ...
                  while ($Lista1 = mysqli_fetch_array($queryList1)) {
                    if ($contador == "0") {
                      echo '<tr><td colspan="12" style="background-color: beige !important;"><b>' . $nombre_grupo . '</b></td></tr>';
                    }
