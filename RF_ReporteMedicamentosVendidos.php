...
$Pos = $_POST['Pos'];
    ...
    header('Content-Disposition: attachment; filename=ReporteMedicamentosVendidos_'.$desde.'_'.$hasta.'.xls');
        ...
        */
        ...
        $QueryFactura = mysqli_query($conn3, "SELECT * FROM sOperacionInv WHERE  (fechaOperacion BETWEEN '{$desde}' AND '{$hasta}') $QueryFactura AND tipo = 1 ORDER BY idOperacion DESC");
