          ...
          <div class="box-body">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-solid">
                ...
                <form action="Guardar_Historia_Dermatologica.php" method="POST">
                  <div class="box-body">
                    ...
                    <div class="box-group" id="accordion1">
                      ...
                      <div class="panel box box-primary">
                        ...
                        <div id="collapseOne" class="panel-collapse collapse">
                          ...
                          <a href="CrearPaciente.php?clienteId=<?= $clienteId ?>" target="_blank">
                            <button class="btn btn-block btn-primary btn-sm" type="button">
                              <h4> <strong> <i class="fas fa-id-card-alt"></i> Editar Paciente </strong></h4>
                            </button>
                          </a>
                        </div>
                      </div>
                      ...
                      <div class="panel box box-primary">
                        <div class="box-header with-border">
                          <h4 class="box-title">
                            <a data-toggle="collapse" data-parent="#accordion1" href="#collapsePer">
                        ...
                        <div id="collapsePer" class="panel-collapse collapse">
                          ...
                          <div class="box-body">
                            ...
                            <div class="col-md-6">
                              ...
                              <input type="text" name="AntecedentesPer[Patologicos]" class="form-control">
                            </div>
                            <div class="col-md-6">
                              <label>Farmacológicos</label>
                              <input type="text" name="AntecedentesPer[Farmacologicos]" class="form-control">
                            </div>
                            <div class="col-md-6">
                              <label>Quirúrgicos</label>
                              <input type="text" name="AntecedentesPer[Quirurgicos]" class="form-control">
                            </div>
                            <div class="col-md-6">
                              <label>Hospitalarios</label>
                              <input type="text" name="AntecedentesPer[Hospitalarios]" class="form-control">
                            </div>
                            <div class="col-md-6">
                              <label>Transfusionales</label>
                              <input type="text" name="AntecedentesPer[Transfusionales]" class="form-control">
                            </div>
                            <div class="col-md-6">
                              <label>Alergicos</label>
                              <input type="text" name="AntecedentesPer[Alergicos]" class="form-control">
                            </div>
                            <div class="col-md-6">
                              <label>Tóxicos</label>
                              <input type="text" name="AntecedentesPer[Toxicos]" class="form-control">
                            </div>
                            <div class="col-md-6">
                              <label>Otros</label>
                              <input type="text" name="AntecedentesPer[Otros]" class="form-control">
                            </div>
                      ...
                      <div class="panel box box-primary">
                        <div class="box-header with-border">
                          <h4 class="box-title">
                            <a data-toggle="collapse" data-parent="#accordion1" href="#collapseFam">
                              Antecedentes Familiares
                            </a>
                          </h4>
                        </div>
                        <div id="collapseFam" class="panel-collapse collapse">
                          ...
                          <div class="box-body">
                            ...
                            <div class="col-md-6">
                              ...
                              <input type="text" name="AntecedentesFa[Hipertension Arterial]" class="form-control">
                            </div>
                            <div class="col-md-6">
                              <label>Familiar/Parentesco</label>
                              <input type="text" name="AntecedentesFa[Familiar/Parentesco (Hipertension Arterial)]" class="form-control">
                            </div>
                            <div class="col-md-6">
                              <label>Diabetes</label>
                              <input type="text" name="AntecedentesFa[Diabetes]" class="form-control">
                            </div>
                            <div class="col-md-6">
                              <label>Familiar/Parentesco</label>
                              <input type="text" name="AntecedentesFa[Familiar/Parentesco (Diabetes)]" class="form-control">
                            </div>
                            <div class="col-md-6">
                              <label>Cancer</label>
                              <input type="text" name="AntecedentesFa[Cancer]" class="form-control">
                            </div>
                            <div class="col-md-6">
                              <label>Familiar/Parentesco</label>
                              <input type="text" name="AntecedentesFa[Familiar/Parentesco (Cancer)]" class="form-control">
                            </div>
                            <div class="col-md-6">
                              <label>Patologias Respiratorias</label>
                              <input type="text" name="AntecedentesFa[Patologias Respiratorias]" class="form-control">
                            </div>
                            <div class="col-md-6">
                              <label>Familiar/Parentesco</label>
                              <input type="text" name="AntecedentesFa[Familiar/Parentesco (Patologias Respiratorias)]" class="form-control">
                            </div>
                            <div class="col-md-6">
                              <label>Patologias Autoinmune</label>
                              <input type="text" name="AntecedentesFa[Patologias Autoinmune]" class="form-control">
                            </div>
                            <div class="col-md-6">
                              <label>Familiar/Parentesco</label>
                              <input type="text" name="AntecedentesFa[Familiar/Parentesco (Patologias Autoinmune)]" class="form-control">
                            </div>
                            <div class="col-md-6">
                              <label>Patologias Hermatologicas</label>
                              <input type="text" name="AntecedentesFa[Patologias Hermatologicas]" class="form-control">
                            </div>
                            <div class="col-md-6">
                              <label>Familiar/Parentesco</label>
                              <input type="text" name="AntecedentesFa[Familiar/Parentesco (Patologias Hermatologicas)]" class="form-control">
                            </div>
                            <div class="col-md-6">
                              <label>Otros</label>
                              <input type="text" name="AntecedentesFa[Otros]" class="form-control">
                            </div>
                      ...
                      <?php if ($genero == 'F') { ?>
                        ...
                        <div class="panel box box-primary">
                          <div class="box-header with-border">
                            <h4 class="box-title">
                              <a data-toggle="collapse" data-parent="#accordion1" href="#collapseGine">
                                Antecedentes Ginecologicos
                              </a>
                            </h4>
                          </div>
                          <div id="collapseGine" class="panel-collapse collapse">
                            ...
                            <div class="box-body">
                              ...
                              <div class="col-md-6">
                                <label>Menarca</label>
                                <input type="text" name="AntecedentesGine[Menarca]" class="form-control">
                              </div>
                              <div class="col-md-6">
                                <label>Fecha de la ultima menstruacion</label>
                                <input type="date" name="AntecedentesGine[Fecha Ultima Menstruacion]" class="form-control">
                              </div>
                              <div class="col-md-6">
                                <label>Actualmente usa algun metodo de Planificacion</label>


                                <input value="Si" type="radio" name="AntecedentesGine[Metodo de Planificacion]" class="flat-red" /> SI
                                <input value="No" type="radio" name="AntecedentesGine[Metodo de Planificacion]" class="flat-red" /> NO

                              </div>
                              <div class="col-md-6">
                                <label>Si es afirmativo explique</label>
                                <input type="text" name="AntecedentesGine[Metodo de Planificacion Respuesta]" class="form-control">
                              </div>

                              <div class="col-md-6">
                                <label>Como es su ciclo mentrual?</label>


                                <input value="Regular" type="radio" name="AntecedentesGine[Ciclo Menstrual]" class="flat-red" /> Regular
                                <input value="Irregular" type="radio" name="AntecedentesGine[Ciclo Menstrual]" class="flat-red" /> Irregular

                              </div>
                              <div class="col-md-6">
                                <label>Explique</label>
                                <input type="text" name="AntecedentesGine[Ciclo Menstrual Respuesta]" class="form-control">
                              </div>
                              <div class="col-md-6">
                                <label>Fecha del ultimo Parto</label>
                                <input type="date" name="AntecedentesGine[Fecha Ultimo Parto]" class="form-control">
                              </div>
                              <div class="col-md-6">
                                <label>Regla Obtetrica GPVAM</label>
                                <input type="text" name="AntecedentesGine[Regla Obtetrica GPVAM]" class="form-control">
                              </div>
                        ...
                        <div id="collapseSix" class="panel-collapse collapse">
                          ...
                          <div class="box-body">
                            ...
                            <div class="col-md-4">
                              ...
                              <input type="text" name="SignosVitales[Presion Arterial Sistolica]" class="form-control input-lg" value="<?php echo $Presion_Arterial_Sistolica; ?>">

                            </div>
                            <div class="col-md-4">
                              <label>Presión Arterial Diastólica [mmHg]</label>
                              <input type="text" name="SignosVitales[Presion Arterial Diastolica]" class="form-control input-lg" value="<?php echo $Presion_Arterial_Diastolica; ?>">
