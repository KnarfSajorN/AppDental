...
<a class="btn btn-app" target="_blank" href="<?php echo $Base;?>imprimirConsentimiento1.php?historiaClinica1=<?php echo $historiaClinica1;?>"> 
...
$queryList=mysqli_query($conn3,"SELECT firma FROM  historiaConsentimientos where ID = $historiaClinica1");
$nrowl=mysqli_num_rows($queryList);
while($rowMotorizado=mysqli_fetch_array($queryList))
{
...
?>
 ...
 <a class="btn btn-app" target="_blank"  href="<?php echo $Base;?>firma/documento/<?php echo $historiaClinica1;?>/1" > 
