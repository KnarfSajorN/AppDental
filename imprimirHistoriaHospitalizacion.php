...
$queryList = mysqli_query($conn3, "SELECT * FROM historiaHospitalizacion where id = $Historia_id");
                    ...
                    <div class="page" style="width:100vw;">
                        ...
                        ?>
                            ...
                            if (strlen($indicaciones) > "0") {
                                echo $tabla[12] . '<b>Indicaciones: </b><br><br>' . $indicaciones . '</div>';
                            }
                            if (strlen($medidas) > "0") {
                                echo $tabla[12] . '<b>Medidas: </b><br><br>' . $medidas . '</div>';
                            }
                            ...
                            if (strlen($evolucionClinica) > "0") {
                                echo $tabla[12] . '<b>Evolucion Clinica: </b><br><br>' . $evolucionClinica . '</div>';
                            }
                            ?>
