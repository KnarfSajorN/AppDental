...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12">
                <h4 class="Titulo_Pagina">Pacientes Historia Emergencia/Hospitalizacion</h4>
                <?php
                $msg = $_GET['msg'];
                if ($msg == '1') {
    ...
    columnastablas = [{
        ...
        },
        {
            "data": function(row, type, set) {
                botones = "";
                botones += "<a href='historiaClinicaEmergencias.php?clienteId=" + row.cliente_id + "' title='Emergencia'><i class='fas fa-file-medical text-warning'></i> </a>";
                botones += "<a href='verHistoriaEmergencia.php?clienteId=" + row.cliente_id + "' title='Ver historial'><i class='fas fa-book-medical text-warning'></i> </a>";
                botones += "<span class='text-primary text-bold' style='margin: 0 1px 0 1px; font-size: 25px'>|</span>";
                botones += "<a href='historiaHospitalizacion.php?clienteId=" + row.cliente_id + "' title='Hospitalizacion'><i class='fas fa-file-medical text-danger'></i> </a>";
                botones += "<a href='verHistoriaHospitalizacion.php?clienteId=" + row.cliente_id + "' title='Ver historial'><i class='fas fa-book-medical text-danger'></i> </a>";
