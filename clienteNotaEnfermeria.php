...
<div class="content-wrapper p-3">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#">Pacientes para Notas de Enfermería</a></li>
        </ol>
    </section>
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h2 class="col-md-12 text-center"><b>Notas de Enfermería</b></h2>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
...
<script>
    ...
    <?php } else if (($_SESSION['vista'] == 0 || $_SESSION['vista'] == 1)) {
        $filtro = (($_SESSION['vista'] == 1) ? " AND (ID_principal = '{$_SESSION['ID']}' OR ID_principal = '{$_SESSION['ID_principal']}')" : ''); ?>
            query_tabla_ajax = "<?php echo "SELECT * FROM  cliente WHERE  (ID_principal = '{$_SESSION['ID']}' OR ID_principal = '{$_SESSION['ID_principal']}') $queryCliente ORDER BY cliente_id"; ?>";
    <?php } ?>
    columnas = ['cliente_id', 'nombre_cliente', 'CODI_CLIENTE', 'direccion_cliente', 'telefono_cliente', 'whatsapp',
        'correo_cliente', 'estado'
    ];
    ...
    },
    {
        "data": function (row, type, set) {
            botones = "";
            botones += '<a href="notaEnfermeria?clienteId=' + btoa(row.cliente_id) +
                '" title="Agregar Nota de Enfermeria"><i class="fa fa-sticky-note text-success"></i></a>';
            ...
            // botones +=
            //     "<a href='#usuarioModal' data-toggle='modal' data-target='#my-modal-Estado-Ingreso' title='Procedimientos' onclick=\"verIngresos({cliente_id: " +
            //     row.cliente_id +
            //     ", usuario_id: <?= $_SESSION['ID'] ?>})\"><i class='fa fa-user text-danger'></i> </a>";
            return botones;
        }
    }
    ];
...
<div id="my-modal-Estado-Ingreso" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="my-modal-title"
    aria-hidden="true">
