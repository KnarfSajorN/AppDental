...
<body>
    ...
    <div class="col-md-12">
      ...
      <table  class="table table-bordered">
        <tbody>
          <tr>
            <td>• <b> Nombre del médico que la indica:</b></td>
            <td><?=$Medico_Indica?></td>
          </tr>
          <!-- <tr>
            <td>• <b> ID del médico:</b></td>
            <td><?php echo funcionMaster($Medico_Indica,'ID','rut','usuariosInterconsulta');?></td>
          </tr> -->
        <!--  <tr>
            <td>• <b> Fecha:</b></td>
          ...
          <tr>
            <td colspan="2"><b><u> Archivos </b></u></td>
          </tr>
            <?php
            $contador=0;
            foreach ($Archivos as $value) 
            {
              $ruta=funcionMaster($value,'id','codigo','archivos');
              $contador++;
              echo '<tr><td colspan="2"><a href="'.$Base.'archivos/'.$ruta.'"> Documento '.$contador.' </a></td></tr>';
            }
            ?>
          </tr>-->
          <tr>
            <td colspan="2"> <b><u> Registro de la vacunación </b></u> </td>
          </tr>
          <tr>
            <td>• <b> Fecha :</b> </td>
            <td><?php echo $Fecha ?></td>
