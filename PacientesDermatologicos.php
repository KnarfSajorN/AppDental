  ...
  columnastablas = [{
...

    {
      "data": function(row, type, set) {
        botones = "";
        botones += "<a href='Historia_Dermatologica.php?clienteId=" + row.cliente_id + "' title='Agregar Historia'><i class='fas fa-file-medical'></i> </a>";
        ...
        botones += "<a href='Historial_Dermatologica.php?clienteId=" + row.cliente_id + "' title='Ver historial'><i class='fas fa-book-medical'></i> </a>";
        ...
        botones += "<a href='historiaImg.php?clienteId=" + row.cliente_id + "' title='Anexar Archivos'><i class='fa fa-folder-open-o text-danger'></i> </a>";
        return botones;
      }
    }
  ];
