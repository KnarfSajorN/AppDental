  ...
  <div class="container">
    <form id="formInforme">
      <div class="ui-dialog-titlebar ui-corner-all ui-widget-header ui-helper-clearfix ui-draggable-handle" style="padding: 10px">
        ...
        <span class="ui-dialog-title" style="vertical-align: middle;">Paciente</span>
        <input name="datos[Nombre_P]" id="Nombre_P" style="vertical-align: middle;" value="<?php echo $_GET['Nombre_P']; ?>" readonly><br>
        <span class="ui-dialog-title" style="vertical-align: middle;">Cédula</span>
        &nbsp;&nbsp;&nbsp;<input name="datos[Numero]" id="Numero" value="<?php echo $_GET['Numero']; ?>" style="vertical-align: middle;" readonly><br>
        <span class="ui-dialog-title" style="vertical-align: middle;">Fecha.N</span>
        &nbsp;<input name="datos[Fecha_N]" id="Fecha_N" style="vertical-align: middle;" readonly>


        <textarea class="dicom_voz" name="datos[informe]" id="informe" cols="40" rows="20" style="width:90%;"></textarea>
        <input type="hidden" name="datos[Numero]" id="Numero" value="<?php echo $_GET['Numero']; ?>">
        <input type="hidden" name="datos[Nombre]" id="Nombre" value="<?php echo $_GET['Nombre']; ?>">
        <input type="hidden" id="cliente_id" value="<?php echo $_GET['ci']; ?>">
