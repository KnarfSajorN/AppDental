...
<?php if ($_GET['accion'] == "create"):
    ...
    $datos = [];
    $queryC = mysqli_query($conn3, "SELECT * from configElement where t = '{$_POST['t']}' order by id asc");
    $queryL = mysqli_query($conn3, "SHOW columns from configElement where `Field` like '%label_%'");
    $queryE = mysqli_query($conn3, "SHOW columns from configElement where `Field` like '%element_%'");
    $i = -1;
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table class="table" data-table-ident="<?= $_POST['identificador'] ?>">
                    ...
                    <tbody>
                        <?php $query = mysqli_query($conn3, "SELECT * FROM configElement where t = '{$_POST['table']}'") ?>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <select onchange='crearElemento(this, this.value, "<?= $_POST["identificador"] ?>")' class="form-control" id="elements">
                                        <?php $querycreadoroptions = mysqli_query($conn3, "SELECT * FROM creadoroptions where estado = 1 order by tag asc") ?>
