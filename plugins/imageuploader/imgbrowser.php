...
$_POST["directorio"]="estetica/ArchivosPlantillas/".$_SESSION['ID'];
*/
...
<div id="header">
    ...
    <img onclick="Cookies.remove('qEditMode');session_destroy();window.close();" src="img/cd-icon-close-grey.png" class="headerIconRight iconHover">
