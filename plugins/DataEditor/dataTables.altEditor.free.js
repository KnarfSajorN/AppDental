    ...
    $.extend(
        altEditor.prototype,
        {
            ...
            _initLanguage: function () {
                ...
                this.language.edit = { 
                    title: this.language.edit.title || 'Editar Dato',
                    button: this.language.edit.button || 'Editar'
                };
                this.language.delete = this.language.delete || {};
                this.language.delete = { 
                    title: this.language.delete.title || 'Eliminar Dato',
                    button: this.language.delete.button || 'Eliminar' 
                };
                this.language.add = this.language.add || {};
                this.language.add = { 
                    title: this.language.add.title || 'Agregar Dato',
                    button: this.language.add.button || 'Agregar'
                };
            ...
            */
            createDialog: function(columnDefs, title, buttonCaption, closeCaption, buttonClass, formName) {
                ...
                var fill = function () 
                {
                   ...
                   /*
                    if (CKEDITOR.instances["Valores_Referencia_Caracteristica"]) { // Check null
                        CKEDITOR.instances["Valores_Referencia_Caracteristica"].destroy(); 
                    } 
                    CKEDITOR.replace('Valores_Referencia_Caracteristica');
                    */
                    ...
                    //ckeditor
                    if (document.getElementById('Valores_Referencia_Caracteristica') != null) {
                        ClassicEditor
                            .create(document.querySelector('#Valores_Referencia_Caracteristica'))
                            .catch(error => {
                                //console.error(error);
                            });
                    }
