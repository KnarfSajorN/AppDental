...
$queryList = mysqli_query($conn3, "SELECT * FROM  Historia_Control_Prenatal where id = $historiaClinica1");
...
if (isset($_GET['tipo'])) {
  ...
  $mensajeW = 'Sr(a) *' . $nombre_cliente . '* Se le envía el siguiente documento registrado, para visualizarlo ingresar en el siguiente link: ' . $Base . 'GO_ImprimirControlPrenatal.php?historiaClinica1=' . ($historiaClinica1) . '&tipo=consulta';
  $accion = 0;
...
<div class="content-wrapper p-3">
  ...
  <section class="content">
    ...
    <div align="center">
      ...
      <a class="btn btn-outline-info btn-lg rounded-pill shadow" target="_blank" href="<?php echo $Base; ?>GO_ImprimirControlPrenatal.php?historiaClinica1=<?php echo $historiaClinica1; ?>&tipo=consulta">
    ...
    <?php 
        $botonesImprimir = [
          ['Consulta', base64_encode($Base.'GO_ImprimirControlPrenatal_plantilla.php?historiaClinica1='.encrypt($historiaClinica1).'&tipo=consulta')],       
        ];
...
<a class="btn btn-outline-info btn-lg rounded-pill shadow" href="<?php echo $Base; ?>GO_FinalizadoControlPrenatal.php?historiaClinica1=<?php echo ($historiaClinica1); ?>&tipo=consulta">
