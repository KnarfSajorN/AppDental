...
$mensajeW = 'Sr(a) *'.$nombre_cliente.'* Se le ha generado un reporte motivo de la consulta con el Dr. '.$Nombre.'; para ver Historia ingresar por el siguiente link:  '.$Base.'/configImprimirConsulta.php?iC='.encrypt($historiaClinica).'&iCr=' . encrypt($idHistoria);
...
$para ="$email";
             ...
             <div>  Link para ver Historia: '.$Base.'verHistoriaClinica/'.encrypt($historiaClinica).'/'.encrypt($idHistoria).'
       ...
       echo "<script language='Javascript'> window.location='cPacientes?iCr=".encrypt($idHistoria)."';</script>"; 
