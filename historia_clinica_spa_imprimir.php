    ...
    <table>
      ...
      <div class="row">
        ...
        <div class="col-xs-4">
          ...
          <img src="archivos/e_tratamiento/<?php echo $img11 ?>" style="width: 100%; height: auto;">
        </div>
      <?php endif ?>
      ...
      <?php if ($img12<>''): ?>
        <div class="col-xs-4">
          ...
          <img src="archivos/e_tratamiento/<?php echo $img12 ?>" style="width: 100%; height: auto;">
        </div>
      <?php endif ?>
      ...
      <?php if ($img13<>''): ?>
        <div class="col-xs-4">
          ...
          <img src="archivos/e_tratamiento/<?php echo $img13 ?>" style="width: 100%; height: auto;">
        </div>
      <?php endif ?>
