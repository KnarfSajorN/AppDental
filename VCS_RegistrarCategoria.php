...
if (isset($_POST['Guardar_Informacion_Pagina'])) {
    ...
    if ($queryList != true) {
        ...
        echo "<script language='Javascript'> window.location='{$ruta}?msg=Se La Categoria Correctamente'</script>";
    }
}
...
if (isset($_POST['Actualizar_Informacion_Pagina'])) {
    ...
    if ($queryList != true) {
        ...
        echo "<script language='Javascript'> window.location='{$ruta}?msg=Se Actualizo La Categoria Correctamente'</script>";
    }
}
///////////////////////////////////////////////////////////////////////////
if ($_GET['Eliminar'] <> "") {
    ...
    if ($queryList != true) {
        ...
        echo "<script language='Javascript'> window.location='{$ruta}?msg=Se Elimino La Categoria Correctamente'</script>";
    }
}
///////////////////////////////////////////////////////////////////////////
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li><a href="#"> Registro de Categorías de las Vacunas </a></li>
        </ol>
    </section>
    ...
    <section class="content">
        <div class="row">
            <div class="content">
                <h4 class="Titulo_Pagina">Registro de Categorías de las Vacunas</h4>
                <div class="box">
                    <div class="box-body">
                        <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST">
                            <div class="form-group col-md-12">
                                <label>Nombre</label>
                                <input type="text" class="form-control input-lg" name="Arreglo[Nombre]" placeholder="Categoria" maxlength="120" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" required>
                            </div>

                            <div class="form-group col-md-12">
                                <label>Descripción</label>
                                <textarea class="form-control input-lg" name="Arreglo[Descripcion]" placeholder="Descripcion"></textarea>
                            </div>
                                        ...
                                        <table id="example1" class="table table-bordered table-striped">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col" width='10%'>Nombre de la Categoria</th>
                                            ...
                                            <tbody>
                                                ...
                                                while ($rowMotorizado = mysqli_fetch_array($queryList)) {
                                                    ...
                                                    if($id=="1"){
                                                        echo "<td width='10%' align='center'></td></tr>";
                                                    }else{
                                                        echo "<td width='10%' align='center'><font color='#04CC05'> <a href='{$ruta}?Editar={$id}' class='btn btn-primary' style='width: 200px;'><i class='fa fa-pencil' title='Editar'> Editar</i></a></font><br>
