              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <td>';
                    ...
                    echo '<a href="historiaClinica6_fisioterapia.php?clienteId=' . $fila[0] . '" title="Agregar Fisioterapia"><i class="fa fa-child"></i> </a>|';
                    echo '<a href="consultaCliente_fisioterapia.php?clienteId=' . $fila[0] . '" title="Ver Historia fisioterapia"><i class="fa fa-search"></i> </a> |';

                    echo '<a href="CrearPaciente.php?clienteId=' . $fila[0] . '" title="Editar Cliente"><i class="fa fa-pencil"></i> </a> |';
