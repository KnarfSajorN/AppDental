...
try {
    ...
    $Tabla = "OBT_Historia";
    $_POST["datos_odonto"] = json_encode($_POST["datos_odonto"]);
    
    if (!array_key_exists('ID_principal', $_POST)) {
        $_POST["ID_principal"] = $_SESSION["ID_principal"];
    }
    ...
    $rutaGo = $Base . "OBT_Finalizado?id=" . encrypt($id);
