                                                ...
                                                ?>
                                                    ...
                                                    <div class="panel panel-default" style="background: #f1f1f1;">
                                                        <div class="panel-heading" role="tab" id="heading" style="background-color: #bad8e687;">
                                                            <h4 class="panel-title">
                                                                <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#Historia<?= $ID ?>a" aria-expanded="false" aria-controls="Historia<?= $ID ?>a">
                                                                    ...
                                                                    <button title="Ver Finalizado" onclick="window.open('OBT_Finalizado?id=<?= encrypt($ID) ?>', '_blank')" style="border: hidden;background-color: initial;font-size: 20px;" t><i class="fa-regular fa-rectangle-list"></i>
                                                                    </button>
                                                                    |
                                                                    <button onclick="window.open('OBT_Seguimiento?cliente_id=<?php echo encrypt($clienteId); ?>&historia_id=<?=6987?>&tabla=<?php echo encrypt($Tabla); ?>', '_blank', 'noopener')" style="border: hidden;background-color: initial;font-size: 20px;" title="Seguimientos"><i class="fas fa-folder-plus"></i></button>

                                                                    <button onclick="window.open('OBT_SeguimientoHistorial?cliente_id=<?php echo encrypt($clienteId); ?>&historia_id=<?=6987?>&tabla=<?php echo encrypt($Tabla); ?>', '_blank', 'noopener')" style="border: hidden;background-color: initial;font-size: 20px;" title="Ver Seguimientos"><i class="fas fa-book"></i></button>
                                                                    |
                                                                    <button onclick="window.open('EV_EvolucionHistorias.php?cliente_id=<?php echo encrypt($clienteId); ?>&historia_id=<?=6987?>&tabla=<?php echo encrypt($Tabla); ?>', '_blank', 'noopener')" style="border: hidden;background-color: initial;font-size: 20px;" title="Nota de Evolución"><i class="fa fa-file"></i></button>

                                                                    <button onclick="window.open('EV_EvolucionHistorial.php?cliente_id=<?php echo encrypt($clienteId); ?>&historia_id=<?=6987?>&tabla=<?php echo encrypt($Tabla); ?>', '_blank', 'noopener')" style="border: hidden;background-color: initial;font-size: 20px;" title="Ver Nota de Evolución"><i class="fa fa-eye"></i></button>
                                                        ...
                                                        <div id="Historia<?= $ID ?>a" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading" style="padding-top: 20px;background-color: rgb(238, 238, 238);">
                                                            ...
                                                            <?php require __DIR__ . '/Require_Contenido_Historia.php'; ?>
