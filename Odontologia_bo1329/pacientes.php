...
<script>
    ...
    },
    {
        "data": function (row, type, set) {
            botones = "";
            botones += "<a href='OBT_Historia?cI=<?= salt() ?>" + btoa(row.cliente_id) + "' title='Nueva historia'><i class='fas fa-file-medical'></i> </a>";
            botones += "<a href='OBT_VerPaciente?cI=<?= salt() ?>" + btoa(row.cliente_id) + "' title='Ver historial'><i class='fas fa-book-medical'></i> </a>";
            botones += "<a href='PT_NuevoPlanTratamiento?clienteId=" + row.cliente_id + "' title='Agregar Plan de Tratamiento'><i class='fas fa-file'></i> </a>";
            botones += "<a href='nuevoPaciente?cI=<?= salt() ?>" + btoa(row.cliente_id) + "' title='Editar Cliente'><i class='fa fa-pencil'></i> </a>";
            botones += "<a href='OBT_Imagenes?cI=<?=salt()?>" + btoa(row.cliente_id) + "' title='Antes, durante y después'><i class='far fa-images text-info'></i> </a>";
...
require_once ("../ajaxCreadorSelect.php");
