...
if (isset($_POST['Actualizar_Informacion_Pagina'])) {
    ...
    $Campo1 = mysqli_query($conn3, "show COLUMNS from Siva WHERE Field = 'idCuentaContable';");
    $nrowCampo1 = mysqli_num_rows($Campo1);
    if ($nrowCampo1 == "0") {
        mysqli_query($conn3, "ALTER TABLE `Siva` ADD `idCuentaContable` TEXT NULL DEFAULT '0' COMMENT '*Creado desde modulo de CTB_IvaCuentaC*'");
    }
                              ...
                              <table class="table table-striped table-bordered" id="example1" style="width:100%">
                                ...
                                <tbody>
                                  ...
                                  while ($RowIva = mysqli_fetch_assoc($ResultsIva)) {
                                    ...
                                    $valor = $RowIva['valor'];
                                    $idCuentaContable = $RowIva['idCuentaContable'];
