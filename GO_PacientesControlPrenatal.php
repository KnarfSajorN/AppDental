...
?>
  ...
  <div class="content-wrapper p-3">
    ...
    <section class="content">
      <div class="">
        <div class="col-xs-12">
          <h4 class="Titulo_Pagina">Modulo de Pacientes Control Prenatal</h4>
...
columnastablas=[
                ...
                { "data": function ( row, type, set ) {
                        botones="";
                        botones+="<a href='GO_HistoriaControlPrenatal.php?clienteId="+row.cliente_id+"' title='Control Prenatal'><i class='fas fa-file-medical'></i> </a>";
                        botones+="<a href='GO_HistorialControlPrenatal.php?clienteId="+row.cliente_id+"' title='Historial Control Prenatal'><i class='fa fa-book'></i> </a>";
