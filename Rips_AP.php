...
header('Content-Disposition: attachment; filename=RipsAP.xls');
...
echo '<table border="1" cellpadding="2" cellspacing="0" width="100%">
    <tr>
        ...
        <td>Codigo del procedimiento</td>
        <td>Ambito de realizacion del procedimiento</td>
        <td>Finalidad del procedimiento</td>
        <td>Personal que atiende</td>
        <td>Diagnostico principal</td>
        <td>Diagnostico relacionado</td>
        <td>Complicacion</td>
        <td>Forma de realizacion del acto quirurgico</td>
