            ...
            <div class="col-xs-12 table-responsive">
                <table class="table table-striped" border="1">
                    ...
                    <tbody>
                        ...
                        $queryList = mysqli_query($conn3, "SELECT * FROM  cliente where (usuario_id='{$_SESSION['ID']}' or usuario_id='{$_SESSION['ID_principal']}') and fechar BETWEEN '$desde' and '$hasta' ");
                        $nrowl = mysqli_num_rows($queryList);
                        while ($rowMotorizado = mysqli_fetch_array($queryList)) {
...
<?
    ...
    header('Content-Disposition: attachment; filename=ReporteClientes' . date("Y-m-d") . '.xls');
    ?>
    <!DOCTYPE html>
    <html>
