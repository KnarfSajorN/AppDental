...
$idOperacion = base64_decode($_GET['idOperacion']);
  ...
  <div class="wrapper">
    ...
    <section class="invoice">
      ...
      <div class="row no-print">
        <div class="col-xs-12">
          <a href="OD_ImprimirPresupuesto?idOperacion='<?php echo $idOperacion ?>'" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Imprimir</a>
