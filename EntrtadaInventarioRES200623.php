...
//	echo '<br>cantidadReg ='.$cantidadReg.'<br>';
	...
	mysqli_query($conn3,"update operacioninv set estado = 1, tipoDoc = 1, fechaReg = '$date', numero = $salidaInv where ususario_id = '$usuario_id' and id = '$id'");
...
mysqli_query($conn3,"INSERT INTO opracioninvheader (usuario_id, tipoDoc, fechaReg, cantidadReg, totalCosto, totalPrecio, catidadTotal, numero, idTercero, nombre, rut) VALUES 
	        ('$usuario_id', '1', '$date', '$cantidadReg', '$totalCosto', '$totalPrecio', '$catidadTotal', '$salidaInv', '$tercero', '$nombre', '$rut');");
