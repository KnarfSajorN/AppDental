...
<div class="content-wrapper p-3">
  ...
  <section class="content">
    <div class="">
      <div class="col-xs-12">
        <h4 class="Titulo_Pagina">Pacientes Historia Gineco-Obstetrica</h4>
        <?php
        $msg = $_GET['msg'];
        if ($msg == '1') {
  ...
  columnastablas = [{
    ...
    },
    {
      "data": function(row, type, set) {
        botones = "";
        botones += "<a href='GO_Historia_Clinica_Ginecobstetrica?clienteId=" + row.cliente_id + "' title='Agregar Historia'><i class='fas fa-file-medical'></i> </a>";
        ...
        botones += "<a href='GO_Historial_Clinico_Ginecobstetrica?clienteId=" + row.cliente_id + "' title='Ver historial'><i class='fas fa-book-medical'></i> </a>";
        ...
        botones += "<a href='historiaClinica_ecografias.php?clienteId=" + row.cliente_id + "' title='Agregar Ecografias'><i class='fa fa-child'></i> </a>";
        botones += "<a href='#usuarioModal' data-toggle='modal' data-target='#my-modal-Estado-Ingreso' title='Procedimientos' onclick=\"verIngresos({cliente_id: " + row.cliente_id + ", usuario_id: <?= $_SESSION['ID'] ?>})\"><i class='fa fa-user text-danger'></i> </a>";
        botones += "<a href='historiaImagenes.php?clienteId=" + row.cliente_id + "' title='Anexar Archivos'><i class='fa fa-folder-open'></i> </a>";
        */
        //botones += "<a href='modal.php?clienteId=" + row.cliente_id + "' title='Examenes'><i class='fa-solid fa-briefcase-medical'></i> </a>";
        return botones;
      }
    }
  ];
