  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Registro de Examenes y Documentos
         
      </h1>
      <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Registro de Examenes y Documentos</a></li>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <td>    
                      ...
                      <a href="historiaImagenes.php?clienteId='.$fila[0].'"><i class="fa fa-plus"></i>Agregar </a>  
