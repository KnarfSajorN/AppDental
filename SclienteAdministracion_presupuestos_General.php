  ...
  <div class="content-wrapper p-4">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Realizar Presupuestos</a></li>
...
query_tabla_ajax="<?php echo "SELECT * FROM  cliente WHERE 1=1 $queryCliente and activo = 1 order by cliente_id";?>";
<?php }elseif ($_SESSION['vista'] == 1){  ?>
query_tabla_ajax="<?php echo "SELECT * FROM  cliente where usuario_id = $ID and activo = 1 $queryCliente  order by cliente_id";?>";
<?php }  ?>
...
columnastablas=[
                ...
                { "data": function ( row, type, set ) {
                        botones="";
                        botones+="<a href='SgenerarPresupuesto.php?clienteId="+row.cliente_id+"' title='Generar Presupuesto'><button type='button' class='btn btn-block btn-outline-info rounded-pill shadow m-1'>Generar Presupuesto</button></a>";
