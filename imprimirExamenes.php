...
<?php  if ( $laboratorio<> '') { $antecedentesPers1 = 'Laboratorio <br>'. $laboratorio;} ?>
...
<p>
  ...
  <?php  if ( $ecografia<> '') { $antecedentesPers2 = 'Ecografias <br>'. $ecografia;} ?>
  <?php  echo  $antecedentesPers2 ?>
...
<p>
  <?php  if ( $otros<> '') { $antecedentesPers3 = 'Otros Examenes <br>'.$otros;} ?>
  <?php  echo  $antecedentesPers3 ?>
