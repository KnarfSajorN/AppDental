...
include("funciones/funcionesUtilidades.php");
            ...
            $id_vacunacion = decrypt($_GET['iDv']);
    ...
    <table>
        ...
        <tbody>
         ...
         <?php
          ...
          echo '<img src="https://chart.googleapis.com/chart?chs=120x120&cht=qr&chl='.$direccion.'&choe=UTF-8" title="Link to Google.com" />';
    ...
    <div class="col-md-12">
      ...
      <table  class="table table-bordered" style="font-size:95%;">
        <tbody>
            ...
            <td colspan="2" align="center"> <b><u> Certificado de Inyección</b></u> </td>
          </tr>
          <tr>
