...
<div class="content-wrapper p-3">
  ...
  <section class="content">
    <div class="box">
      <div class="col-md-12">
        <h4 class="Titulo_Pagina">Pacientes Historia Otorrino</h4>
  ...
  columnastablas = [{
    ...
    },
    {
      "data": function(row, type, set) {
        botones = "";
        botones += "<a href='HO_Historia_Otorrino?clienteId=" + (row.cliente_id) + "' title='Agregar Historia'><i class='fas fa-file-medical'></i> </a>";
        botones += "<a href='HO_Historial_Otorrino?clienteId=" + (row.cliente_id) + "' title='Ver Historial'><i class='fas fa-book-medical'></i> </a>";
