...
<a class="btn btn-app" href="<?php echo $Base;?>pacientesPosOperatorio.php"> 
...
<a class="btn btn-app" target="_blank" href="<?php echo $Base;?>imprimirInformePostOperatorio.php?historiaClinica1=<?php echo $historiaClinica1;?>"> 
  <i class="fa fa-print"></i> Imprimir Informe Quirurgico 
</a>
<!--
