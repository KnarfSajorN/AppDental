...
include 'funciones/conn3.php';
            ...
            $historiaClinica1 = $_GET['historiaClinica5'];




                $queryList=mysqli_query($conn3,"SELECT * FROM  epidemiologia where ID =  $historiaClinica1");
...
<div class="row">
 ...
 <?php
  ...
  ?>
        ...
        <div class="row">
              <div class="col-xs-8">  <h6>SNS-MSP/DR ALBUJA CENTROS MEDICOS/HCU-Form.012A/2008</h6> </div>
               <div class="col-xs-4">   <h6>IMAGENOLOGIA-SOLICITUD</h6> </div>
