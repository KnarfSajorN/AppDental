      ...
      <div class="col-xs-12 table-responsive">
        <table class="table table-striped" border="1">
          ...
          <tbody>
            ...
            if ($tipo == 0) {
              ...
              $queryList = mysqli_query($conn3, "SELECT * FROM  sOperacionInv  where activo = 1 and (ID_principal = '{$_SESSION['ID']}' or ID_principal = '{$_SESSION['ID_principal']}') and idCliente = $tipo and fechaOperacion BETWEEN '$desde' and '$hasta' and tipo IN (2,4,5,6) order by numeroDoc asc ");
            }
            $sumtotalNeto = 0;
            $summontoPagado = 0;
        ...
        <div class="col-xs-12 table-responsive">
          ...
          if ($tipo == 0) {
            ...
            $queryList = mysqli_query($conn3, "SELECT * FROM  sOperacionInv  where (ID_principal = '{$_SESSION['ID']}' or ID_principal = '{$_SESSION['ID_principal']}') and idCliente = $tipo and fechaOperacion BETWEEN '$desde' and '$hasta' and tipo IN (2,4,5,6) order by numeroDoc asc");
          }
          ...
          <table class="table table-striped" border="1">
            ...
            <tbody>
              ...
              if ($tipo == 0) {
                ...
                left join sOperacionInv sin on abo.numero_operacion = sin.idOperacion
                INNER JOIN Medios_Pago mp ON abo.pago = mp.id 
                WHERE sin.fechaOperacion BETWEEN '$desde' AND '$hasta'  and abo.cliente_id = $tipo
                and (sin.ID_principal = '{$_SESSION['ID']}' or sin.ID_principal = '{$_SESSION['ID_principal']}')
                and sin.tipo IN (2,4,5,6)
                -- GROUP BY mp.Nombre
                ");
        ...
        <table class="table table-striped" border="1">
          ...
          <tbody>
            ...
            if ($tipo == 0) {
              ...
              $queryList = mysqli_query($conn3, "SELECT * FROM  sOperacionInv  where activo = 1 and (ID_principal = '{$_SESSION['ID']}' or ID_principal = '{$_SESSION['ID_principal']}') and idCliente = $tipo and fechaOperacion BETWEEN '$desde' and '$hasta' and tipo IN (2,4,5,6) ");
            }
            $sumtotalNeto = 0;
            $summontoPagado = 0;
            if ($queryList) {
