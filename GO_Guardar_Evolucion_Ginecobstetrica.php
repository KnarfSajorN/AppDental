<?php
 ...
 //  include 'menu.php'; 
  ...
  include 'guardarCita_Include.php';
        ...
        mysqli_query($conn3,"INSERT INTO evoluciones (cliente_id, usuario_id, Fecha, Hora,  motivoConsulta, id_historiaClinica,Realizado_Desde) VALUES  ('$clienteId', '$ID', '$fechar', '$hora',  '$motivoConsulta','$historiaClinica','Historia_Clinica_Ginecobstetrica');");
...
$Recetario_Nombre_Historia = "evoluciones";
 ...
 foreach($_FILES["archivo"]['tmp_name'] as $key => $tmp_name)
    {
        ...
        if($_FILES["archivo"]["name"][$key]) {
            ...
            $filename = $Ran."-".$_FILES["archivo"]["name"][$key]; //Obtenemos el nombre original del archivo
  ...
  $descripcion = $_POST['NombreC'];

    mysqli_query($conn3,"INSERT INTO archivos (cliente_id,usuario_id,historia_id,codigo,fecha, descripcion,NombreVisual,estado,Realizado_Desde) VALUES   ('$clienteId', '$ID', '$historiaClinica1','$filename','$fechar', '$descripcion','$NombreC', '1','evoluciones')") or die(mysqli_error($conn3));
...
echo "INSERT INTO archivos (cliente_id,usuario_id,historia_id,codigo,fecha, descripcion,NombreC) VALUES   ('$clienteId', '$ID', '$historiaClinica1','$filename','$fechar', '$descripcion','$NombreC')";  
...
echo "<script language='Javascript'> window.location='GO_Finalizado_Evolucion_Ginecobstetrica?historiaClinica1=$historiaClinica1';</script>";
