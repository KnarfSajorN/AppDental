              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                 ...
                 echo'<td><a href="historiaClinica_ecografias.php?clienteId='.$fila[0].'" title="Agregar Cita">'.$fila[2].' </a></td>';
                  ...
                  echo '<a href="historiaEntrevista_operadorTerapeutico.php?clienteId='.$fila[0].'" title="Agregar Entrevista"><i class="fa fa-heartbeat"></i> </a>|';  
                 echo '<a href="consultaCliente_OperadorTerapeutico.php?clienteId='.$fila[0].'" title="Ver Historia Operador"><i class="fa fa-search"></i> </a> |';
