  ...
  columnastablas = [{
    ...
    },
    {
      "data": function(row, type, set) {
        botones = "";
        botones += "<a href='HC_HistoriaGeneral?cI=<?=salt()?>" + btoa(row.cliente_id) + "' title='Agregar Historia'><i class='fas fa-file-medical'></i> </a>";
        ...
        botones += "<a href='HC_HistorialGeneral?cI=<?=salt()?>" + btoa(row.cliente_id) + "' title='Ver historial'><i class='fas fa-book-medical'></i> </a>";
