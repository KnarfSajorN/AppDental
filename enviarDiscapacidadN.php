...
$mensajeW = 'Sr(a) *'.$nombre_cliente.'* Se le ha generado una Incapacidad motivo de la consulta con el Dr. '.$Nombre.'; para ver incapacidad ingresar por el siguiente link:  '.$Base.'/verIncapacidad/'.$historiaClinica1.' ';
...
$para ="$email";
                ...
                // título
                $titulo = 'Incapacidad resultado de consulta con el Dr. '.$Nombre.'';

                // mensaje
                $mensaje = '
                <html>
                <head>
                  <title>Incapacidad de consulta la Empresa'.$nombreF.'</title>
                    <body> 
                    
                               Hola buen dia señor(a) '.$nombre_cliente.', Enviamos link para ver Incapacidad. :<br><br>

                
             <div>  Link para ver Incapacidad: '.$Base.'/verIncapacidad/'.$historiaClinica1.'
                ...
                $cabeceras .= 'From:  Incapacidad Medica <noreply@medicalsoftplus.com>' . "\r\n";
