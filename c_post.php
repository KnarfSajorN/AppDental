...
<div class="tab-pane" id="Consultas5" >
      ...
      <form action="c_post_enviar.php" method="POST" enctype="multipart/form-data">
...
<label> 
 ...
 <textarea  id="editor1" name="contenido" rows="110" cols="180"></textarea>
          ...
          <button type="submit" class="btn btn-block btn-primary btn-sm" id="registro_usuario" name="registro_usuario"><h4> Enviar </h4></button>
