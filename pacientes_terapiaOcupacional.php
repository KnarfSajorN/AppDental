      ...
      ?>
          ...
          <div class="box">
            <div class="box-header">
              <a href="nuevoPaciente_ecografias.php">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                 ...
                 echo'<td><a href="historiaClinica_ecografias.php?clienteId='.$fila[0].'" title="Agregar Cita">'.$fila[2].' </a></td>';
                  ...
                  echo '<a href="historiaClinica_terapiaOcupacional.php?clienteId='.$fila[0].'" title="Agregar seguimiento Terapia"><i class="fa fa-heartbeat"></i> </a>|';  
                  echo '<a href="consultaCliente_terapiaOcupacional.php?clienteId='.$fila[0].'" title="Ver Historia fisioterapia"><i class="fa fa-search"></i> </a> |';
