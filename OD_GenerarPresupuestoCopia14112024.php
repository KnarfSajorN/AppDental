                  ...
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                     ...
                     <div class="form-group col-md-2" align="center" style="margin-top: 27px;">
                       <center><button type="submit" class="tn btn-block btn-outline-info rounded-pill shadow m-1" name="GuardarDetalleOrden"> <font size="5"> <strong> + </strong>  </font></button></center>
                    </div>
                  ...
                  <div class="form-row">
                    ...
                    <?php 
                      ...
                      <label for="">Factura a nombre del Doctor </label>
                       ...
                       <br>
                      <center><button type="submit" class="btn btn-block btn-outline-danger rounded-pill shadow m-1"> <strong> <h1>  Totalizar Presupuesto</h1> </strong> </button></center>
