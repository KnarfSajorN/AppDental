...
<script type="text/javascript">
  ...
  function drawChart() {
    ...
    data.addColumn('number', 'Logo - Logoaudiometria');
...
<body>
	<div class="row">
	<div class="col-md-12" align="center"> <h3> Grafia de Alta Frecuencia: </h3> </div>
    <div id="curve_chart" class="col-md-12" align="center" style="width: 1100px; height: 600px"></div>
...
<body style="margin-left: -135px;">
	<div class="row">
	<div class="col-md-12" align="center"> <h3 class="titulo_grafica" > Grafia de Multifrecuencia: </h3> </div>
    <div id="curve_chart" class="col-md-12" align="center" style="width: 1550px; height: 600px;zoom: 0.9;"></div>
      ...
      {  
        ...
        for(index in iconos_arreglo) 
        {
          ...
          if(url!=null && yPos !=null)
          {
            ...
            whiteHat[index].className = 'whiteHat';
            // 16x16 (image size in this example)
            whiteHat[index].style.top = (yPos+36) + 'px';
            whiteHat[index].style.left = (xPos-168) + 'px';
          }
...
<script type="text/javascript">
    ...
    function drawChart() {
        ...
        // <!-- Campos Editables-->
        vias_escrito<?php echo $NombreGrafica ?> = ["Oido Derecho", "Oido Izquierdo"];
        // <!-- Campos Editables-->
