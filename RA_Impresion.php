...
$queryList = mysqli_query($conn3, "SELECT * FROM  Historia_Anestesia where id = $idHistoria");
...
$Datos_Personales = "<table class='table' style='width: 100vw;margin-top: 3px;'>
                            <tr>
                                <td width='35%'>
        ...
        <tbody>
            <tr>
                <td>
                    ...
                    $queryList = mysqli_query($conn3, "SELECT * FROM  Historia_Anestesia where id = $idHistoria LIMIT 1");
                    $nrowl = mysqli_num_rows($queryList);
                    ...
                    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                        ...
                        $ArregloDatosPrimerModulo = array(
                            ...
                            "hora_inicio_anestesia" => $rowMotorizado['PrimerModulo_hora_inicio_anestesia'],
                            "hora_finaliza_anestesia" => $rowMotorizado['PrimerModulo_hora_finaliza_anestesia'],
                        ...
                        echo '
                        <table class="table table-bordered" style="width:100vw;">
                        <thead>
                        <tr>
                            <th>Fecha</th>
                            <th>Sala</th>
                        ...
                        <tr>
                            <th colspan="2">Hora inicio anestesia '.$ArregloDatosPrimerModulo['hora_inicio_anestesia'].'</th>
                            <th colspan="2">Hora finalización anestesia '.$ArregloDatosPrimerModulo['hora_finaliza_anestesia'].'</th>
                            <th colspan="2"></th>
                        </tr>
                        </tbody>
                        </table>';
                        ...
                        $ArregloDatosRegional = array(
                            ...
                            "Revision Maquina" => $rowMotorizado['AnestesiaRegional_Revision_Maquina'],//4
                            "Fujo O" => $rowMotorizado['AnestesiaRegional_Fujo_O'],
                            ...
                            "Linea Art" => $rowMotorizado['AnestesiaRegional_Linea_Art'],//5
                            "Fon Precord" => $rowMotorizado['AnestesiaRegional_Fon_Precord'],//6
                            "Fon Essofag" => $rowMotorizado['AnestesiaRegional_Fon_Essofag'],
                            "Sonda NG" => $rowMotorizado['AnestesiaRegional_Sonda_NG'],
                            "Sonda Vesical" => $rowMotorizado['AnestesiaRegional_Sonda_Vesical'],
                            "Swan Gans" => $rowMotorizado['AnestesiaRegional_Swan_Gans'],//6
                            "NT Der" => $rowMotorizado['AnestesiaRegional_NT_Der'],//7 -31
                            "OT" => $rowMotorizado['AnestesiaRegional_OT'],
                            "NT Izq" => $rowMotorizado['AnestesiaRegional_NT_Izq'],
                            "Tubo NO" => $rowMotorizado['AnestesiaRegional_Tuno_NO'],
                            ...
                            "S Abierto" => $rowMotorizado['AnestesiaRegional_S_Abierto'],
                            "S Cerrado" => $rowMotorizado['AnestesiaRegional_S_Cerrado'],//8
                        ...
                        echo'<table class="table table-bordered" style="width:100vw;">
                            <thead>
                            <tr>
                        ...
                        ?>
                                    ...
                                    <table class="table table-bordered" style="width:100vw;zoom: 0.8">
                                        <thead>
                                            <tr>
