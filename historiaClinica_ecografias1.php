...
<form action="guardarHistoriaClinica2_ecografias.php" method="POST" id="cri" name="cri" enctype="multipart/form-data">
                ...
                -->
                    <div class="box-header with-border text-center">
                      <h2 class="box-title">Ecografía obstétrica Segundo y Tercer Trimestre</h2>
                    </div>
                    <br>
                   ...
                   <!--     <div class="form-group col-md-6">
                    ...
                    <div class="col-md-6"> 
                        ...
                        <div class="form-group col-md-6">
                          <label class="control-label">Semanas DBP</label>
               ...
               <!--       <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="form-group col-md-6">
                          <label class="control-label">Semanas HC</label>
                ...
                <!--      <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="form-group col-md-6">
                          <label class="control-label">Semanas AC</label>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                          <label class="control-label">Semanas LF</label>
