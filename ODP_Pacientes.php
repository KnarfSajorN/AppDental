  ...
  <div class="content-wrapper p-3">
    ...
    <section class="content-header">
      <ol class="breadcrumb">
        ...
        <li><a href="#">Módulo Odontograma Pediátrico</a></li>
      </ol>
    </section>
    <!-- Main content -->
    <section class="content">
      <div class="">
        <div class="col-xs-12">
          <h4 class="Titulo_Pagina">Módulo Odontograma Pediátrico</h4>
...
columnastablas=[
                ...
                { "data": function ( row, type, set ) {
                        botones="";
                        botones+="<a href='ODP_Odontopediatria?clienteId="+row.cliente_id+"' title='Odontograma Pediátrico'><i class='fa fa-tooth'></i> </a>";
                        botones+="<a href='ODP_HistorialOdontogramaPediatrico?clienteId="+row.cliente_id+"' title='Historial Odontograma Pediátrico'><i class='fa fa-book'></i> </a>";
                        return botones;
                        }
                } 
