<?php
 ...
 //  include 'menu.php'; 
  ...
  $conn3 = mysqli_connect($host,$userdb,$pass2,$DB)or die ('Ha fallado la conexion MySQL: '.mysqli_error($conn3));
        ...
        $prescripciones = reem($_POST['prescripciones']);
        $medicamentos = reem($_POST['medicamentos']);
        ...
        mysqli_query($conn3,"INSERT INTO evolucionesE (cliente_id, usuario_id, Fecha, Hora,  motivoConsulta, id_historiaClinica, prescripciones,medicamentos) VALUES  ('$clienteId', '$ID', '$fechar', '$hora',  '$motivoConsulta','$historiaClinica', '$prescripciones','$medicamentos');");
...
echo "<script language='Javascript'> window.location='cVerPacienteE?cI=".encrypt($clienteId)."&iCr=".encrypt(30)."';</script>";
