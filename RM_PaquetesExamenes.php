              ...
              <div class="box box-solid">
                    ...
                    <form action="#" method="POST" name="formularioActualizarcliente">
                        ...
                        <div class="box-body">
                            ...
                            <tbody>
                    <?php                                         
                        $queryList=mysqli_query($conn3,"SELECT * FROM  RM_Paquete WHERE Activo='1' AND usuario_id='$_SESSION[ID]'");
                                      ...
                                      while($row_recordset32=mysqli_fetch_array($queryList))
                                      {
                                        ...
                                        <a href="RM_VerPaquete.php?id='.$id.'" class="btn btn-block btn-outline-info btn-lg rounded-pill shadow"  title="Ver/Editar Paquetes"><i class="fa fa-eye"></i>Ver Paquete/Procedimientos </a> <br> 
