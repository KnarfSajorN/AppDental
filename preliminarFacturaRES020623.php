...
-->
              <tr>
                <th>Pagado:</th>
                <td><?php echo $montoPagado.''.$moneda?></td>
              </tr>
               <tr>
                <th>Saldo:</th>
...
-->
      ...
      <div class="col-md-12" align="center" style="margin-top:20px;padding:0;">

<a class="btn btn-block btn-primary btn-sm" target="_blank" href="<?php echo $Base; ?>enviarFactura.php?cliente=<?php echo $idCliente; ?>&idOperacion=<?php echo $idOperacion ?>">
