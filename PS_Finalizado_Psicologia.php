...
if (isset($_GET['tipo'])) {
  ...
  $mensajeW = 'Sr(a) *' . $nombre_cliente . '* Se le envia el siguiente documento registrado en la cita ' . $Base . 'PS_Imprimir_Consulta_Psicologia?historiaClinica1=' . $historiaClinica1 . '';
  $accion = 0;
...
?>
      ...
      <div class="content-wrapper p-3">
        ...
        <section class="content-header">
            ...
            <section class="content">
              ...
              <a class="btn btn-outline-info btn-lg rounded-pill shadow" target="_blank" href="<?php echo $Base;?>PS_Imprimir_Consulta_Psicologia?historiaClinica1=<?php echo $historiaClinica1;?>"> 
                <i class="fa fa-print"></i> Imprimir Consulta 
              </a>

              <?php 
        $botonesImprimir = [
          ['Consulta', base64_encode($Base.'PS_Imprimir_Consulta_Psicologia_plantilla.php?historiaClinica1='.encrypt($historiaClinica1).'')],       
        ];
      ...
      <a class="btn btn-outline-info btn-lg rounded-pill shadow" href="<?php echo $Base; ?>PS_Finalizado_Psicologia?historiaClinica1=<?php echo $historiaClinica1; ?>&tipo=consulta">
