...
include '../menu.php';
$ID = $_SESSION['ID'];
$tabla = "nominaEmpresasCargos";
$page = 'nominaEmpresasCargos';
// cargar datos
if ($_GET['FAID']) {
...
if (!$_GET['e']) {
    echo "<script>location.href = './nominaSeleccionarEmpresa?p=" . base64_encode($page)."&n=" . base64_encode('Cargo') . "'</script>";
}
if ($idEmpresa == 0){
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                <div class="float-left">
                                    <h4><?= ($rowConfig != null ? 'Editar cargo #' . $rowConfig['id'] : 'Registrar nuevo cargo') ?> en <strong><?=$rowEmpresa['nombre']?></strong> </h4>
                                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-info">
                            <div class="card-header">
                                <div class="float-left">
                                    <h4>Listado de cargos en <strong><?=$rowEmpresa['nombre']?></strong></h4>
                                </div>
                            </div>
                            <div class="card-body">
