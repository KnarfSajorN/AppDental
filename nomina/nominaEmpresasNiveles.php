...
include '../menu.php';
$ID = $_SESSION['ID'];
$tabla = "nominaEmpresasNiveles";
$page = 'nominaEmpresasNiveles';
// cargar datos
if ($_GET['FAID']) {
...
if (!$_GET['e']) {
    echo "<script>location.href = './nominaSeleccionarEmpresa?p=" . base64_encode($page)."&n=" . base64_encode('Unidad Funcional') . "'</script>";
}
if ($idEmpresa == 0){
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                <div class="float-left">
                                    <h4><?= ($rowConfig != null ? 'Editar unidad funcional #' . $rowConfig['id'] : 'Registrar nueva unidad funcional') ?> en <strong><?=$rowEmpresa['nombre']?></strong> </h4>
                                </div>
                            ...
                            <form id="correoForm">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="" name="datos[responsable]" value="<?= $rowConfig['responsable'] ?>" autocomplete="new-password">
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-info">
                            <div class="card-header">
                                <div class="float-left">
                                    <h4>Listado de unidades funcionales en <strong><?=$rowEmpresa['nombre']?></strong></h4>
                                </div>
                            </div>
                            <div class="card-body">
...
?>
<script>
    titulo_tabla = 'Unidades funcionales';
