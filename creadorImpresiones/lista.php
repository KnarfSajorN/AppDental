...
<script>
    ...
    query_tabla_ajax = "<?= "SELECT * FROM  configImpresiones where estado = 1 and ID_principal in (0,'{$_SESSION['ID_principal']}') "; ?>";

    columnas = ['id', 'fechaRegistro', 'nombrePlantilla', 'tipoPapel', 'AnchoPapel', 'AltoPapel', 'orientacion', 'MargenSuperior', 'MargenInferior', 'MargenIzquierdo', 'MargenDerecho', 'encabezado', 'piePagina', 'usuario_id', 'fecha', 'ID_principal'];
