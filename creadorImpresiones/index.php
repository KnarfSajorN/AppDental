                                ...
                                <div class="col-md-12">
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control mt-2" id="encabezadoH" min="0" step="1" required name="datos[encabezadoH]" value="<?= ($rowConfig['encabezadoH'] > 0 ? $rowConfig['encabezadoH'] : 0) ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control mt-2" id="pieH" min="0" step="1" required name="datos[pieH]" value="<?= ($rowConfig['pieH'] > 0 ? $rowConfig['pieH'] : 0) ?>">
