                ...
                <div class="tab" role="tabpanel">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation"><a href="#Section1" aria-controls="home" role="tab" data-toggle="tab"
                                class="active"> <i class='fas fa-book-medical' style='font-size:26px'> </i> Historias
                                Epicrisis</a></li>
                        <li role="presentation"><a href="#Section2" aria-controls="home" role="tab" data-toggle="tab">
                                <i class='fas fa-book-medical' style='font-size:26px'> </i> Registros de Exámenes </a>
                        </li>
                    </ul>
                    <!-- Tab panes -->
                        ...
                        <div role="tabpanel" class="tab-pane fade in active show" id="Section1">
                            ...
                            <div class="col-md-12">
                                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                    ...
                                    $queryList = mysqli_query($conn3, "SELECT * FROM  historiaClinicaEpic where cliente_id = $clienteId and usuario_id = $usuarioId order by ID DESC");
                                    while ($rowMotorizado = mysqli_fetch_array($queryList)) {
                                        ...
                                        $antecedentes     = $rowMotorizado['detalle'];
                                    ...
                                    <div class="panel panel-default" style="background: #f1f1f1;">
                                        <div class="panel-heading" role="tab" id="heading"
                                            ...
                                            <h4 class="panel-title">
                                                <a class="collapsed" role="button" data-toggle="collapse"
                                                    ...
                                                    href="#HistoriaMedicinaEstetica<?php echo $id_medicinaEstetica ?>"
                                                    aria-expanded="false"
                                                    aria-controls="HistoriaMedicinaEstetica<?php echo $id_medicinaEstetica ?>">
                                                    Fecha
                                                    <?php echo $Fecha . " - " . $Hora . " | <strong> " . $envejecimiento . ' ' . $cirugia . " |  </strong>"; ?>
                                                    <button
                                                        onclick="window.open('configFinalizadoEpic.php?iC=<?php echo $id_medicinaEstetica; ?>', '_blank', 'noopener')"
                                                        style="border: hidden;background-color: initial;font-size: 20px;"><i
                                                            class="fa-regular fa-rectangle-list"></i></button>

                                                    <button
                                                        onclick="window.open('EV_EvolucionHistorias.php?cliente_id=<?php echo encrypt($cliente_id_modulo); ?>&historia_id=<?php echo encrypt($id_medicinaEstetica); ?>&tabla=<?php echo encrypt($TablaHistoria); ?>', '_blank', 'noopener')"
                                                        style="border: hidden;background-color: initial;font-size: 20px;"><i
                                                            class="fa fa-file"></i></button>

                                                    <button
                                                        onclick="window.open('EV_EvolucionHistorial.php?cliente_id=<?php echo encrypt($cliente_id_modulo); ?>&historia_id=<?php echo encrypt($id_medicinaEstetica); ?>&tabla=<?php echo encrypt($TablaHistoria); ?>', '_blank', 'noopener')"
                                                        style="border: hidden;background-color: initial;font-size: 20px;"><i
                                        ...
                                        <div id="HistoriaMedicinaEstetica<?php echo $id_medicinaEstetica ?>"
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <p> Peso: <?php echo $peso ?>, Altura: <?php echo $altura ?> , IMC:
                                                    <?php echo $imc ?> , <?php echo $ComposicionCorpora ?></p>
                                                ...
                                                <div class="col-xs-4">
                                                    ...
                                                    <img src="historiaClinica5/<?php echo $img11 ?>"
                                                ...
                                                <div class="col-xs-4">
                                                    ...
                                                    <img src="historiaClinica5/<?php echo $img12 ?>"
                                                        style="width: 50%; height: auto;">
                                                </div>
                                                <?php endif ?>
                                                ...
                                                <div class="col-xs-4">
                                                    ...
                                                    <img src="historiaClinica5/<?php echo $img13 ?>"
                                                        style="width: 50%; height: auto;">
                                                </div>
                                                <?php endif ?>
                                                    ...
                                                    <table class="table table-responsive"
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th scope="col"
                                                                    style="text-align: center;font-size: 25px;"><i
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="text-align: center;">
                                                                    <a target="blank"
                                                                        href="<?php echo $Base; ?>archivos/<?php echo $resulImg['codigo']; ?>">
                                                                ...
                                                                <td style="text-align: center;">
                                                                    <a target="_blank"
                                                                        href="<?php echo $Base; ?>archivos/<?php echo $resulImg['codigo']; ?>">
                                                                        <a
                                                                            href="<?php echo $Base; ?>archivos/<?php echo $resulImg['codigo']; ?>">Ver
                                                                            Archivo o Imagen <br>
                                                                        </a>
                                                                    </a>
                                                                </td>
                                                                <td style="text-align: center;">
                                                                    <a target="_blank"
                                                                        href="<?php echo $Base; ?>enviarArchivo.php?cliente=<?php echo $clienteId; ?>&id=<?php echo $Producto; ?>">
                                                                        Enviar Archivo <br>
                                                                    </a>
                                                                </td>
    ...
    <th>
        <a target="_blank" href="<?php echo $Base; ?>/archivos/<?php echo $resulImg['codigo']; ?>">
                                <a href="<?php echo $Base; ?>/archivos/'<?php echo $resulImg['codigo']; ?>'" >Ver Archivo o Imagen     <br>
                                                                ...
                                                                <td style="text-align: center;">
                                                                    <a target="_blank"
                                                                        href="<?php echo $Base; ?>enviarArchivoPaquete.php?cliente=<?php echo $clienteId; ?>&descripcion=<?php echo $descripcion; ?>">
                                                                        Enviar Archivos <br>
                                                                    </a>
                                                                </td>
                                                            </tr>
