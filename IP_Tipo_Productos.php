<?php 
  ...
  $Nombre_Tabla = "IP_Inventario_Tipo";
            ...
            <div class="box-body">
              ...
              <div class="col-xs-12">
                 <div class="box">
                    <div class="box-body">
                       <div class="col-md-12">
                        <h2 style="text-align: center;font-weight: bold;"> Tipo de Productos </h2>
                          <table id="example1" class="table table-bordered table-striped">
                             <thead>
                              ...
                              <tbody>
                                ...
                                $queryList=mysqli_query($conn3,"SELECT * FROM  {$Nombre_Tabla} WHERE usuario_id='$usuario_id'");
                                while($rowMotorizado=mysqli_fetch_array($queryList))
                                {
                                   //$contador++;
                                  $id = $rowMotorizado['id'];
