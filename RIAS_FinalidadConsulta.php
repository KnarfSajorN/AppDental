...
$Nombre_Tabla = "RIAS_FinalidadConsulta";
#Inicio
...
if (isset($_POST['Guardar_Informacion_Pagina'])) {
    ...
    if ($queryList != true) {
        echo "<script language='Javascript'> window.location='{$ruta}?error=Hubo Un Error Al Guardar La Finalidad de la Consulta'</script>";
    } else {
        echo "<script language='Javascript'> window.location='{$ruta}?msg=Se Guardo La Finalidad de la Consulta Correctamente'</script>";
    }
}
...
if (isset($_POST['Actualizar_Informacion_Pagina'])) {
    ...
    if ($queryList != true) {
        echo "<script language='Javascript'> window.location='{$ruta}?error=Hubo Un Error al Actualizar La Finalidad de la Consulta'</script>";
    } else {
        echo "<script language='Javascript'> window.location='{$ruta}?msg=Se Actualizo La Finalidad de la Consulta Correctamente'</script>";
    }
}
...
if ($_GET['Eliminar'] <> "" AND $_GET['Valid']==1) {
    ...
    if ($queryList != true) {
        echo "<script language='Javascript'> window.location='{$ruta}?error=Hubo Un Error Al Eliminar La Finalidad de la Consulta'</script>";
    } else {
        echo "<script language='Javascript'> window.location='{$ruta}?msg=Se Elimino La Finalidad de la Consulta Correctamente'</script>";
    }
}
                    ...
                    <div class="card-body">
                      ...
                      <div class="card-header-title font-size-lg text-capitalize font-weight-normal row" style="background-color:#17a2b812;padding: 20px;">
                        ...
                        <div class="col-md-6" style="align-self: center;">
                          <h2>Finalidad de la consulta</h2>
                        </div>
                        <div class="col-md-3">
