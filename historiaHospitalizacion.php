                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-solid">
                                <!-- /.box-header -->
                                <form action="guardarHistoriaHospitalizacion.php" method="POST" name="formularioActualizarcliente">
                                    <div class="box-body">
                                        ...
                                        <div class="box-group" id="accordion1">
                                            ...
                                            <!-- <div class="panel box box-primary">
                                                ...
                                                <div id="collapseTen" class="panel-collapse collapse">
                                                    <div class="box-body">
                                                        <div class="col-md-12">
                                                            <label>Tratmiento</label><textarea name="tratamiento" class="form-control input-lg" placeholder="Tratamiento" style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;max-width: 100%;"></textarea>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="box-header with-border">
                                                    <h4 class="box-title">
                                                        <a data-toggle="collapse" data-parent="#accordion1" href="#collapseEight">
                                                            Solicitud de Laboratorios y Exámenes Complementarios
                                                        </a>
                                                    </h4>
                                                </div>
                     ...
                     cierre de lista-->
                      ...
                      -->
                                            ...
                                            <div class="panel box box-primary">
                                                ...
                                                <div id="collapseSixteen" class="panel-collapse collapse">
                                                    ...
                                                    <div class="tab">
                                                        ...
                                                        <button type="button" class="tablinks" onclick="MenuAntecedentes(event, 'Indicaciones')">Indicaciones</button>
                                                        <button type="button" class="tablinks" onclick="MenuAntecedentes(event, 'Medidas')">Medidas</button>
                                                        <button type="button" class="tablinks" onclick="MenuAntecedentes(event, 'Medicamentos')">Prescripción o Medicamentos</button>
                                                        <button type="button" class="tablinks" onclick="MenuAntecedentes(event, 'Examenes')">Examanes</button>
                                                    ...
                                                    <div id="Indicaciones" class="tabcontent">
                                                        <div class="box-body">
                                                            ...
                                                            <div class="description">
                                                                <div class="col-md-12">
                                                                    <textarea name="indicaciones" class="form-control input-lg" placeholder="indicaciones" style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;max-width: 100%;"></textarea>
                                                                </div>
                                                                    ...
                                                                    <div class="card card-just-text" data-background="color" data-color="azul">
                                                                        <div class="content">
                                                                            <h4 class="title"><a href="#">
                                                                                    <h2> Prescripción o Medicamentos</h2>
                                                                                </a></h4>
                                                                            <div class="description">
                                                    ...
                                                    <div id="Medidas" class="tabcontent">
                                                        <div class="box-body">
                                                            ...
                                                            <div class="description">
                                                                <div class="col-md-12">
                                                                    <textarea name="medidas" class="form-control input-lg" placeholder="medidas" style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;max-width: 100%;"></textarea>
                                                                </div>
                                                            </div><!-- cierre de la descripcion-->
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="panel box box-primary">
                                                <div class="box-header with-border">
                                                    <h4 class="box-title">
                                                        <a data-toggle="collapse" data-parent="#accordion1" href="#collapseFor">
                                                            Evolucion Clinica
                                                        </a>
                                                    </h4>
                                                </div>
                                                <div id="collapseFor" class="panel-collapse collapse">
                                                    <div class="col-md-12">
                                                        <label>Evolucion Clinica</label><textarea name="evolucionClinica" class="form-control input-lg" placeholder="Evolucion Clinica" style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;max-width: 100%;"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--cierre de lista-->
