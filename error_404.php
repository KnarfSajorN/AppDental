...
<div class="container">
    <div class="left-section">
        <div class="inner-content" style="text-align-last: center;">
            <img src="isologoDental.png" alt="Dentalsoft" style="width:170px;height:170px; margin-top: 20px;">
            <h1 class="heading">404</h1>
            <p class="subheading">Parece que la página que estabas buscando ya no está aquí.</p><br>
            <p class="subheading">Si crees que es un error contacta con soporte.</p>
        </div>
    </div>
