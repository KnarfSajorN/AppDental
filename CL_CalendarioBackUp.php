    ...
    $(document).ready(function() {
        ...
        var calendar = $('#calendar').fullCalendar({
            ...
            events: [
                ...
                $queryList = mysqli_query($conn3, "SELECT * FROM  citas  where estado != '5' $filtro order by fecha asc ");
                // $nrowl = mysqli_num_rows($queryList);
                while ($RowCitas = mysqli_fetch_array($queryList)) {
                    ...
                    $MotivoConsulta = (is_numeric($RowCitas["motivoConsulta"]) ? utf8_encode(funcionMaster($RowCitas["motivoConsulta"], 'id', 'descripcion', 'Motivos_Consulta')) : $RowCitas["motivoConsulta"]);
            ...
            <div class="modal-content">
                ...
                <form action="Cambiar_Medico.php" method="POST">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-block btn-outline-info  rounded-pill shadow" data-dismiss="modal">Close</button>
                        <button class="btn btn-block btn-outline-info rounded-pill shadow" type="submit" name="submit" value="Submit">Aceptar</button>
                    </div>
                </form>
            </div>
