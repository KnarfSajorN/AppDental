...
<form action="guardarHistoriaClinica2_ecografias.php" method="POST" id="cri" name="cri" enctype="multipart/form-data">
                ...
                --> <br> <br>
                    <div class="box-header with-border text-center">
                      <h2 class="box-title">Ecografía Genética</h2>
                    </div>
                    <br>  <div class="form-group col-md-12"><hr style="border-color:blue;"></div>
                    <input type="hidden" name="tipo_ecografia"  value="Ecografia Genetica">
...
<td>
 ...
 <br>
                    <div class="box-header with-border">
                      <h1 class="box-title"> Fondo del saco</h1>
                    </div>
 ...
 <br><div class="form-group col-md-12"><hr style="border-color:blue;"></div>
                    <div class="box-header with-border"  align="center">
                      <h1 class="box-title">Ovario Derecho </h1>
                    </div>
                    <br>
  ...
  <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="control-label">Hallazgos </label>
 ...
 <br><div class="form-group col-md-12"><hr style="border-color:blue;"></div>
                    <div class="box-header with-border" align="center">
                      <h1 class="box-title">Ovario Izquierdo</h1>
                    </div>
                    <br>
  ...
  <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="control-label">Hallazgos </label>
                          <input type="text" name="hallazgos1" class="form-control">
                        </div>
                      </div>
 ...
 <br> <div class="form-group col-md-12"><hr style="border-color:blue;"></div>
                    <div class="box-header with-border"  align="center">
                      <h1 class="box-title"> Saco Gestacional </h1>
                    </div>
                    <br>
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="control-label">Medidas en mm/Semanas/Dias </label>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" name="bordes" class="form-control">
                        </div>
                      </div>
  ...
  <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="control-label">Reacción coriodecidual</label>
                          <input type="text" name="reaccion" class="form-control">
                        </div>
                      </div>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" name="hematomas" class="form-control">
                        </div>
                      </div>
...
<div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" name="formas" class="form-control">
                        </div>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" name="aestomago" class="form-control">
                        </div>
                      </div>
...
<div class="box-header with-border"  >
                      <h2 class="box-title" >Extremidades </h2>
                    </div>
                    <br>
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        ...
                        <label><input type="radio" name="polocefalico" value="presente"> Presente</label>

                        <label><input type="radio" name="polocefalico" value="ausente"> Ausente</label>
...
<div class="box-header with-border"  >
                      <h2 class="box-title" >Liquido Amniótico </h2>
                    </div>
...
<div class="box-header with-border"  >
                      <h2 class="box-title" >Vesicula Vitelina  </h2>
                    </div>
...
<br><div class="form-group col-md-12"><hr style="border-color:blue;"></div>
                    <div class="box-header with-border"  align="center">
                      <h1 class="box-title" > Traslucencia Nucal </h1>
                    </div>
                    <br>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label class="control-label">( N &lt; 2.5mm ) </label>
                          <input type="text" name="nucal" class="form-control">
                        </div>
                      </div>
...
<br><div class="form-group col-md-12"><hr style="border-color:blue;"></div>
                    <div class="box-header with-border"  align="center">
                      <h1 class="box-title" > Hueso Nasal </h1>
                    </div>
                    <br>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        ...
                        <label><input type="radio" name="hueso" value="presente"> Presente</label>

                        <label><input type="radio" name="hueso" value="ausente"> Ausente</label>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="control-label"> ( P95.N 2.1 – 2.7mm) </label>
                          <input type="text" name="valorhueso" class="form-control">
                        </div>
                      </div>
...
<br><div class="form-group col-md-12"><hr style="border-color:blue;"></div>
                    <div class="box-header with-border"  align="center">
                      <h1 class="box-title" > DUCTUS VENOSO </h1>
                    </div>
                    <br>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                        <label class="control-label">  Velocidad ( &gt; 80cm/seg)</label>  <br>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="control-label">Angulo ( &lt;30°) </label>
                       ...
                       <div class="col-md-4">
                        <div class="form-group">
                          <label class="control-label">Forma(Trifásica) </label>
                          <input type="text" name="forma" class="form-control">
                        </div>
                      </div>
...
<br><div class="form-group col-md-12"><hr style="border-color:blue;"></div>
                    <div class="box-header with-border"  align="center">
                      <h1 class="box-title" > FLUJO TRICUSPIDEO </h1>
                    </div>
                    <br>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        ...
                        <input type="text" name="velocidad1" class="form-control">
                          </div> 
                        </div>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="control-label">Angulo ( &lt;30°) </label>
                          <input type="text" name="angulo1" class="form-control">
                        </div>
                      </div>    
                       ...
                       <div class="col-md-4">
                        <div class="form-group">
                          <label class="control-label">Forma(Trifásica) </label>
                          <input type="text" name="forma1" class="form-control">
                        </div>
                      </div>
...
<br><div class="form-group col-md-12"><hr style="border-color:blue;"></div>
                    <div class="box-header with-border"  align="center">
                      <h1 class="box-title" > ANGULO FRONTO MAXILAR(N 77 – 85°)</h1>
                    </div>
                       
 <textarea class="form-control"  name="frontom" placeholder="" rows="3" ></textarea>
 ...
 <textarea class="form-control"  name="diagnostico" placeholder="" rows="3" ></textarea>
