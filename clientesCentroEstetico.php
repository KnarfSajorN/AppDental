...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="box">
      <div class="col-md-12">
        <h4 class="Titulo_Pagina">Pacientes Historia Centro Estético</h4>
  ...
  columnastablas = [{
    ...
    },
    {
      "data": function(row, type, set) {
        botones = "";
        botones += "<a href='HC_HistoriaCentroEstetico?cI=<?=salt()?>" + btoa(row.cliente_id) + "' title='Agregar Historia'><i class='fas fa-file-medical'></i> </a>";
        botones += "<a href='HC_HistorialCentroEstetico?cI=<?=salt()?>" + btoa(row.cliente_id) + "' title='Ver Historial'><i class='fas fa-book-medical'></i> </a>";
