...
Laboratorio <br>:'.$laboratorio.'
 </p>
<p>

 Ecografias <br>'.$ecografia.'
 </p>

<p>

 Otros Examenes <br>'.$otros.'
</p>
...
$mensajeW = 'Solicitud de examenes con el Dr. JOSE LUIS RAMIREZ OSORIO
Hola buen dia '.$nombrecliente.', Como resultado de su consulta con  el Doctor JOSE LUIS RAMIREZ OSORIO, se le ha formulado los siguientes medicamentos :
-
ORDEN DE LABORARIO: 
'.$laboratorio.'
