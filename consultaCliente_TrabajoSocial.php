...
<hr>  
  ...
  <a class="btn btn-primary" href="historiaClinica_terapiaOcupacional.php?clienteId=<?php echo $clienteId;?>" role="button"> <i class="fa fa-heartbeat"></i>  Nueva consulta </a>
...
<br>
 ...
 echo "SELECT * FROM  historiaClinica_TrabajoSocial where cliente_id = $clienteId order by ID DESC";
   
                  $queryList=mysqli_query($conn3,"SELECT * FROM  historiaClinica_TrabajoSocial where cliente_id = $clienteId order by ID DESC");
...

                  {
                      ...
                      $trabajosocial           = $row_recordset32['trabajosocial'];      
                  ...
                  <div class="box-header with-border">
                    <h4 class="box-title">
                      <a data-toggle="collapse" data-parent="#accordion" href="#<?php echo $ID?>">
                        Fecha <?php echo $Fecha .'-'.$Hora.' - '. $trabajosocial?> <a href="finalizadoTerapiaOcupacional.php?historiaClinica1=<?php echo $ID?>" title="Imprimir Consulta" target="_blank"><i class="fa fa-print"></i> </a>
                      </a>
                    </h4>
                  </div>
               ...
               <div align="right" >
                Fecha <?php echo $Fecha .'-'.$Hora.' - '. $trabajosocial?>
               </div>
               
              <?php if (strlen($trabajosocial)>0): ?>
              <div>
              <label> trabajosocial:</label>
              <label>  <?php echo $trabajosocial?></label>
