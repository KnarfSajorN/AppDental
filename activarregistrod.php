...
<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 text-center" style="border-top-style: solid;">
 ...
 <h1> Plan Anual Basico </h1> 
<h5>1 usuario</h5>
<h3> <strong> $ 189.00 USD</strong>   </h3>
<h6> <strong> mensual $15.75 USD</strong>   </h6>
...
<?php
$referencia1 = $ID.'/'.$email.'/1/'.rand(1,50);
?>
<hr style="border-color:blue;">
 
<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="hosted_button_id" value="2GQH7PBJD4B3C">
...
<form>
    <script src='https://checkout.epayco.co/checkout.js' 
        data-epayco-key='9d4609604f27eb05637e8d28401444ba' 
        class='epayco-button' 
        data-epayco-amount='20'  
        data-epayco-name='consulta' 
        data-epayco-description='consulta' 
        data-epayco-currency='USD'    
        data-epayco-country='CO' 
        data-epayco-test='false' 
        data-epayco-external='false' 
        data-epayco-response='http://medicalsoftplus.com/baseDev/epay_respuesta.php' 
        data-epayco-confirmation='http://medicalsoftplus.com/baseDev/epay_respuesta.php' 
        data-epayco-invoice = '<?php echo $referencia1?>'
        data-epayco-extra1  = '<?php echo $email?>'
        data-epayco-button='https://sievensoft.com/paypal.png' > 
    </script> 
</form>
-->
...
<h3> <strong> $ 90,00 USD</strong>   </h3>
<h4> <font color="#929292">  15.00 mes </font> </h4>


<?php
$referencia1 = $ID.'/'.$email.'/3/'.rand(1,50);
?>
<hr style="border-color:blue;">
...
<hr style="border-color:blue;">
 ...
 <h1> Plan Anual Plus </h1> 
<h5>1 usuario + 1 auxiliar</h5>
<h3> <strong> $ 249.00 USD</strong>   </h3>
<h6> <strong> mensual $20.75 USD</strong>   </h6>
...
<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="hosted_button_id" value="8XKD38MCY9E3L">
<input type="image" src="https://sievensoft.com/paypal.png" width="100%" height="20%"border="0" name="submit" alt="PayPal - The safer, easier way to pay online!">
<img alt="" border="0" src="https://sievensoft.com/paypal.png" width="1" height="1">
</form>
...
<hr style="border-color:blue;">
 ...
 <h1> Plan 2 Años Premium </h1> 
<h5>2 usuario + 1 auxiliar</h5>
<h3> <strong> $ 364.00 USD</strong>   </h3>
<h6> <strong> mensual $15.16 USD</strong>   </h6>
...
<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="hosted_button_id" value="MPVW4U9DPRTEJ">
<input type="image" src="https://sievensoft.com/paypal.png" width="100%" height="20%"border="0" name="submit" alt="PayPal - The safer, easier way to pay online!">
<img alt="" border="0" src="https://sievensoft.com/paypal.png" width="1" height="1">
</form>
...
<h1> LICENCIA </h1>
<h3> <strong> $ 100.00 USD</strong>   </h3>
