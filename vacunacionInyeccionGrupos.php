...
<div  class=" box-info" align="center">
 ...
 <a href="RegistrarInyeccionesAGrupo?eD='.encrypt($id).'&grupo='.encrypt($grupo).'" title="Editar Inyección"><i class="fa fa-pencil"></i> </a> |

<a href="EliminarInyeccionesGrupos.php?v='.encrypt($id).'&grupo='.encrypt($grupo).'" title="Eliminar Inyección"><i class="fa fa-trash"></i> </a> 
                    </td>
