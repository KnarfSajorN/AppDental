          ...
          ?>
            ...
            $Inputs = array(
              ...
              "¿Qué tan fuerte fue su  tinnitus, en promedio, durante el último mes? '0' sería  'sin tinnitus' y '10' sería  tan fuerte como un disparo" => array(
                "Nombre" => "{$n_arr}[¿Qué tan fuerte fue su  tinnitus, en promedio, durante el último mes? \'0\' sería  \'sin tinnitus\' y \'10\' sería  tan fuerte como un disparo]",
                "Tipo"  => "select",
              ...
              <div class="col-md-12 row">
                ...
                while ($rowMotorizado = mysqli_fetch_array($queryList)) {
                  ...
                  if ($tipo == "1" and $clase == "3") {
                    $select_izquierdo .= '<option value="' . $ruta . '" data-imagesrc="https://medicalsoftplus.com/baseDev/IconosGraficas/' . $ruta . '"; > ' . $nombre . ' </option>';
                  }

                  if ($tipo == "2" and $clase == "3") {
                    $select_derecho .= '<option value="' . $ruta . '" data-imagesrc="https://medicalsoftplus.com/baseDev/IconosGraficas/' . $ruta . '"; > ' . $nombre . ' </option>';
                  }
                }
                ?>
