...
$QueryHistoria = mysqli_query($conn3, "SELECT * FROM  RIAS_HistoriaJuventud where id = $id");
while ($RowHistoria = mysqli_fetch_array($QueryHistoria)) {

  $cliente_id = $RowHistoria['cliente_id'];

  $fechaNacimiento = funcionMaster($RowHistoria['cliente_id'], "cliente_id","fechaNacimiento","cliente");

}

$TipoHistoria = "RIAS_HistoriaJuventud";
...
$DiasNacio_Paciente = calcularDiasDesdeNacimiento($fechaNacimiento);//importante no quitar
    ...
    <div class="box">
        <div class="box-body">
            ...
            <a class="btn btn-outline-info btn-lg rounded-pill shadow" target="_blank"
                href="<?php echo $Base; ?>RIAS_Impresion_Juventud.php?id=<?php echo ($id); ?>">
