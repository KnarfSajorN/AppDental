...
<a class="btn btn-app" href="<?php echo $Base;?>pacientes_Odonto.php"> 
...
<a class="btn btn-app" target="_blank" href="<?php echo $Base;?>imprimirInformeOdontologico.php?historiaClinica1=<?php echo $historiaClinica1;?>"> 
  <i class="fa fa-print"></i> Imprimir Informe Odontologico
</a>
<!--
