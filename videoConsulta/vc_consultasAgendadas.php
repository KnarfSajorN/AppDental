...
<script>
    ...
    <?php if (($_SESSION['vista'] == 0 || $_SESSION['vista'] == 1) and $_SESSION['sucursal'] != 0) {
        ...
        query_tabla_ajax = "<?php echo "SELECT *, estado as noEstado FROM  citas WHERE {$filtro} (estado  = 1 or estado  = 2) and tipo = 1 order by fecha, Hora asc"; ?>";
    ...
    columnas = ['idCitas', 'doctor', 'fecha', 'Hora', 'nombre', 'telefono', 'correo', 'motivoConsulta', 'noEstado', 'idCliente'];
