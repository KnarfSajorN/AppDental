...
while ($row_recordset32 = mysqli_fetch_array($queryList)) {
  ...
  /// para el modulo de información del acompa;ante 
          ...
          <div class="box-body">
            ...
            <div class="col-md-12">
              ...
              <div class=" box-solid">
                    ...
                    <div class="panel box box-primary">
                      <div class="box-header with-border">
                        <h4 class="box-title">
                          ...
                          <a data-toggle="collapse" data-target="#collapseEstadoIngreso" aria-expanded="false" aria-controls="collapseEstadoIngreso">
                            Estado Ingreso del Paciente
                          </a>
                        </h4>
                      </div>
                      <!--<div id="collapseEstadoIngreso" class="panel-collapse collapse">-->
                      <div id="collapseEstadoIngreso" class="collapse" aria-labelledby="headingOne">
                        <div class="col-md-12">
                ...
                <form action="hcpGuardar" method="POST" id="FormularioHistoriaClinica">
                  <div class="box-body">
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingOne">
                          ...
                          <div class="box-body row">
                            ...
                            <div class="col-md-6">
                              ...
                              <input type="text" name="InformacionAcudiente[Telefono Acudiente]" class="form-control" value="<?=$telefono_acompanante;?>">
                            </div>
                            ...
                            <script>
                              ...
                              var Opcion = "<?php echo $parentesco_acompanante; ?>";
                              var selectElement = document.getElementById("ParentescoAcudiente");
                              var valorSeleccionado = selectElement.value;

                              // Recorremos todas las opciones para verificar si Opcion coincide
                          ...
                          <div id="Ginecobstetricos" class="tabcontent">
                            <div class="row">
                              ...
                              <div id="masdetallesginecologicos" class="collapse col-md-12">
                                ...
                                <div class="col-md-4">
                                  <label>Fecha de Ultima Citología</label>
                        ...
                        <div id="collapseSix" class="collapse" aria-labelledby="headingOne">
                          ...
                          <div class="box-body row">
                            ...
                            <div class="col-md-4">
                              ...
                              <input type="number" name="SignosVitales[Peso Corporal]" id="KG_peso" class="form-control input-lg" onchange="IMC();" step="0.01" value="<?php echo $Peso; ?>">
                            ...
                            <div class="col-md-4">
                              ...
                              <input type="number" name="SignosVitales[Altura]" id="CM_altura" class="form-control input-lg" onchange="IMC();" step="0.01" value="<?php echo $Altura; ?>">
                              <!-- <input type="number" name="SignosVitales[Altura]" id="CM_altura" class="form-control input-lg" onchange="IMC();" step="0.01" value=""> -->
                            </div>
                            <div class="col-md-4">
                              <label>IMC</label>
                              <input type="number" name="SignosVitales[IMC]" id="IMC_Paciente" class="form-control input-lg" step="0.01" value="<?php echo $IMC; ?>">
                            ...
                            <div class="col-md-4">
                              ...
                              <input type="number" name="SignosVitales[Perimetro Cefalico]" class="form-control input-lg" onchange='document.getElementsByName("Grafico_Pediatria[Perimetro Cefalico]")[0].value=this.value' step="0.01" value="<?php echo $Perimetro_Cefalico; ?>">
                            ...
                            <div class="col-md-4">
                              ...
                              <input type="number" name="SignosVitales[Frecuencia Respiratoria]" class="form-control input-lg" step="0.01" value="<?php echo $Frecuencia_Respiratoria; ?>">
                            ...
                            <div class="col-md-4">
                              ...
                              <input type="number" name="SignosVitales[Presion Arterial Sistolica]" id="PresionArterialSistolica" class="form-control input-lg" step="0.01" onchange="CalculaPresionArterialMedia()" value="<?php echo $Presion_Arterial_Sistolica; ?>">
                            ...
                            <div class="col-md-4">
                              ...
                              <input type="number" name="SignosVitales[Presion Arterial Diastolica]" id="PresionArterialDiastolica" class="form-control input-lg" step="0.01" onchange="CalculaPresionArterialMedia()" value="<?php echo $Presion_Arterial_Diastolica; ?>">
                            ...
                            <div class="col-md-4">
                              ...
                              <input type="number" name="SignosVitales[Tension Arterial Media]" id="TensionArterialMedia" class="form-control input-lg" step="0.01" value="<?php echo $Tension_Arterial_Media; ?>">
                            ...
                            <div class="col-md-4">
                              ...
                              <input type="number" name="SignosVitales[Saturacion Oxigeno]" class="form-control input-lg" step="0.01" value="<?php echo $Saturacion_Oxigeno; ?>">
                            ...
                            <div class="col-md-4">
                              <label>Peso para Edad</label>
                              <input type="text" name="Peso_edad" class="form-control input-lg">
                            </div>


                            <div class="col-md-4">
                              <label>Peso para Talla</label>
                              <input type="text" name="peso_talla" class="form-control input-lg">
                            </div>

                            <div class="col-md-4">
                              <label>Talla para edad</label>
                              <input type="text" name="talla_edad" class="form-control input-lg">
                            </div>

                            <div class="col-md-4">
                              <label>Estado Nutricional</label>
                              <input type="text" name="estado_nutricional" class="form-control input-lg" value="Normal">
                            </div>
                      ...
                      <div class="panel box box-primary">
                        ...
                        <div id="collapseSeven" class="collapse" aria-labelledby="headingOne">
                          ...
                          <div class="box-body">
                            ...
                            <div class="col-md-4">
                              <button type="button" style="display: initial;" data-target="#modalForm3" data-toggle="modal" title="Agregar Paraclinico" class="btn btn-outline-info btn-lg rounded-pill shadow" ><i class="fa fa-plus"> Agregar Paraclínico</i>
                              </button>
                            </div>
                      ...
                      <div class="panel box box-primary">
                        <div class="box-header with-border">
                          <h4 class="box-title">
                            ...
                            <a data-toggle="collapse" data-target="#collapseFifty" aria-expanded="false" aria-controls="collapseFifty">
                              Escala de Tanner
                            </a>
                          </h4>
                        </div>
                        <!--<div id="collapseFifty" class="panel-collapse collapse">-->
                        <div id="collapseFifty" class="collapse" aria-labelledby="headingOne">
                                  ...
                                  <tr>
                                    <td <?= $optiongen1 ?>>
                                      <div> <input type="radio" value="1" name="niño2">
                                        ...
                                        <p><b>Estado 1</b>. Sin vello púbico, Testicúlos y Pene infantil. </p>
                                      </div>
                                    </td>
                                    <td <?= $optiongen2 ?>>
                                      <div>
                      ...
                      <div class="panel box box-primary">
                        ...
                        <div id="collapseTen" class="collapse" aria-labelledby="headingOne">
                          ...
                          <div class="box-body row">
                            ...
                            <div class="col-md-6">
                              <label>Oídos</label><textarea name="OrganoSentidos[Oidos]" class="form-control input-lg" placeholder="Oidos" style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;max-width: 100%;"></textarea>
                            </div>
                      ...
                      <div class="panel box box-primary">
                        ...
                        <div id="collapseEleven" class="collapse" aria-labelledby="headingOne">
                          ...
                          <div class="box-body row">
                            ...
                            <div class="col-md-6">
                              <label>Transpiración</label><textarea name="SintomasGenerales[Transpiracion]" class="form-control input-lg" placeholder="Transpiración" style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;max-width: 100%;"></textarea>
                            </div>
                     ...
                     cierre de lista-->
                      ...
                      <div class="panel box box-primary">
                        <div class="box-header with-border">
                          <h4 class="box-title">
                            ...
                            <a data-toggle="collapse" data-target="#collapseFourteen" aria-expanded="false" aria-controls="collapseFourteen">
                              Impresión
                            </a>
                          </h4>
                        </div>
                        <!--<div id="collapseFourteen" class="panel-collapse collapse">-->
                        <div id="collapseFourteen" class="collapse" aria-labelledby="headingOne">
                      ...
                      <div class="panel box box-primary">
                        <div class="box-header with-border">
                          <h4 class="box-title">
                            ...
                            <a data-toggle="collapse" data-target="#collapseFiveteen" aria-expanded="false" aria-controls="collapseFiveteen">
                              Plan de manejo
                            </a>
                          </h4>
                        </div>
                        <!--<div id="collapseFiveteen" class="panel-collapse collapse">-->
                        <div id="collapseFiveteen" class="collapse" aria-labelledby="headingOne">
                      ...
                      <div class="panel box box-primary">
                        <div class="box-header with-border">
                          <h4 class="box-title">
                            <!--<a data-toggle="collapse" data-parent="#accordion1" href="#collapseFiveteen">-->
                            <a data-toggle="collapse" data-target="#collapseFiveteenF" aria-expanded="false" aria-controls="collapseFiveteen">
                              Sospecha diagnóstico
                            </a>
                          </h4>
                        </div>
                        <!--<div id="collapseFiveteen" class="panel-collapse collapse">-->
                        <div id="collapseFiveteenF" class="collapse" aria-labelledby="headingOne">

                          <div class="box-body">

                            <div class="col-md-12">
                              <textarea name="Sospecha[Sospecha diagnostico]" class="form-control input-lg" placeholder="" style="width: 100%; min-height: 60px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;max-width: 100%;"></textarea>
                            </div>
                      ...
                      <div class="panel box box-primary">
                        <div class="box-header with-border">
                          <h4 class="box-title">
                            <!--<a data-toggle="collapse" data-parent="#accordion1" href="#collapseFiveteen">-->
                            <a data-toggle="collapse" data-target="#collapseFiveteenFS" aria-expanded="false" aria-controls="collapseFiveteen">
                              Ver receta y Diagnósticos Anteriores
                            </a>
                          </h4>
                        </div>
                        <!--<div id="collapseFiveteen" class="panel-collapse collapse">-->
                        <div id="collapseFiveteenFS" class="collapse" aria-labelledby="headingOne">
                            ...
                            <div class="card bg-gradient-primary collapsed-card">
                                <div class="card-header border-0 ui-sortable-handle" style="cursor: move;">
                                  ...
                                  <div class="card-tools">
                                    <button type="button" class="btn btn-outline-info rounded-pill btn-sm" data-card-widget="collapse" title="Collapse" style="color: white;">
                      ...
                      <div class="panel box box-primary">
                        <div class="box-header with-border">
                          <h4 class="box-title">
                            ...
                            <a data-toggle="collapse" data-target="#collapseSixteen" aria-expanded="false" aria-controls="collapseSixteen">
                              Prescripciones
                            </a>
                          </h4>
                        </div>
                        ...
                        <div id="collapseSixteen" class="collapse" aria-labelledby="headingOne">
                          ...
                          <div class="tab">
                            ...
                            <button type="button" class="tablinks" onclick="MenuAntecedentes(event, 'Examenes')">Exámenes y Laboratorios</button>
                          </div>
                          <!-- barra de menu final -->
                          ...
                          <!-- Submodulo Insumos -->
                          <div id="Examenes" class="tabcontent">
                            ...
                            <div class="box-body">
                              ...
                              <div class="form-group col-md-12">
                                ...
                                <textarea name="Observaciones_Imagen" class="ejemplo" placeholder="Observaciones" style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;margin: 0px;margin-top: 15px;max-width: 100%;"></textarea>
                              </div>
                              ...
                              <div class="form-group col-md-12">
                                <label>Observaciones</label>
                                <textarea name="Observaciones_Labora" class="ejemplo" placeholder="Observaciones" style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;margin: 0px;margin-top: 15px;max-width: 100%;"></textarea>
                              </div>
                          ...
                          <div id="Insumos" class="tabcontent">
                            ...
                            <div class="col-md-4">
                              <br><br>
                              <button type="button" style="display: initial;" data-target="#modalForm5" data-toggle="modal" title="Agregar Insumos" class="btn btn-outline-info btn-lg rounded-pill shadow"><i class="fa fa-plus"> Agregar Insumos</i>
                              </button>
                            </div>
                            <div class="col-md-8">&nbsp;</div>
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <div class="col-md-3">
                          ...
                          <button type='button' class='btn btn-outline-info rounded-pill' style='width:100%;margin-bottom: 10px;' data-toggle='modal' data-target='#modalGraficas' onclick='CargarGraficas(" <?php echo $clienteId ?>",1,1);'> Gráfica Peso / Edad </button>
                        </div>

                        <div class="col-md-3">

                          <button type='button' class='btn btn-outline-info rounded-pill' style='width:100%;margin-bottom: 10px;' data-toggle='modal' data-target='#modalGraficas' onclick='CargarGraficas(" <?php echo $clienteId ?>",2,1);'>Gráfica Estatura / Edad </button>
                        </div>

                        <div class="col-md-3">
                          <button type='button' class='btn btn-outline-info rounded-pill' style='width:100%;margin-bottom: 10px;' data-toggle='modal' data-target='#modalGraficas' onclick='CargarGraficas(" <?php echo $clienteId ?>",3,1);'>Gráfica Perimetro Cefalico </button>
                        </div>

                        <div class="col-md-3">
                          <button type='button' class='btn btn-outline-info rounded-pill' style='width:100%;margin-bottom: 10px;' data-toggle='modal' data-target='#modalGraficas' onclick='CargarGraficas(" <?php echo $clienteId ?>",4,1);'>Gráfica IMC</button>
                        </div>
                        </div>
                        <label>Ya terminé <input type="checkbox" value="" required=""></label>
                        <center><button type="submit" class="btn btn-block btn-outline-info rounded-pill" onclick="verificarformulario()">
                            <h2> <strong> Guardar</strong> </h2>
                          </button></center>
                      </div>
                    </div>
                  </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <center>
          <button type="button" class="btn btn-outline-secondary btn-lg rounded-pill shadow" data-dismiss="modal">Cerrar</button>
          <button id="user-data-next-button" class="my-button btn btn-outline-info btn-lg rounded-pill shadow" onclick="$.when(GuardarParaclinico()).then(tabla_paraclinicos());" disabled>Guardar</button>
        </center>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <button type="button" class="btn btn-outline-secondary btn-lg rounded-pill shadow" data-dismiss="modal">Cerrar</button>
        <a href="#" onclick="$.when(GuardarIncapacidad()).then(tabla_incapacidades());" class="btn btn-outline-info btn-lg rounded-pill shadow"> <i class="fa fa-glyphicon glyphicon-plus"></i> <strong> Actualizar </strong></a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <button type="button" class="btn btn-outline-secondary btn-lg rounded-pill shadow" data-dismiss="modal">Cerrar</button>
        <a href="#" onclick="$.when(GuardarInsumos()).then(tabla_insumos());" class="btn btn-outline-info btn-lg rounded-pill shadow"> <i class="fa fa-glyphicon glyphicon-plus"></i> <strong> Actualizar </strong></a>
...
<script>
  function CargarGraficas(cliente_id, Tipo, DatosGrafica) {
    ...
    for (var i = 0; i < Botones[Tipo].length; i++) {
      //estilo de los botones con class='btn btn-outline-info rounded-pill' y width='100%' y un hr separador 
      Botones_Grafica += "<button type='button' class='btn btn-outline-info rounded-pill' style='width:100%;' onclick='window.open(\"" + Direccion + "?cI=<?=salt()?>" + btoa(cliente_id) + "&Tipo=" + TipoArreglo[Tipo] + "&Botones=" + Botones[Tipo][i] + "\",\"_blank\")'>" + TipoArregloVisual[Tipo] + " [" + Botones[Tipo][i] + "]</button><hr>";
...
$Nombre_Tabla_autoguardado = "Historia_Pediatria";//nombre de la tabla de la base de datos de la historia

$RutaFinal_Encryptado = $_SERVER['SCRIPT_URI']."?cl={$cliente_id_autoguardado}";

include 'AutoGuardados/HistoriaEncryptada/AutoGuardado_Historia_Encryptado.php';
?>
