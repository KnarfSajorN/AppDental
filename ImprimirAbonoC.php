...
if($idCliente=="0"){
    $entidad_id = funcionMaster($convenio_id, 'id', 'entidad_id', 'Rips_Convenio');
    $NombreEntidad = funcionMaster($entidad_id, 'id', 'Nombre', 'Rips_Entidades');

    $TextoCliente = " Entidad: $NombreEntidad <br>  ";
}else{
    $nombre_paciente = funcionMaster($idCliente, 'cliente_id', 'nombre_cliente', 'cliente');

    $TextoCliente = " Paciente: $nombre_paciente <br> Cédula: $CODI_CLIENTE ";
}
        ...
        <div class="col-md-12">
            ...
            <div class="box box-solid">
                ...
                <div class="row">
                        ...
                        <table class="tg" style="undefined;table-layout: fixed; width: 100%">
                            ...
                            <tr align="center">
                                ...
                                <th class="titulo" colspan="4" rowspan="4" align="center">
                                    ...
                                    <!--<h9 align="center"> <?php echo  $empresaNombre ?> <?php echo   $direccion ?>  </h9>-->
                                </th>
                            </tr>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h4 align="center"><b> RECIBO DE PAGO DE CUENTA A COBRAR</b></h4>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-4" style="font-size: 18px">Método de pago:
                            <?php echo funcionMaster($pago,'id','Nombre','Medios_Pago')  ?>
                        </DIV>

                        <div class="col-4" style="font-size: 18px"> Cancelado:
                            <?php echo number_format($valor_abonado,2).''.$moneda  ?>
                        </DIV>
                        <div class="col-4" style="font-size: 18px"> Pendiente:
                            <?php echo number_format($saldo1,2).''.$moneda ?>
                        </DIV>
                        <div class="col-12" style="font-size: 18px"> Notas :
                            <?php echo $notas ?>
                        </DIV>
                        <hr>
                    </div>
