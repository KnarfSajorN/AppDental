        ...
        navigator.mediaDevices.getUserMedia({
            ...
            .then(stream => {
                ...
                mediaRecorder.addEventListener("stop", () => {
                    ...
                    const RUTA_SERVIDOR = "guardarP.php";
                    $duracion.textContent = "Enviando vídeo POR FAVOR no cerrar la ventana hasta CULMINAR...";
                    fetch(RUTA_SERVIDOR, {
                            method: "POST",
                            body: formData,
                        })
                        ...
                        .then(respuestaComoTexto => {
                            ...
                            $duracion.innerHTML = `<strong>Vídeo subido correctamente. Muchas Gracias por su tiempo. que tenga buen dia</strong>&nbsp; <a target="_blank" href="videos/${respuestaComoTexto}">Ver video</a>`
                        })
                });
            })
            .catch(error => {
