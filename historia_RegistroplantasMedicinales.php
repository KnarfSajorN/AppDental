  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#"> Registro Plantas Medicinales</a></li>
...
<hr>  
 ...
 <form action="guardarHistoria_AccionesAcondicionamiento.php" method="POST" name="formularioActualizarcliente">
                ...
                <div class="col-md-12"> <font size="1"> <h3>ACTIVIDAD </h3> </font></div>
               <div class="form-group col-md-3">
                  <div align="left">Número de la Actividad:</div>
                  <input type="text" class="form-control input-lg" id="fimico" name="num" placeholder="">
                </div>

                 <div class="form-group col-md-9">
                  <div align="left">Tema:</div>
                  <input type="text" class="form-control input-lg" id="fimico" name="tema" placeholder="">
                </div>



               <div class="form-group col-md-6">
                  <div align="left">Objetivo de la actividad</div>
                  <input type="text" class="form-control input-lg" id="fimico" name="objetivo" placeholder="">
                </div>
                <div class="form-group col-md-6">
                  <div align="left">Participación</div>
                  <input type="text" class="form-control input-lg" id="leuticos" name="participacion" placeholder="">
                </div> 
                <div class="form-group col-md-6">
                  <div align="left">Desarrollo de la Actividad</div>
                  <input type="text" class="form-control input-lg" id="alcoholicos" name="desarrollo" placeholder="">
                </div> 
                <div class="form-group col-md-6">
                  <div align="left">Desempeño</div>
                  <input type="text" class="form-control input-lg" id="neuropaticos" name="desempeño" placeholder="">
                </div> 

                <div class="form-group col-md-12">     
                  <label><strong>  Reflexiones y Compromisos</strong></label>
                  <textarea class="form-control" id="diagnostico_p" name="reflexiones" rows="4">
       ...
       <div class="panel box box-success">
                ...
                <div class="col-md-12"> <font size="1"> <h3>SESIÓN</h3> </font></div>
               <div class="form-group col-md-3">
                  <div align="left">Número de la Sección:</div>
                  <input type="text" class="form-control input-lg" id="fimico" name="num1" placeholder="">
                </div>

                 <div class="form-group col-md-9">
                  <div align="left">Tema:</div>
                  <input type="text" class="form-control input-lg" id="fimico" name="tema1" placeholder="">
                </div>



               <div class="form-group col-md-6">
                  <div align="left">Objetivo de la Actividad Socioeducativa</div>
                  <input type="text" class="form-control input-lg" id="fimico" name="objetivo1" placeholder="">
                </div>
              
                <div class="form-group col-md-6">
                  <div align="left">Desarrollo de la Actividad  Socioeducativa</div>
                  <input type="text" class="form-control input-lg" id="alcoholicos" name="desarrollo1" placeholder="">
                </div> 
               

                <div class="form-group col-md-12">     
                  <label><strong>  Reflexiones y Compromisos</strong></label>
                  <textarea class="form-control" id="diagnostico_p" name="reflexiones1" rows="4">
