...
<script>
    ...
    function ModalModuloContabilidadCXC(){
        $('#ModalContabilidadCXC').modal('show');
    ...
    function GuardarDatosContabilidad(){
        ...
        var formularioPrincipal = document.getElementById('FormularioCuentaporCobrar');
        ...
        document.getElementById('FormularioCuentaporCobrar').submit();
...
<!-- El Modal -->
<div class="modal fade" id="ModalContabilidadCXC">
  <div class="modal-dialog modal-lg" style="margin-top: 170px;">
    <div class="modal-content">
    
      <!-- Encabezado del Modal -->
      <div class="modal-header">
        <h5 class="modal-title">Modulo Contabilidad CXC</h5>
      ...
      <div class="modal-body row">
        ...
        <div class="form-group col-md-12" id="Div_CuentaContableCXC">
            <label style="width:100%;">Cuenta Contable [Cuenta por Cobrar] *Haber*</label>
