...
//SELECT SUM(totalBruto) as totalBruto, sum(montoPagado) as montoPagado, idCliente FROM `sOperacionInv`GROUP BY (idCliente)
                    $resultado=mysql_query("SELECT * FROM  v_sOperacionInv where idEmpresa =$ID and  idCliente = $idcliente order by numeroDoc");
...
if ($saldo > 0) {
                  ...
                  <td>    
                      ...
                      <a href="v_actualizarPago.php?idOperacion='.$fila[0].'"><i class="fa fa-plus"></i> Registrar Pago Completo</a>     
