...
$queryList = mysqli_query($conn3, "SELECT * FROM  Historia_Dermatologica where id = $Historia_id");
...
while ($rowMotorizado = mysqli_fetch_array($queryList)) {
  ...
  $queryList = mysqli_query($conn3, "SELECT firma FROM  firmas where historia_id = $Historia_id and historia_nombre = 'Historia_Dermatologica'");
      $nrowl = mysqli_num_rows($queryList);
      while ($rowMotorizado = mysqli_fetch_array($queryList)) {
            ...
            <tr>
                <td>
                    ...
                    <div class="page" style="width:100vw;">
                        ...
                        ?>
                            <h3 align="center">Historia Dermatologica</h3>
                            <?php
                            $Historia_Nombre = "Historia_Dermatologica";
                            ...
                            if (strlen($AntecedentesPer) > "0") {
                                echo $tabla[12] . '<b>Antecedentes Personales </b><br><br>' . $AntecedentesPer . '</div>';
                            }
