                    ...
                    <thead>
                      ...
                      <tr>
                        ...
                        <th scope="col" style="width: 20px; text-align: center;"> <b>O</b>
                          <input type="text" class="form-control" step="any" size="40"
                            style="width: 70px;height: 34px;padding: 6px 12px;display: block;" value="<?php echo $SI2 ?>">
          </td>
          <th scope="col" style="width: 20px; text-align: center;"> <b>C</b>
            <input type="text" class="form-control" step="any" size="40"
              style="width: 70px;height: 34px;padding: 6px 12px;display: block;" value="<?php echo $BL1 ?>">
            </td>
          <th scope="col" colspan="2"></th>
          <th scope="col" style="width: 20px; text-align: center;"> <b>O</b>
            <input type="text" class="form-control" step="any" size="40"
              style="width: 70px;height: 34px;padding: 6px 12px;display: block;" value="<?php echo $BL2 ?>">
            </td>
          <th scope="col" style="width: 20px; text-align: center;"> <b>C</b>
            <input type="text" class="form-control" step="any" size="40"
              style="width: 70px;height: 34px;padding: 6px 12px;display: block;" value="<?php echo $BL5 ?>">
            </td>
        </tr>
        </thead>
      <tbody>
        <tr>
          ...
          <td colspan="2">AP</td>
          <td style="width: 20px;"><input type="text" name="AP1" id="AP1" class="form-control" step="any" size="40"
              style="width: 70px;height: 34px;padding: 6px 12px;display: block;" value="<?php echo $AP1 ?>"></td>
          <td style="width: 20px;"><input type="text" name="AP2" id="AP2" class="form-control" step="any" size="40"
              style="width: 70px;height: 34px;padding: 6px 12px;display: block;" value="<?php echo $AP2 ?>"></td>
          <td style="width: 20px;"> <input type="text" name="AP3" id="AP3" class="form-control" step="0.01" size="40"
              style="width: 70px;height: 34px;padding: 6px 12px;display: block;" value="<?php echo $AP3 ?>">
          </td>
          <td style="width: 20px;"><input type="text" name="AP4" id="AP4" class="form-control" step="any" size="40"
              style="width: 70px;height: 34px;padding: 6px 12px;display: block;" value="<?php echo $AP4 ?>">
          </td>

          <td style="width: 20px;"> <input type="text" name="AP5" id="AP5" class="form-control" step="0.01" size="40"
              style="width: 70px;height: 34px;padding: 6px 12px;display: block;" value="<?php echo $AP5 ?>">
          </td>
          <td style="width: 20px;"><input type="text" name="AP6" id="AP6" class="form-control" step="any" size="40"
              style="width: 70px;height: 34px;padding: 6px 12px;display: block;" value="<?php echo $AP6 ?>">
          </td>
          <td style="width: 20px;"><input type="text" name="AP7" id="AP7" class="form-control" step="any" size="40"
              style="width: 70px;height: 34px;padding: 6px 12px;display: block;" value="<?php echo $AP7 ?>">
          </td>
          <td style="width: 20px;"> <input type="text" name="AP8" id="AP8" class="form-control" step="any" size="40"
              style="width: 70px;height: 34px;padding: 6px 12px;display: block;" value="<?php echo $AP8 ?>">
          </td>
        </tr>

        <tr>
          <td colspan="2">SI</td>
          <td style="width: 20px;"><input type="text" name="SI1" id="SI1" class="form-control" step="any"
              style="width: 70px;height: 34px;padding: 6px 12px;display: block;" value="<?php echo $SI1 ?>"></td>
          <td></td>
          <td style="width: 20px;"><input type="text" name="SI3" id="SI3" class="form-control" step="any"
              style="width: 70px;height: 34px;padding: 6px 12px;display: block;" value="<?php echo $SI3 ?>">
          </td>

          <td style="width: 20px;"> <input type="text" name="SI4" id="SI4" class="form-control" step="any"
              style="width: 70px;height: 34px;padding: 6px 12px;display: block;" value="<?php echo $SI4 ?>">
          </td>

          <td style="width: 20px;"><input type="text" name="SI5" id="SI5" class="form-control" step="any" size="40"
              style="width: 70px;height: 34px;padding: 6px 12px;display: block;" value="<?php echo $SI5 ?>">
          </td>
          <td></td>
          <td style="width: 20px;"><input type="text" name="SI7" id="SI7" class="form-control" step="any" size="40"
              style="width: 70px;height: 34px;padding: 6px 12px;display: block;" value="<?php echo $SI7 ?>">
          </td>
          <td style="width: 20px;"> <input type="text" name="SI8" id="SI8" class="form-control" step="any" size="40"
              style="width: 70px;height: 34px;padding: 6px 12px;display: block;" value="<?php echo $SI8 ?>">
          </td>
        </tr>
        ...
        <tr>
          ...
          <td></td>
          <td style="width: 20px;"><input type="text" name="BL3" id="BL3" class="form-control" step="any"
              style="width: 70px;height: 34px;padding: 6px 12px;display: block;" value="<?php echo $BL3 ?>">
          </td>
          <td style="width: 20px;"><input type="text" name="BL4" id="BL4" class="form-control" step="any"
              style="width: 70px;height: 34px;padding: 6px 12px;display: block;" value="<?php echo $BL4 ?>">
          </td>
          <td></td>
          <td></td>
          <td style="width: 20px;"><input type="text" name="BL7" id="BL7" class="form-control" step="any" size="40"
              style="width: 70px;height: 34px;padding: 6px 12px;display: block;" value="<?php echo $BL7 ?>">
          </td>
          <td style="width: 20px;"> <input type="text" name="BL8" id="BL8" class="form-control" step="any" size="40"
              style="width: 70px;height: 34px;padding: 6px 12px;display: block;" value="<?php echo $BL8 ?>">
          </td>
        </tr>
        <tr>
          <td colspan="2">SP</td>
          <td></td>
          <td></td>
          <td style="width: 20px;"><input type="text" name="SP3" id="SP3" class="form-control" step="any"
              style="width: 70px;height: 34px;padding: 6px 12px;display: block;" value="<?php echo $SP3 ?>">
          </td>
          <td style="width: 20px;"><input type="text" name="SP4" id="SP4" class="form-control" step="any"
              style="width: 70px;height: 34px;padding: 6px 12px;display: block;" value="<?php echo $SP4 ?>">
          </td>
          <td></td>
          <td></td>
          <td style="width: 20px;"><input type="text" name="SP7" id="SP7" class="form-control" step="any" size="40"
              style="width: 70px;height: 34px;padding: 6px 12px;display: block;" value="<?php echo $SP7 ?>">
          </td>
          <td style="width: 20px;"> <input type="text" name="SP8" id="SP8" class="form-control" step="0.01" size="40"
              style="width: 70px;height: 34px;padding: 6px 12px;display: block;" value="<?php echo $SP8 ?>">
          </td>
        </tr>
        <tr>
          <td colspan="4">BL (MAxilar)</td>
          <td style="width: 20px;"><input type="text" name="BLM1" id="BLM1" class="form-control" step="any"
              style="width: 70px;height: 34px;padding: 6px 12px;display: block;" value="<?php echo $BLM1 ?>">
          </td>
          <td style="width: 20px;"><input type="text" name="BLM2" id="BLM2" class="form-control" step="any"
              style="width: 70px;height: 34px;padding: 6px 12px;display: block;" value="<?php echo $BLM2 ?>">
          </td>
          <td></td>
          <td></td>
          <td></td>
        ...
        <tr>
          ...
          <td></td>
          <td></td>
          <td style="width: 20px;"><input type="text" name="IDis3" id="IDis3" class="form-control" step="any"
              style="width: 70px;height: 34px;padding: 6px 12px;display: block;" value="<?php echo $IDis3 ?>">
          </td>
          <td style="width: 20px;"><input type="text" name="IDis4" id="IDis4" class="form-control" step="any"
              style="width: 70px;height: 34px;padding: 6px 12px;display: block;" value="<?php echo $IDis4 ?>">
          </td>
          <td></td>
          <td></td>
          <td style="width: 20px;"><input type="text" name="IDis7" id="IDis7" class="form-control" step="any" size="40"
              style="width: 70px;height: 34px;padding: 6px 12px;display: block;" value="<?php echo $IDis7 ?>">
          </td>
          <td style="width: 20px;"> <input type="text" name="IDis8" id="IDis8" class="form-control" step="any" size="40"
              style="width: 70px;height: 34px;padding: 6px 12px;display: block;" value="<?php echo $IDis8 ?>">
          </td>
        </tr>
        <tr>
          <td colspan="2">ICD</td>
          <td></td>
          <td></td>
          <td style="width: 20px;"><input type="number" class="form-control" step="any" name="Total_T" id="Total_T"
              style="width: 70px;height: 34px;padding: 6px 12px;display: block;" value="<?php echo $Total_T ?>">
          </td>
          <td style="width: 20px;"><input type="text" class="form-control" step="any" name="Total_O" id="Total_O"
              style="width: 70px;height: 34px;padding: 6px 12px;display: block;" value="<?php echo $Total_O ?>">
          </td>
          <td></td>
          <td></td>
          <td style="width: 20px;"><input type="text" name="Total_R" id="Total_R" class="form-control" step="any"
              size="40" style="width: 70px;height: 34px;padding: 6px 12px;display: block;" value="<?php echo $Total_R ?>">
          </td>
          <td style="width: 20px;"> <input type="text" name="Total_G" id="Total_G" class="form-control" step="any"
              size="40" style="width: 70px;height: 34px;padding: 6px 12px;display: block;" value="<?php echo $Total_G ?>">
          </td>
        </tr>
      </tbody>
    </table>
      ...
      <thead>
        <tr>
          ...
          <th scope="col" style="width: 20px; text-align: center;">O
            <input type="text" name="ELO1" id="ELO1" class="form-control" step="any"
              style="width: 70px;height: 34px;padding: 6px 12px;display: block;" value="<?php echo $ELO1 ?>">
          </th>
          <th scope="col" style="width: 20px; text-align: center;">C
            <input type="text" name="ELO2" id="ELO2" class="form-control" step="any"
              style="width: 70px;height: 34px;padding: 6px 12px;display: block;" value="<?php echo $ELO2 ?>">
          </th>
          <th scope="col" colspan="2" style="width: 20px; text-align: center;">AP</th>
          <th scope="col" style="width: 20px; text-align: center;">O
            <input type="text" name="ELO3" id="ELO3" class="form-control" step="any"
              style="width: 70px;height: 34px;padding: 6px 12px;display: block;" value="<?php echo $ELO3 ?>">
          </th>
          <th scope="col" style="width: 20px; text-align: center;">C
            <input type="text" name="ELO4" id="ELO4" class="form-control" step="any"
              style="width: 70px;height: 34px;padding: 6px 12px;display: block;" value="<?php echo $ELO4 ?>">
          </th>
        </tr>
      </thead>
      <tbody>
        <tr>
          ...
          <td style="width: 20px; text-align: center;"><input type="text" name="ElementoBL" id="ElementoBL"
              class="form-control" step="any" value="<?php echo $ElementoBL ?>"></td>
          <td style="width: 20px; text-align: center;"><input type="text" name="ELBL4" id="ELBL4" class="form-control"
              step="any" value="<?php echo $ELBL4 ?>"></td>
          <td colspan="2"></td>
          <td></td>
          <td></td>
        </tr>
        <tr>
          ...
          <td><input type="text" name="ELOS1" id="ELOS1" class="form-control" step="any" value="<?php echo $ELOS1 ?>">
          </td>
          <td><input type="text" name="ELOS2" id="ELOS2" class="form-control" step="any" value="<?php echo $ELOS2 ?>">
          </td>
          <td colspan="2" style="width: 20px; text-align: center;">SI</td>
          <td><input type="text" name="ELOS3" id="ELOS3" class="form-control" step="any" value="<?php echo $ELOS3 ?>">
          </td>
          <td><input type="text" name="ELOS4" id="ELOS4" class="form-control" step="any" value="<?php echo $ELOS4 ?>">
          </td>
        </tr>
        <tr>
          ...
          <td><input type="text" name="ELPO1" id="ELPO1" class="form-control" step="any" value="<?php echo $ELPO1 ?>">
          </td>
          <td><input type="text" name="ELPO2" id="ELPO2" class="form-control" step="any" value="<?php echo $ELPO2 ?>">
          </td>
        </tr>
      </tbody>
    </table>
