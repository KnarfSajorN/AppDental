...
Diagnósticos:<br>
    ...
    <?php  echo $cie4 ?><br>
        ...
        <h4 align="center">EVOLUCIÓN CONTROL PRENATAL</h4>
                <div class="col-md-12">
          </div>
        </div>
...
<p>
  <?php  if ($Fecha <> '') {$Fecha1 = 'Fecha:'.$Fecha.'<BR>';} ?>
  <?php  echo $Fecha1  ?>
</p>
<p>

  <?php  if ($semana_emabarazo <> '') {$semana_emabarazo1 = 'Semana Embarazo:'.$semana_emabarazo.'<BR>';} ?>
  <?php  echo $semana_emabarazo1  ?>

  </p>

  <P>

  <?php  if ($presion_arterial <> '') {$presion_arterial1 = 'Presión Arterial:'.$presion_arterial.'<BR>';} ?>
  <?php  echo $presion_arterial1  ?>
  ...
  <P>
   ...
   <?php  if ($pulso <> '') {$pulso1 = 'Pulso:'.$pulso.'<BR>';} ?>
  <?php  echo $pulso1  ?>
  ...
  <?php  if ($tempratura <> '') {$tempratura1 = 'Temperatura:'.$tempratura.'<BR>';} ?>
  <?php  echo $tempratura1  ?>
  ...
  <?php  if ($peso <> '') {$peso1 = 'Peso:'.$peso.'<BR>';} ?>
  <?php  echo $peso1  ?>
  ...
  <?php  if ($altura <> '') {$altura1 = 'Altura Uterina:'.$altura.'<BR>';} ?>
  <?php  echo $altura1  ?>
  ...
  <?php  if ($frecuencia <> '') {$frecuencia1 = 'Frecuencia Cardíaca Fetal:'.$frecuencia.'<BR>';} ?>
  <?php  echo $frecuencia1  ?>

  </P>

  <P>

  <?php  if ($posicion <> '') {$posicion1 = 'Posición:'.$posicion.'<BR>';} ?>
  <?php  echo $posicion1  ?>
 ...
 <?php  if ($presentacion <> '') {$presentacion1 = 'Presentación:'.$presentacion.'<BR>';} ?>
  <?php  echo $presentacion1  ?>

  </P>

  <P>

  <?php  if ($movimientos <> '') {$movimientos1 = 'Movimientos Fetales:'.$movimientos.'<BR>';} ?>
  <?php  echo $movimientos1  ?>
  ...
  <?php  if ($edema <> '') {$edema1 = 'Edema:'.$edema.'<BR>';} ?>
  <?php  echo $edema1  ?>
