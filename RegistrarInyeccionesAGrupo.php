...
if ($_GET['eD'] <> "") {
  ...
  $accion = ' Editar Inyección Asociada a Grupo';
  ...
  $tabla .= ' <b>INFORMACIÓN REGISTRADA DE LA INYECCIÓN ' . $Nombre_Vacuna . ' PARA EL GRUPO ' . $Nombre_Grupo . '</b> ';
...
<th> <input type="hidden"  value="' . $idOper1 . '" class="form-control input-lg" id="idOper' . $cont . '" name="idOper" >   <a href="#"  onclick="eliminarItem(' . $cont . ',' . $grupo . ',' . $Id_Vacuna . ');"> <font size="5"> <strong>  <i class="fa fa-trash"></i>   </strong>  </font> </a> ' . $noD . ' </th> <th>' . $tiempo . ' ' . $var . ' </th> 
  ...
  $accion = ' Registrar Inyección a Grupo';
}
...
<div class="content-wrapper p-3">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active"> Registrar Inyección a Grupo </li>
    </ol>
  </section>

  <br>
  <section class="content">
  <h4 class="Titulo_Pagina">Registrar Inyección a Grupo  </h4>
      ...
      <div class="card-body">
        ...
        <div class="content">
          <div class="">
            ...
            <form action="GuardarInyeccionAGrupo.php" method="POST" name="formularioGuardarVacunaAGrupo" enctype="multipart/form-data" class="row">
              ...
              <div class="form-group col-md-12">
                ...
                ?>
                  ...
                  <br>
                  <center><a href="RegistrarInyeccionesAGrupo.php" class="btn btn-block btn-primary btn-sm">Nueva Inyección a Grupo</a></center>
                <?php
                }
                ?>
              </div>
          ...
          <tbody>
            ...
            while ($Lista1 = mysqli_fetch_array($queryList)) {
              ...
              echo '     <tr>
                    ...
                    <a href="vacunacionInyeccionGrupos?eD=' . encrypt($id) . '" title="Ver/Editar grupo"><i class="fa fa-pencil"></i> </a> |

<a href="EliminarInyeccionesGrupos.php?eD=' . encrypt($id) . '" title="Eliminar"><i class="fa fa-trash"></i> </a> 
