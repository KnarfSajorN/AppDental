...
$tabla = mysqli_query($conn3, "SHOW TABLES LIKE 'RIAS_HistoriaAdolescencia'");
$nrowtabla = mysqli_num_rows($tabla);
if ($nrowtabla == 0) {
    $query = "CREATE TABLE `RIAS_HistoriaAdolescencia` ( 
...
foreach ($ArregloCamposAdicionales as $key => $value) {
    $Campo1 = mysqli_query($conn3, "show COLUMNS from RIAS_HistoriaAdolescencia WHERE Field = '$value';");
    $nrowCampo1 = mysqli_num_rows($Campo1);
    if ($nrowCampo1 == "0") {
        mysqli_query($conn3, "ALTER TABLE `RIAS_HistoriaAdolescencia` ADD `$value` TEXT NULL ");
    }
}
...
$ArregloCamposAdicionales=["ValoracionDerechosSexuales"];
...
foreach (eliminarElementosVacios($_POST['Anamnesis']['ValoracionDerechosSexuales']) as $key => $value) {

    $ArregloAntecedentes['ValoracionDerechosSexuales'][$key]=$value;


}

////////////////////////////////////////? 1.2.1 Derechos sexuales y reproductivos [FIN] /////////////////////////////////////
...
$ArregloCamposAdicionales=["ValoracionDesarrollo_FuncionesCognitivas","ValoracionDesarrollo_Identidad_Anexo14","ValoracionDesarrollo_Autonomia","ValoracionDesarrollo_Autonomia_Anexo15"];
...
$ArregloCamposAdicionales=["SaludSexual_Signos","SaludSexual_MaduracionSexualCrecimiento","SaludSexual_AspectosMaduracion","SaludSexual_Mujeres","SaludSexual_Varones","SaludSexual_Intersexuales","SaludSexual_Otros","SaludSexual_EscalaTanner"];
...
$ArregloCamposAdicionales=["SaludMental_Valoracion","SaludMental_RQC","SaludMental_SRQ","SaludMental_ASISST","SaludMental_AUDIT","SaludMental_RQCInterpretacion","SaludMental_RQCPuntaje","SaludMental_SRQInterpretacion","SaludMental_AUDITInterpretacion","SaludMental_AUDITPuntaje","SaludMental_ASISSTPuntaje","SaludMental_ASISSTInterpretacion"];
...
//echo "INSERT INTO RIAS_HistoriaAdolescencia (usuario_id,cliente_id,{$Campos},Familiograma_Archivo,Ecomapa_Archivo) VALUES ('$usuario_id','$cliente_id',{$Valores},'$Familiograma','$Ecomapa');";

$queryList = mysqli_query($conn3, "INSERT INTO RIAS_HistoriaAdolescencia (usuario_id,cliente_id,{$Campos},Familiograma_Archivo,Ecomapa_Archivo) VALUES ('$usuario_id','$cliente_id',{$Valores},'$Familiograma','$Ecomapa');") or die(mysqli_error($conn3));
...
$Recetario_Nombre_Historia = "RIAS_HistoriaAdolescencia";
...
echo "<script language='Javascript'> window.location='RIAS_Finalizado_Adolescencia.php?id=$Historia_id';</script>";
