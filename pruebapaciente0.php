...
$Nombre_Tabla = "CH_Tabla_Historia";
#Inicio
if (isset($_POST['Guardar_Informacion_Pagina'])) {
    ...
    $_POST["Arreglo"]["Nombre_Tabla"] = str_replace(" ", "_", $_POST["Arreglo"]["Nombre"]);
    ...
    if ($queryList != true) {
        ...
        echo "<script language='Javascript'> window.location='{$ruta}?msg=Se Registraron Los Datos Correctamenter'</script>";
    }
}
...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <div class="content">
                <h4 class="Titulo_Pagina">Registro de H</h4>
                <div class="box">
                    <div class="box-body">
                        <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST">
                            <div class="form-group col-md-12">
                                <label>Nombre de la Historia</label>
                                <input type="text" class="form-control input-lg" name="Arreglo[Nombre]" placeholder="Nombre de la H" pattern="[A-Za-z0-9 ]+" maxlength="80" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);if (!this.checkValidity()) this.value = this.value.slice(0, -1)" required>
                            </div>
                            ...
                            <?php else : ?>
                                <input type="hidden" class="form-control input-lg" name="Arreglo[Nombre_Tabla]" value="">
                                <div class="col-sm-12">
                                        ...
                                        <table id="example1" class="table table-bordered table-striped">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col" width="50%">Nombre de la H</th>
                                            ...
                                            <tbody>
                                                ...
                                                while ($rowMotorizado = mysqli_fetch_array($queryList)) {
                                                    ...
                                                    $ruta = htmlentities($_SERVER['PHP_SELF']);
                                                    echo "<tr><th scope='row' width='10%'>{$id}</th>
                                                    <td width='50%' align='center'>{$Nombre}</td>
                                                    <td width='40%' align='center'><font color='#04CC05'> <a href='{$ruta}?Editar={$id}' class='btn btn-primary' style='width: 200px;'><i class='fa fa-pencil' title='Editar'> Editar</i></a></font><br>
                                                        ...
                                                        <font> <a href='pruebapaciente.php?Historia={$id}' class='btn btn-primary' style='width: 200px;'> <i class='fa fa-plus' title='Agregar'> Ver H </i></a></font>
