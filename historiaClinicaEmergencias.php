                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-solid">
                                <!-- /.box-header -->
                                <form action="guardarHistoriaEmergencias.php" method="POST" name="formularioActualizarcliente">
                                    <div class="box-body">
                      ...
                      -->
                                            ...
                                            <div class="panel box box-primary">
                                                ...
                                                <div id="collapseFor" class="panel-collapse collapse">
                                                    <div class="col-md-12">
                                                        <label>Interconsulta</label><textarea name="interconsulta" class="form-control input-lg" placeholder="Interconsulta" style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;max-width: 100%;"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--cierre de lista-->
