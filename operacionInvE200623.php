  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Entrada de inventarios</a></li>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <form method="POST" action="EntrtadaInventario.php"> 
...
<!--
                ...
                <select id="tercero" name="tercero" class="form-control select2" style="width: 100%;" required="required">
                    ...
                    <?php
                        ...
                        $queryList=mysqli_query($conn3,"SELECT * FROM sproveedores WHERE usuario_id = $ususario_id order by nombre");
                  ...
                  <div class="col-md-1">
                    <br>
                    <br>
                    <font color="#04CC05" size="6"> <a href="<?php echo $Base?>proveedores"> <i class="fa fa-plus-circle" title="Agregar nuevo proveedor"></i>  </a></font> 
                  </div>
-->
  ...
  <hr>  
                ...
                Referencia | Descripción | Existencia
...
<script type="text/javascript">
        ...
        function cargarcosto(){
            ...
            var usuario_id = $("#usuario_id").val();
              ...
              $.ajax({
                  type : "POST",
                  url: "ajax_cargarCosto.php",
                  data: {codigoProd:codigoProd, usuario_id:usuario_id},
