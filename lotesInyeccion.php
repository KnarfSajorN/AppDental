...
<div class="content-wrapper p-3">
  ...
  <h4 class="Titulo_Pagina">Registrar Nuevo Lote</h4>
      ...
      <div class="card-body">
        ...
        <div class="content">
          <div class="">
            ...
            <form action="agregarLoteInyeccion.php" method="POST" name="formularioActualizarcliente" enctype="multipart/form-data" class="row">
              ...
              <div class="form-group col-md-12">
                ...
                if (decrypt($_GET['eDl']) == "") {
                ?>
                  <center><button type="submit" name="Guardar" class="btn btn-block btn-outline-info rounded-pill shadow">Guardar</button></center>
                <?php
                } else {
                ?>
                  <input type="hidden" name="idLote" value="<?php echo decrypt($_GET['eDl']) ?>">
                  <input type="hidden" name="vacuna" value="<?php echo $vacuna ?>">
                  <center><button type="submit" name="Actualizar" class="btn btn-block btn-outline-info rounded-pill shadow">Actualizar</button></center>
                <?php
                }
                ?>
        ...
        <table id="example1" class="table table-bordered table-striped" style="font-size: 15px;">
          ...
          <tbody>
            ...
            while ($Lista = mysqli_fetch_array($queryList)) {
              ...
              if ($_SESSION['TIPO'] == 99) {
                echo '
                    <td><a class="eliminar" href="EliminarloteInyeccion.php?iL=' . encrypt($idLote) . '&v=' . encrypt($vacuna) . '" ><i class="fa fa-trash" style="color:RED" title = "Eliminar"></i>  </a> |
                     <a href="lotesInyeccion?eDl=' . encrypt($idLote) . '&eD=' . encrypt($vacuna) . '" title="Editar Lote"><i class="fa fa-pencil"></i> </a> | </td>
