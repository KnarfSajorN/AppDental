...
$tratamientoResumen    = ($_POST['tratamientoResumen']);
...
if ($rs1 <> '') {
  $s1 = ' Fiebre : ' . sino($rs1) . '<trong> | </trong>';
}
if ($rs2 <> '') {
  $s2 = ' Tos: ' . sino($rs2) . '<trong> | </trong>';
}
if ($rs3 <> '') {
  $s3 = ' Rinorrea: ' . sino($rs3) . '<trong> | </trong>';
}
if ($rs4 <> '') {
  $s4 = ' Cefalea: ' . sino($rs4) . '<trong> | </trong>';
}
if ($rs5 <> '') {
  $s5 = ' Mareo: ' . sino($rs5) . '<trong> | </trong>';
}
if ($rs6 <> '') {
  $s6 = ' Vomito: ' . sino($rs6) . '<trong> | </trong>';
}
if ($rs7 <> '') {
  $s7 = ' Diarrea: ' . sino($rs7) . '<trong> | </trong>';
}
if ($rs8 <> '') {
  $s8 = ' Disuria: ' . sino($rs8) . '<trong> | </trong>';
}
if ($rs9 <> '') {
  $s9 = ' Dolor de Garganta: ' . sino($rs9) . '<trong> | </trong>';
}
if ($rs10 <> '') {
  $s10 = ' Dolor Adominal: ' . sino($rs10) . '<trong> | </trong>';
}
if ($rs11 <> '') {
  $s11 = ' Disnea: ' . sino($rs11) . '<trong> | </trong>';
}
if ($rs12 <> '') {
  $s12 = ' Otalgia: ' . sino($rs12) . '<trong> | </trong>';
}
if ($rs13 <> '') {
  $s13 = ' Perdida de Peso: ' . sino($rs13) . '<trong> | </trong>';
}
if ($rs14 <> '') {
  $s14 = ' Sangre en las heces o al defecar: ' . sino($rs14) . '<trong> | </trong>';
}
if ($rs15 <> '') {
  $s15 = ' Hematuria: ' . sino($rs15) . '<trong> | </trong>';
}
if ($rs16 <> '') {
  $s16 = ' Dolor en las extremidades: ' . sino($rs16) . '<trong> | </trong>';
}
if ($rs17 <> '') {
  $s17 = ' Parestesias: ' . sino($rs17) . '<trong> | </trong>';
}
if ($rs18 <> '') {
  $s18 = ' Hipoestesias: ' . sino($rs18) . '<trong> | <br> </trong>';
}
if (strlen($enfermedadActual) > 0) {
  $senfermedadActual = 'Enfermedad Actual: ' . $enfermedadActual . '<trong> | </trong>';
}
...
$prestaciones2         = ($_POST['prestaciones2']);
...
if (strlen($t11) > 0) {
  $rt11 = $t11 . '<trong> | </trong>';
}
if (strlen($t12) > 0) {
  $rt12 = $t12 . '<trong> | </trong>';
}
if (strlen($t13) > 0) {
  $rt13 = $t13 . '<trong> | </trong>';
}
if (strlen($t14) > 0) {
  $rt14 = $t14 . '<trong> | </trong>';
}
if (strlen($t15) > 0) {
  $rt15 = $t15 . '<trong> | </trong>';
}
if (strlen($t16) > 0) {
  $rt16 = $t16 . '<trong> | </trong>';
}
if (strlen($t17) > 0) {
  $rt17 = $t17 . '<trong> | </trong>';
}
if (strlen($t18) > 0) {
  $rt18 = $t18 . '<trong> | </trong>';
}
if (strlen($t19) > 0) {
  $rt19 = $t19 . '<trong> | </trong>';
}
if (strlen($t20) > 0) {
  $rt20 = $t20 . '<trong> | </trong>';
}
if (strlen($t21) > 0) {
  $rt21 = $t21 . '<trong> | </trong>';
}
if (strlen($t22) > 0) {
  $rt22 = $t22 . '<trong> | </trong>';
}
if (strlen($t23) > 0) {
  $rt23 = $t23 . '<trong> | </trong>';
}
if (strlen($t24) > 0) {
  $rt24 = $t24 . '<trong> | </trong>';
}
if (strlen($t25) > 0) {
  $rt25 = $t25 . '<trong> | </trong>';
}
if (strlen($t26) > 0) {
  $rt26 = $t26 . '<trong> | </trong>';
}
if (strlen($t27) > 0) {
  $rt27 = $t27 . '<trong> | </trong>';
}
if (strlen($t28) > 0) {
  $rt28 = $t28 . '<trong> | </trong>';
}
if (strlen($t29) > 0) {
  $rt29 = $t29 . '<trong> | </trong>';
}
if (strlen($t30) > 0) {
  $rt30 = $t30 . '<trong> | </trong>';
}
if (strlen($t31) > 0) {
  $rt31 = $t31 . '<trong> | </trong>';
}
if (strlen($t32) > 0) {
  $rt32 = $t32 . '<trong> | </trong>';
}
if (strlen($t33) > 0) {
  $rt33 = $t33 . '<trong> | </trong>';
}
if (strlen($diagnostico1) > 0) {
  $rdiagnostico1 = $diagnostico1 . '<trong> | </trong>';
}
...
if (strlen($cutaneo) > 0) {
  $rcutaneo = $cutaneo . '<trong> | </trong>';
}
if (strlen($acne) > 0) {
  $racne = $acne . '<trong> | </trong>';
}
if (strlen($fototico) > 0) {
  $rfototico = $fototico . '<trong> | </trong>';
}
if (strlen($pele) > 0) {
  $rpele = $pele . '<trong> | </trong>';
}
if (strlen($lesoes) > 0) {
  $rlesoes = $lesoes . '<trong> | </trong>';
}
if (strlen($est_cutaneos) > 0) {
  $rest_cutaneos = $est_cutaneos . '<trong> | </trong>';
}
if (strlen($diagnostico2) > 0) {
  $rdiagnostico2 = $diagnostico2 . '<trong> | </trong>';
}
...
if (strlen($t311) > 0) {
  $rt311 = $t311 . '<trong> | </trong>';
}
if (strlen($t312) > 0) {
  $rt312 = $t312 . '<trong> | </trong>';
}
if (strlen($t313) > 0) {
  $rt313 = $t313 . '<trong> | </trong>';
}
if (strlen($t314) > 0) {
  $rt314 = $t314 . '<trong> | </trong>';
}
if (strlen($t315) > 0) {
  $rt315 = $t315 . '<trong> | </trong>';
}
if (strlen($t316) > 0) {
  $rt316 = $t316 . '<trong> | </trong>';
}
if (strlen($t317) > 0) {
  $rt317 = $t317 . '<trong> | </trong>';
}
if (strlen($t318) > 0) {
  $rt318 = $t318 . '<trong> | </trong>';
}
if (strlen($t319) > 0) {
  $rt319 = $t319 . '<trong> | </trong>';
}
if (strlen($t320) > 0) {
  $rt320 = $t320 . '<trong> | </trong>';
}
if (strlen($t321) > 0) {
  $rt321 = $t321 . '<trong> | </trong>';
}
if (strlen($t322) > 0) {
  $rt322 = $t322 . '<trong> | </trong>';
}
if (strlen($t323) > 0) {
  $rt323 = $t323 . '<trong> | </trong>';
}
if (strlen($diagnostico3) > 0) {
  $rdiagnostico3 = $diagnostico3 . '<trong> | </trong>';
}
...
if (strlen($t411) > 0) {
  $rt411 = $t411 . '<trong> | </trong>';
}
if (strlen($t412) > 0) {
  $rt412 = $t412 . '<trong> | </trong>';
}
if (strlen($t413) > 0) {
  $rt413 = $t413 . '<trong> | </trong>';
}
if (strlen($t414) > 0) {
  $rt414 = $t414 . '<trong> | </trong>';
}
if (strlen($t415) > 0) {
  $rt415 = $t415 . '<trong> | </trong>';
}
if (strlen($t416) > 0) {
  $rt416 = $t416 . '<trong> | </trong>';
}
if (strlen($t417) > 0) {
  $rt417 = $t417 . '<trong> | </trong>';
}
if (strlen($t418) > 0) {
  $rt418 = $t418 . '<trong> | </trong>';
}
if (strlen($t419) > 0) {
  $rt419 = $t419 . '<trong> | </trong>';
}
if (strlen($t420) > 0) {
  $rt420 = $t420 . '<trong> | </trong>';
}
if (strlen($t421) > 0) {
  $rt421 = $t421 . '<trong> | </trong>';
}
if (strlen($t422) > 0) {
  $rt422 = $t422 . '<trong> | </trong>';
}
if (strlen($t423) > 0) {
  $rt423 = $t423 . '<trong> | </trong>';
}
if (strlen($t424) > 0) {
  $rt424 = $t424 . '<trong> | </trong>';
}
if (strlen($diagnostico4) > 0) {
  $rdiagnostico4 = $diagnostico4 . '<trong> | </trong>';
}


$tratamiento4 = $rt411 . $rt412 . $rt413 . $rt414 . $rt415 . $rt416 . $rt417 . $rt418 . $rt419 . $rt420 . $rt421 . $rt422 . $rt423 . $rt424 . $rdiagnostico4;
...
mysqli_query($conn3, "INSERT INTO historiaClinicaCirugiaPlastica (cliente_id, usuario_id, Fecha, Hora, envejecimiento, cirugia, tratamiento, tratamientoResumen, procedimiento, planAtencion, notas, fotoAntes, fotoDurante, fotoDespues, pagoAbono, peso, altura, imc, ComposicionCorporal, diagnostico5, rSistema, motivoConsulta, CIE10) VALUE
...
$lastInserId = mysqli_insert_id($conn3);


echo "INSERT INTO historiaClinicaCirugiaPlastica (cliente_id, usuario_id, Fecha, Hora, envejecimiento, cirugia, tratamiento, tratamientoResumen, procedimiento, planAtencion, notas, fotoAntes, fotoDurante, fotoDespues, pagoAbono, peso, altura, imc, ComposicionCorporal, diagnostico5, rSistema, motivoConsulta) VALUE
...
/*
              ...
              $queryListhc=mysqli_query($conn3,"SELECT MAX(ID) as historiaClinicaCirugiaPlastica from historiaClinica1 where cliente_id= $clienteId");
...
echo "<script language='Javascript'> window.location='hccpFinalizado?iC=".encrypt($lastInserId)."';</script>"; 
