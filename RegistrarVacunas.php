    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="portada"><i class="fa fa-dashboard"></i> Escritorio </a></li>
         ...
         <li  class="active"> Registrar Nueva Vacuna </li>
      </ol>
    </section>
...
<div  class="box box-info" align="center">
 ...
 <div class="card-body">
    <h4 class="card-title">  Registro de Nuevas Vacunas (Inventario)  </h4>
    <br><br>
    <div class="content">
      <div class="">

           <form action="GuardarVacuna.php" method="POST" name="formularioActualizarcliente" enctype="multipart/form-data" class="row">
...
if ($_SESSION['TIPO'] ==99) { ECHO '
                    ...
                    <a href="vacunacionRegistroV?eD='.encrypt($id).'" title="Editar Vacuna"><i class="fa fa-pencil"></i> </a> |
                    <a href="vacunacionLotes?eD='.encrypt($id).'" title="Agregar Lote"><i class="fa fa-plus-square"></i> </a> |
         <a class="eliminar" href="vacunacionEliminar?v='.encrypt($id).'" ><i class="fa fa-trash" style="color:RED" title = "Eliminar"></i>  </a>  </td>
