...
{ 
  ...
  mysqli_query($conn3,"UPDATE cliente SET 
    ...
    echo "<script language='Javascript'> window.location='patientes?msg=3';</script>"; 

}

/*
                  $resultado=mysql_query("SELECT * FROM  cliente where cliente_id =$cliente_id");
                  ...
                  $celular_cliente = $fila[3];
                  $ciudad_cliente = $fila[4];
                  $correo_cliente = $fila[5];
                  $CODI_CLIENTE = $fila[6];
                  $genero = $fila[11];
                  $direccion_cliente = $fila[12];
                  $telefono_cliente = $fila[13];
                  $edad_cliente = $fila[14];
                  $profesion_cliente = $fila[15];
                  $acompananteFamiliar = $fila[16];
                  $telefono_acompanante = $fila[17];
                  $antecedentes = $fila[18];
                  $entidadSalud = $fila[19];
                  $seguro = $fila[20];
                  $nota = $fila[21];
...
<br> 
 <div class="card-body">
          ...
          <br>
           ...
           <form action="agregarClientesE.php" method="POST" name="formularioActualizarcliente">
           <div class="form-row">
...
?>
              ...
              <div class="form-group col-md-4">
                ...
                <input value="<?php echo $profesion_cliente?>" type="text" class="form-control input-lg" id="profesion_cliente" name="profesion_cliente" placeholder="Profesion" required>
              </div>
...
?>
               ...
               <div class="form-group col-md-4">
                ...
                <input value="<?php echo $tiposSangre?>" type="text" class="form-control input-lg" id="tiposSangre" name="tiposSangre" placeholder="tipo de Sangre" required>
              </div>
              <div class="form-group col-md-4">
                <div align="left">Toma algún Medicamento </div>
               
                <input value="<?php echo $tomaMedicamento?>" type="text" class="form-control input-lg" id="tomaMedicamento" name="tomaMedicamento" placeholder="toma Medicamento" required>
              </div>
