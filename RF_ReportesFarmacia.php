...
<div class="col-md-12">
    <div class="accordion-header" id="productosPorVencer-header" style="cursor: pointer; background-color: #f0f0f0; padding: 10px; text-align: center; color: black;">
        <i class="fas fa-id-card-alt" style="color: black;"></i><strong>Productos por Vencer</strong>
    </div>
    <div class="accordion-content" id="productosPorVencer-content" style="display: none;">
        <form action="RF_ReporteMedicamentosVencer.php" method="POST" enctype="multipart/form-data">
            <div class="col-md-12 row" style="text-align:center">
                ...
                <div class="col-md-12">
                    <label style="color: red;">La fecha que se ingresa es el rango donde el producto tiene la fecha de vencimiento</label>
                </div>
...
<div class="col-md-12">
    <div class="accordion-header" id="existenciasActuales-header" style="cursor: pointer; background-color: #f0f0f0; padding: 10px; text-align: center; color: black;">
        <i class="fas fa-id-card-alt" style="color: black;"></i><strong> Existencias Actuales</strong>
    </div>
    <div class="accordion-content" id="existenciasActuales-content" style="display: none;">
...
<div class="col-md-12">
    <div class="accordion-header" id="productosVendidos-header" style="cursor: pointer; background-color: #f0f0f0; padding: 10px; text-align: center; color: black;">
        <i class="fas fa-id-card-alt" style="color: black;"></i><STRONG>Productos Vendidos
    </div>
    <div class="accordion-content" id="productosVendidos-content" style="display: none;">
 ...
 <div class="col-md-12">
    <div class="accordion-header" id="productosComprados-header" style="cursor: pointer; background-color: #f0f0f0; padding: 10px; text-align: center; color: black;">
        <i class="fas fa-id-card-alt" style="color: black;"></i> Productos Comprados
    </div>
    <div class="accordion-content" id="productosComprados-content" style="display: none;">
...
<div class="col-md-12">
    <div class="accordion-header" id="minimoMaximoMedicamento-header" style="cursor: pointer; background-color: #f0f0f0; padding: 10px; text-align: center; color: black;">
        <i class="fas fa-id-card-alt" style="color: black;"></i> Mínimo y Máximo por Medicamento
    </div>
    <div class="accordion-content" id="minimoMaximoMedicamento-content" style="display: none;">
...
<div class="col-md-12">
    <div class="accordion-header" id="minimoMaximoFechaCompraVenta-header" style="cursor: pointer; background-color: #f0f0f0; padding: 10px; text-align: center; color: black;">
        <i class="fas fa-id-card-alt" style="color: black;"></i> Mínimo y Máximo por Medicamento, Fecha Última Compra y Venta del Producto
    </div>
    <div class="accordion-content" id="minimoMaximoFechaCompraVenta-content" style="display: none;">
...
<div class="col-md-12">
    <div class="accordion-header" id="existenciasDepartamento-header" style="cursor: pointer; background-color: #f0f0f0; padding: 10px; text-align: center; color: black;">
        <i class="fas fa-id-card-alt" style="color: black;"></i> Reporte de Existencias por Departamentos/Tipo
    </div>
    <div class="accordion-content" id="existenciasDepartamento-content" style="display: none;">
...
<div class="col-md-12">
    <div class="accordion-header" id="cantidadVendidos-header" style="cursor: pointer; background-color: #f0f0f0; padding: 10px; text-align: center; color: black;">
        <i class="fas fa-id-card-alt" style="color: black;"></i> Reporte Cantidad Vendidos Dias, Mes, Año
    </div>
    <div class="accordion-content" id="cantidadVendidos-content" style="display: none;">
        <form action="RF_ReporteCantidadVendidosFiltro.php" method="POST" enctype="multipart/form-data">
            <div class="col-md-12 row" style="text-align:center">
                <div class="col-md-6">
                    ...
                    <select name="TipoFechas" class="form-control select2 select input-lg" style="width: 100%;" onchange="TipoFechasVendidos()" required>
...
<div class="col-md-12">
    <div class="accordion-header" id="cantidadComprados-header" style="cursor: pointer; background-color: #f0f0f0; padding: 10px; text-align: center; color: black;">
        <i class="fas fa-id-card-alt" style="color: black;"></i> Reporte Cantidad Comprados Dias, Mes, Año
    </div>
    <div class="accordion-content" id="cantidadComprados-content" style="display: none;">
        <form action="RF_ReporteCantidadCompradosFiltro.php" method="POST" enctype="multipart/form-data">
            <div class="col-md-12 row" style="text-align:center">
                <div class="col-md-6">
                    <label style='padding-top: 15px;'> Tipo Filtro </label>
                    <select name="TipoFechas_Compras" class="form-control select2 select input-lg" style="width: 100%;" onchange="TipoFechasCompras()" required>
                        <option value="" selected="selected">Seleccione</option>
                        <option value="Dias">Dias</option>
                        <option value="Mes">Mes</option>
                        <option value="Año">Año</option>
...
document.addEventListener("DOMContentLoaded", function() {
    const header = document.getElementById("productosPorVencer-header");
    const content = document.getElementById("productosPorVencer-content");
...
document.addEventListener("DOMContentLoaded", function() {
    const header = document.getElementById("existenciasActuales-header");
    const content = document.getElementById("existenciasActuales-content");
...
document.addEventListener("DOMContentLoaded", function() {
    const header = document.getElementById("productosVendidos-header");
    const content = document.getElementById("productosVendidos-content");
...
document.addEventListener("DOMContentLoaded", function() {
    const header = document.getElementById("productosComprados-header");
    const content = document.getElementById("productosComprados-content");
...
document.addEventListener("DOMContentLoaded", function() {
    const header = document.getElementById("minimoMaximoMedicamento-header");
    const content = document.getElementById("minimoMaximoMedicamento-content");
...
document.addEventListener("DOMContentLoaded", function() {
    const header = document.getElementById("minimoMaximoFechaCompraVenta-header");
    const content = document.getElementById("minimoMaximoFechaCompraVenta-content");
...
document.addEventListener("DOMContentLoaded", function() {
    const header = document.getElementById("existenciasDepartamento-header");
    const content = document.getElementById("existenciasDepartamento-content");
...
document.addEventListener("DOMContentLoaded", function() {
    const header = document.getElementById("cantidadVendidos-header");
    const content = document.getElementById("cantidadVendidos-content");
...
document.addEventListener("DOMContentLoaded", function() {
    const header = document.getElementById("cantidadComprados-header");
    const content = document.getElementById("cantidadComprados-content");
