              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                elseif ($_SESSION['rol'] == 2)
                {
                 echo'<td><a href="historiaClinica2.php?clienteId='.$fila[0].'" title="Agregar Cita">'.$fila[2].' </a></td>';
                  ...
                  echo '<a href="historiaClinica13_posoperatorio.php?clienteId='.$fila[0].'" title="Agregar Consulta"><i class="fa fa-heartbeat"></i> </a>|';
                 
                
 
                  echo '<a href="consultaPostOperatorio.php?clienteId='.$fila[0].'" title="Ver Historia"><i class="fa fa-search"></i> </a> |';
