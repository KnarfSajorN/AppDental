            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <div class="col-md-12">
                            <div class="progress">
                                <div class="progress-bar progress-bar-primary progress-bar-striped" id="progress-bar" role="progressbar"  aria-valuemin="0" aria-valuemax="100" style="width: 40%">
                        ...
                        <div class="col-md-12 center text-center" id="todo" style="display:none !important">
