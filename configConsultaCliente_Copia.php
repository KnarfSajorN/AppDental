                        ...
                        <div class="col-md-12">
                            <div class="tab" role="tabpanel">
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    <li role="presentation"><a href="#Consultas" aria-controls="home" role="tab" data-toggle="tab" class="active"> <i class='fas fa-book-medical' style='font-size:26px'> </i> Historias de
                                            <?= $Nombre_HistoriaCreador_Limpio ?></a></li>
