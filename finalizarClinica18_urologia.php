...
<a class="btn btn-app" target="_blank" href="<?php echo $Base;?>imprimirHistoriaUrologia.php?historiaClinica1=<?php echo $historiaClinica1;?>"> 
  <i class="fa fa-print"></i> Imprimir Historia Urologia
</a>
<!--
