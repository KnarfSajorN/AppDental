                              ...
                              <div class="box-group" id="accordion">
                                ...
                                <div class="panel box box-success">
                                  <div class="box-header with-border">
                                    <h4 class="box-title">
                                      <a data-toggle="collapse" data-parent="#accordion" href="#collapse5">
                                        Procedimiento Pre-Hospitalizacion
                                      </a>
                                    </h4>
                                  </div>
                                  ...
                                  <div id="collapse5" class="panel-collapse collapse">
                                  	...
                                  	<label>Atenciones Brindadas</label><br>
                                  	<select class="form-control select2" multiple>
                                  		<option>Suministro de medicamentos</option>
                                  		<option>Urgencias</option>
                                  		<option>Triaje</option>
                                  	</select>

									                 <label>Otras atenciones</label>                                  	
                                  <textarea class="form-control" name="atenciones[Otras Atenciones]"></textarea>

                                  <label>El paciente ingresa a hospitalizacion</label><br>
                                    <select class="form-control select2" onchange="validarHospitalizacion(this.value)">
                                    ...
                                    <input type="hidden" name="siNoHospitalizacion" id="siNoHospitalizacion">
                                    ...
                                    <script type="text/javascript">
                                      function validarHospitalizacion(rta){
                                        ...
                                        if (rta == "Si") {
                                          Swal.fire({
                                            title: '¿Esta seguro de asignar al paciente a hospitalizacion?',
                                            icon: 'question',
                                            ...
                                            if (result.isConfirmed) {
                                              ...
                                              Swal.fire('Hecho', 'Al finalizar sera redireccionado al formulario dew hospitalizacion del paciente', 'success');
                                            } else if (result.dismiss === Swal.DismissReason.cancel) {
                                              // El usuario hizo clic en "No" o cerró el modal.
                                              Swal.fire('Cancelado', 'Al finalizar será redirigido a modulo de impresion', 'info');
                                            }
                                          });
                                        }
