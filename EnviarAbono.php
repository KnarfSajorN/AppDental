...
$mensajeW = ' Sr(a) *'.$nombre_cliente .'* Se le ha registrado un abono de la factura por el valor de : *'.$valor_abonado.'* *'.$Moneda.'* porfavor firmar en el siguiente link para confirmar el abono, Link:  '.$Base.'firma/FirmarAbono/'.$idOperacion.'/'.$id.' ';
$accion = 0;
