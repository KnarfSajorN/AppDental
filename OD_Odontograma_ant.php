                        ...
                        <div style="display: inline-table;width:100%">
                            ...
                            <a href="OD_Impresion.php?clienteId=<?= $cliente_id; ?>&usuarioId=<?= $_SESSION['ID']; ?>" target="_blank">
                                <button class="btn btn-block btn-primary btn-sm">
                                    <h4> <strong> <i class="fa-solid fa-teeth    "></i> Imprimir Odontograma </strong></h4>
                                </button>
                            </a>
                            <hr>
                            <a href="OD_OdontogramaInicial.php?clienteId=<?= $cliente_id; ?>">
                                <button class="btn btn-block btn-primary btn-sm">
                                    <h4> <strong> <i class="fa-solid fa-teeth"></i> Ingresar a Odontograma Inicial</strong></h4>
                                </button>
                            </a>
                        </div>
...
<script>
    ...
    var optionFormat1 = function(item) {
        ...
        template += svg;
        template += "<label style='position: relative;top: -11px;left: 3px;margin-left: 3px;'>" + item.text + "<label>";
    ...
    function ModalSwalEdicion(response, lugar) {
        ...
        Swal.fire({
            ...
            html: '<label for="estado_edicion">Motivo Consulta:</label><br>' +
                ...
                '<input id="detalle_edicion"  type="text" class="input-lg" placeholder="Escribe aquí el detalle" style="width:100%;">' +
                '<br><br>' +
    ...
    function EnviarAFirmarCliente(detalle_id) {
        ...
        Swal.fire({
            ...
            html: '<label for="whatsapp_enviar">Whatsapp:</label><br>' +
                '<input id="whatsapp_enviar"  type="number" class="input-lg" placeholder="Escribe aquí el numero Whatsapp a enviar el detalle a firmar" style="width:100%;" value="<?= $Paciente_Whatsapp; ?>">' +
                '<label for="correo_enviar">Correo:</label><br>' +
                '<input id="correo_enviar"  type="email" class="input-lg" placeholder="Escribe aquí el email a enviar el detalle a firmar" style="width:100%;" value="<?= $Paciente_Correo; ?>">' +
    ...
    function EditarEstadoProcedimiento(detalle_id) {
        ...
        Swal.fire({
            ...
            html: '<label for="Estado_Modal_Procedimiento">Estado</label><br>' +
                '<select id="Estado_Modal_Procedimiento" class="input-lg" style="width:100%;"><option value="Registrado">Registrado</option><option value="Realizado">Realizado</option><option value="No Realizado">No Realizado</option>' +
                '</select>' +
                '<label for="Detalle_Modal_Procedimiento">Detalle:</label><br>' +
                '<input id="Detalle_Modal_Procedimiento"  type="text" class="input-lg" placeholder="Escribe aquí el detalle" style="width:100%;">' +
                '<input id="detalle_odontograma_id" type="hidden" value="' + detalle_id + '">',
            icon: 'info',
            showCancelButton: true,
