...
include("funciones/funcionesUtilidades.php");
    ...
    $queryList=mysqli_query($conn3,"SELECT * FROM  cliente where cliente_id = $cliente_id");
            ...
            $cie1=mysqli_query($conn3,"SELECT * FROM historiaClinica9_Quirurgico_Cie10 as hc, cie10 as cie10 WHERE hc.historiaClinica9_id='$historiaClinica1' AND cie10.codigo=hc.codigo");
...
//////////////////////////////////////////////////////////////////////////// Acá comienza el mensaje al correo
...
Antecedentes Familiares: 
  ...
  <p>
Examenes de las partes del cuerpo : 
    '.$partes.'
 </p>
...
<p>
Diagnóstico Ministerio de Salud : 
    '.$diagnosticoMsalud.'
 </p>
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////// Acá comienza el mensaje a Whatssap //////////////////////



$mensajeW = 'Informe de la consulta medica con el Dr. JOSE LUIS RAMIREZ OSORIO
Hola buen dia '.$nombrecliente.', se envia resultado de su consulta con  el Doctor JOSE LUIS RAMIREZ OSORIO.
-
