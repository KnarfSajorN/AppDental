...
if (isset($_POST['GuardarDetalleOrden'])) {
  ...
  '$impuesto', '$totalbase', '$subTotal', '$usuario_id', '$cliente_id','$descuento_final','$descuento_base','7','$SinvDep_id','$Deposito_id','$ivaMonto','$iva','$totalConIva');") or die(mysqli_error($conn3));
...
$queryList = mysqli_query($conn3, "SELECT * FROM  cliente where (usuario_id ='{$_SESSION['ID']}' or usuario_id = '{$_SESSION['ID_principal']}') AND cliente_id=$clienteId");
while ($rowMotorizado = mysqli_fetch_array($queryList)) {
...
$Deposito_id = "0";
$resultado = mysqli_query($conn3, "SELECT * FROM  sDetalleOperPendites where estado = 1 and (id_usuario ='{$_SESSION['ID']}' or id_usuario = '{$_SESSION['ID_principal']}') and  id_cliente = $clienteId AND tipo = '7' order by id");
        ...
        <div>
              ...
              <div class="box-body">
                ...
                <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>?clienteId=<?php echo $clienteId; ?>" method="POST" name="formularioActualizarcliente">
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-12">
                      <div class="form-group col-md-12">
                        ...
                        <select id="codigoProd" name="codigoProd" class="form-control select2" style="width: 100%;" required="required" onChange="CargarPrecioProducto();">
                          ...
                          <?php
                          $queryList = mysqli_query($conn3, "SELECT * FROM sinvetrios WHERE (ID_principal = '{$_SESSION['ID']}' OR ID_principal = '{$_SESSION['ID_principal']}') AND estado <>'0' ");
                    ...
                    <div class="form-group col-md-2" align="center" style="margin-top:4px;">
                      <br>
                      <button type="submit" class="btn btn-block btn-outline-primary rounded-pill " name="GuardarDetalleOrden">
                ...
                <table class="table table-striped">
                  ...
                  <tbody>
                    <tr>
                      ...
                      $resultado = mysqli_query($conn3, "SELECT * FROM  sDetalleOperPendites where (id_usuario ='{$_SESSION['ID']}' or id_usuario = '{$_SESSION['ID_principal']}') AND id_cliente = $clienteId AND estado = 1 AND tipo = 7 order by id");
                      while ($fila = mysqli_fetch_array($resultado)) {
                    ...
                    <td width="10%"><div align="Right">' . number_format($fila['subTotal'], 2) . '' . $moneda . '</div></td>';
                        ...
                        $fila_id = $fila["id"];
                        echo "<td width='1%'><a href='#' onclick='BorrarDetalleFactura($fila_id)'><i class='fa fa-trash' style='color:red'></i> </a></td>";
          ...
          <div class="box">
            <div class="box-body">
              ...
              $ID = $_SESSION['ID'];
              //tipo 1 -> facturas
              $resultado = mysqli_query($conn3, "SELECT * FROM sDetalleMetodosPagos WHERE (id_usuario ='{$_SESSION['ID']}' or id_usuario = '{$_SESSION['ID_principal']}') AND id_cliente = $clienteId AND idOperacion = 0 AND tipo = '7' ");
              ...
              <div class="row">
                <?php
                $queryUser = "SELECT * FROM Medios_Pago WHERE (ID_principal = $ID_Usuario or ID_principal = $ID_UsuarioP ) AND Activo = '1' ";
                ...
                <div class="col-md-3">
                  <form action="guardarDetalleMetodo.php" method="POST" name="formularioActualizarcliente" style="width:100%">
                    ...
                    <div class="form-group col-md-12">
                      ...
                      <label>Monto</label>
                      <input type="number" id="nota_pago" required name="nota_pago" placeholder="Monto" class="form-control input-lg" min="0" max="<?= round($MontoDebe, 2); ?>"><br>
                      <button id="btnPagar" type="submit" class="btn btn-block btn-outline-primary rounded-pill ">
                        <i class="fa fa-coins"></i>
                        Pagar
                      </button>
                      <script>
                        //funcion para mostrar la imagen del QR en el metodo de pago
                      ...
                      <!-- <button id="myButton" class="btn btn-block btn-outline-primary rounded-pill" style="display: none;">Mostrar QR</button> -->
                  ...
                  <table class="table table-striped">
                    ...
                    <thead>
                      ...
                      <tr>
                        ...
                        <th>
                          <div align="Right">
                            <h3><?php echo round($totalMet - $total, 2)  ?></h3>
                          </div>
                        </th>
                ...
                <div class="col-md-6">
                  ...
                  <form action="OD_TotalizarFactura.php" method="POST" name="formularioActualizarcliente" id="totalizarFactura">
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        ...
                        <select name="id_usuario" id="id_usuario_totalizar" class="form-control input-lg select">
                        ...
                        <input type="number" name="montoPagado" placeholder="Monto Pagado" class="form-control input-lg" step="any" value="<?= $pendiente; ?>" readonly> <br>
...
$usuario_id = $_SESSION['ID']; //necesario para funcionar
$TipoDetalle_ModalPresupuestos = "Factura";
...
<script type="text/javascript">
  ...
  */
  ...
  function BorrarDetalleFactura(id) {
    $.ajax({
      type: "POST",
...
<script>
  ...
  document.getElementById('totalizarFactura').addEventListener('submit', function(event) {
    ...
    var tipo = "7"; //1-> Factura General | revisar el campo tipo de soperacioninv
    $.ajax({
      type: "POST",
