        ...
        <div class="col-xs-12 table-responsive">
            <table class="table table-striped" border="1">
                ...
                <tbody>
                    ...
                    $queryListC = mysqli_query($conn3, "SELECT * FROM  cliente  WHERE DATE(Fechar) BETWEEN CAST('$desde' AS DATE) AND CAST('$hasta' AS DATE) $andtipo GROUP by cliente_id");
...
$queryList = mysqli_query($conn3, "SELECT genero, COUNT(*) AS total FROM cliente WHERE DATE(Fechar) BETWEEN CAST('$desde' AS DATE) AND CAST('$hasta' AS DATE) $andtipo GROUP BY genero");
// $queryList1 = mysqli_query($conn3, "SELECT genero, COUNT(*) AS total FROM cliente WHERE DATE(fechar) BETWEEN CAST('$desde' AS DATE) AND CAST('$hasta' AS DATE) GROUP BY genero");
