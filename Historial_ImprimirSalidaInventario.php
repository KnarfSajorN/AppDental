  ...
  <div class="wrapper">
    ...
    <section class="invoice">
      ...
      <div class="row invoice-info">
        ...
        <!-- /.col -->
        <div class="col-sm-6 invoice-col">
          <b>Salida # 0000<?php echo $idinvheader ?></b><br>
            ...
            <tbody>
              ...
              while ($fila = mysqli_fetch_array($resultado)) {
                ...
                echo '     <tr>
                  ...
                  <td width="10%"><div align="Right">' . $costo . '' . $moneda . '</div></td>
                  <td width="15%"><div align="Right">' . $costo_total . '' . $moneda . '</div></td>
        ...
        <div class="col-xs-6">
          ...
          <div class="table-responsive">
            <table class="table">
              <tr>
                <th>Total Costo:</th>
                <td><?php echo $totalCosto . '' . $moneda ?></td>
              </tr>
            </table>
          </div>
        </div>
