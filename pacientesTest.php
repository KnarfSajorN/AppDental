      ...
      ?>
          ...
          <div class="box">
            ...
            <div class="box-body table-responsive">
              <table id="Tabla_Rapida_AJAX" class="table table-bordered table-striped table-responsive">
                <thead>
                <tr>
                  <th>Nombre</th>
                  <th>Cedula</th>
...
columnastablas=[
                ...
                { "data": function ( row, type, set ) {
                        botones="";
                        botones+="<a href='testCoronavirus.php?clienteId="+row.cliente_id+"' title='Agregar Test Corona Virus'><i class='fas fa-file-medical'></i> </a>";
                        botones+="<a href='consultaCliente_test.php?clienteId="+row.cliente_id+"' title='Ver historial Test'><i class='fas fa-book-medical'></i> </a>";
