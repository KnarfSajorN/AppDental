    ...
    <section class="content">
      <div class="row">
        ...
        <div class="form-row">
          ...
          <br>
      		 <form action="guardarHistoriaClinica4.php" method="POST" name="formularioActualizarcliente">
            <input type="hidden" id="clienteId" name="usuario_id" value="<?php echo $usuario_id;?>" >
                ...
                <div class="form-group col-md-12">
      		      <input type="text" class="form-control" id="motivoConsulta" name="Descripcion" placeholder="Descripcion" >
      		    </div>
              
               
              <div class="form-group col-md-12">
      		      <input type="text" class="form-control" id="motivoConsulta" name="motivoConsulta" placeholder="Motivo Consulta" >
      		    </div>
              
              <div class="form-group col-md-12">
      		      <input type="text" class="form-control" id="antecedentesPesonales" name="antecedentesPesonales" placeholder="Antecedentes Personales" >
      		    </div>
              <div class="form-group col-md-12">
      		      <input type="text" class="form-control" id="antecedentesFamililares" name="antecedentesFamililares" placeholder="Antecedentes Familiares" >
      		    </div>
               <div class="form-group col-md-6">
      		      <input type="text" class="form-control" id="motivoConsulta" name="acompananteFamiliar" placeholder="Acompanante Familiar" >
      		    </div>
              
              <div class="form-group col-md-6">
      		      <input type="text" class="form-control" id="antecedentes" name="telefono_acompanante" placeholder="Telefono Acompanante" >
      		    </div>
...
<textarea  class="form-control" id="corneaD" name="biomicroscopia" rows="4">
1.
2.
3.
</textarea>
              <label><strong>   impresion Diagnostica  </strong></label>
              
<textarea  class="form-control" id="impresionDiagnostica" name=" impresionDiagnostica" rows="4">
1.
2.
3.
</textarea>
              <label><strong> plan De Manejo  </strong></label>
              
<textarea  class="form-control" id="planDeManejo" name="planDeManejo" rows="4">
1.
2.
3.
</textarea>
