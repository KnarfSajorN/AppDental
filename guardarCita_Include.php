...
Atte. *ALTE Dentalsoft* Teléfono ' . $telefonoF . ' Correo ' . $emailF . '';
  ...
  $mensaje2 = ' *' . funcionMaster($doctor, 'ID', 'NOMBRE_USUARIO', 'usuarios') . '* la cita Ha sido agendada con la paciente *' . $nombre . '*,  *' . $fecha . '* a las *' . $Hora . '* en *' . $sucursal . '*. Motivo: *' . $MotivoConsulta_Texto . '* Atte ALTE Dentalsoft';
...
Atte. *' . $nombreF . '* Teléfono ' . $telefonoF . ' Correo ' . $emailF . '';
  ...
  $mensaje2 = '*' . $doctor . '*  se ha agendado  una cita con la paciente *' . $nombre . '*,  *' . $fecha . '* a las *' . $Hora . '* en *' . $sucursal . '*. Motivo: *' . $MotivoConsulta_Texto . '* Atte ALTE Dentalsoft';
...
$mensaje .=  "<h1 align='center'>Motivo consulta: $MotivoConsulta_Texto </h1>";

$mensaje .=  "<h1 align='center'>Su consulta es con $nombreD</h1>";

$mensaje .=  "<h1 align='center'>En $sucursal</h1>";
...
//   $mensaje .=  "              <img src='https://medicalsoftplus.com/baseDev/logos/{$LogoF}' alt='Logo' style='width: auto; max-height: 100px; display:block;'>";
//   $mensaje .=  "          </td>";
//   $mensaje .=  "      </tr>";
//   $mensaje .=  "      <tr style='background-color: #00A74B;'>";
//   $mensaje .=  "          <td style='width: 5%;padding:20px 0;text-align:center;' align='center'>";
//   $mensaje .=  "              <img src='https://medicalsoftplus.com/baseDev/webPro/assets/img/agenda.png' align='center' alt='Logo' style='width: auto; max-height: 50px; display:block; margin: auto;'>";
//   $mensaje .=  "          </td>";
