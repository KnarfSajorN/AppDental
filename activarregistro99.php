...
<?php if ($country <> 'CO'): ?>
 ...
 <h1>  <img src="https://www.outletbebe.es/media/catalog/product/cache/1/image/350x350/9df78eab33525d08d6e5fb8d27136e95/r/e/regalo.jpg" height="5%" width="8%"> Licencia 1 año  <img src="https://www.outletbebe.es/media/catalog/product/cache/1/image/350x350/9df78eab33525d08d6e5fb8d27136e95/r/e/regalo.jpg" height="5%" width="8%"> </h1> 
...
<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="hosted_button_id" value="ZV7T69GKWUR7G">
...
<h1>  <img src="https://www.outletbebe.es/media/catalog/product/cache/1/image/350x350/9df78eab33525d08d6e5fb8d27136e95/r/e/regalo.jpg" height="5%" width="8%">  Plan Anual    <img src="https://www.outletbebe.es/media/catalog/product/cache/1/image/350x350/9df78eab33525d08d6e5fb8d27136e95/r/e/regalo.jpg" height="5%" width="8%"> </h1>
<h5>1 usuario + 1 auxiliar</h5>
<h3> <strong> $336.600 COP</strong>   </h3>
...
$referencia1 = $ID.';'.$email.';2;'.rand(1,50);
 ...
 <form method="post" id="formulariopayu" action="https://gateway.payulatam.com/ppp-web-gateway/">
  ...
  <input name="description"   type="hidden"  value="Licencia 50% de descuento<?=$referencia1 ?>"  >
  <input name="referenceCode" type="hidden"  value="<?=$referencia1?>" >
  <input name="amount"        type="hidden"  value="336600"   >
  <input name="tax"           type="hidden"  value="0"  >
  <input name="taxReturnBase" type="hidden"  value="0" >
  <input name="currency"      type="hidden"  value="COP" >
  <input name="signature"     type="hidden"  value="<?=md5('Tqo1lFV06vrOrh505Llmn2IMSL~589297~'.$referencia1.'~336600~COP')?>"/>
