          ...
          ?>
            ...
            while ($row_recordset32A = mysqli_fetch_array($queryListA)) {
              ...
              echo '      
                      ...
                      <font color="#04CC05"> <a href="Perfil2.php?usuario_id=' . $id . '"> <i class="fa fa-pencil" title="Editar" name="Virtual"></i>  </a></font> |
                       <font color="#04CC05"> <a href="usuarios?borrar_usuarios=' . $id . '&usuario_id=' . $ID . '"> <i class="fa fa-trash" title="Borrar Usuario" name="Virtual"></i>  </a></font>|
                       <a href="permisosMenuUsuarios.php?idU=' . encrypt($id) . '"><i class="fas fa-pen" title="Editar permisos de Usuarios"></i></a>
                      </td>
                      </tr>';
            }
            ?>
