...
<div class="content-wrapper p-3">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active"> Registrar Inyección a <?php echo $Nombre; ?> </li>
    </ol>
  </section>

  <br>
  <section class="content">
  <h4 class="Titulo_Pagina">Registrar Inyección a <?php echo $Nombre; ?> </h4>
      ...
      <div class="card-body">
        ...
        <div class="content">
          <div class="">
            ...
            <form class="row" action="GuardarAplicarInyeccion.php" method="POST" name="formularioGuardarVacuna" enctype="multipart/form-data">
              ...
              <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control input-lg" name="doctor"  id="doctor" placeholder="Nombre Doctor" value="<?=$_SESSION['NOMBRE_USUARIO'];?>">
             ...
             <!-- <textarea  id="doctor" name="doctor"  class="textarea" placeholder="Nombre Doctor" style="width: 100%;" ></textarea> -->
              ...
              <div class="form-group col-md-6">
                <div align="left"> Persona que lo Administra </div>
                     ...
                     <input type="text" class="form-control input-lg" name="persona_administra"  id="persona_administra" placeholder="Nombre Persona" value="<?=$_SESSION['NOMBRE_USUARIO'];?>">
<!--
    ...
    <div class="box row">
      <br>
      <div class="form-group col-md-12">
        <center><a href="ImprimirInyeccion?cI=<?= encrypt($idcliente) ?>" class="btn btn-outline-info rounded-pill btn-block btn-sm">Imprimir Esquema de Inyecciones</a></center>
      ...
      <div class="form-group col-md-6">
        ...
        <center><a href="HistorialInyeccion?cI=<?= encrypt($idcliente) ?>" class="btn btn-outline-info rounded-pill btn-block btn-sm"><i class="fa fa-print"></i> Imprimir Historial de Inyecciones</a></center>
      </div>


      <div class="form-group col-md-6">
        <center><a href="enviarHistorialInyeccion?iC=<?= encrypt($idcliente) ?>" class="btn btn-outline-info rounded-pill btn-block btn-sm"><i class="fa fa-paper-plane"></i> Enviar Historial (Correo / WhatsApp) </a></center>
            ...
            while ($Lista = mysqli_fetch_array($queryList)) {
              ...
              while ($Lista1 = mysqli_fetch_array($queryList1)) {
                ...
                echo '<tr><td>' . $Nombre_Vacuna . ' </td>
                        ...
                        <a href="certificadoInyeccion?iD=' . encrypt($Lista1['id_vacunacion']) . '" title="Certificado Inyeccion"><i class="fa fa-file-text-o"></i> </a>  |
                        <a href="enviarcertificadoInyeccion.php?iD=' . encrypt($Lista1['id_vacunacion']) . '&iC=' . encrypt($idcliente) . '" title="Enviar Certificado"><i class="fa fa-paper-plane"></i> </a>  |';
                if ($_SESSION['TIPO'] == '99') {

                  echo '
                        <a title="Eliminar Inyeccion"><i class="fa fa-trash-o" onclick="confirmation(' . $Lista1['id_vacunacion'] . ')"></i> </a> ';
                }
...
<script type="text/javascript">
  function confirmation(valor) {
    if (confirm("Seguro desea eliminar el este registro?")) {
      return window.location = "EliminarInyeccionesClientes.php?idV=<?=salt()?>" + btoa(valor);
    } else {
      return false;
    }
  }
