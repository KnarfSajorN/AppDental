...
if ($parteAplicadaDetalleq =='') {$parteAplicadaDetalleq= 0;}
...
if ($parteAplicadaDetalle[0] == '') {
    $parteAplicadaDetalle[0] = '0';
}
if ($parteAplicadaDetalle[1] == '') {
    $parteAplicadaDetalle[1] = '0';
}
if ($parteAplicadaDetalle[2] == '') {
    $parteAplicadaDetalle[2] = '0';
}
if ($parteAplicadaDetalle[3] == '') {
    $parteAplicadaDetalle[3] = '0';
}
if ($parteAplicadaDetalle[4] == '') {
    $parteAplicadaDetalle[4] = '0';
}
if ($parteAplicadaDetalle[5] == '') {
    $parteAplicadaDetalle[5] = '0';
}
...
//echo "UPDATE odontogramaMasterHistoria SET $idPzaQuery = '$parteAplicada' WHERE idCliente = $idCliente";

$fecha = date("Y-m-d");
$hora = date("h:i:s");


mysqli_query($conn3, "INSERT INTO odontogramaMasterDetalle (fecha, hora, idUsuario, idCliente, idPza, detalle, tratamiento, parte, parteAplicadaDetalle) VALUES ('$fecha', '$hora', '1', '$idCliente', '$parteDetalleog', '$detalleOdontograma', '$servicioAplicado', '$parteAplicada', '$parteAplicadaDetalleq');");



echo '<font color ="green" size = "3"><strong>NUEVO detalle Grabado</strong>: ' . $detalleOdontograma . ' ' . $parteAplicada . '</font><br>';
