            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  echo '<a href="historiaClinica_TrabajoSocial.php?clienteId='.$fila[0].'" title="Agregar Consulta"><i class="fa fa-heartbeat"></i> </a>|';
 
                  echo '<a href="consultaCliente_TrabajoSocial.php?clienteId='.$fila[0].'" title="Ver Historia"><i class="fa fa-search"></i> </a> |';
