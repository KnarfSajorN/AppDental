...
<footer class="main-footer">
    <strong>Copyright &copy; 2018-<?= date('Y') ?> <?php echo $_SERVER["HTTP_HOST"] ?> <?php echo $sistema ?>.</strong> Todos los derechos reservados. <strong>Diseñado por <a target="_blank" href="https://sevenglobalcompany.com/">Seven Global Company</a> </strong><BR>
    <strong>Soporte vía chat, horario de atención Lunes a Viernes de 8 AM a 6 PM y Sábados de 8 AM a 4 PM.</strong>
...
<script type="text/javascript">window.$crisp=[];window.CRISP_WEBSITE_ID="1da0a57b-6157-40b5-bc5e-ea2746b4489b";(function(){d=document;s=d.createElement("script");s.src="https://client.crisp.chat/l.js";s.async=1;d.getElementsByTagName("head")[0].appendChild(s);})();</script>
...
<aside class="control-sidebar control-sidebar-dark">
    ...
    <form id="personalizarForm">
        <div class="form-group p-4">
            ...
            <select name="datos[tema]" class="custom-select mb-3" id="temaNav" onchange="visualizarTema(this.value);">
                <option value="primary" class="bg-primary">Medical</option>
                <option value="secondary" class="bg-secondary">Gris</option>
                <option value="info" class="bg-info">Manzana</option>
                <option value="success" class="bg-success">Hoja</option>
                <option value="danger" class="bg-danger">Rojo</option>
                <option value="indigo" class="bg-indigo">Indigo</option>
                <option value="purple" class="bg-purple">Purpura</option>
                <option value="pink" class="bg-pink">Rosa</option>
                <option value="lightblue" class="bg-lightblue">Azul claro</option>
                <option value="teal" class="bg-teal">Verde azulado</option>
                <option value="cyan" class="bg-cyan">Cian</option>
                <!-- <option value="gray" class="bg-gray">Gris</option> -->
                <option value="light" class="bg-light">Luz</option>
                <option value="warning" class="bg-warning">Amarillo</option>
                <option value="white" class="bg-white">Blanco</option>
                <option value="orange" class="bg-orange">Naranja</option>
            </select>            
            <br>
            <button type="submit" class="btn btn-primary btn-block btn-sm" onclick="$('#personalizarForm').automaticForm({
                type: 2,
            ...
            <br>
            <small>el tema se vera reflejado en la proxima sesión del usuario</small>
        </div>
    </form>
    <script>
...
$Campo_Javascript_Historia_Audiologia=false;
