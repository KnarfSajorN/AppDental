...
<body>
 ...
 <table align="center"><tr><td><h3><b>  REPORTE DE VIDEO CONSULTAS</b></h3> </td></tr>
...
if ($doctor<>'') 
{
                 $queryList=mysqli_query($conn3,"SELECT * FROM  citas  where  tipo = 1 and doctor = $doctor AND fecha BETWEEN '$desde1' and '$hasta1'   order by fecha asc  "); 


//echo "SELECT * FROM  citas  where  tipo = 1 and doctor = $doctor AND fecha BETWEEN '$desde1' and '$hasta1'   order by fecha asc  ";
...
$queryList=mysqli_query($conn3,"SELECT * FROM  citas  where  tipo = 1  AND fecha BETWEEN '$desde' and '$hasta'   order by fecha asc  "); 

//echo "SELECT * FROM  citas  where  tipo = 1  AND fecha BETWEEN '$desde' and '$hasta'   order by fecha asc  ";
}
                ...
                <tr>
                    ...
                    <th class="text-center">Fecha-Hora</th>
                    <th class="text-center">Pciente</th>
