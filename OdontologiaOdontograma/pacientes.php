...
<script>
    ...
    },
    {
        "data": function (row, type, set) {
            botones = "";
            botones += "<a href='OBO_Historia?cI=<?= salt() ?>" + btoa(row.cliente_id) + "' title='Nueva historia'><i class='fas fa-file-medical'></i> </a>";
            botones += "<a href='OBO_VerPaciente?cI=<?= salt() ?>" + btoa(row.cliente_id) + "' title='Ver historial'><i class='fas fa-book-medical'></i> </a>";
