        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <!-- <form action="#" method="POST" name="formularioEnvioExamen"
                    onsubmit="event.preventDefault();GuardarPieza();"> -->
                    <div class="row">
                        ...
                        <input type="hidden" id="cie_10" value="0">
                        ...
                        <button type="button" onclick="GuardarPieza()" class="btn btn-primary" style="width:50%;float: right;"
...
<script>
    ...
    function CargarImagenPieza(elemento) {
        ...
        $.ajax({
            ...
            success: function(response) {
                console.log("Response => CargarImagenPieza" , response);
    ...
    function CargarImagenDiente(elemento) {
        ...
        $.ajax({
            ...
            success: function(response) {
                console.log("CargarImagenDiente => " , response);
    ...
    function ModalSwalEdicion(response, lugar) {
        ...
        Swal.fire({
            ...
            html: '<label for="estado_edicion">Motivo Consulta:</label><br>' +
                ...
                //'</select>' +
                //'<br><br>' +
                '<label for="CIE10_edicion">CIE11</label><br>' +
