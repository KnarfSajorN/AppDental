...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li><a href="#">Cliente Facturacion Entidad</a></li>
        </ol>
    </section>
    <!-- Main content -->
    <section class="content">
        <div class="">
            <div class="col-xs-12">
                <h4 class="Titulo_Pagina">Cliente Facturacion Entidad</h4>
  ...
  columnastablas = [{
    ...
    },
    {
      "data": function(row, type, set) {
        botones = "";
        botones += "<a class='btn btn-block btn-outline-info btn-lg rounded-pill shadow' href='EN_FacturacionCliente?clienteId=" + row.cliente_id + "' title='Registrar Factura'><i class='fa-solid fa-file-invoice'> </i> Registrar Factura </a>";
        return botones;
      }
    }
  ];
