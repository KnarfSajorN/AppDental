       ...
       <div class="row">
         ...
         <!-- this row will not appear when printing -->
          <div class="no-print" style="width:100%">
            <div class="col-md-12">
              <a href="imprimirPresupuesto.php?idOperacion=<?php echo $idOperacion ?>" target="_blank" class="btn btn-block btn-outline-info rounded-pill shadow m-1" style="width:100%"><i class="fa fa-print"></i> Imprimir</a>
