        ...
        <div class="row">
            <div class="col-md-3">
                    ...
                    <div class="box box-body">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <select id="clienteId" name="clienteId" class="form-control select2" style="width: 100%;" onChange="verificarCliente();" required>
                                ...
                                <?php
                                $queryList = mysqli_query($conn3, "SELECT * FROM  cliente where usuario_id = '{$_SESSION['ID']}'");
                ...
                <div style="background: #ffffff;border-top: 3px solid #d2d6de;margin-bottom: 20px;width: 100%;box-shadow: 0 1px 1px rgba(0,0,0,0.1);margin-top: -25px;padding: 10px;">
                    <a class="btn btn-block btn-outline-info btn-lg rounded-pill shadow" href="controlCitas" target="_blank">
...
<!--<div class="modal" id="exampleModal" role="dialog" aria-labelledby="exampleModal" aria-hidden="true">-->
...
$queryList = mysqli_query($conn3, "SELECT ID,NOMBRE_USUARIO FROM  usuarios WHERE ACTIVO=1 and id = '{$_SESSION['ID']}'");
$nrowl = mysqli_num_rows($queryList);
            ...
            events: [
                ...
                while ($RowCitas = mysqli_fetch_array($queryList)) {
                    ...
                    foreach ($botonesPresencial as $key => $value) {
                        $btnGroup .= "<button type='button' class='btn " . ($key == $estadoPresencia ? "btn btn-block btn-outline-info btn-lg rounded-pill shadow" : 'btn-default') . "' onclick='presenciaDinamico({$idCitas}, {$key})' title='{$value}'> {$value} </button>";
                    }
            ...
            <div class="modal-content">
                ...
                <form action="Cambiar_Medico.php" method="POST">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-block btn-outline-info btn-lg rounded-pill shadow" data-dismiss="modal">Close</button>
                        <button class="btn btn-block btn-outline-info btn-lg rounded-pill shadow" type="submit" name="submit" value="Submit">Aceptar</button>
                    </div>
                </form>
            </div>
