...
<script>
    ...
    function enviarReceta() {
        ...
        if (receta_id === "") {
            ...
            // Codificando los valores antes de agregarlos a la URL
            let receta_id_encoded = btoa(receta_id);
            let cliente_id_encoded = btoa(cliente_id);
            let usuario_id_encoded = btoa(usuario_id);

            // Redirigiendo con los parámetros codificados
            window.location.href = 'RecetaEnviar.php?receta_id=' + receta_id_encoded +
                '&cliente_id=' + cliente_id_encoded +
                '&usuario_id=' + usuario_id_encoded;
