...
<?php
 ...
 <div class="card-body">
  ...
  <a class="btn btn-primary" href="Documentos.php?clienteId=<?php echo $clienteId;?>" role="button"> <i class="fa fa-heartbeat"></i>  Nueva consulta </a>
...
<br>
          ...
          <hr align="center" size="10" width="100%" color="#000000">
           ...
           CERTIFICADOS
                  ...
                  $queryList=mysqli_query($conn3,"SELECT * FROM  historiaDocumento where cliente_id = $clienteId order by ID DESC");
...

                  {
                      ...
                      $documento           = $row_recordset32['documento'];      
                      ...
                      {
                        $Firmo = '<font color="red"> No Firmado </font>'; 
                      }
                  ...
                  <div class="box-header with-border">
                    <h4 class="box-title">
                      <a data-toggle="collapse" data-parent="#accordion" href="#<?php echo $ID?>">
                        Fecha <?php echo $Fecha .'-'.$Hora?> <a href="imprimirDocumento.php?historiaClinica1=<?php echo $ID?>" title="Imprimir Consulta" target="_blank"><i class="fa fa-print"></i> </a>
                      </a>
                    </h4>
                  </div>
               ...
               <div align="right" >
                Fecha <?php echo $Fecha .'-'.$Hora.' - '.$Firmo?>
               </div>
               <div align="left">
               <?php
               echo $consentimiento;
...
echo '<br>';               
               ...
               ?>
                ...
                {
                $Firmo = '<font color="red"> Documento No Firmado </font>'; 
                }
