...
$mensajeW = 'Sr(a) *'.$nombre_cliente.'* Se le ha generado una Orden de Examenes motivo de la consulta con el Dr. '.$Nombre.'; para ver Orden de Examenes ingresar por el siguiente link:  '.$Base.'/verOrdendeExamenes/'.$historiaClinica1.' ';
...
$para ="$email";
                ...
                // título
                $titulo = 'Orden de Examenes resultado de consulta con el Dr. '.$Nombre.'';

                // mensaje
                $mensaje = '
                <html>
                <head>
                  <title>Orden de Examenes de consulta la Empresa'.$nombreF.'</title>
                    <body> 
                    
                               Hola buen dia señor(a) '.$nombre_cliente.', Enviamos link para ver Orden de Examenes. :<br><br>

                
             <div>  Link para ver Orden de Examenes: '.$Base.'/verOrdendeExamenes/'.$historiaClinica1.'
                ...
                $cabeceras .= 'From:  Orden de Examenes Medica <noreply@medicalsoftplus.com>' . "\r\n";
