...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="box">
            <div class="col-md-12">
                <h4 class="Titulo_Pagina">Pacientes Epicris</h4>
...
columnastablas = [{
    ...
    },
    {
        "data": function(row, type, set) {
            botones = "";
            botones += "<a href='epicrisis.php?cI=<?= salt() ?>" + btoa(row.cliente_id) +
                "' title='Agregar Historia'><i class='fas fa-file-medical'></i> </a>";
            // botones += "<a href='epicrisis.php?cI=" + (row.cliente_id) +
            //     "' title='Agregar Historia Epic Crisis'><i class='fas fa-file-medical'></i> </a>";
            botones += "<a href='EC_consulta.php?cI=" + (row.cliente_id) +
