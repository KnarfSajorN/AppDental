...
if (isset($_POST['Guardar_Informacion_Pagina'])) {
    ...
    $queryList = mysqli_query($conn3, "INSERT INTO {$Nombre_Tabla} (usuario_id, ID_principal, {$Campos}) VALUES ('$usuario_id', '{$ID_principal}' ,{$Valores});");
...
$queryConfig = mysqli_query($conn3, "SELECT * FROM config WHERE ID_USUARIO = '$usuario_id'");
$queryConfig = mysqli_fetch_assoc($queryConfig);
$nombreF = $queryConfig['nombreF'];
$direccionF = $queryConfig['direccionF'];
$telefonoF = $queryConfig['telefonoF'];
    ...
    $NOMBRE_DOC = funcionMaster($usuario_id, 'ID', 'NOMBRE_USUARIO', 'usuarios');


$mensaje = 'Sr(a) *' . $nombre_cliente . '* usted a quedado registrado como paciente del Dr(a) *' . $NOMBRE_DOC . '*.

 🏥'.$nombreF.' 
 📍Direccion: *' . $direccionF . '
 📞Contactanos al ' . $telefonoF .'
...
if (isset($_POST['Actualizar_Informacion_Pagina'])) {
    ...
    $convenio_id_viejo = funcionMaster($_POST['arreglo_id'], 'cliente_id', 'convenio_id', 'cliente');
    ...
    //     $sucursal = "0";
    // }
    $sucursal = isset($_POST['Arreglo']['sucursal']) ? $_POST['Arreglo']['sucursal'] : "0";
    $usuario_id = $_POST['usuario_id'];
    $ID_principal = $_POST['ID_principal'];
    $queryList = mysqli_query($conn3, "UPDATE {$Nombre_Tabla} SET {$Campos}, usuario_id='$usuario_id', ID_principal='{$ID_principal}',sucursal='$sucursal' WHERE cliente_id = '{$arreglo_id}' limit 1;");
    ...
    $convenio_id = $_POST['Arreglo']['convenio_id'];
    if ($convenio_id_viejo != $convenio_id) {
        mysqli_query($conn3, "UPDATE  sDetalleOperPendites SET estado=0 where estado = 1  and  id_cliente = $arreglo_id AND tipo=9");
        //evitar que al cambiar de convenio sigan los mismo detallees
    }
    ////////////////////////////////////////////////////////////////CARGAR IMAGEN////////////////////////////////////////////////////////////////
...
if (isset($_GET['clienteId']) || isset($_GET['cI'])) {
    ...
    <script>
        window.onload = function () {
            ...
            if (Arreglo['entidad_id'] != "") {
                //console.log('321321');
                Convenio(Arreglo['entidad_id'], Arreglo['convenio_id']);
...
<div class="content-wrapper p-3" style="background: white !important;">
    ...
    <section class="content">
        <div class="">
            <div class="content">
                <h4 class="Titulo_Pagina"> <a href='<?php echo "{$Base}Pacientes.php"; ?>'> <i
                    ...
                    <div class="box-body">
                        <form action='<?php echo htmlentities($_SERVER["PHP_SELF"]); ?>' method="POST"
                            ...
                            <div class="input col-md-6 webflow-style-input">
                                <select class="input__field" name="Arreglo[tipo_cliente]" id="tipo_cliente"
                            ...
                            <div class="input col-md-6 webflow-style-input">
                                <input type="text" class="input__field" name="Arreglo[CODI_CLIENTE]" id="CODI_CLIENTE"
                            ...
                            <div class="input col-md-6 webflow-style-input">
                                <input type="date" class="input__field" name="Arreglo[expedicionDocumento]"
                                    id="expedicionDocumento">
                                <span class="input__label"><label for="expedicionDocumento">Fecha de
                                        Expedicion</label></span>
                            </div>

                            <div class="input col-md-12 webflow-style-input" id="Cedula_Div"
                                style="text-align-last: center;">

                            </div>

                            <div class="input col-md-6 webflow-style-input">
                                <input type="date" class="input__field" name="Arreglo[fechaNacimiento]"
                                    id="fechaNacimiento" required onchange="CalcularEdad(this.value)">
                                <span class="input__label"><label for="fechaNacimiento">Fecha de
                                        Nacimiento</label></span>
                            </div>
                            ...
                            <div class="input col-md-6 webflow-style-input">
                                <input type="text" class="input__field" name="Arreglo[primer_apellido]"
                                    id="primer_apellido" placeholder=" " maxlength="120"
                                    oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                    required>
                                <span class="input__label"><label for="primer_apellido">Primer Apellido</label></span>
                            </div>
                            <div class="input col-md-6 webflow-style-input">
                                <input type="text" class="input__field" name="Arreglo[segundo_apellido]"
                                    id="segundo_apellido" placeholder=" " maxlength="120"
                                    oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                                <span class="input__label"><label for="segundo_apellido">Segundo Apellido</label></span>
                            </div>

                            <div class="input col-md-6 webflow-style-input">
                                <input type="text" class="input__field" name="Arreglo[primer_nombre]" id="primer_nombre"
                            ...
                            <div class="input col-md-6 webflow-style-input">
                                <input type="text" class="input__field" name="Arreglo[segundo_nombre]"
                                    id="segundo_nombre" placeholder=" " maxlength="120"
                                    oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                            ...
                            <div class="input col-md-6 webflow-style-input" id="pais_div">
                                <select class="input__field select2" name="Arreglo[codigo_pais]" id="PaisResidencia"
                                    onchange="paises(this.value,'','');" required>
                                ...
                                <span class="input__label_select2"><label for="PaisResidencia">País de
                                        Residencia</label></span>
                            </div>

                            <div class="input col-md-6 webflow-style-input" id="ciudad_div">
                                <select class="input__field select2" name="Arreglo[codigo_ciudad]" id="CiudadResidencia"
                                    required>
                                    <option value="" selected> Seleccione </option>

                                </select>
                                <span class="input__label_select2"><label for="CiudadResidencia">Ciudad
                                        Residencia</label></span>
                            </div>
                            ...
                            <div class="input col-md-6 webflow-style-input">
                                <input type="text" class="input__field" name="Arreglo[nacionalidad]" id="Nacionalidad"
                                    placeholder=" " maxlength="120"
                                    oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                            ...
                            <div class="input col-md-6 webflow-style-input">
                                <input type="text" class="input__field" name="Arreglo[direccion_cliente]"
                                    id="direccion_cliente" placeholder=" " maxlength="120"
                                    oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                                <span class="input__label"><label for="direccion_cliente">Dirección</label></span>
                            </div>

                            <div class="input col-md-6 webflow-style-input">
                                <input type="email" class="input__field" name="Arreglo[correo_cliente]"
                                    id="correo_cliente" placeholder="" maxlength="100"
                                    oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                            ...
                            <div class="input col-md-6 webflow-style-input">
                                <select class="input__field select2" name="Arreglo[genero]" id="genero" required
                                    onchange="VisualizarGenero(this.value)">
                                    <option value="" selected> Seleccione </option>
                            ...
                            <div id="Div_PreguntasFemenino" class="row" style="display:none;width:100%">
                                ...
                                <div class="input col-md-6 webflow-style-input">
                                    <input type="date" class="input__field" name="Arreglo[Fecha_Ultimo_Parto]"
                                        id="FechaUltimoParto">
                                    <span class="input__label"><label for="FechaUltimoParto">Fecha de ultimo
                                            parto</label></span>
                                </div>

                                <div class="input col-md-6 webflow-style-input">
                                    <input type="date" class="input__field" name="Arreglo[Fecha_Ultima_Mestruacion]"
                                        id="FechaUltimaMestruacion">
                                    <span class="input__label"><label for="FechaUltimaMestruacion">Fecha de ultima
                                            menstruación</label></span>
                                </div>

                                <div class="input col-md-12 webflow-style-input">
                                    <input type="number" class="input__field" name="Arreglo[Numero_Embarazos]"
                                        id="NumeroEmbarazos">
                                    <span class="input__label"><label for="NumeroEmbarazos">Numero de
                                            Embarazos</label></span>
                                </div>
                            </div>
                            ...
                            <div class="input col-md-6 webflow-style-input">
                                <select class="input__field select2" name="Arreglo[nivel_educacion]"
                                    id="NivelEducacion">
                                    <option value="" selected> Seleccione </option>
                                    <option value="Preescolar"> Preescolar </option>
                                    <option value="Basica Primaria"> Básica Primaria </option>
                                    <option value="Basica Secundaria"> Básica Secundaria </option>
                                    <option value="Basica Secundaria (Bachillerato Basico)"> Básica Secundaria
                                        (Bachillerato Básico) </option>
                                    <option value="Media Academica o Clasica (Bachillerato Basico)"> Media Académica o
                                        Clásica (Bachillerato Basico) </option>
                                    <option value="Media Tecnica (Bachillerato Tecnico)"> Media Técnica (Bachillerato
                                        Técnico) </option>
                                ...
                                <span class="input__label_select2"><label for="NivelEducacion">Nivel de
                                        Educación</label></span>
                            </div>

                            <div class="input col-md-6 webflow-style-input">
                                <input type="text" class="input__field" name="Arreglo[ocupacion]" id="Ocupacion"
                                    placeholder=" " maxlength="120"
                                    oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                            ...
                            <div class="input col-md-6 webflow-style-input">
                                <input type="text" class="input__field" name="Arreglo[telefono_cliente]"
                                    id="TelefonoCliente" placeholder=" " maxlength="120"
                                    oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                            ...
                            <div class="input col-md-3 webflow-style-input">
                                <select class="input__field select2" name="Arreglo[indicativo]" id="indicativo" required
                                    onchange="placeholderPais(this.value)">
                                    <option
                                        value="<?= (empty($configData['Indicativo']) ? '57' : $configData['Indicativo']) ?>"
                                        selected>
                                        <?= (empty($configData['Indicativo']) ? '57' : $configData['Indicativo']) ?> -
                                        <?= (empty($configData['Indicativo']) ? 'Colombia' : funcionMaster($configData['Indicativo'], 'numero', 'nombre', 'indicativos')) ?>
                                    </option>
                                    <?php
                                    //where / value del option (si se quiere mas de un valor separarlo por ,) / texto del option (si se quiere mas de un valor separarlo por ,)/ tabla
                            ...
                            <div class="input col-md-3 webflow-style-input">
                                <input type="number" class="input__field" name="Arreglo[whatsapp]" id="whatsapp"
                                    placeholder="300..." maxlength="30"
                                    oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                            ...
                            <script>
                                function placeholderPais(pais) {
                                    const telefonosAmerica = ['555-1234', '555-5678', '55-1234-5678', '9 1234-5678',
                                        '15 1234-5678', '9 1234-5678', '321 1234567', '9 1234-5678', '987 123 456',
                                        '99 123 456', '412-1234567'
                                    ];
                                    //   estadosUnidos: ,
                                    //   canada: ,
                                    //   mexico: ,
                            ...
                            <div class="input col-md-6 webflow-style-input">
                                <input type="text" class="input__field" name="Arreglo[celular_cliente]"
                                    id="celular_cliente" placeholder=" " maxlength="120"
                                    oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                            ...
                            <div class="col-md-6" style="text-align: -webkit-center;">
                                <label style="padding-bottom: 10px;margin-bottom: 0px;">
                                    <input type="checkbox" class="option-input checkbox" name="Arreglo[habeasdata]"
                                        value="Si" checked /> Autoriza recibir notificaciones vía WhatsApp (Habeas Data)
                                </label>
                            </div>
                            ...
                            <div class="input col-md-6 webflow-style-input">
                                ...
                                <span class="input__label_select2"><label for="Sindrome_Down">¿El paciente presenta
                                        síntomas de síndrome de down?</label></span>
                            </div>

                            <!-- ============== APLICA CUANDO ES CLIENTE/EMPRESA - CONVENIOS  ============== -->
                            <!--<div class="input col-md-6 webflow-style-input">

                                <select id="empleador" name="Arreglo[empleador]" class="input__field select2">
                                    <option value="" selected="selected">Seleccione Empresa ...</option>
                                    <?php
                                    $queryList = mysqli_query($conn3, "SELECT * FROM v_clienteE where activa =1 ");
                                ...
                                <span class="input__label_select2"><label for="empleador">Empresa</label></span>
                            </div>
 ...
 <div class="input col-md-6 webflow-style-input">
                                ...
                                <select id="empresa" name="Arreglo[empresa]" class="input__field select2">
                                    <option value="" selected="selected">Seleccione Empresa...</option>
                                    <?php
                                ...
                                <span class="input__label_select2"><label for="empresa">Empresa en Misión </label></span>
                            </div>-->
                            ...
                            <div class="input col-md-6 webflow-style-input">
                                <select class="input__field select2" name="Arreglo[tipoUsuario]" id="TipoAfiliado">
                                    ...
                                    <option value="Desplazado con afiliación al Régimen Contributivo"> Desplazado con
                                        afiliación al Régimen Contributivo </option>
                                    <option value="Desplazado con afiliación al Régimen Subsidiado"> Desplazado con
                                        afiliación al Régimen Subsidiado </option>
                                    <option value="Desplazado no asegurado (Vinculado)"> Desplazado no asegurado
                                        (Vinculado) </option>
                                    <option value="Regímenes de Excepción"> Regímenes de Excepción </option>
                                    <option value="Régimen Especial"> Régimen Especial </option>
                                    <option value="Otro"> Otro </option>
                                </select>
                                <span class="input__label_select2"><label for="TipoAfiliado">Tipo de
                                        Afiliado</label></span>
                            </div>
                            ...
                            <div class="input col-md-6 webflow-style-input">
                                ...
                                <select id="cie" name="Arreglo[entidad_id]" class="input__field select2"
                                    onchange="Convenio(this.value)">
                                    <option value="" selected="selected">Seleccione ...</option>
                                    <?php
                                    $queryList = mysqli_query($conn3, "SELECT * FROM Rips_Entidades where 1=1 and ID_principal='{$_SESSION['ID_principal']}' ");
                                    if ($queryList) {
                                        while ($RowMotorizado = mysqli_fetch_array($queryList)) {
                                            $id = $RowMotorizado['id'];
                                ...
                                <span class="input__label_select2"><label for="cie">Entidad de Salud
                                        [EPS]</label></span>
                            </div>

                            <div class="input col-md-6 webflow-style-input">

                                <select id="convenio" name="Arreglo[convenio_id]" class="form-control select2"
                                    style="width: 100%;">
                                </select>
                            ...
                            <div class="input col-md-6 webflow-style-input">
                                <select class="input__field select2" name="Arreglo[prepagada]" id="prepagada">
                                    ...
                                    <option value="Compañía de seguros de vida Aurora"> Compañía de seguros de vida
                                        Aurora </option>
                            ...
                            <div class="input col-md-6 webflow-style-input">
                                <select class="input__field select2" name="Arreglo[sucursal]" id="sucursal">
                                    <option value=""> Seleccione </option>
                                    <?php
                                    sucursalesSelect($_SESSION['ID_principal']);
                                    ?>
                                </select>
                            ...
                            <div class="input col-md-12 webflow-style-input">
                                <input type="text" class="input__field" name="Arreglo[acompananteFamiliar]"
                                    id="acompananteFamiliar" placeholder=" " maxlength="120"
                                    oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                                <span class="input__label"><label for="acompananteFamiliar">Nombre Acompañante
                                        Familiar</label></span>
                            </div>
                            <div class="input col-md-6 webflow-style-input">
                                <input type="text" class="input__field" name="Arreglo[telefono_acompanante]"
                                    id="telefono_acompanante" placeholder=" " maxlength="120"
                                    oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                                <span class="input__label"><label for="telefono_acompanante">Teléfono Acompañante
                                        Familiar</label></span>
                            </div>
                            ...
                            <div class="input col-md-6 webflow-style-input">
                                ...
                                <select class="input__field select2" name="Arreglo[parentesco_acompanante]"
                                    id="parentesco_acompanante">
                                    <option value="" selected>Seleccione</option>
                                ...
                                <span class="input__label_select2"><label
                                        for="parentesco_acompanante">Parentesco</label></span>
                            </div>
                            ...
                            <div class="input col-md-12 webflow-style-input">
                                <input type="text" class="input__field" name="Arreglo[responsableFamiliar]"
                                    id="responsableFamiliar" placeholder=" " maxlength="120"
                                    oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                                <span class="input__label"><label for="responsableFamiliar">Nombre
                                        Responsable</label></span>
                            </div>
                            <div class="input col-md-6 webflow-style-input">
                                <input type="text" class="input__field" name="Arreglo[telefono_responsable]"
                                    id="telefono_responsable" placeholder=" " maxlength="120"
                                    oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                                <span class="input__label"><label for="telefono_responsable">Teléfono
                                        Responsable</label></span>
                            </div>
                            ...
                            <div class="input col-md-6 webflow-style-input">
                                ...
                                <select class="input__field select2" name="Arreglo[parentesco_responsable]"
                                ...
                                <span class="input__label_select2"><label
                                        for="parentesco_responsable">Parentesco</label></span>
                            </div>
                            ...
                            <div class="col-md-3">
                                <label style="padding-bottom: 10px;margin-bottom: 0px;">
                                    <input type="checkbox" class="option-input checkbox" name="Arreglo[ap1]"
                                        value="1" /> Alergias a los aines
                                </label>
                            </div>

                            <div class="col-md-3">
                                <label style="padding-bottom: 10px;margin-bottom: 0px;">
                                    <input type="checkbox" class="option-input checkbox" name="Arreglo[ap2]"
                                        value="1" /> Asma
                                </label>
                            </div>
                            ...
                            <div class="col-md-3">
                                <label style="padding-bottom: 10px;margin-bottom: 0px;">
                                    <input type="checkbox" class="option-input checkbox" name="Arreglo[ap3]"
                                        value="1" /> HTA
                                </label>
                            </div>
                            ...
                            <div class="col-md-3">
                                <label style="padding-bottom: 10px;margin-bottom: 0px;">
                                    <input type="checkbox" class="option-input checkbox" name="Arreglo[ap4]"
                                        value="1" /> Diabetes
                                </label>
                            </div>
                            ...
                            <div class="col-md-3">
                                <label style="padding-bottom: 10px;margin-bottom: 0px;">
                                    <input type="checkbox" class="option-input checkbox" name="Arreglo[ap5]"
                                        value="1" /> Hipotiroidismo
                                </label>
                            </div>

                            <div class="col-md-3">
                                <label style="padding-bottom: 10px;margin-bottom: 0px;">
                                    <input type="checkbox" class="option-input checkbox" name="Arreglo[ap6]"
                                        value="1" /> Tabaquismo
                                </label>
                            </div>
                            ...
                            <div class="col-md-3">
                                <label style="padding-bottom: 10px;margin-bottom: 0px;">
                                    <input type="checkbox" class="option-input checkbox" name="Arreglo[ap7]"
                                        value="1" /> Licor
                                </label>
                            </div>
                            ...
                            <div class="col-md-3">
                                <label style="padding-bottom: 10px;margin-bottom: 0px;">
                                    <input type="checkbox" class="option-input checkbox" name="Arreglo[ap8]"
                                        value="1" /> Alergias
                                </label>
                            </div>
                            ...
                            <div class="col-md-3">
                                <label style="padding-bottom: 10px;margin-bottom: 0px;">
                                    <input type="checkbox" class="option-input checkbox" name="Arreglo[ap9]"
                                        value="1" /> Cirugías
                                </label>
                            </div>

                            <div class="input col-md-9 webflow-style-input">
                                <textarea class="input__field" name="Arreglo[cirugiasCuales]" id="CualesCirugias"
                                    style="height:120px;" placeholder=" "></textarea>
                                <span class="input__label_select2"><label for="CualesCirugias">Cuales
                                        Cirugías</label></span>
                            </div>
                            ...
                            <div class="input col-md-12 webflow-style-input">
                                <input type="text" class="input__field" name="Arreglo[alergias]" id="alergias"
                                    placeholder=" " maxlength="180"
                                    oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                                <span class="input__label"><label for="alergias">¿Tiene Alergias?
                                        ¿Cuáles?</label></span>
                            </div>

                            <div class="input col-md-12 webflow-style-input">
                                <input type="text" class="input__field" name="Arreglo[tomaMedicamento]"
                                    id="MedicamentosTomados" placeholder=" " maxlength="180"
                                    oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                                <span class="input__label"><label for="MedicamentosTomados">¿Toma
                                        Medicamentos?</label></span>
                            </div>

                            <div class="input col-md-12 webflow-style-input">
                                <textarea class="input__field" name="Arreglo[enfermedadesPequeno]"
                                    id="AntecedentesFamiliares" placeholder=" " style="height:120px;"></textarea>
                                <span class="input__label_select2"><label for="AntecedentesFamiliares">Antecedentes
                                        Familiares</label></span>
                            </div>

                            <div class="input col-md-12 webflow-style-input">
                                <textarea class="input__field" name="Arreglo[nota]" id="nota" placeholder=" "
                                    style="height:120px;"></textarea>
                                <span class="input__label_select2"><label for="nota">Notas Adicionales</label></span>
                            </div>

                            <div class="col-md-12 row" id="modulo_foto"
                                style="border: groove;margin-top: 15px;margin-bottom: 15px;">
                                <input type="hidden" id="foto_mostrada">
                                <div class="form-group col-md-6">
                                    <p id="errorTxt"></p>
                                    <div>
                                        <video id="theVideo" autoplay
                                            style="width: 100%;height: 300px;border-style: ridge;"></video>
                                        <canvas id="theCanvas"
                                            style="width: 100%;height: 300px;border-style: ridge;background-color: antiquewhite;display:none"></canvas>
                                        <input type="hidden" id="foto" name="foto">
                                        <div id="visualizar"
                                            class="border border-compu rounded-lg border-2 justify-center text-center">
                                        </div>
                                    </div>
                                    <div class="botones_camara_pc">
                                        <select name="listaDeDispositivos" id="listaDeDispositivos"
                                            class="form-control input-lg select" onchange="Camara(this.value)">
                                        ...
                                        <button type="button" id="btnCapture"
                                            ...
                                            style="width: 80%;z-index: 2;position: relative;background-color: white">Tomar
                                            Captura <i class="fas fa-angle-down float-right mt-2"></i></button>
                                        <button type="button" id="btnRemove"
                                            class="btn btn-block btn-outline-info btn-lg rounded-pill shadow"
                                            style="float: right;height: 45px;width: 20%;background-color: antiquewhite;border-radius: 0px 5px 5px 0px;border: snow;top: -55px;position: relative;padding-left: 25%;z-index: 1;"><i
                                                class="fa fa-trash" style="left:-42px;position:relative;"></i></button>
                                ...
                                <div class="form-group col-md-6" style="text-align-last: center;">
                                    ...
                                    <label for="file-input" class="text-compu icono">
                                        ...
                                        <p><i class="fas fa-arrow-right"></i><strong> Subir Foto de Perfil </strong><i
                                                class="fas fa-arrow-left"></i></p>
                                    </label>
                                    <input id="file-input" type="file" accept="image/*" capture="camera" name="imagen"
                                        style="display: none;" />
                                </div>
                            </div>
                            ...
                            <?php if ($_GET['clienteId'] <> "" || $_GET['cI'] <> ""): ?>
                                <div class="col-sm-12">
                                    <br>
                                    <input type="hidden" name="arreglo_id" id="cliente_id"
                                        value="<?= ($_GET['cI'] != '' ? decrypt($_GET['cI']) : $_GET['clienteId']) ?>">
                                    <center><button type="submit"
                                            class="btn btn-block btn-outline-info btn-lg rounded-pill shadow"
                                            name="Actualizar_Informacion_Pagina">
                                            <h2> <strong> A c t u a l i z a r <i
                                                        class="fas fa-angle-down float-right mt-2"></i></strong> </h2>
                                        </button></center>
                                </div>
                            <?php else: ?>
                                <div class="col-sm-12">
        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="w-100 text-center justify-center" style="text-align: -webkit-center;">
                    ...
                    <button class="btn btn-block btn-outline-info btn-lg rounded-pill shadow" data-dismiss="modal"
                        type="button">Ok <i class="fas fa-angle-down float-right mt-2"></i></button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    function paises(valor, departamento, ciudad) {
        if (valor == "CO") {
            ...
            select.innerHTML =
                "<select class='input__field select2' name='Arreglo[codigo_departamento]' id='DepartamentoResidencia' onchange='departamento_ciudad(this.value,);' required></select>";
            select.innerHTML +=
                "<span class='input__label_select2'><label for='DepartamentoResidencia'>Departamento de Residencia</label></span>";
    ...
    function Convenio(valor, convenio_id) {
    ...
    function VisualizarGenero(Genero) {
        if (Genero == "F") {
            // No mostrar nuevamente datos ginecoobstetricos
