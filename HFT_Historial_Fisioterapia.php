  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Historial Fisioterapia</a></li>
      </ol>
    </section>
      ...
      <div class="row">
        <div class="card-body">
          ...
          <?php echo datosPacientes($clienteId);?>
            <div align="center">
            <a class="btn btn-outline-info btn-lg rounded-pill shadow m-1" href="HFT_Historia_Fisioterapia?clienteId=<?php echo $clienteId;?>" role="button"> <i class="fa fa-heartbeat"></i>  Nueva Consulta </a>
            ...
            <div class="col-md-12">
                <div class="tab" role="tabpanel">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" ><a href="#Section1" aria-controls="home" role="tab" data-toggle="tab" class="active"> <i class='fas fa-book-medical' style='font-size:26px'> </i> Historias de Fisioterapia</a></li>
                          ...
                          <div class="col-md-12">
                            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                ...
                                <?php 
                                    ...
                                    $queryList=mysqli_query($conn3,"SELECT * FROM  Historia_Clinica_Fisioterapia where cliente_id = $clienteId AND usuario_id = '$usuarioId' order by id DESC ");
                                    ...
                                    $TablaHistoria="Historia_Clinica_Fisioterapia";
                                ?>
                                <div class="panel panel-default" style="background: #f1f1f1;">
                                  <div class="panel-heading" role="tab" id="heading" style="background-color: #bad8e687;">
                                    <h4 class="panel-title">
                                      <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#HistoriaFisioterapia<?php echo $id?>" aria-expanded="false" aria-controls="HistoriaFisioterapia<?php echo $id?>">
                                        Fecha <?php echo $Fecha .'  ';?>

                                        <button onclick="window.location.href='HFT_Finalizado_Historia_Fisioterapia?historiaClinica1=<?php echo $id;?>'" style="border: hidden;background-color: initial;font-size: 20px;"><i class="fa-regular fa-rectangle-list" style="top: 2px;position: relative;"></i></button>
                                  ...
                                  <div id="HistoriaFisioterapia<?php echo $id?>" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading" style="padding-top: 20px;background-color: rgb(238, 238, 238);">
