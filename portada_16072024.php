            ...
            <div class="box-body ">
                <div class="row">
                    ...
                    <div class="col-md-12 mt-3">
                        ...
                        <select class="form-control input-lg select2 w-100" name="clienteIngreso" id="clienteIngreso" onchange="verIngresos({cliente_id: this.value, usuario_id: <?= $_SESSION['ID'] ?>})" style="width: 100%;">
                            ...
                            <?php if (($_SESSION['vista'] == 0 || $_SESSION['vista'] == 1) and $_SESSION['sucursal'] != 0) {
                                ...
                                $query = "SELECT * FROM  cliente WHERE {$filtro} sucursal = '$sucursal' $queryCliente ORDER BY cliente_id";
                                ...
                                $query = "SELECT * FROM  cliente WHERE 1=1 {$filtro} $queryCliente ORDER BY cliente_id";
                            }
...
<?php } */ ?>
                ...
                <div class="row" style="text-align: center">
                    <div class="col-md-6">
                        ...
                        $resultado = mysqli_query($conn3, "SELECT * FROM sinvetrios where (usuario_id = '{$_SESSION['ID']}' or usuario_id = '{$_SESSION['ID_principal']}') and estado = 'Activo'");
                    ...
                    <div class="col-md-6">
                        ...
                        <tbody>
                            ...
                            $ID = $_SESSION['ID'];
                            $arrayDatosA = [];
                            $resultado = mysqli_query($conn3, "SELECT * FROM cliente where (usuario_id = '{$_SESSION['ID']}' || usuario_id = '{$_SESSION['ID_principal']}')");
                    ...
                    <div class="col-md-6">
                        ...
                        and (usuario_id = '{$_SESSION['ID']}' or usuario_id = '{$_SESSION['ID_principal']}')
                        GROUP BY fecha");
                        while ($fila = mysqli_fetch_array($resultado)) {
                            $Numero++;
