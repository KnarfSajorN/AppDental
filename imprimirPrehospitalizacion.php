...
$idPreHospitalizacion = decrypt($_GET['idPre']);

$queryList = mysqli_query($conn3, "SELECT * FROM  ingresoPrehospitalizacion where idPreH = $idPreHospitalizacion");
            ...
            <tr>
                <td>
                    ...
                    <table class="table" style="width: 100%;margin-top: 3px;">
                            ...
                            <tr style="border-bottom-width: 1px;">
                                <td>
                                    <b>Fecha y Hora de Ingreso:</b> <?php echo $fechaRegistro . " ".$horaRegistro ?>
                                </td>
                                <td>
                        ...
                        <h3 align='center'>Registro de Prehospitalizacion</h3>
