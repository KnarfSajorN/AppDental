                            ...
                            <table class="table table-bordered table-striped" style="font-size:18px;display: flex; flex-flow: column;">
                                <thead style="display: flex; flex-flow: column;">
                                    <tr style="display: flex; flex-flow: row;">
                                        ...
                                        <th style="width: calc(100%/4); word-break: break-all; overflow: hidden;">Numero</th>
                                ...
                                <tbody id="resSend" style="display: flex; flex-flow: column; max-height: 700px; overflow: auto;">
                                    <?php $queryws_contactos = mysqli_query($conn3, "SELECT * from cliente where habeasdata = 'Si' and enviado <> 0") ?>
...
<?php if ($_GET['send']) { ?>
    <script>
        function enviarMensajes() {
            $.ajax("./moduloMasivos/ajax_enviarMensajes.php?accion=1", {
                type: "POST",
                data: {
                ...
                success: function(response) {
                    ...
                    if (validar[1] == "true") {
                        ...
                        window.location.href = "masivoMensajesW";
