...
if ($_POST) {
    switch ($_POST['accion']) {
        case 1:
            ...
            // ahora los filtros preestablecidos
            // var_dump($_POST);
            
            $query  = "INSERT into ws_mensajes set usuarioId = $ID, titulo = '$nombre', mensaje = '$mensaje', filtro = '$filtro_', filtroAZ = '$filtroAZ_' , idArchivo = '$archivo', ID_principal = '$ID_principal'";
            ...
            foreach ($_POST['filtroPre'] as $key => $value) {
                ...
                mysqli_query($conn3, "ALTER TABLE ws_mensajes ADD COLUMN filtroPre_$key text null default null");
                mysqli_query($conn3, "UPDATE ws_mensajes set filtroPre_$key = '1' where id = $lasId");
                ...
                mysqli_query($conn3, "ALTER TABLE ws_mensajes ADD COLUMN filtroR_$key text null default null");
                mysqli_query($conn3, "UPDATE ws_mensajes set filtroR_$key = '$contact' where id = $lasId");
            }
            echo '<script>window.location.href="./masivoMensajesW"</script>';
            break;
        case 2:
            // update
            $id = $_POST['id'];
            ...
            $filtro_ = substr($filtro_, 0, -2);
            $query  = "UPDATE ws_mensajes set titulo = '$nombre', mensaje = '$mensaje', filtro = '$filtro_', filtroAZ = '$filtroAZ_' , idArchivo = '$archivo' where id = $id";
            mysqli_query($conn3, $query);
...
$Base = 'https://app.dentalsoftplus.com/';
        ...
        <div class="">
            <div class="col-xs-12">
                <h4 class="Titulo_Pagina">
                    Lista de mensajes masivos - WhatsApp
                </h4>
                <div class="box">
                    <!-- /.box-header -->
                    <div class="box-body">
                        <div class="center text-center">
                            <a href="./masivoFiltros" type="button" class="btn btn-outline-info rounded-pill">
                                <i class="fas fa-plus"></i>
                                Editar filtros personalizados
                            </a>
                            <a href="./masivoArchivos" type="button" class="btn btn-outline-info rounded-pill">
                                <i class="fas fa-plus"></i>
                                Agregar archivos publicitarios
                            </a>
                        </div>
                        <hr>
                        ...
                        <div class="modal fade" id="nuevoContacto" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true" style="overflow: auto;">
                            <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="<?= 'masivoMensajesW' ?>" method="POST" style="overflow: auto;">
                                        <div class="modal-body row" style="margin:0;">
                                            ...
                                            <!-- <div class="col-md-12">
                                                <label for="">Lleva archivos</label>
                                                <select name="larchivo" id="larchivo" class="form-control">
                                                    <option value="0" selected>No</option>
                                                    <option value="1">Si</option>
                                                </select>
                                            </div> -->
                                            <div class="col-md-12">
                                                <label for="">archivo Publicitario</label>
                                                <select name="archivo" id="archivo" class="form-control input-lg" style="width:100%;">
                                                    <option value="0" selected>Sin Archivo</option>
                                                    <?php
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td style="text-align: center;">
                                                                    <a href="<?= $Base . '/r/' . $resulImg['alias'] ?>" target="_blank">
                                                                        <i class="fa fa-eye"></i>
                                                                    </a>
                                                                </td>
                                                            </tr>
                        ...
                        <div class="box-body">
                            ...
                            <table id="example1" class="table table-bordered table-striped" style="font-size:18px">
                                ...
                                <tbody>
                                    <?php
                                    $query = "SELECT * from ws_mensajes where ID_principal = '{$_SESSION['ID_principal']}' ";
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form action="<?= 'masivoMensajesW' ?>" method="POST" style="overflow: auto;">
                                                        <div class="modal-body row" style="margin:0;">
                                                            ...
                                                            <div class="col-md-12">
                                                                <label for="">Filtros Personalizado</label>
                                                                <select name="filtro[]" id="filtro" class="form-control input-lg select2" style="width:100%;" multiple>
                                                                    <?php
                                                            ...
                                                            <div class="col-md-12">
                                                                <label for="">Mensaje</label>
                                                                <textarea class="form-control" id="textarea<?= $row['id'] ?>" rows="3" name="mensaje" required><?= $row['mensaje'] ?></textarea>
                                                            </div>
                                                            <div class="col-md-12">
                                                                <label for="">archivo Publicitario</label>
                                                                <select name="archivo" id="archivo" class="form-control input-lg" style="width:100%;">
                                                                    ...
                                                                    if ($result2){
                                                                        while ($row2 = mysqli_fetch_array($result2)) {
                                                                            echo '<option value="' . $row2['id'] . '" ' . ($row['idArchivo'] == $row2['id'] ? 'selected' : '') . ' >' . $row2['descripcion'] . '</option>';
                                                                        }
                                                                    }
                                                                    ?>
                                                                </select>
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        ?>
                                                                            <tr>
                                                                                ...
                                                                                <td style="text-align: center;">
                                                                                    <!-- <button type="button" onclick="CopyPaste('<?= rawurlencode($resulImg['alias']) ?>', this)" class="btn btn-outline-danger rounded-pill btn-disabled text-bold">Copiar <i class="fa fa-file" data-icon="gridicons:print"></i></button> -->
                                                                                    <a href="<?= $Base . '/r/' . $resulImg['alias'] ?>" target="_blank">
                                                                                        <i class="fa fa-eye"></i>
                                                                                    </a>
                                                                                </td>
                                    ...
                                    <?php
                                        ...
                                        echo '<a href="masivoActivarFiltro?id=' . encrypt($row['id']) . '&estado=' . $☺[0] . '&tabla=ws_mensajes" class="btn btn-' . $☺[1] . ' rounded-pill" title="' . $☺[2] . '"><i class="fas fa-power-off "></i></a>';
                                        if ($row['activo'] == 1) {
                                            echo '|<a href="masivoEnviarWhatsApp?A=' . encrypt($row['id']) . '&send=' . encrypt("mucho texto :)") . '" target="_blank" class="btn btn-outline-success rounded-pill" title="Enviar Mensaje"><i class="fas fa-paper-plane "></i></a>';
                                        }
...
<script type="text/javascript">
    const CopyPaste = (alias, el) => {
        ...
        $temp.val(`https://app.dentalsoftplus.com/<?= trim(explode("/", $_SERVER['PHP_SELF'])[1]) ?>/r/${alias}`).select();
