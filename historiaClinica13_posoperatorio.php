...
<hr>  
 ...
 <form action="guardarhistoriaClinica13PostOperatorio.php" method="POST" name="formularioActualizarcliente">
                    ...
                    <div class="box-body">
                          ...
                          <div class="col-md-12">
                            <div class="form-group has-#00a65a">
                              <label>Control PostOperatorio(s)</label>
                              <textarea class="form-control" rows="3" name="operatorio" placeholder="Enter ..." style="border:1px solid #00a65a"></textarea>
                            </div>
                          </div>
