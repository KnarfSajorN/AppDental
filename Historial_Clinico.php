    ...
    <div class="row">
      <div class="card-body">
        <div class="box">
          ...
          <div align="center">
            <a class="btn btn-outline-info btn-lg rounded-pill shadow m-1" href="HC_HistoriaGeneral?cI=<?= encrypt($clienteId); ?>" role="button"> <i class="fa fa-heartbeat"></i> Nueva Consulta </a>
                      ...
                      <div class="panel-heading" role="tab" id="heading" style="background-color: #bad8e687;">
                        <h4 class="panel-title">
                          <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#Historia<?php echo $id ?>" aria-expanded="false" aria-controls="Historia<?php echo $id ?>">
                            ...
                            <!-- <button onclick="window.location.href='Finalizado_Historia_Clinica.php?historiaClinica1=<?php echo $id; ?>'" style="border: hidden;background-color: initial;font-size: 20px;"><i class="iconify" data-icon="gridicons:print"></i></button> -->
                          </a>
                        </h4>
                      </div>
                        ...
                        <div class="panel-heading" role="tab" id="heading" style="background-color: #bad8e687;">
                          <h4 class="panel-title">
                            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#Examenesx<?php echo $id ?>" aria-expanded="false" aria-controls="Examenesx<?php echo $id ?>">
                              ...
                              <!-- <button onclick="window.open('HC_ImprimirGeneral?HC=<?php echo encrypt($id); ?>&tipo=<?php echo $tipo_encriptado; ?>', '_blank')" style="border: hidden;background-color: initial;font-size: 20px;" title="Imprimir Exámenes a Realizar"><i class="iconify" data-icon="gridicons:print"></i></button> -->
                              <button onclick="window.open('HC_ImprimirGeneral?HC=<?php echo encrypt($historia_id); ?>&tipo=<?php echo $tipo_encriptado; ?>', '_blank')" style="border: hidden;background-color: initial;font-size: 20px;"><i class="iconify" data-icon="gridicons:print"></i></button>
                              <button onclick="window.open('enviarWP.php?HC=<?php echo encrypt($historia_id); ?>&tipo=<?php echo $tipo_encriptado; ?>', '_blank')" style="border: hidden;background-color: initial;font-size: 20px;" title="Enviar Exámenes"><i class="fa fa-paper-plane" data-icon="gridicons:print"></i></button>
                            </a>
                          </h4>
                        </div>
                      ...
                      <div class="panel-heading" role="tab" id="headingOne" style="background-color: #bad8e687;">
                        <h4 class="panel-title">
                          <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#Receta<?php echo $id; ?>" aria-expanded="true" aria-controls="collapseOne"> Receta <?php echo $id; ?>
                            ...
                            <button onclick="ImprimirVentanaAparte('RM_ImprimirReceta.php?receta_id=<?php echo $receta_id; ?>&cliente_id=<?php echo $cliente_id; ?>')" style="border: hidden;background-color: initial;font-size: 20px;" title="Imprimir Receta"><i class="iconify" data-icon="gridicons:print"></i></button>
