...
<div class="content-wrapper p-3">
  ...
  <section class="invoice p-3">
      ...
      <div class="col-md-12 table-responsive">
        <table class="table table-striped">
          ...
          <tbody>
            ...
            $resultado = mysqli_query($conn3, "SELECT * FROM  sDetalleOperDevolucion where estado = 1 and  id_cliente = $idCliente 
    ...
    <div class="no-print" style="width:100%">
      <div class="col-md-12">
        <a href="DV_ImprimirDevolucion?idOperacion=<?php echo $idOperacion ?>" target="_blank" class="btn btn-block btn-outline-info rounded-pill shadow m-1" style="width:100%" ><i class="fa fa-print"></i> Imprimir</a>
      </div>
      <div class="col-md-12">
        <br>
      </div>
