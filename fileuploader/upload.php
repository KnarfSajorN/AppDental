...
$Arreglo["uuid"] = "9e8bd5b9-073f-4c3d-aa23-81ce1c52f65e";
$Arreglo["uploadName"] = "1-images.jfif";
*/
...
foreach ($_FILES as $key => $Archivo) {
    $contador++;
            ...
            if (isset($Archivo["name"])) {
                ...
                $directorio1 = $directorio . "96/"; //Declaramos un  variable con la ruta donde guardaremos los archivos
                //Validamos si la ruta de destino existe, en caso de no existir la creamos
                ...
                $directorio2 = $directorio1 . "Prueba/"; //Declaramos un  variable con la ruta donde guardaremos los archivos
                //Validamos si la ruta de destino existe, en caso de no existir la creamos
                ...
                if (move_uploaded_file($source, $target_path)) {
                    ...
                    $Arreglo["uploadName"] = "{$nombre_asignado} - {$inputName}";
                } else {
                    $Arreglo["success"] = false;
                    $Arreglo["error"] = "No se pudo Cargar la imagen";
                }
