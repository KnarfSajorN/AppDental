...
<head>
	...
	<link href="../plugins/FineUploader/fine-uploader-gallery.min.css" rel="stylesheet">
	<script src="../plugins/FineUploader/fine-uploader.min.js"></script>		
	<?php //require_once("../plugins/FineUploader/templates/gallery.html"); 
    ?>
...
<head>
    <script src="../plugins/FineUploader/fine-uploader.js"></script>
    <link href="../plugins/FineUploader/fine-uploader-new.css">
...
<body>
    <form action="upload.php" id="qq-form">
