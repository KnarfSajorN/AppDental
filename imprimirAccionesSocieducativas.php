...
include 'funciones/conn3.php';
            ...
            $historiaClinica1 = $_GET['historiaClinica1'];
                ...
                while($rowMotorizado=mysqli_fetch_array($queryList))
                {
                  ...
                  $numero          =$rowMotorizado['numeduc'];
                  $tema          =$rowMotorizado['temaeduc'];
                   $objetivo         =$rowMotorizado['objetivoeduc'];
                   $desarrollo         =$rowMotorizado['desarrolloeduc'];
                  $reflexiones       =$rowMotorizado['reflexioneseduc'];
