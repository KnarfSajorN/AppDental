              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  echo '     <tr>';
                   ...
                   echo'<td><a href="historiaClinicaHospitalizacion.php?clienteId='.$fila[0].'" title="">'.$fila[2].' </a></td>';
                  ...
                  echo '<a href="historiaClinicaHospitalizacion.php?clienteId='.$fila[0].'" title="Agregar Hospitalizacion"><i class="fa fa-heartbeat"></i> </a>|';  
