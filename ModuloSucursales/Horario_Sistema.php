    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">
                <a data-toggle="collapse" href="#collapseHorario">Horario General/Sucursales</a>
            </h4>
        </div>
        <div id="collapseHorario" class="panel-collapse collapse ">
            <div class="panel-body">
                <div class="col-md-12">
                    ...
                    <select id="Sucursal" name="Sucursal_Horario" class="form-control select2" data-placeholder="Seleccione Sucursal" style="width: 100%;" onchange="HorarioSucursal(this.value)">
                        ...
                        $queryList = mysqli_query($conn3, "SELECT * FROM  sucursales where idUsuario=1");
                ...
                <table class="table">
                    <thead class="thead-light">
                        <tr>
                            ...
                            <th scope="col" style='width: 10%;text-align:center;'>Dia Laboral</th>
                    ...
                    <tbody>
                        ...
                        <td><input type='time' class='form-control input-lg'  name='Horario[{$InputsD1[$key]}]'></td>
                        <td><input type='time' class='form-control input-lg'  name='Horario[{$InputsH1[$key]}]'></td>";

                            echo "  <td>&nbsp;</td>
                        <td><input type='time' class='form-control input-lg'  name='Horario[{$InputsD2[$key]}]'></td>
                        <td><input type='time' class='form-control input-lg'  name='Horario[{$InputsH2[$key]}]'></td>
                    </tr>";
                        }
            ...
            <div class="panel-footer">Horario</div>
        </div>
    </div>
</div>
