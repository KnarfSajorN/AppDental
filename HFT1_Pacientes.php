...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="">
      <div class="col-md-12">
        <h4 class="Titulo_Pagina">Pacientes Historia Fisioterapia Gráfica</h4>
  ...
  columnastablas = [{
    ...
    },
    {
      "data": function(row, type, set) {
        botones = "";
        botones += "<a href='HFT1_Historia_Fisioterapia?clienteId=" + (row.cliente_id) + "' title='Agregar Historia'><i class='fas fa-file-medical'></i> </a>";
        botones += "<a href='HFT1_Historial_Fisioterapia?clienteId=" + (row.cliente_id) + "' title='Ver Historial'><i class='fas fa-book-medical'></i> </a>";
