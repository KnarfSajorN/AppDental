           ...
           $telefono                =$rowMotorizado['celular_cliente'];
            $seguro                     =$rowMotorizado['seguro'];
              ...
              $genero                     =$rowMotorizado['genero'];
                  ...
                  $queryList=mysqli_query($conn3,"SELECT * FROM  operacionRecetario  group by idReceta, cliente_id ");
...
<body>
  ...
  <div class="row no-print">
        <div class="col-xs-12">  
          <a href="<?php echo $Base;?>ReportesRecetas.php"   class="btn btn-default">  Regresar</a>
 ...
 <table align="center"><tr><td><h3><b>  REPORTE DE RECETAS </b></h3> </td></tr>
...
$conn3 = mysqli_connect($host,$userdb,$pass2,$DB)or die ('Ha fallado la conexion MySQL: '.mysqli_error($conn3));
                  ...
                  $queryList=mysqli_query($conn3,"SELECT * FROM  operacionRecetario l , cliente c, usuarios u where l.fecha BETWEEN '$desde' and '$hasta' and l.cliente_id=c.cliente_id and l.usuario_id=u.ID ");

echo "SELECT * FROM  operacionRecetario l , cliente c, usuarios u where l.fecha BETWEEN '$desde' and '$hasta' and l.cliente_id = c.cliente_id and l.usuario_id=u.ID";
...

                  {
                     $ID                 = $row_recordset32['id'];                
                      ...
                      $uso             = $row_recordset32['uso'];
                      $prioridad       = $row_recordset32['prioridad'];
        ...
        $cantidad        = $row_recordset32['cantidad'];  
        $fecha        = $row_recordset32['fecha'];  
       $paciente= $row_recordset32['nombre_cliente'];
                      ...
                      <td width="10%" class="text-center"> '.$paciente.'</td>
                      ...
                      <td width="30%" class="text-center">'.$cantidad.' '.$Producto.$producto1.'&nbsp&nbspDosis:'.$dosis.' '.$posologia.'cada'.$frecuencia.'&nbsp&nbspdurante'.$dias.' </td>';
