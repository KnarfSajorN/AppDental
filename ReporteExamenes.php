            ...
            <table class="table table-striped" border="1">
                <thead>
                    <tr style="background: #A4A4A4">
                        ...
                        <th> Examen</th>
                        <th> Número de trabajadores con resultado anormal </th>
                ...
                <tbody>
                    ...
                    $queryListC = mysqli_query($conn3, "SELECT COUNT(cliente_id) AS total,ExamenID,cliente_id FROM Reporte_Examenes WHERE resultadoID=2 AND DATE(Fecha_Registro) BETWEEN CAST('$desde' AS DATE) AND CAST('$hasta' AS DATE) GROUP BY ExamenID ");
                    ...
                    if ($queryListC) {
                        ...
                        echo ' <tr>
                        <td width="25%">' . funcionMaster1($ExamenID, 'id', 'Nombre', 'empresas_cargos') . ' </td>
...
$queryList1 = mysqli_query($conn3, "SELECT COUNT(cliente_id) AS total,ExamenID,cliente_id FROM Reporte_Examenes WHERE resultadoID=2 AND DATE(Fecha_Registro) BETWEEN CAST('$desde' AS DATE) AND CAST('$hasta' AS DATE) GROUP BY ExamenID ");
