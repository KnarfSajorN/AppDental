...
<img src="https://hellomedical.net/co/assets/img/logo.png" height="10%" width="50%">
<div  class="box box-info" align="center">
            <div class="box-header with-border">


              <img src="img/logo.png" height="40%" width="60%">
              <br>
             Usuarios
              <br>
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="accesoUsuarios.php" method="POST">
              <div class="box-body">
          ...
          <div align="center">
          <h4 class="box-title"> <a href="recover">  Olvidé Mi Clave </a>   </h4>  
