...
// ----------------------------------------------------------------------------------------------------------------------------
								...
								<div class="box box-solid">
						            ...
						            <div class="box-body">
              							<div class="box-group" id="accordion1">
											...
											<form action="guardar_historiaTerapiaOcupacional.php" method="POST" name="formularioActualizarcliente">
                          ...
                          <input type="date" name="fechaN" class="form-control">
										                    ...
										                    <div class="row">
                                                               <div class="col-md-12">
      																...
      																<label><b> Antecedentes Ocupacionales</b></label>
                                                                     <textarea class="form-control"  name="ant_ocupacionales" rows="3" ></textarea>
      																</div>
										                        ...
										                        <div class="col-md-12">
										                          	<div class="form-group">
											                            <label><b> Desempeño en Áreas Ocupacionales </b></label>
											                            <textarea class="form-control"  name="areas_ocupacionales" rows="3" placeholder="  
																		ACTIVIDADES DE LA VIDA DIARIA BASICAS Y PERSONALES:  
																		ACTIVIDADES INSTRUMENTALES DE LA VIDA DIARIA:"></textarea>
	                          										</div>
	                        									</div>
	                    									</div>
                                                        ...
                                                        <div class="row">
										                        <div class="col-md-12">
										                          	<div class="form-group">
											                            <label><b> Educación y Trabajo </b></label>
										                        ...
										                        <div class="col-md-12">
										                          	<div class="form-group">
											                            <label><b> TIEMPO LIBRE Y OCIO</b></label>
											                            <textarea class="form-control"  name="tiempo_libre" rows="3" placeholder="  
																		OCIO SALUDABLE:  
																		OCIO DE RIESGO:"></textarea>
	                          										</div>
	                        									</div>
	                    									</div>
 ...
 <div class="row">
										                        <div class="col-md-12">
										                          	<div class="form-group">
											                            <label><b> POYECTOS , INTERESES Y OBJETIVOS</b></label>
											                            <textarea class="form-control"  name="proyectos" rows="3" ></textarea>
	                          										</div>
	                        									</div>
	                    									</div>
...
<div class="row">
										                        <div class="col-md-12">
										                          	<div class="form-group">
											                            <label><b> PARTICIPACIÓN SOCIAL</b></label>
											                            <textarea class="form-control"  name="participacion" rows="3" ></textarea>
	                          										</div>
	                        									</div>
	                    									</div>
...
<div class="row">
										                        <div class="col-md-12">
										                          	<div class="form-group">
											                            <label><b> Habilidades de desempeño</b></label>
...
<div class="row">
										                        <div class="col-md-12">
										                          	<div class="form-group">
											                            <label><b> PERCEPCIÓN DE HABILIDADES DESTREZAS Y LIMITACIONES</b></label>
											                            <textarea class="form-control"  name="percepcion" rows="3" ></textarea>
	                          										</div>
	                        									</div>
	                    									</div>
...
<div class="row">
										                        <div class="col-md-12">
										                          	<div class="form-group">
											                            <label><b> PATRONES DE DESEMPEÑO
</b></label>
											                            <textarea class="form-control"  name="patrones" rows="3"  placeholder="  
																		HABITOS:
																		RUTINAS:
																		ROLES:
" ></textarea>
...
<div class="row">
										                        <div class="col-md-12">
										                          	<div class="form-group">
											                            ...
											                            <textarea class="form-control"  name="entorno" rows="3" ></textarea>
	                          										</div>
	                        									</div>
	                    									</div>
                                                               ...
                                                               <div class="row">
											                            ...
											                            <label><b> PLAN DE PREVENCIÓN OCUPACIONAL</b></label>
									                        ...
									                        <div class="col-md-4">
										                        ...
										                        <div class="col-md-8">
										                          <div class="form-group">
										                            ...
										                            <input type="text" name="objetivo1"class="form-control" placeholder="" maxlength="120" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
										                          </div>
										                        </div>  
										                        <div class="col-md-12">
										                          <div class="form-group">
										                            <label class="control-label">Intervención:</label>
										                            <input type="text" name="intervencion" class="form-control" placeholder="" maxlength="120" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
										                          </div>
										                        </div>
									                        ...
									                        <div class="col-md-6">
										                          <div class="form-group">
										                            ...
										                            <input type="text" name="profesion" class="form-control" placeholder="" maxlength="120" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
										                          </div>
										                        </div> 
										                        <div class="col-md-6">
										                          <div class="form-group">
										                            <label class="control-label">Registro profesional Número:</label>
										                            <input type="text" name="registro1"class="form-control" placeholder="" maxlength="120" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
										                          </div>
										                        </div>  
									                    ...
									                    <h4 class="box-title">
									                      <a data-toggle="collapse" data-parent="#accordion1" href="#collapse3">
									                        Seguimiento Terapia Ocupacional
									                      </a>
									                    </h4>
									                </div>
									                	...
									                	<div class="box-body">
										                    <div class="row">
                                                                    ...
                                                                    <div class="form-group col-md-12">
      																...
      																<label><b> SITUACIÓN ENCONTRADA</b></label>
      																<textarea id="examenPartesdCuerpo" name="situacion" class="textarea" placeholder="" style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>

    															</div> </div> 


                <div class="col-md-12"> 
                <font size="1"> <h4>PLAN DE INTERVENCIÓN OCUPACIONAL </h4> </font></div>
               <div class="form-group col-md-3">
                  <div align="left">Fecha:</div>
                  <input type="date" class="form-control input-lg" id="fimico" name="fechaplan" >
                </div>

 <div class="form-group col-md-9">
                  <div align="left">Objetivo:</div>
                  <input type="text" class="form-control input-lg" id="fimico" name="num" placeholder="">
                </div>
 <div class="form-group col-md-12">
                  <div align="left">Intervención:</div>
                 <textarea id="examenPartesdCuerpo" name="situacion" class="textarea" placeholder="" style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                </div>
