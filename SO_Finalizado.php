...
if (isset($_POST['Enviar_Firma'])) {
  ...
  $mensajeW = 'Sr(a) *' . $nombre_cliente . '* Se le ha sugerido firmar esta historia clínica, para proceder abrir el siguiente link ' . $Base . 'firma/firmardocumento/' . $historiaClinica1 . '/conceptolaboral/' . $cliente_id;
  $accion = 0;
  ...
  echo "<script language='Javascript'> window.location='SO_Finalizado?historiaClinica1=" .$historiaClinica1 . "';</script>";
}
...
if (isset($_GET['tipo'])) {
  ...
  if ($tipo == "consulta") {
    ...
    $mensajeW = 'Sr(a) *' . $nombre_cliente . '* Se le envia el siguiente documento, registrado en la consulta ' . $Base . 'SO_Imprimir_Historia?historiaClinica1=' .$historiaClinica1;
  }

  $accion = 0;
  Whatsapp_sent_cliente($linkkey, $whatsapp, $mensajeW, $cliente_id, $usuario_id, $whatsapp, $accion);

  echo "<script language='Javascript'> window.location='SO_Finalizado?historiaClinica1=" .$historiaClinica1 . "&msg=Mensaje Enviado';</script>";
}
  ...
  <section class="content">
    ...
    <div align="center">
      ...
      <a class="btn btn-outline-info btn-lg rounded-pill shadow" target="_blank"
        href="<?php echo $Base; ?>SO_Imprimir_Historia?historiaClinica1=<?php echo ($historiaClinica1); ?>">
    ...
    <div align="center">
      ...
      <a class="btn btn-outline-info btn-lg rounded-pill shadow" 
        href="<?php echo $Base; ?>SO_Finalizado?historiaClinica1=<?php echo ($historiaClinica1); ?>&tipo=consulta">
    ...
    <div align="center">
      ...
      $queryList = mysqli_query($conn3, "SELECT firma FROM  firmas where historia_id = $historiaClinica1 and historia_nombre = 'conceptolaboral'");
      ...
      if (strlen($firma) > 10) {
        ...
        <form action="SO_Finalizado?historiaClinica1=<?php echo ($historiaClinica1) ?>" method="POST"
