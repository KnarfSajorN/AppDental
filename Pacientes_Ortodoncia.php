...
<div class="content-wrapper p-3">
    ...
    <section class="content">
        <div class="">
            <div class="col-xs-12">
                <h4 class="Titulo_Pagina">Pacientes Historia Ortodoncia</h4>
                <?php
                $msg = $_GET['msg'];
                if ($msg == '1') {
...
<script>
    ...
    },
    {
        "data": function (row, type, set) {
            ...
            botones += "<a href='Historial_Ortodoncia?clienteId=" + row.cliente_id + "' title='Ver historial Ortodoncia'><i class='fas fa-book-medical'></i> </a>";
