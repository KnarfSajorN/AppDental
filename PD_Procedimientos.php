...
if (isset($_POST['Guardar_Informacion_Pagina'])) {
    ...
    if ($queryList != true) {
        echo "<script language='Javascript'> window.location='{$ruta}?error=Hubo Un Error Al Guardar El Procedimiento'</script>";
    } else {
        echo "<script language='Javascript'> window.location='{$ruta}?msg=Se Guardo El Procedimiento Correctamente'</script>";
    }
}
    ...
    <script>
        window.onload = function() {
            ...
            for (index in Arreglo) {
              ...
              if ((document.getElementsByName("Arreglo[" + index + "]")[0].tagName == "INPUT" || document.getElementsByName("Arreglo[" + index + "]")[0].tagName == "TEXTAREA") && document.getElementsByName("Arreglo[" + index + "]")[0].type != "checkbox" && document.getElementsByName("Arreglo[" + index + "]")[0].type != "radio") {
                    ...
                    <div class="card-body">
                      ...
                      <div class="card-header-title font-size-lg text-capitalize font-weight-normal row" style="background-color:#17a2b812;padding: 20px;">
                        ...
                        <div class="col-md-6" style="align-self: center;">
                          <h2>Procedimientos/Patología Podograma</h2>
                        </div>
                        <div class="col-md-3">
                          <ul class="nav nav-justified">
                            <a href="PD_SubirSVG" style="width: 100%;margin-bottom: 10px;">
                            ...
                            <li class="nav-item col-md-12" style="display: contents;"><a data-toggle="tab" id="boton_modulo_informacion" style="margin-bottom: 10px;" href="#tab-eg-0" class="btn btn-block btn-outline-info btn-lg rounded-pill shadow active"><?= ($_GET['Editar']) ? 'Editar <br>' . funcionMaster($_GET['Editar'], 'id', 'Nombre', $Nombre_Tabla) : 'Nuevo' ?></a></li>
                            ...
                            <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST" class="row" enctype="multipart/form-data" id="FormularioInformacion">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="row col-md-12" style="height:300px;overflow-y: scroll;">
                                        <?php
                                            $queryList = mysqli_query($conn3, "SELECT * FROM  PD_Iconos_SVG WHERE Activo='1' order by ID ASC ");
                                            while ($rowMotorizado = mysqli_fetch_array($queryList)) {
                              ...
                              <table class="table table-striped table-bordered" id="example1" style="width:100%">
                                ...
                                <tbody>
                                  ...
                                  while ($RowTabla = mysqli_fetch_assoc($QueryExeecuteTabla)) {
                                    ...
                                    $Icono = funcionMaster($RowTabla['Icono'],'id','SVG','PD_Iconos_SVG');
