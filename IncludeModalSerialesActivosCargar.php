...
function GuardarDatosExistenciasActivos(){
    ...
    data: {
        formulario: formData,
        Tipo_Consulta: "Agregar Seriales Producto Detalles Cargar Activos"
    },
...
function BuscarSerialRegistradoDetalles(campo) {
    ...
    $.ajax({
        ...
        data: {
            ...
            Sinvdep: Sinvdep,
            Tipo_Consulta: "Buscar Serial Registrado Detalles Cargar Activos"
        },
        success: function(response) {
...
$(document).ready(function () {
    ...
    if (faltaLlenarSerialElement.length > 0) {
        ...
        var submitButton = $('#TotalizarCargarActivo :submit');
        ...
        if (submitButton.length > 0) {
            ...
            $('#TotalizarCargarActivo').append([br, nuevoInput, br]);
        }
