...
$Arreglo["Peso x Edad"] = ["Tipo" => "Gráfica Peso / Edad", "Unidad" => "Peso (kg)", "Variable" => "Peso", "Minimo" => "0", "Maximo" => "120"];
$Arreglo["Altura x Edad"] = ["Tipo" => "Gráfica Altura / Edad", "Unidad" => "Altura (cm)", "Variable" => "Altura", "Minimo" => "0", "Maximo" => "228"];
$Arreglo["Perimetro Cefalico"] = ["Tipo" => "Gráfica Perímetro Cefálico", "Unidad" => "Perímetro Cefálico (cm)", "Variable" => "Perimetro_Cefalico", "Minimo" => "0", "Maximo" => "60"];
$Arreglo["IMC"] = ["Tipo" => "Gráfica IMC / Edad", "Unidad" => "IMC", "Variable" => "IMC", "Minimo" => "0", "Maximo" => "228"];
...
$MinMeses = intval($Botones_Finales[0]) * 12;
$MaxMeses = intval($Botones_Finales[1]) * 12;
...
if ($MinMeses != "" and $MaxMeses != "") {
    $QueryLista = mysqli_query($conn3, "SELECT * from Tabla_Crecimiento_OMS where Tipo = '{$Tipo}' AND Genero='{$Genero[$G]}' AND Meses BETWEEN '$MinMeses' AND '$MaxMeses'  ORDER BY Meses ASC");
    $min_grafica = $MinMeses;
    $max_grafica = $MaxMeses;
} else {
    $QueryLista = mysqli_query($conn3, "SELECT * from Tabla_Crecimiento_OMS where Tipo = '{$Tipo}' AND Genero='{$Genero[$G]}' ORDER BY Meses ASC");
    $min_grafica = '0';
    $max_grafica = '241';
    $Intervalo = '12';
}
...
while ($RowLista = mysqli_fetch_array($QueryLista)) {
    ...
    $Percentil_3 = $RowLista['Percentil_3'];

    $ArrayLista_3[] = array("x" => $Meses, "y" => $Percentil_3);

    $Percentil_15 = $RowLista['Percentil_15'];

    $ArrayLista_15[] = array("x" => $Meses, "y" => $Percentil_15);

    $Percentil_50 = $RowLista['Percentil_50'];

    $ArrayLista_50[] = array("x" => $Meses, "y" => $Percentil_50);

    $Percentil_85 = $RowLista['Percentil_85'];

    $ArrayLista_85[] = array("x" => $Meses, "y" => $Percentil_85);

    $Percentil_97 = $RowLista['Percentil_97'];

    $ArrayLista_97[] = array("x" => $Meses, "y" => $Percentil_97);
}
