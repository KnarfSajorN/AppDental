...
<form class="col-md-12" id="DatosFormulario_ModalAgendamiento">
            <div class="row">
                <div class="col-md-12 row">
                    ...
                    <select class="form-control select2" id="motivoConsulta" name="motivoConsulta" placeholder="Motivo de consulta" style="width:100%" onchange="tiempoMotivoConsulta(this.value, 'duracion')">
                                    ...
                                    if($contadormotivo=="1"){
                                        $duracioninput = $row_recordset32A['Tiempo'];
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select id="duracion" name="duracion" class="form-control select2" data-placeholder="Seleccione el tiempo en minutos" style="width: 100%;" >
                            <option value="<?php echo $duracioninput ?>" selected> <?php echo $duracioninput; ?> </option>
                            <option >5</option>
                            <option>10</option>
                            <option>15</option>
                            <option>20</option>
                    ...
                    <input type="hidden" name="idCitas" value="0">
            ...
            <input type="hidden" name="id_formulario_agendarcita" id="id_formulario_agendarcita" value="">
    </form>
<!--cierre de lista-->
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="guardarCitaEnFormulario();">Guardar Historia</button>
      </div>
