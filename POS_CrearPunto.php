...
<div class="content-wrapper p-3">
    ...
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li><a href="#"> Registro de Puntos POS </a></li>
        </ol>
    </section>
    ...
    <section class="content">
        <div class="">
            <div class="content">
                <h4 class="Titulo_Pagina">Registro de Puntos POS </h4>
                <div class="box">
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <label>Serie</label>
                                <input type="text" class="form-control input-lg" name="Arreglo[Serie]" placeholder="Serie" value="" maxlength="120" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" required>
                            </div>

                            <div class="form-group col-md-6">
                                <label>Numero Factura</label>
                                <input type="number" class="form-control input-lg" name="Arreglo[NumeroFactura]"  value="0" maxlength="20" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" required>
                            </div>

                            <div class="form-group col-md-6">
                                <label>Numero Devolución</label>
                                <input type="number" class="form-control input-lg" name="Arreglo[NumeroDevolucion]"  value="0" maxlength="20" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" required>
                            </div>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-body">
                                    <div class="col-md-12">
                                        <h2 style="text-align: center;font-weight: bold;"> Puntos POS </h2>
                                        <table id="example1" class="table table-bordered table-striped">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col">Numero Devolución</th>
                                            ...
                                            <tbody>
                                                ...
                                                while ($rowMotorizado = mysqli_fetch_array($queryList)) {
                                                    ...
                                                    <td width='20%' align='center'>{$Nombre}</td>
                                                     <td width='20%' align='center'>{$Serie}</td>
                                                     <td width='20%' align='center'>{$NumeroFactura}</td>
                                                     <td width='20%' align='center'>{$NumeroDevolucion}</td>";
