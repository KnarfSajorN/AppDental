...
$QueryHistoria = mysqli_query($conn3, "SELECT * FROM  RIAS_HistoriaAdultez where id = $id");
...
$TipoHistoria = "RIAS_HistoriaAdultez";
    ...
    <div class="box">
        <div class="box-body">
            ...
            <a class="btn btn-outline-info btn-lg rounded-pill shadow" target="_blank"
                href="<?php echo $Base; ?>RIAS_Impresion_Adultez.php?id=<?php echo ($id); ?>">
