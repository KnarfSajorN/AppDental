    ...
    <section class="content">
      <div class="row">
        ...
        <div class="form-row">
          ...
          <br>
      		 <form action="guardarlasik.php" method="POST" name="formularioActualizarcliente">
            <input type="hidden" id="clienteId" name="usuario_id" value="<?php echo $usuario_id;?>" >
                ...
                <div class="form-group col-md-12">
      		      <input type="number" class="form-control" id="motivoConsulta" name="numaeroLasik" placeholder="Numaero Lasik" >
      		    </div>
...
<textarea  class="form-control" id="Descripcion" name="motivoDeConsulta" rows="4">

</textarea>
 
              <label><strong>  agudeza Visual  </strong></label>
              
<textarea  class="form-control" id="agudezaVisual" name="agudezaVisual" rows="4">
1.
2.
3.
</textarea>
...
<textarea  class="form-control" id="diagnostico" name="impresionDiagnostica" rows="4">
1.
2.
3.
</textarea>
