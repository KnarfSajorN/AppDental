...
if ($form1 == 1) {
    ...
    $queryUsuarioExiste = mysqli_query($conn3, "SELECT id FROM c_catalogo WHERE idUsuario = '$usuarioId'");

    if (mysqli_num_rows($queryUsuarioExiste) > 0) {
    ...
    whatsapp = '$whatsapp',  f = '$f', t = '$t', i= '$i', l = '$l', y = '$y',  telefonos = '$telefonos', anosExperiencia = '$anosExperiencia', activo = '1',
        ...
        mysqli_query($conn3, "INSERT INTO c_catalogo SET 
        ...
        GoogleA = '$GoogleA'") or die(mysqli_error($conn3));
