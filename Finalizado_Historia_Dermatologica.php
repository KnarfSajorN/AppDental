...
$queryList = mysqli_query($conn3, "SELECT * FROM  Historia_Dermatologica where ID = $historiaClinica1");
...
$correo = funcionMaster($cliente_id, 'cliente_id', 'correo_cliente', 'cliente');
...
if (isset($_POST['Enviar_Firma'])) {
  ...
  echo "<script language='Javascript'> window.location='Finalizado_Historia_Dermatologica.php?&historiaClinica1=" . $historiaClinica1 . "';</script>";
}

if (isset($_GET['tipo'])) {
  $correo = funcionMaster($cliente_id, 'cliente_id', 'correo_cliente', 'cliente');
  $tipo = $_GET['tipo'];
  $mensajeW = 'Sr(a) *' . $nombre_cliente . '* Se le envia el siguiente documento registrado en la cita ' . $Base . 'Imprimir_Historia_Dermatologica.php?historiaClinica1=' . $historiaClinica1 . '&tipo=' . $tipo;
  $accion = 0;
  Whatsapp_sent_cliente($linkkey, $whatsapp, $mensajeW, $cliente_id, $usuario_id, $whatsapp, $accion);


  $texto = 'Sr(a) *' . $nombre_cliente . '* Se le envia el siguiente documento registrado en la cita ' . $Base . 'Imprimir_Historia_Dermatologica.php?historiaClinica1=' . $historiaClinica1 . '&tipo=' . $tipo;
...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div align="center">
      ...
      <!-- <a class="btn btn-app" target="_blank" href="<?php echo $Base; ?>RM_ImprimirReceta.php?historia_clinica_id=<?php echo $historiaClinica1; ?>&nombre_historia=Historia_Clinica">
      ...
      <a class="btn btn-app" target="_blank" href="<?php echo $Base; ?>Imprimir_Historia_Dermatologica.php?historiaClinica1=<?php echo $historiaClinica1; ?>&tipo=consulta">
    ...
    <div align="center">
      ...
      <a class="btn btn-app" href="<?php echo $Base; ?>Finalizado_Historia_Dermatologica.php?historiaClinica1=<?php echo $historiaClinica1; ?>&tipo=consulta">
