        ...
        <div class="">
            <div class="content">
                <div class="box">
                    ...
                    <div class="card-header-tab card-header" style="justify-content: center;"><h2 align="center">Reporte Mayores Contables Con Centro De Costos</h2></div>
                      <form action="RP_Reporte_mayorCont_Centrocostos_informacion.php" method="POST">

                        <br>
                        <div class="col-xs-12">
                          <label>Cuenta/Nombre</label>
                          <select id="nombre_cuenta" name="nombre_cuenta" class="form-control" style="width: 100%;" required>
                            <option value="0" select>Todos</option>
                            <?php

                             $queryList=mysqli_query($conn3,"SELECT * FROM CCuentas");
                        ...
                        <div class="col-xs-12">
                          ...
                          <select id="centro_costos" name="centro_costos" class="form-control" style="width: 100%;" required>
                            <option value="0" select>Todos</option>
                            <?php

                             $queryList=mysqli_query($conn3,"SELECT * FROM CcentroCostos");
                             $nrowl=mysqli_num_rows($queryList);
                             while($row_recordset32=mysqli_fetch_array($queryList))
                             {
                              $id      = $row_recordset32['id'];
