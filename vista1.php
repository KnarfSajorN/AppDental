...
<form action="OportunidadCitas1.php" method="POST"> 
  <div class="col-xs-6">
<h4><b>Seleccione una fecha probable para agendar cita </b> </h4> 
...
<div class="col-xs-6">
    <h4><b>Grupos o categorías de atenciones médicas</b></h4> <font color = 'red'><h5>(Si no selecciona ninguna se mostrará la agenda de todos los especialistas) </h5></font>
...
<a href="#"  onclick="cargarFecha();"> <font size="6"> <i class="fa-solid fa-magnifying-glass"></i> <strong>   Consultar </strong>  </font> </a>
               </div>
 ...
 <script type="text/javascript">
   ...
   function cargarFecha(){
        ...
        $.ajax({
            type: "POST",
            url: "OportunidadCitas1.php",
            data: {fechaE:fechaE, idcliente:idcliente,usuario:usuario, grupo:grupo },
            success: function(response) {
                $('#div-results').html(response);
        var duracion = $("#duracion1").val();  // aqui enviamos el mensaje por medio de un arreglo               
            }
        });
...
var duracion = $("#duracion1").val();  // aqui enviamos el mensaje por medio de un arreglo     
        ...
        $.ajax({
            ...
            data: {fecha:fecha, Hora:Hora, usuario_id:usuario_id, doctor:doctor , clienteId:clienteId , motivo:motivo , duracion:duracion },
            success: function(response) {
...
var duracion = $("#duracion2").val();  // aqui enviamos el mensaje por medio de un arreglo     
...
var duracion = $("#duracion3").val();  // aqui enviamos el mensaje por medio de un arreglo     
...
var duracion = $("#duracion4").val();  // aqui enviamos el mensaje por medio de un arreglo     
...
var duracion = $("#duracion5").val();  // aqui enviamos el mensaje por medio de un arreglo     
...
var duracion = $("#duracion6").val();  // aqui enviamos el mensaje por medio de un arreglo     
...
var duracion = $("#duracion7").val();  // aqui enviamos el mensaje por medio de un arreglo     
...
var duracion = $("#duracion8").val();  // aqui enviamos el mensaje por medio de un arreglo     
...
var duracion = $("#duracion9").val();  // aqui enviamos el mensaje por medio de un arreglo     
...
var duracion = $("#duracion10").val();  // aqui enviamos el mensaje por medio de un arreglo     
...
var duracion = $("#duracion11").val();  // aqui enviamos el mensaje por medio de un arreglo     
...
// estas son las variables que enviamos
  ...
  // aqui enviamos el mensaje por medio de un arreglo     
        ...
        $.ajax({
            ...
            data: {fecha:fecha, Hora:Hora, usuario_id:usuario_id, doctor:doctor, tipo:tipo, numero:numero},
            success: function(response) {
                $('#div-resultsHora1').html(response);
...
// estas son las variables que enviamos
 ...
 // aqui enviamos el mensaje por medio de un arreglo     
        ...
        $.ajax({
            ...
            data: {fecha:fecha, Hora:Hora, usuario_id:usuario_id, doctor:doctor, tipo:tipo, numero:numero},
            success: function(response) {
                $('#div-resultsHora2').html(response);
...
// estas son las variables que enviamos
 ...
 // aqui enviamos el mensaje por medio de un arreglo     
        ...
        $.ajax({
            ...
            data: {fecha:fecha, Hora:Hora, usuario_id:usuario_id, doctor:doctor, tipo:tipo, numero:numero},
            success: function(response) {
                $('#div-resultsHora3').html(response);
...
// estas son las variables que enviamos
  ...
  // aqui enviamos el mensaje por medio de un arreglo     
        ...
        $.ajax({
            ...
            data: {fecha:fecha, Hora:Hora, usuario_id:usuario_id, doctor:doctor, tipo:tipo, numero:numero},
            success: function(response) {
                $('#div-resultsHora4').html(response);
