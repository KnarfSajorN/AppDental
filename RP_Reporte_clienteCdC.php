            ...
            <div class="content">
                ...
                <div class="m-3">
                 <div class="box">
                  ...
                  <div class="box-body">
                    <div class="col-xs-12">
                      <div class="card-header-tab card-header" style="justify-content: center;"><h2 align="center">Reporte de Clientes con Centro de Costos</h2></div>
                      <form action="ReporteGeneral.php" method="POST">
                        ...
                        <input type="hidden" class="form-control input-lg" name="tipo_reporte" value="Reporte de Clientes con Centro de Costos" required>
