...
<div class="content-wrapper p-3">
    ...
    <section class="content-header">
        <h1>
            Cliente: <?php echo $nombre_paciente ?>
    ...
    <section class="content">
        <div class="row">
            ...
            <p>   </p>
                ...
                <div class="box">
                    <form action="AbonoRegistrarC.php" method="POST" name="formularioActualizarcliente">
                        <div class="box-header" align="center">
                            <h2>Factura (A Cobrar) #<?php echo $numeroDoc ?></h2>
                        </div>
                        <!-- /.box-header -->
                            ...
                            <div class="table-responsive" style="overflow: auto;">
                                <table id="example1" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            <th>id</th>
                                            <th>Número de Operación / Factura</th>
                                            <th>Fecha</th>
                                            <th>Hora</th>
                                            <th>Método</th>
                                            <th>
                                    ...
                                    <tbody>
                                        ...
                                        $queryList = mysqli_query($conn3, "SELECT * FROM  abonoC where numero_operacion = '$idOperacion' and activo= 1");
                                        $nrowl = mysqli_num_rows($queryList);
                                        while ($rowMotorizado = mysqli_fetch_array($queryList)) {
                                            $id = $rowMotorizado['id'];
                                        ...
                                        <td> <a target="_blank" href="ImprimirAbonoC?idOperacion=' . $numero_operacion . '&idAbono=' . $id . '"><i class="iconify" data-icon="ph:newspaper-clipping-bold" style="font-size:25px;position:relative;top:5px;"></i> Imprimir comprobante</a> </td>
                                        '; ?>
                                            <td>
                                                <a href="AnularAbonoC?idOperacion=<?php echo $numero_operacion; ?>&idAbono=<?php echo $id; ?>" onclick="showConfirmationAlert(event)">
                                        ...
                                        <?php
                                            if (strlen($firma) > 1) {
                                                ...
                                                echo '<td> <a href="EnviarAbonoC?idOperacion=' . $numero_operacion . '&idAbono=' . $id . '"><i class="iconify" data-icon="bx:bx-mail-send" style="font-size:25px;position:relative;top:5px;"></i> Enviar Confirmación del Abono</a> </td>
                                                </tr>';
                                            }
                ...
                <div class="box">
                    <form action="AbonoRegistrarC.php" method="POST" name="formularioActualizarcliente">
                        <div class="box-header" align="center">
                            <h2>Facturas Anuladas (A Cobrar) #<?php echo $numeroDoc ?></h2>
                        </div>
                        <!-- /.box-header -->
                        <div class="container-fluid" style="padding: 20px;">
                            <div class="table-responsive" style="overflow: auto;">
                                <table id="example1" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            <th>id</th>
                                            <th>Numero Operacion / Factura</th>
                                            <th>Fecha</th>
                                            <th>Hora</th>
                                            <th>Método</th>
                                            <th>
                                    ...
                                    <tbody>
                                        ...
                                        $queryList = mysqli_query($conn3, "SELECT * FROM  abonoC where  numero_operacion = '$idOperacion' and activo= 0");
                                        $nrowl = mysqli_num_rows($queryList);
                                        while ($rowMotorizado = mysqli_fetch_array($queryList)) {
                                            $id = $rowMotorizado['id'];
                                            $numero_operacion = $rowMotorizado['numero_operacion'];
