...
if($_POST['submitButton'] == "excel") {
    header('Content-Type: application/vnd.ms-excel; charset=UTF-8');
    header('Content-Disposition: attachment; filename=ReporteReferidos_' . date("Y-m-d") . '.xls');
?>
<!DOCTYPE html>
<html>
        ...
        <div class="col-xs-12 table-responsive">
            <table class="table table-striped" border="1">
                ...
                <tbody>
                    ...
                    $queryList = mysqli_query($conn3, "SELECT * FROM  cliente c where fechar BETWEEN '$desde' and '$hasta' and  c.Referido > 0 ");
                    $nrowl = mysqli_num_rows($queryList);
                    while ($rowMotorizado = mysqli_fetch_array($queryList)) {
...
elseif($_POST['submitButton'] == "generar") {
?>
<!DOCTYPE html>
<html>
