...
<script>
    ...
    function ModalModuloContabilidadCXP(){
        $('#ModalContabilidadCXP').modal('show');
    ...
    function GuardarDatosContabilidad(){
        ...
        var formularioPrincipal = document.getElementById('FormularioCuentaporPagar');
        ...
        document.getElementById('FormularioCuentaporPagar').submit();
...
<!-- El Modal -->
<div class="modal fade" id="ModalContabilidadCXP">
  <div class="modal-dialog modal-lg" style="margin-top: 170px;">
    <div class="modal-content">
    
      <!-- Encabezado del Modal -->
      <div class="modal-header">
        <h5 class="modal-title">Modulo Contabilidad CXP</h5>
      ...
      <div class="modal-body row">
        ...
        <div class="form-group col-md-12" id="Div_CuentaContableCXP">
            <label style="width:100%;">Cuenta Contable [Cuenta por Pagar] *Haber*</label>
            <select class="input-lg form-control select2" name="Arreglo[idCuentaContableCXP]" id="idCuentaContableCXP" style="width:100%;" required>
                ...
                while ($row_recordset32 = mysqli_fetch_array($queryList)) {
                    ...
                    if($idC==$IdOperacion_CuentaContablePrefeterminada){
            ...
            <label>*Viene pre seleccionada la cuenta por cobrar seleccionada en la factura*</label>
        </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-block btn-outline-danger rounded-pill shadow" data-dismiss="modal">Cerrar</button>
        <button type="submit" class="btn btn-block btn-outline-success rounded-pill shadow" >Guardar</button>
      </div>
    </form>
