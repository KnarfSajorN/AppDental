...
<a class="btn btn-app" target="_blank" href="<?php echo $Base;?>imprimirEntrevista_operador.php?historiaClinica1=<?php echo $historiaClinica1;?>"> 
  <i class="fa fa-print"></i> Imprimir Entrevista
</a>
