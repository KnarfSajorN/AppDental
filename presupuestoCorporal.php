...
if (isset($_POST['key'])) {
    ...
    if (isset($_POST['key']) && $_POST['key'] == 'cargaData') {
        ...
        $items = mysqli_query($conn3, "SELECT descripcion, subTotal,Total, id FROM sDetalleOperPendites WHERE estado = 1 AND tipo = 5 AND id_cliente = '{$cliente_id}'");
...
if (isset($_POST['finalizado'])) {
    ...
    as sumSubTotal,SUM(Impuesto_Numerico) as sumImpuesto,SUM(Total) as sumTotal from sDetalleOperPendites where estado = 1 and id_usuario = '{$id_usuario}' and id_cliente = '{$clienteId}' AND tipo = 5 order by id") or die(mysqli_error($conn3));
    ...
    */
    ...
    if ($insert) {
        ...
        $update = mysqli_query($conn3, "UPDATE usuarios SET numeroPresupuesto = '{$usuario['numeroPresupuesto']}' WHERE ID = '{$id_usuario}';") or die(mysqli_error($conn3));
        //$operacionInc = mysqli_query($conn3, "SELECT idOperacion FROM sOperacionInv WHERE numeroDoc = '{$usuario['numeroPresupuesto']}' AND tipo = '5'") or die(mysqli_error($conn3));
        $operacionInc = mysqli_query($conn3, "SELECT idOperacion FROM sOperacionInv WHERE idOperacion = '{$idOperacion}' AND tipo = '5'") or die(mysqli_error($conn3));
        $nrow = mysqli_num_rows($operacionInc);
        if ($nrow > 0) {
            $operacionInc = $operacionInc->fetch_assoc();
        }
        $queryList = mysqli_query($conn3, "SELECT * FROM  sDetalleOperPendites WHERE estado = 1 AND id_usuario = '{$id_usuario}' AND id_cliente = '{$clienteId}' AND tipo = 5") or die(mysqli_error($conn3));
        ...
        echo "<script>window.location.href='preliminarpresupuestoCorporal.php?idOperacion={$operacionInc['idOperacion']}'</script>";
    } else {
        echo "<script>window.location.href='presupuestoFacila.php?clienteId={$clienteId}'</script>";
    }
    exit();
} else {
...
$Deposito_id="0";
$resultado = mysqli_query($conn3, "SELECT * FROM  sDetalleOperPendites where estado = 1 and  id_usuario =$usuario_id and  id_cliente = $cliente_id AND tipo = '5' order by id");
...
<div class="content-wrapper p-3">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#">Presupuesto Corporal</a></li>
        </ol>
    </section>
        ...
        <div >
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="col-md-12">
                            <form action="./presupuestoCorporal.php" method="post">
                                <div class="row">
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <div class="col-md-6 cuelloEscoteTextarea">
                                                <label for="cuelloEscote">Glúteos</label>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-12" style="margin: 0; padding: 0; position: relative;">
                                                    ...
                                                    <img src="./img/presupuestos/corporalSuperior.png" alt="" class="img-fluid" style="width: 100%; height: 400px; position: absolute; left: 0; top: 0;">
                                                </div>
                                                <div class="form-group">
                                                    <div class="col-md-12">
                                                        <hr>
                                                ...
                                                <div class="col-md-12" style="margin: 0; padding: 0; position: relative;">
                                                    ...
                                                    <img src="./img/presupuestos/corporalInferior.png" alt="" class="img-fluid" style="width: 100%; height: 320px; position: absolute; left: 0; top: 0;">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-12" style="margin: 0; padding: 0; position: relative;">
                                                    ...
                                                    <input type="submit" value="T E R M I N A R - P R E S U P U E S T O" id="BotonPresupuesto" class="btn btn-block btn-outline-info rounded-pill shadow m-1" disabled><!-- se debe activar por la funcion -->
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <form action="./presupuestoCorporal.php" method="post" id="anexarProducto">
                                <div class="row">
        ...
        data.forEach(element => {
            if(element.id!="0"){
                item = `<tr>
                            ...
                            <td>${element.Total}</td>
                            <td>
                                <button class="btn btn-block btn-outline-danger rounded-pill shadow m-1" onclick="removeItem(${element.id})">
