...
columnastablas=[
                ...
                { "data": function ( row, type, set ) {
                        botones="";
                        botones+="<a href='consentimiento.php?clienteId="+row.cliente_id+"' title='Generar Consentimiento'><i class='fas fa-file-medical'></i> </a>";
                        botones+="<a href='consultaCliente_consentimiento.php?clienteId="+row.cliente_id+"' title='Ver historial Consentimientos'><i class='fas fa-book-medical'></i> </a>";
