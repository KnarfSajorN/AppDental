  ...
  <div class="content-wrapper p-3">
    ...
    <section class="content-header">
      <ol class="breadcrumb">
        ...
        <li><a href="#">Modulo Periodontograma</a></li>
      </ol>
    </section>
    <!-- Main content -->
    <section class="content">
      <div class="">
        <div class="col-xs-12">
          <h4 class="Titulo_Pagina">Modulo Periodontograma</h4>
...
columnastablas=[
                ...
                { "data": function ( row, type, set ) {
                        botones="";
                        botones+="<a href='PO_Periodontograma?clienteId="+row.cliente_id+"' title='Periodontograma'><i class='fa-sharp fa-solid fa-teeth-open'></i> </a>";
                        return botones;
                        }
                } 
