                            ...
                            <ul class="nav nav-pills">
                                <?php for ($i = 0; $i < count($arrayMenu); $i++): ?>
                                    <li class="nav-item"><a class="nav-link <?= ($i == 0) ? 'active' : '' ?>"
                                            href="#<?= $arrayMenu[$i]['tab'] ?>"
                                            data-toggle="tab"><?= $arrayMenu[$i]['Nombre'] ?></a></li>
                                <?php endfor ?>
                            </ul>
                        </div>
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <div class="progress center text-center align-self-end">
                                                        <div class="progress-bar <?= ($porcentaje >= 80 ? 'bg-primary-gradient' : 'bg-secondary') ?>"
                                                            role="progressbar" style="width: <?= $porcentaje ?>%;"
                                                            aria-valuenow="<?= $porcentaje ?>" aria-valuemin="0"
                                                            aria-valuemax="100">Perfil al <?= $porcentaje ?>%
                                                            <?= ($porcentaje > 80 ? '😄' : '') ?>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="card-footer">
                                                    <small>Use los botones de "Información de contacto" y "Galería de
                                                        imágenes" para completar su perfil</small>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="card">
                                                <div class="card-body center text-center">
                                                    <a href="https://erp.dentalsoftplus.com/comentarios?m=<?= salt() . base64_encode($rowCatalogo['id']) ?>"
                                                        title="<?= $estrellas ?> / 5 estrellas">
                                                        <?php
                                ...
                                <div class="tab-pane" id="info">
                                    <form id="form-catalogo">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <small>https://erp.dentalsoftplus.com/medico/ <strong
                                                            class="text-danger">minombre</strong> </small>
                                                    <input type="text" class="form-control" id="direccionWeb"
                                                        placeholder="Nombre de tu web" name="datos[direccionWeb]"
                                                        accept="text/html" minlength="1" maxlength="20"
                                                        oninput="this.value = this.value.replace(/[^a-z]/g, '');"
                                                        onchange="validarDireccionWeb(this.value,<?= $rowCatalogo['id'] ?>)"
                                                        value="<?= ($rowCatalogo != null ? $rowCatalogo['direccionWeb'] : '') ?>">
                                                    <small class="form-text text-danger">(No se permiten espacios ni
                                                        caracteres especiales, máximo 20 caracteres)</small>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="nombre"
                                                        placeholder="Nombre" name="datos[nombre]"
                                                        value="<?= ($rowCatalogo != null ? $rowCatalogo['nombre'] : '') ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="valorconsulta"
                                                        placeholder="valorconsulta" name="datos[valorconsulta]"
                                                        value="<?= ($rowCatalogo != null ? $rowCatalogo['valorconsulta'] : '') ?>">
                                                </div>
                                            </div>

                                            <div class="col-md-6" id="pais_div">
                                                <div align="left"> Pais de Residencia</div>
                                                <select name="pais" id="pais" class="form-control input-lg select2"
                                                    style="width: 100%;" onchange="paises(this.value);">
                                            ...
                                            <!-- <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="datos[pais]" class="form-control select2 w-100"
                                                        style="width:100%;" id="pais"></select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="datos[ciudad]" class="form-control select2 w-100"
                                                        style="width:100%;" id="ciudad"></select>
                                                </div>
                                            </div> -->
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="categoria"
                                                        placeholder="Especialidad" name="datos[categoria]"
                                                        value="<?= ($rowCatalogo != null ? $rowCatalogo['categoria'] : '') ?>">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="categoria2"
                                                        placeholder="Especialidad" name="datos[categoria2]"
                                                        value="<?= ($rowCatalogo != null ? $rowCatalogo['categoria2'] : '') ?>">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" id="anosExperiencia"
                                                        placeholder="Años" name="datos[anosExperiencia]" min="1"
                                                        value="<?= ($rowCatalogo != null ? $rowCatalogo['anosExperiencia'] : '') ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="telefonos"
                                                        placeholder="Números de contacto" name="datos[telefonos]"
                                                        value="<?= ($rowCatalogo != null ? $rowCatalogo['telefonos'] : '') ?>">
                                                    <small class="form-text text-muted">por favor separar por comas
                                                        (,)</small>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="whatsapp"
                                                        placeholder="Números de WhatsApp" name="datos[whatsapp]"
                                                        value="<?= ($rowCatalogo != null ? $rowCatalogo['whatsapp'] : '') ?>">
                                                    <small class="form-text text-muted">por favor separar por comas
                                                        (,)</small>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="idiomas"
                                                        placeholder="Idiomas" name="datos[idiomas]"
                                                        value="<?= ($rowCatalogo != null ? $rowCatalogo['idiomas'] : '') ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="fpago"
                                                        placeholder="fpago" name="datos[fpago]"
                                                        value="<?= ($rowCatalogo != null ? $rowCatalogo['fpago'] : '') ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="datos[cp]"
                                                            id="cp" value="1" <?= ($rowCatalogo != null && $rowCatalogo['cp'] == 1 ? 'checked' : '') ?>>
                                                        <label for="cp" class="form-check-label">Presencial</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="datos[cv]"
                                                            id="cv" value="1" <?= ($rowCatalogo != null && $rowCatalogo['cv'] == 1 ? 'checked' : '') ?>>
                                                        <label for="cv" class="form-check-label">Domiciliar</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="datos[cd]"
                                                            id="cd" value="1" <?= ($rowCatalogo != null && $rowCatalogo['cd'] == 1 ? 'checked' : '') ?>>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="direccion"
                                                        placeholder="Direccion" name="datos[direccion]"
                                                        value="<?= ($rowCatalogo != null ? $rowCatalogo['direccion'] : '') ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="facebook"
                                                        placeholder="https://www.facebook.com/medico" name="datos[f]"
                                                        value="<?= ($rowCatalogo != null ? $rowCatalogo['f'] : '') ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="Twitter"
                                                        placeholder="https://www.twitter.com/medico" name="datos[t]"
                                                        value="<?= ($rowCatalogo != null ? $rowCatalogo['t'] : '') ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="Instagram"
                                                        placeholder="https://www.instagram.com/medico" name="datos[i]"
                                                        value="<?= ($rowCatalogo != null ? $rowCatalogo['i'] : '') ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="Linkedin"
                                                        placeholder="https://www.linkedin.com/in/medico" name="datos[l]"
                                                        value="<?= ($rowCatalogo != null ? $rowCatalogo['l'] : '') ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="Youtube"
                                                        placeholder="https://www.youtube.com/medico" name="datos[y]"
                                                        value="<?= ($rowCatalogo != null ? $rowCatalogo['y'] : '') ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="editorJR" name="datos[proySer]" id="proySer"
                                                        cols="30"
                                                        rows="10"><?= ($rowCatalogo != null ? $rowCatalogo['proySer'] : '') ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="editorJR" name="datos[proySer2]" id="proySer2"
                                                        cols="30"
                                                        rows="10"><?= ($rowCatalogo != null ? $rowCatalogo['proySer2'] : '') ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="editorJR" name="datos[proySer3]" id="proySer3"
                                                        cols="30"
                                                        rows="10"><?= ($rowCatalogo != null ? $rowCatalogo['proySer3'] : '') ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <button type="submit" class="btn btn-primary btn-block"
                                            onclick="$('#form-catalogo').automaticForm({type:<?= ($rowCatalogo != null ? 2 : 1) ?>,idUpdate:'<?= ($rowCatalogo != null ? $rowCatalogo['id'] : '') ?>',table:'c_catalogo',reload:'',page:''});">Guardar</button>
                                    </form>
                                </div>
                                                        ...
                                                        <?php foreach ($arrayVisitasTotales as $key => $value) { ?>
                                                            <li class="nav-item">
                                                                <a class="nav-link">
                                                                    <?= $key ?>
                                                                    <span
                                                                        class="badge bg-primary float-right"><?= $value ?></span>
                                                                </a>
                                                            </li>
                                                        <?php } ?>
                                                    </ul>
                                ...
                                <div class="tab-pane" id="pagos">
                                    <form id="pago-form">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="nombreBeneficiario"
                                                        name="datos[nombreBeneficiario]"
                                                        value="<?= $rowDatosPago['nombreBeneficiario'] ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="">País</label>
                                                    <input type="text" class="form-control" id="pais" name="datos[pais]"
                                                        value="<?= $rowDatosPago['pais'] ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="nombreBanco"
                                                        name="datos[nombreBanco]"
                                                        value="<?= $rowDatosPago['nombreBanco'] ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="numeroCuenta"
                                                        name="datos[numeroCuenta]"
                                                        value="<?= $rowDatosPago['numeroCuenta'] ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="codigoBanco"
                                                        name="datos[codigoBanco]"
                                                        value="<?= $rowDatosPago['codigoBanco'] ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="">Código IBAN (International Bank Account
                                                        Number)</label>
                                                    <input type="text" class="form-control" id="IBAN" name="datos[IBAN]"
                                                        value="<?= $rowDatosPago['IBAN'] ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="SWIFT"
                                                        name="datos[SWIFT]" value="<?= $rowDatosPago['SWIFT'] ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input"
                                                                name="datos[habilitado]" value="1"
                                                                <?= ($rowDatosPago['habilitado'] == 1 ? 'checked' : '') ?>>
                                                    ...
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input"
                                                                name="datos[habilitado]" value="0"
                                                                <?= ($rowDatosPago['habilitado'] == 0 ? 'checked' : '') ?>>
                                                            No
                                                        </label>
                                                    </div>
                                                </div>
                                            ...
                                            <input type="hidden" name="datos[fechaRegistro]"
                                                value="<?= date('Y-m-d H:i:s') ?>">

                                            <div class="col-md-12">
                                                <button type="submit" class="btn btn-primary btn-block"
                                                    onclick="$('#pago-form').automaticForm({type:<?= ($rowDatosPago != null ? 2 : 1) ?>,idUpdate:'<?= ($rowDatosPago != null ? $rowDatosPago['id'] : '') ?>',table:'c_pasarela', reload:'', page:''});">Guardar</button>
                                            </div>
                                        ...
                                        <div class="card-body">
                                            <form id="form-galeria">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="file" class="form-control" id="foto"
                                                                name="archivos[foto|c_foto]" style="display:none;">
                                                            <label for="foto">
                                                                <img src="<?= $Base ?>uploads/<?= $_SESSION['ID_principal'] ?>/c_foto/<?= $rowCatalogo['foto'] ?>"
                                                                    class="img img-responsive w-100 img-fluid img-thumbnail"
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="file" class="form-control" id="banner"
                                                                name="archivos[banner|c_banner]" style="display:none;"
                                                                accept="image/*">
                                                            <br>
                                                            <label for="banner" style="width: 100%;">
                                                                <img accept="image/*"
                                                                    src="<?= $Base ?>uploads/<?= $_SESSION['ID_principal'] ?>/c_banner/<?= $rowCatalogo['banner'] ?>"
                                                                    class="img img-responsive w-100 img-fluid img-thumbnail"
                                                                    style="border-radius:1rem; width: 100%; height: 150px; object-fit: cover; object-position: <?= $rowCatalogo['bannerPosition'] ?>; z-index: -1;"
                                                                    alt="" id="banner-img">
                                                                <small>Click a la foto para cambiar</small>
                                                            </label>

                                                            <label for="titulo">Posición de Portada</label>
                                                            <select name="datos[bannerPosition]"
                                                                class="form-control select2 w-100" style="width:100%;"
                                                                id="bannerPosition" onchange="cambiarBanner();">
                                                                <option value="top"
                                                                    <?= ($rowCatalogo['bannerPosition'] == 'top' ? 'selected' : '') ?>>Superior</option>
                                                                <option value="center"
                                                                    <?= ($rowCatalogo['bannerPosition'] == 'center' ? 'selected' : '') ?>>Centrado</option>
                                                                <option value="bottom"
                                                                    <?= ($rowCatalogo['bannerPosition'] == 'bottom' ? 'selected' : '') ?>>Inferior</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <button type="submit" class="btn btn-primary btn-block"
                                                            onclick="$('#form-galeria').automaticForm({type:<?= ($rowCatalogo != null ? 2 : 1) ?>,idUpdate:'<?= ($rowCatalogo != null ? $rowCatalogo['id'] : '') ?>',table:'c_catalogo',reload:'',page:''});">Guardar</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form id="form-archivos">
                                                <input type="hidden" name="datos[idCatalogo]"
                                                    value="<?= $rowCatalogo['id'] ?>">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <label for="exampleInputFile">Subir Archivo</label>
                                                        <div class="input-group">
                                                            <div class="custom-file">
                                                                <input type="file" name="archivos[archivo|c_galeria]"
                                                    ...
                                                    <div class="col-md-12">
                                                        <button type="submit"
                                                            class="mt-3 btn btn-maroon bg-maroon btn-block"
                                                            onclick="$('#form-archivos').automaticForm({type:1,idUpdate:'',table:'c_galeria',reload:'',page:'anuncio'});">Subir</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
                                                ...
                                                while ($rowArchivos = mysqli_fetch_assoc($resultArchivos)) {
                                                    ...
                                                    <div class="col-6 col-md-2 p-1" style="align-self:center;">
                                                        <div class="m-2 border border-maroon rounded">
                                                            <div class="mx-auto align-items-center center text-center"
                                                            ...
                                                            <div class="bg-maroon text-center px-2"
                                                                style="min-height: 80px;">
                                                                <div class="overflow-auto"
                                                                    style="max-height: 50px; min-height: 50px;">
                                                                    <span class=" "
                                                                        style="font-size: 13px;"><?= $rowArchivos['archivo'] ?></span>
                                                                </div>
                                                                <div class="row py-2">
                                                                    <?php if ($previsualizar === 'doc') { ?>
                                                                        <div class="col-6 mx-auto">
                                                                            <a class="btn btn-sm btn-maroon text-white"
                                                                                href="<?= $Base ?>uploads/<?= $_SESSION['ID_principal'] ?>/c_galeria/<?= $rowArchivos['archivo'] ?>"
                                                                    ...
                                                                    <?php } ?>
                                                                    <div class="col-6 mx-auto">
                                                                        <a download="<?= $rowArchivos['archivo'] ?>"
                                                                            class="btn btn-sm btn-maroon text-white"
                                                                            href="./c_galeria/<?= $rowArchivos['archivo'] ?>"
                                                                            target="_blank">
...
<script>
    ...
    //         onInit: function () {
    //             console.log('SelectMaster inicializado para ciudades');
    //         },
