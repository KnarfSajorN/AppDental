 ...
 */           
      //  echo "4  ";
                ...
                //insetamos el usuario
                    $queryUsuario = "INSERT INTO historiaClinica3 (cliente_id, usuario_id, CODI_CLIENTE, Fecha, Hora, Descripcion, motivoConsulta, antecedentesPesonales, antecedentesFamililares, biomicroscopia, fondoDeOjo, diagnostico, conducta) VALUES ('$cliente_id' ,'$usuario_id' ,'$CODI_CLIENTE' ,'$Fecha' ,'$Hora' ,'$Descripcion' ,'$motivoConsulta' ,'$antecedentesPesonales' ,'$antecedentesFamililares' ,'$biomicroscopia' ,'$fondoDeOjo' ,'$diagnostico' ,'$conducta')";
