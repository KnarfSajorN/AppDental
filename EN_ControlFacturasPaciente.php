...
<div class="content-wrapper p-3">
  ...
  <section class="content-header">
    <h1>
      Control de Facturas de Clientes Entidad
    </h1>
    <ol class="breadcrumb">
      <li><a href="portada"><i class="fa fa-dashboard"></i> Escritorio</a></li>
      <li><a href="#">Control de Facturas de Clientes Entidad</a></li>
          ...
          <div class="box-body">
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                $resultado = mysqli_query($conn3,"SELECT * FROM  sOperacionInv where  tipo = 9 $queryCliente order by numeroDoc");
                // echo "SELECT * FROM  sOperacionInv where  tipo = 9 $queryCliente order by numeroDoc";
                while ($fila = mysqli_fetch_array($resultado)) {
                  ...
                  <td width='10%' <?php echo $Color ?>>
                            ...
                            <a class='dropdown-item' href='EN_PreliminarFactura?idOperacion=<?php echo  $fila[0]; ?>' target='_blank'>
                            <button type='button' class='btn btn-block btn-outline-info rounded-pill  btn-block'>
                                Preliminar Factura Entidad
                            </button>
                            </a>
                            <a class='dropdown-item' href='EN_ImprimirClienteFactura?idOperacion=<?php echo $fila[0]; ?>' target='_blank'>
                            <button type='button' class='btn btn-block btn-outline-success rounded-pill  btn-block'>
                                Imprimir Factura Entidad
                            </button>
                            </a>

                            <a class='dropdown-item' href='DV_GenerarDevolucionFactura.php?idOperacion=<?php echo $fila['idOperacion']; ?>' target='_blank'>
