                    ...
                    <div class="box-body">
                        <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control input-lg" name="Arreglo[Nombre]" placeholder="Nombre de la Entidad" value="" maxlength="120" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" required>
                            </div>

                            <div class="form-group col-md-12">
                                <label>Descripcion</label>
                                <textarea name="Arreglo[Descripcion]" class="editorJR" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                            </div>
                                        ...
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                while ($rowMotorizado = mysqli_fetch_array($queryList)) {
                                                    ...
                                                    <font> <a href='Rips_Convenios.php?entidad_id={$id}' class='btn btn-primary' style='width: 200px;background-color:#609724;margin-top:5px;margin-bottom:5px'> <i class='fa fa-book' title='Agregar Convenios'>  Agregar Convenios </i></a></font><br>
                                                    </td></tr>";
                                                }
