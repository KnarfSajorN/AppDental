...
$queryList = mysqli_query($conn3, "SELECT * FROM  RIAS_HistoriaAdultez where id = $idHistoria");
        ...
        <tbody>
            <tr>
                <td>
                    ...
                    $queryList = mysqli_query($conn3, "SELECT * FROM  RIAS_HistoriaAdultez where id = $idHistoria LIMIT 1");
                    $nrowl = mysqli_num_rows($queryList);
