...
// ----------------------------------------------------------------
// 18 10 2022 - Jose
// Descifrar los datos en formato RTF para ser Leidos o usados como texto plano
// ----------------------------------------------------------------
// Para usar esta función solo deben incluir este php a donde necesite 
// y usarlo de la siguiente forma ej:
//    
// include "funciones/rtf2text.php";
// $reader = new RtfReader(); // reader es un nuevo objeto de clase RtfReader
// $rtf = $datos; // la variable $rtf seria el dato o string que vamos a convertir
// $reader->Parse($rtf);  // aquí el objeto RtfReader va a analizar la secuencia / estructura del dato
// $formatter = new RtfHtml(); // y ya por aquí lo vamos a formatear
// $laVariableQueVoyAUsar = $formatter->Format($reader->root); // el objeto reader final va a tener varias posiciones dentro de si la cual nos interesa el root donde están los datos que fueron formateados y los que podemos utilizar finalmente.
// ----------------------------------------------------------------
...
// ----------------------------------------------------------------
// me conecto al localhost para hacer pruebas
// prueba con do891
// ----------------------------------------------------------------
// $host = 'localhost';
// $userdb = 'medicaso_rootBase';
// $pass2 = '5qA?o]t6d-h25qA?o]t6d-h2';
// $DB = 'medicaso_ms_do891';
// $conn3 = mysqli_connect($host, $userdb, $pass2, $DB) or die('Ha fallado la conexion MySQL: ' . mysqli_error($conn3));

// $query = "SELECT * from drreceta limit 100";
// $result = mysqli_query($conn3, $query);
// $cont = 0;
// while ($row = mysqli_fetch_array($result)) {
//     $cont++;
//     echo $cont . '<br>';
//     // hacemos la conversion y miramos
//     $datos = $row['Medicamento'];
//     if (is_null($datos)) {
//         // nada
//         echo "Vacio";
//     } else {
