...
$queryList = mysqli_query($conn3, "SELECT * FROM  citas  where estado = 8 and estadoEspera=1  AND fecha = '$fechacitashoy' and doctor = '" . $_SESSION['ID'] . "' order by fecha asc ");
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="card-deck row">
                        ...
                        $queryList = mysqli_query($conn3, "SELECT * FROM citas WHERE estado = 8 AND estadoEspera = 1 AND doctor='$ID' AND fecha = '$fechahoycita' ORDER BY fecha ASC");
                        $nrowl = mysqli_num_rows($queryList);
                ...
                while ($RowMenu = mysqli_fetch_array($QueryMenu)) {
                    ...
                    foreach ($Arreglo_Grupos as $key => $value) {
                        ...
                        foreach ($ArregloMenuFinal as $key => $value) {
                            ...
                            echo "<button class=' btn btn-primary btn-block w-100 h-100' title='$value[Nombre]' style='{$ColorBoton};' onclick=\"window.location.href='$value[Ruta]'\">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-12">
                ...
                <div class="small-box bg-gradient-primary">
                    <div class="inner">
                        ...
                        if ($vista == "0") {
                            $query = mysqli_query($conn3, "SELECT COUNT(*) AS total FROM cliente ");
                        } else {
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-12">
                ...
                <div class="small-box bg-gradient-green">
                    <div class="inner">
                        ...
                        and idEmpresa = '{$_SESSION['ID']}'
                        ");
                        // $query = mysqli_query($conn3, "SELECT SUM(totalNeto - descuentos - montoPagado) AS totalMensual FROM sOperacionInv WHERE MONTH(fechaOperacion) = MONTH(CURRENT_DATE())");
                        // echo "SELECT SUM(totalNeto - descuentos - montoPagado) AS totalMensual FROM sOperacionInv WHERE MONTH(fecha) = MONTH(CURRENT_DATE())";
                        $row = mysqli_fetch_assoc($query);
            ...
            <div class="box-body ">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <button class="btn btn-block btn-outline-info btn-lg rounded-pill shadow"
                            onclick="toggleContent()">Crear Citas <i
                                class="fas fa-angle-down float-right mt-2"></i></button>
                    </div>
                    <div class="col-md-6">
                        <button class="btn btn-block btn-outline-info btn-lg rounded-pill shadow"
                            onclick="toggleContent1()">Crear Pacientes <i
                                class="fas fa-angle-down float-right mt-2"></i></button>
                    </div>


                    <div class="col-md-12 mt-3">
                        <label for="clienteIngreso">Paciente Ingreso</label>
                        <select class="form-control input-lg select2 w-100" name="clienteIngreso" id="clienteIngreso"
                            onchange="verIngresos({cliente_id: this.value, usuario_id: <?= $_SESSION['ID'] ?>})"
                            style="width: 100%;">
                            ...
                            <?php if (($_SESSION['vista'] == 0 || $_SESSION['vista'] == 1) and $_SESSION['sucursal'] != 0) {
                                ...
                                $query = "SELECT * FROM  cliente WHERE {$filtro} sucursal = '$sucursal' ORDER BY cliente_id";
                            } else if (($_SESSION['vista'] == 0 || $_SESSION['vista'] == 1)) {
                                $filtro = (($_SESSION['vista'] == 1) ? "WHERE usuario_id = '{$_SESSION['ID']}'" : '');
                                $query = "SELECT * FROM  cliente {$filtro} ORDER BY cliente_id";
                            }

                            $query_sql = mysqli_query($conn3, $query);
                            foreach ($query_sql as $key) {
                                echo "<option value='" . $key['cliente_id'] . "'>" . $key['nombre_cliente'] . "</option>";
                            }
                        ...
                        <div class="row center text-center justify-content-center mt-4">
                            <div class="col-md-6 col-md-6 text-center" id="div-Ingresos"></div>
                        </div>
                    </div>
                                ...
                                <form method="GET" action="agregarCitas">
                                    ...
                                    <div class="col-md-9">
                                        <select id="clienteId" name="clienteId" class="form-control select2"
                                            ...
                                            <?php
                                            $queryList = mysqli_query($conn3, "SELECT * FROM cliente order by nombre_cliente");
                                            $nrowl = mysqli_num_rows($queryList);
                                            while ($row_recordset32 = mysqli_fetch_array($queryList)) {
                                    ...
                                    <div class="col-md-3">
                                        <button class="btn btn-block btn-outline-info btn-lg rounded-pill shadow"> <i
                                                class="fa fa-glyphicon glyphicon-plus"></i> Agendar Cita <i
                                                class="fas fa-angle-down float-right mt-2"></i></button>
                                    </div>
                                </form>
                            </div>
                                        ...
                                        <form action="guardarCliente_escritorio.php" method="POST"
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <input type="text" class="form-control input-lg" name="CODI_CLIENTE"
                                                    id="CODI_CLIENTE" placeholder="" maxlength="20"
                                            ...
                                            <div id="Div_PreguntasFemenino" class="col-md-12 row"
                                                style="display:none;width:100%">

                                                <div class="form-group col-md-6">
                                                    <div align="left"> Fecha de ultimo parto </div>
                                                    <input type="date" class="form-control input-lg"
                                                        name="Arreglo[Fecha_Ultimo_Parto]" id="FechaUltimoParto">
                                                </div>

                                                <div class="form-group col-md-6">
                                                    <div align="left"> Fecha de ultima menstruación </div>
                                                    <input type="date" class="form-control input-lg"
                                                        name="Arreglo[Fecha_Ultima_Mestruacion]"
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input type="number" class="form-control input-lg"
                                                        name="Arreglo[Numero_Embarazos]" id="NumeroEmbarazos">
                                                </div>
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <center>
                                                    ...
                                                    <button type="submit"
                                                        ...
                                                        <i class="fa fa-glyphicon glyphicon-plus"></i>Guardar <i
                                                            class="fas fa-angle-down float-right mt-2"></i></button>
                ...
                <div class="row" style="text-align: center">
                    <div class="col-md-6">
                        ...
                        $resultado = mysqli_query($conn3, "SELECT * FROM sinvetrios where usuario_id = '$ID'");
                    ...
                    <div class="col-md-6">
                        ...
                        <tbody>
                            ...
                            $ID = $_SESSION['ID'];
                            $arrayDatosA = [];
                            $resultado = mysqli_query($conn3, "SELECT * FROM cliente where usuario_id = '$ID'");
                    ...
                    <div class="col-md-6">
                        ...
                        $resultado = mysqli_query($conn3, "SELECT * FROM Historia_Clinica where usuario_id = '$ID'");
