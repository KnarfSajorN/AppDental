  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Pacientes Terapia Respiratoria
         
      </h1>
      <ol class="breadcrumb">
        <li><a href="portada"><i class="fa fa-dashboard"></i> Escritorio</a></li>
        <li><a href="#">Pacientes Terapia Respiratoria </a></li>
      </ol>
    </section>
      ...
      ?>
          ...
          <div class="box">
            <div class="box-header">
              <a href="nuevoPaciente_quirurgico">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  echo'<td><a href="historiaClinica20_terapiaRespiratoria.php?clienteId='.$fila[0].'" title="Agregar Cita">'.$fila[2].' </a></td>';
                  ...
                  echo '<a href="historiaClinica20_terapiaRespiratoria.php?clienteId='.$fila[0].'" title="Agregar Consulta"><i class="fa fa-heartbeat"></i> </a>|';
                 
               
 
                  echo '<a href="ConsultaUrologia.php?clienteId='.$fila[0].'" title="Ver Historia"><i class="fa fa-search"></i> </a> |';
