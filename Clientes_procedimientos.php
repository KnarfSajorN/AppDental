              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  echo '     <tr>';
                   ...
                   echo'<td><a href="procedimientos.php?clienteId='.$fila[0].'" title="">'.$fila[2].' </a></td>';
                  ...
                  echo '<a href="procedimientos.php?clienteId='.$fila[0].'" title="Agregar Acciones"><i class="fa fa-heartbeat"></i> </a>|';  
               
                  echo '<a href="consultaCliente_accionesProcedimientos.php?clienteId='.$fila[0].'" title="Ver Historia"><i class="fa fa-search"></i> </a> |';
