      ...
      <div class="col-xs-12">
        ...
        <div class="box">
          ...
          <div class="box-body">
            ...
            <!-- FIN PERSONALIZADO -->
            <form class="form-horizontal" action="guardarHistoriaClinica_laboral" method="POST" enctype="multipart/form-data">
                                  ...
                                  <div class="box-body">
                                    ...
                                    <style type="text/css">
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          <td class="tg-0lax">Procesamiento sensorial: propiocepcion</td>
