<?php
 ...
 //  include 'menu.php'; 
    ...
    $con=conectar();
        ...
        $acompananteFamiliar1         = reem($_POST['acompananteFamiliar']);   
        $telefono_acompanante         = reem($_POST['telefono_acompanante']);   
        $parentesco         = reem($_POST['parentesco']);   
        

$acompananteFamiliar = $acompananteFamiliar1.' '.$parentesco;



        $antecedentesP         = reem($_POST['antecedentesP']);   
        $antecedentesF         = reem($_POST['antecedentesF']);   

strlen($antecedentesF)
if (strlen($antecedentesP) > 0) {$RantecedentesP = 'Antecedentes Personales : '.$antecedentesP.'<br> ';}
if (strlen($antecedentesF) > 0) {$RantecedentesF = 'Antecedentes FAmiliares : '.$antecedentesF.'<br> ';}
 
$antecedentes = $RantecedentesP.$RantecedentesF;
...
if ($e14 <> '') {$ei14 = ' Notas  : '.$e14.'<trong> | </trong>';}
...
if (strlen($e24)> 0) {$ei24 = ' Notas   : '.$e24.'<trong> | </trong>';}
...
if (strlen($e36)> 0) {$ei36 = ' Notas   : '.$e36.'<trong> | </trong>';}
...
if (strlen($e44)> 0) {$ei44 = ' Notas   : '.$e44.'<trong> | </trong>';}
...
// *********************************************************    TABLA  historiaClinica1 *********************************************************
mysqli_query($conn3,"INSERT INTO historiaClinica1 (cliente_id, usuario_id, Fecha, Hora, motivoConsulta, diagnostico, tratamiento, notas, recipe, incapacidades, cie10, rSistema, enfermedadActual, acompananteFamiliar, telefono_acompanante, paraClinicos, remision, diagnosticoMsalud, comoTomarlo, antecedentes) VALUES 
  ('$clienteId', '$ID', '$fechar', '$hora', '$motivoConsulta', '$diagnostico', '$tratamiento', '$notas',  '$recipe', '$incapacidades', '$cie10', '$rSistema', '$enfermedadActual', '$acompananteFamiliar', '$telefono_acompanante', '$paraClinicos', '$remision', '$diagnosticoMsalud', '$comoTomarlo', '$antecedentes');");
// *********************************************************    TABLA  historiaClinica1 *********************************************************
// *********************************************************    TABLA  historiaClinica1 *********************************************************
