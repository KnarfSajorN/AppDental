...
columnastablas=[
                ...
                { "data": function ( row, type, set ) {
                        botones="";
                        botones+="<a href='GraficasCrecimiento.php?clienteId="+row.cliente_id+"&Tipo=Peso x Edad' title='Grafica Peso / Edad'><i class='fa fa-line-chart' style='color:#7699fd;'></i> </a>";
                        botones+="<a href='GraficasCrecimiento.php?clienteId="+row.cliente_id+"&Tipo=Estatura x Edad' title='Grafica Estatura / Edad'><i class='fa fa-line-chart' style='color:#ba60c5;'></i> </a>";
                        botones+="<a href='GraficasCrecimiento.php?clienteId="+row.cliente_id+"&Tipo=Circunferencia de Cabeza' title='Grafica Circunferencia'><i class='fa fa-line-chart' style='color:#edde27;'></i> </a>";
                        botones+="<a href='GraficasCrecimiento.php?clienteId="+row.cliente_id+"&Tipo=IMC' title='Grafica IMC'><i class='fa fa-line-chart' style='color:#6a27ed;'></i> </a>";
                        return botones;
                        }
                } 
