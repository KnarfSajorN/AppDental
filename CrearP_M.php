...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <ol class="breadcrumb">
            <li><a href="portada"><i class="fa fa-dashboard"></i> Directorio a</a></li>
            <li><a href="#"> Directorio b</a></li>
        </ol>
    </section>
...
<label for="">Fecha</label>
                            ...
                            <?php if ($_GET['clienteId'] <> "") : ?>
                                <div class="col-sm-12">
                                    <br>
                                    <input type="hidden" name="arreglo_id" id="cliente_id" value="<?php echo $_GET['clienteId'] ?>">
