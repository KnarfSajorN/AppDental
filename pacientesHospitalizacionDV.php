...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <ol class="breadcrumb">
      ...
      <li><a href="#">Pacientes Hospitalizacion</a></li>
    </ol>
  </section>
  <!-- Main content -->
  <section class="content">
    <div class="">
      <div class="col-md-12">
        <h4 class="Titulo_Pagina">Pacientes Hospitalización</h4>
        <?php
        $msg = $_GET['msg'];
        if ($msg == '1') {
  ...
  columnastablas = [{
    ...
    },
    {
      "data": function(row, type, set) {
        botones = "";
        botones += "<a href='ingresoHospitalizacion.php?cI=<?=salt()?>" + btoa(row.cliente_id) + "' title='Ingresar a Hospitalización'><i class='fas fa-file-medical'></i></a>";
        botones += "<a href='historialHospitalizacion.php?idC=" + (row.cliente_id) + "' title='Ver historial'><i class='fas fa-book-medical'></i> </a>";
