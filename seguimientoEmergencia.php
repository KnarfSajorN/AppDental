...
if ($_POST['evolucion'] && !$_POST['editar']) {
    ...
    $queryResult = mysqli_query($conn3, "INSERT INTO seguimientoEmergencia SET idCliente = $idCliente, idDoctor = $idDoctor, idHistoria = $historiaClinica1, evolucion = '$evolucion'");
    if (!$queryResult) {
        var_dump(mysqli_error_list($conn3));
    } else {
        echo '<script>location.href = "seguimientoEmergencia.php?historiaClinica1=' . $historiaClinica1 . '&cliente=' . $clienteId . '"</script>';
    }
}
...
if ($_POST['editar']) {
    ...
    $evolucion = $_POST['evolucion'];
    $id = $_POST['editar'];
    $queryResult = mysqli_query($conn3, "UPDATE seguimientoEmergencia SET evolucion = '$evolucion' WHERE id = $id AND idCliente = $idCliente AND idDoctor = $idDoctor AND idHistoria = $historiaClinica1");
    if (!$queryResult) {
        var_dump(mysqli_error_list($conn3));
    } else {
        echo '<script>location.href = "seguimientoEmergencia.php?historiaClinica1=' . $historiaClinica1 . '&cliente=' . $clienteId . '"</script>';
...
if ($_GET['edit']) {
    $id = $_GET['edit'];
    $queryList = mysqli_query($conn3, "SELECT * FROM seguimientoEmergencia where id = $id AND idCliente= '$clienteId' and  idHistoria='$historiaClinica1' order by id desc");
            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <form action="seguimientoEmergencia.php?historiaClinica1=<?= $historiaClinica1 ?>&cliente=<?= $clienteId ?>" method="POST" name="formularioActualizarcliente " enctype="multipart/form-data">
                ...
                <div id="collapseOne" class="collapse show" role="tabpanel" aria-labelledby="headingOne">
                    <div class="card-block">
                        ...
                        <div class="form-row">
                            ...
                            $queryList = mysqli_query($conn3, "SELECT * FROM seguimientoEmergencia where idCliente= '$clienteId' and  idHistoria='$historiaClinica1' order by id desc");
                            //  echo "SELECT * FROM  historiaClinica1 where cliente_id = $clienteId and usuario_id = $usuarioId order by ID DESC";
                            $nrowl = mysqli_num_rows($queryList);
                                ...
                                <div class="col-xs-12 table-responsive">
                                    <table class="table table-striped">
                                        ...
                                        <td width="100%">
                                            ...
                                            <a href="seguimientoEmergencia.php?historiaClinica1=<?= $historiaClinica1 ?>&cliente=<?= $clienteId ?>&edit=<?= $id ?>" title="Modificar Seguimiento"><i class="fa fa-pencil"></i> MODIFICAR SEGUIMIENTO</a>
