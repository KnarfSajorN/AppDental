...
$tabla = mysqli_query($conn3, "SHOW TABLES LIKE 'RIAS_HistoriaInfancia'");
$nrowtabla = mysqli_num_rows($tabla);
if ($nrowtabla == 0) {
    $query = "CREATE TABLE `RIAS_HistoriaInfancia` ( 
...
foreach ($ArregloCamposAdicionales as $key => $value) {
    $Campo1 = mysqli_query($conn3, "show COLUMNS from RIAS_HistoriaInfancia WHERE Field = '$value';");
    $nrowCampo1 = mysqli_num_rows($Campo1);
    if ($nrowCampo1 == "0") {
        mysqli_query($conn3, "ALTER TABLE `RIAS_HistoriaInfancia` ADD `$value` TEXT NULL ");
    }
}
...
////////////////////////////////////////? 1.2 Consumos y hábitos alimentarios [FIN] /////////////////////////////////////
...
////////////////////////////////////////? 1.3 Prácticas y hábitos saludables  ////////////////////////////////////////
...
////////////////////////////////////////? 1.3 Prácticas y hábitos saludables [FIN] /////////////////////////////////////
...
$ArregloCamposAdicionales=["DesarolloAprendizaje"];
...
foreach (eliminarElementosVacios($_POST['Anamnesis']['DesarolloAprendizaje']) as $key => $value) {

    $ArregloAntecedentes['DesarolloAprendizaje'][$key]=$value;

}

////////////////////////////////////////? 1.4 Desarrollo y aprendizaje [FIN] /////////////////////////////////////
...
$ArregloCamposAdicionales=["PracticasCrianzaCuidado_FormasComunicacion","PracticasCrianzaCuidado_Actividades"];
...
$ArregloCamposAdicionales=["RendimientoEscolar_ComportamientoAprendizaje","RendimientoEscolar_GOODENOUGHT","RendimientoEscolar_DatosTestGoodenough",
"ValoracionDesarollo_MotricidadGruesa","ValoracionDesarollo_MotricidadFinoAdaptativa","ValoracionDesarollo_AudicionLenguaje","ValoracionDesarollo_PersonalSocial","ValoracionDesarollo_TamizajeA_MCHARF","ValoracionDesarollo_TamizajeA_MCHARF_Seguimiento","ValoracionDesarollo_Interpretacion", "ValoracionDesarrollo_jsonDataEscala", "ValoracionDesarrollo_EscalaAbreviadaTablaPuntuacionHTML"];
...
foreach (eliminarElementosVacios($_POST['ExamenFisico']['RendimientoEscolar']) as $key => $value) {
    
    if (in_array('RendimientoEscolar_'.$key, $ArregloCamposAdicionales)) {
        if(is_array($value)){

            foreach ($value as $key_2 => $value_2) {
                $ArregloAntecedentes['RendimientoEscolar_'.$key][$key_2]=$value_2;
            }

        }else{
            $ArregloAntecedentes['RendimientoEscolar_'.$key]=$value;
        }
    }
}
...
////////////////////////////////////////? 2.2 Valoración del desarrollo y rendimiento escolar [FIN] /////////////////////////////////////
...
$ArregloCamposAdicionales=["SaludSexual_Signos","SaludSexual_Ninas","SaludSexual_Ninos","SaludSexual_Intersexuales","SaludSexual_Otros","SaludSexual_EscalaTanner"];
...
$ArregloCamposAdicionales=["SaludBucal_Valoracion","SaludBucal_ValoracionEstructuras"];
...
$ArregloCamposAdicionales=["SaludMental_Valoracion","SaludMental_RQC","SaludMental_RQCInterpretacion","SaludMental_RQCPuntaje"];
...
//echo "INSERT INTO RIAS_HistoriaInfancia (usuario_id,cliente_id,{$Campos},Familiograma_Archivo,Ecomapa_Archivo) VALUES ('$usuario_id','$cliente_id',{$Valores},'$Familiograma','$Ecomapa');";

$queryList = mysqli_query($conn3, "INSERT INTO RIAS_HistoriaInfancia (usuario_id,cliente_id,{$Campos},Familiograma_Archivo,Ecomapa_Archivo) VALUES ('$usuario_id','$cliente_id',{$Valores},'$Familiograma','$Ecomapa');") or die(mysqli_error($conn3));
...
$Recetario_Nombre_Historia = "RIAS_HistoriaInfancia";
...
echo "<script language='Javascript'> window.location='RIAS_Finalizado_Infancia.php?id=$Historia_id';</script>";
//echo "<button class='btn btn-primary' onclick='window.location=`RIAS_Finalizado_Infancia.php?id=$Historia_id`'>Finalizar</button>";
