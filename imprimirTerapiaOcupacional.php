...
include("funciones/funcionesUtilidades.php");
            ...
            $historiaClinica1 = $_GET['historiaClinica1'];
                ...
                $queryList=mysqli_query($conn3,"SELECT * FROM    historiaClinicaTerapia_Ocupacional where id =  $historiaClinica1");
                ...
                while($rowMotorizado=mysqli_fetch_array($queryList))
                {
                  ...
                  $Valoracion         =$rowMotorizado['valoracion'];
                 $seguimiento        =$rowMotorizado['seguimiento'];
           ...
           $queryList=mysqli_query($conn3,"SELECT * FROM  config where ID_Usuario = $usuario_id");
            ...
            while($rowMotorizado=mysqli_fetch_array($queryList))
            {
              ...
              if (strlen($LogoF) > 0) 
              {
                $Logo = '<img src="'.$Base.'logos/'.$LogoF.'" height="110" width="110">'; 
              }
...
<div class="row">
 ...
 <h2 align="center">  HISTORIA TERAPIA OCUPACIONAL </h2>
 <div class="col-xs-3">
