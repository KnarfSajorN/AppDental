...
<div class="col-md-12">
  ...
  <a class="btn btn-primary" href="imagenologia.php?clienteId=<?php echo $clienteId;?>" role="button"> <i class="fa fa-heartbeat"></i>  Nueva Orden </a>
...
<br>
          ...
          <div class="nav-tabs-custom">
            ...
            <!--    <li class="active"><a href="#Consultas" data-toggle="tab">Historia Clínica</a></li>
              ...
              <li><a href="#Examenes" data-toggle="tab">Imagenologia</a></li>
            </ul>
  ...
  <div class="tab-pane" id="Examenes">
      <hr align="center" size="10" width="100%" color="#000000">
           <h3>
           Registros de Ordenes de Imagenologia    </h3>  
                  ...
                  <div class="box-header with-border">
                    <h4 class="box-title">
                      <a data-toggle="collapse" data-parent="#accordion" href="#<?php echo $ID?>">
                        Fecha / Hora <?php echo $Fecha; ?> <a href="imprimirImagenologia.php?historiaClinica1=<?php echo $ID?>" title="Imprimir Consulta" target="_blank"><i class="fa fa-print"></i> </a>
                      </a>
                    </h4>
                  </div>
