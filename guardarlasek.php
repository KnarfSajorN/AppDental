...
include("../conexiones/conexionP.php");
    $con=conectar();
      //  echo "1";
        ...
        $Fecha                         = $_POST['Fecha'];                        
        $Hora                          = $_POST['Hora'];                         
        $numaeroLasek                   = $_POST['numaeroLasek'];                  
 ...
 */           
      //  echo "4  ";
                ...
                //insetamos el usuario
                    $queryUsuario = "INSERT INTO historiaLasek (cliente_id, usuario_id, CODI_CLIENTE, Fecha, Hora, numaeroLasek, Descripcion, biomicroscopia, diagnostico, plan) VALUES ('$cliente_id' ,'$usuario_id' ,'$CODI_CLIENTE' ,'$Fecha' ,'$Hora' ,'$numaeroLasek' ,'$Descripcion' ,'$biomicroscopia' ,'$diagnostico' ,'$plan ')";
