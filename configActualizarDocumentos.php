C<?php
  ...
  include 'configFunciones.php';
      ...
      mysqli_query($conn3,"update configDocumentos set consentimiento = '$consentimiento', nombre = '$nombre', firma= '$firma' where id = $idConsentimiento;");
 ...
 echo "<script language='Javascript'> window.location='configDocumentos.php?men=2';</script>";  
