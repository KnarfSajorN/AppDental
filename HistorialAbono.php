       ...
       <div class="row">
         <div class="col-md-12">
               ...
               <div class="container-fluid" style="padding: 20px;">
                 ...
                 <div class="table-responsive" style="overflow: auto;">
                  ...
                  <th><div align="right">Monto Pagado Nuevo</div></th> antiguo modulo-->
                     ...
                     <tbody>
                       <?php
                        ...
                        while ($rowMotorizado = mysqli_fetch_array($queryList)) {
                          ...
                          echo '     <tr ' . $Color . '>
                    <td>' . $id . ' </td>
                    <td> Operacion # ' . $numero_operacion . ' /  #' . $numero_documento . ' </td>
                    <td>' . $fecha . '</td>
                    <td>' . $hora . '</td>
                    <td>' . funcionMaster($pago,'id','Nombre','Medios_Pago') . '</td>
                    ...
                    <td> 
                      <a title="Imprimir comprobante con plantilla 1" href="ImprimirAbono.php?idOperacion=' . $numero_operacion . '&idAbono=' . $id . '"><i class="iconify" data-icon="ph:newspaper-clipping-bold" style="font-size:25px;position:relative;top:5px;"></i></a>
                      <a title="Imprimir comprobante con plantilla 2" class="text-success" href="ImprimirAbonoF2?idOperacion=' . $numero_operacion . '&idAbono=' . $id . '"><i class="iconify" data-icon="ph:newspaper-clipping-bold" style="font-size:25px;position:relative;top:5px;"></i></a>
                    </td>';
                        ?>
                         <td>
                           <a href="AnularAbonoC.php?idOperacion=<?php echo $numero_operacion; ?>&idAbono=<?php echo $id; ?>" onclick="showConfirmationAlert(event)">
                       ...
                       <?php
                          if (strlen($firma) > 1) {
                            ...
                            echo '<td> <a href="EnviarAbono.php?idOperacion=' . $numero_operacion . '&idAbono=' . $id . '"><i class="iconify" data-icon="bx:bx-mail-send" style="font-size:25px;position:relative;top:5px;"></i> Enviar Confirmación del Abono</a> </td>
                        </tr>';
                          }
           ...
           <div class="box">
             <form action="AbonoRegistrar.php" method="POST" name="formularioActualizarcliente">
               <div class="box-header" align="center">
                 <h2>Abonos Anulados #<?php echo $numeroDoc ?></h2>
               </div>
               <!-- /.box-header -->
               <div class="container-fluid" style="padding: 20px;">
                 <div class="table-responsive" style="overflow: auto;">
                   <table id="example1" class="table table-bordered table-striped">
                     ...
                     <tbody>
                       <?php
                        ...
                        $queryList = mysqli_query($conn3, "SELECT * FROM  abono where  numero_operacion = '$idOperacion' and activo= 0");
                        $nrowl = mysqli_num_rows($queryList);
                        while ($rowMotorizado = mysqli_fetch_array($queryList)) {
                          $id = $rowMotorizado['id'];
                          $numero_operacion = $rowMotorizado['numero_operacion'];
   ...
   <?php
    include 'footer.php';
//<td> 
// <a href="ImprimirAbono.php?idOperacion=' . $numero_operacion . '&idAbono=' . $id . '"><i class="iconify" data-icon="ph:newspaper-clipping-bold" style="font-size:25px;position:relative;top:5px;"></i> Imprimir comprobante</a>
// </td>
    ?>