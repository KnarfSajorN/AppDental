    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="card-body">
          <h4 class="card-title">Profesion  </h4>
          <br>
...
<?php echo $respuesta;?>
 ...
 <div class="form-group col-md-12">
      Descripción 
          ...
          <center>
    <button type="submit" class="btn btn-block btn-primary btn-sm" name="registro_profesion"> <h4> <strong>  Guardar  </strong> </h4> </button></center>
...
$conn3 = mysqli_connect($host,$userdb,$pass2,$DB)or die ('Ha fallado la conexion MySQL: '.mysqli_error($conn3));
                 ...
                 $queryListA=mysqli_query($conn3,"SELECT * FROM  c_profesion  order by id");
