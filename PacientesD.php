...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="box">
      <div class="col-md-12">
        <h4 class="Titulo_Pagina">Pacientes Escalas Dermatológicas</h4>
  ...
  columnastablas = [{
    ...
    },
    {
      "data": function(row, type, set) {
        botones = "";
        botones += "<a href='hced?cI=<?=salt()?>" + btoa(row.cliente_id) + "' title='Agregar Historia'><i class='fas fa-file-medical'></i> </a>";
        botones += "<a href='hcedVerPaciente?cI=<?=salt()?>" + btoa(row.cliente_id) + "' title='Ver Historial'><i class='fas fa-book-medical'></i> </a>";
