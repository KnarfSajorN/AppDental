   ...
   <div class="content-wrapper p-3">
              ...
              -->
               ...
               <div class="col-md-12">
                 ...
                 <form class="row" action="index.php" method="post">
                   ...
                   <select id="status" name="status" class="form-control select2" onChange="mostrar(this.value);" style="width: 40%;">
                     ...
                     <option value="servicio4">Mesoterapia Facial </option>
                     <option value="servicio5">Mesoterapia Capilar</option>
                     <option value="servicio6">Mesoterapia Corporal </option>
               ...
               <div id="servicio1" class="element" style="display: none;">
                 <div class="col-md-12">
                   ...
                   <form class="row" class="form-horizontal" action="guardarHistoriaClinica2_v2.php" method="POST" enctype="multipart/form-data" id="FormularioHistoriaClinica_1">

                     <!-- ********************************************************************************************************************************
     ********************************************************    Tratamiento Corporal    ********************************************
     ******************************************************************************************************************************** -->

                     <div class="form-group col-md-12"> Tratamiento </div>
                     ...
                     <div class="form-group col-md-12">
                       <font size="4"> Antecedentes adicionales </font>
                     </div>
                     <div class="form-group col-md-7">
                       <input type="text" class="form-control input-lg" id="s" name="antA" step="any">
                     </div>
                     ...
                     <div class="form-group col-md-4">
                       <font size="4">% Grasa </font>

                       <input type="number" class="form-control input-lg" id="to12" name="to12" step="any">
                     </div>

                     <div class="form-group col-md-4">
                       <font size="4">% Musculo </font>

                       <input type="number" class="form-control input-lg" id="to13" name="to13" step="any">
                     </div>

                     <div class="form-group col-md-4">
                       <font size="4"> Grasa visceral </font>

                       <input type="number" class="form-control input-lg" id="to14" name="to14" step="any">
                     </div>
                     ...
                     <div class="form-group col-md-3">
                       ...
                       <input type="number" class="form-control input-lg 1" id="peso1" name="peso" onChange="calcularimc1();" step="any">
                     </div>

                     <div class="form-group col-md-3">
                       <div align="left">Altura en <strong> Centímetros </strong></div>
                       <input type="number" class="form-control input-lg 1" id="altura1" name="altura" onChange="calcularimc1();" step="any">
                     </div>

                     <div class="form-group col-md-3">
                       <div align="left"> Índice de masa corporal </div>
                       <input type="number" class="form-control input-lg 1" id="imc1" name="imc" step="any">
                     </div>

                     <div class="form-group col-md-3">
                       <div align="left">Composición corporal</div>
                       <input type="text" class="form-control input-lg 1" id="ComposicionCorporal1" name="ComposicionCorporal">
                     </div>
               ...
               <div id="servicio2" class="element" style="display: none;">
                 ...
                 <form class="row" class="form-horizontal" action="guardarHistoriaClinica2_v2.php" method="POST" enctype="multipart/form-data" id="FormularioHistoriaClinica_2">
     ...
     ******************************************************************************************************************************** -->
                   ...
                   <div class="col-md-12">
                    <textarea id="motivoConsulta" name="AntecedentesFamiliar" class="textarea" placeholder="Antecedentes Familiar" style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" required></textarea>
                   </div>
                   ...
                   <div align="center" class="col-md-12 row">
                     ...
                     <div class="form-group col-md-8">
                       <label>Clasificación de Ritides Facial </label>
                       <select name="to52" class="form-control select2" data-placeholder="Seleccionar" style="width: 100%;" tabindex="-1" aria-hidden="true">
                         ...
                         <option value="Clase 1 : Elastosis leve, con pequeños cambios de textura y aparición de líneas discretamente acentuadas sobre la piel.">
                           Clase 1 : Elastosis leve, con pequeños cambios de textura y aparición de
                           líneas discretamente acentuadas sobre la piel.
                         </option>
                         <option value="Clase 2: Elastosis moderada, con pápulas de elastosis que se distinguen de la piel normal por su color amarillento y traslúcido bajo luz directa y discreta discromía.">Clase 2: Elastosis moderada, con pápulas de elastosis que se distinguen de
                           la piel normal por su color amarillento y traslúcido bajo luz directa y
                           discreta discromía.
                         </option>
                         <option value="value3">Clase 3:Elastosis severa, elastosis multipapular y concluyente con piel
                           pálida y amarilla, además de aparición de arrugas profundas romboidales.
                     ...
                     <div class="form-group col-md-4">
                       ...
                       <select name="to53" class="form-control select2" data-placeholder="Seleccionar" style="width: 100%;" tabindex="-1" aria-hidden="true">
                         ...
                         <option value="Con acné">Con acné</option>
                     ...
                     <div class="form-group col-md-4">
                       ...
                       <select name="to54" class="form-control select2" data-placeholder="Seleccionar" style="width: 100%;" tabindex="-1" aria-hidden="true">
                     ...
                     <div class="form-group col-md-4">
                       <label>Textura</label>
                       <select name="to55" class="form-control select2" data-placeholder="Seleccionar" style="width: 100%;" tabindex="-1" aria-hidden="true">
                     ...
                     <div class="form-group col-md-4">
                       <label> Piel </label>
                       <select name="to56" class="form-control select2" data-placeholder="Seleccionar" style="width: 100%;" tabindex="-1" aria-hidden="true">
                         <option value="Normal">Normal </option>
                   ...
                   <div class="row">
                     <div class="col-md-12 row">
                       ...
                       <div class="form-group col-md-4">
                         <label>Según lesión predominante - Acne </label>
                         <select name="to57" class="form-control select2" data-placeholder="Seleccionar" style="width: 100%;" tabindex="-1" aria-hidden="true">
                           <option value="Comedónico">Comedónico</option>
                           <option value="Pápulo-pustuloso<">Pápulo-pustuloso</option>
                           <option value="Nódulo-quístico">Nódulo-quístico</option>
                           <option value="-"> - </option>
                         </select>
                       </div>
                       ...
                       <div class="form-group col-md-4">
                         <label>Según grado de severidad</label>
                         <select name="to58" class="form-control select2" data-placeholder="Seleccionar" style="width: 100%;" tabindex="-1" aria-hidden="true">
                           <option value="Leve < de 20">Leve < de 20</option>
                           <option value="Moderado 20-50">Moderado 20-50</option>
                           <option value="Severo > de 50">Severo > de 50</option>
                           <option value="-"> - </option>
                         </select>
                       </div>
                       ...
                       <div class="form-group col-md-4">
                         <label>Formas especiales</label>
                         <select name="to59" class="form-control select2 select2-hidden-accessible" data-placeholder="Seleccionar" style="width: 100%;" tabindex="-1" aria-hidden="true">
                           <option value="Fulminans">Fulminans</option>
                           <option value="Conglobata">Conglobata</option>
                           <option value="-"> - </option>
                       ...
                       <div class="form-group col-md-12">
                         ...
                         <input type="checkbox" class="minimal" id="to38" name="to59a">
                         <br>
                         Cuales
                         <input type="text" class="form-control input-lg" name="to59b"> <br>
                       ...
                       <div class="form-group col-md-12">
                         ...
                         <input type="text" class="form-control input-lg" name="cAcne2">
                       </div>
                       <br>
                       <div class="form-group col-md-12">
                       ...
                       <div class="form-group col-md-12">
                        ...
                        <!--
                       <div class="form-group col-md-3">
                         <input type="checkbox" class="minimal" id="to40a" name="to40a">
                         <font size="4">T/A </font>
                       </div>
                       <div class="form-group col-md-3">
                         <input type="checkbox" class="minimal" id="to41a" name="to41a">
                         <font size="4">F/C </font>
                       </div>
                       <div class="form-group col-md-3">
                         <input type="checkbox" class="minimal" id="to42a" name="to42a">
                         <font size="4">F/R </font>
                       </div>
                       <div class="form-group col-md-3">
                         <input type="checkbox" class="minimal" id="to43a" name="to43a">
                         <font size="4">T </font>
                       </div>
                        -->
                        ...
                        <div class="form-group col-md-3">
                          <font size="4">T/A </font>
                         <input type="text" class="form-control input-lg" id="to40a" name="to40a">
                         
                       </div>
                       <div class="form-group col-md-3">
                        <font size="4">F/C </font>
                         <input type="text" class="form-control input-lg" id="to41a" name="to41a">
                         
                       </div>
                       <div class="form-group col-md-3">
                        <font size="4">F/R </font>
                         <input type="text" class="form-control input-lg" id="to42a" name="to42a">
                         
                       </div>
                       <div class="form-group col-md-3">
                        <font size="4">T </font>
                         <input type="text" class="form-control input-lg" id="to43a" name="to43a">
                       ...
                       <div class="form-group col-md-3">
                         <div align="left">Peso en KG</div>
                         <input type="number" class="form-control input-lg 2" id="peso2" name="peso" onChange="calcularimc2();" step="any">
                       </div>

                       <div class="form-group col-md-3">
                         <div align="left">Altura en <strong> Centímetros </strong></div>
                         <input type="number" class="form-control input-lg 2" id="altura2" name="altura" onChange="calcularimc2();" step="any">
                       </div>

                       <div class="form-group col-md-3">
                         <div align="left"> Índice de masa corporal </div>
                         <input type="number" class="form-control input-lg 2" id="imc2" name="imc" step="any">
                       </div>

                       <div class="form-group col-md-3">
                         <div align="left">Composición corporal</div>
                         <input type="text" class="form-control input-lg 2" id="ComposicionCorporal2" name="ComposicionCorporal">
                       </div>
             ...
             <div id="servicio3" class="element" style="display: none;">
               <div class="col-md-12">
                 ...
                 <form class="row" class="form-horizontal" action="guardarHistoriaClinica2_v2.php" method="POST" enctype="multipart/form-data" id="FormularioHistoriaClinica_3">
...
líneas discretamente acentuadas sobre la piel.
          ...
          <option value="Clase 2: Elastosis moderada, con pápulas de elastosis que se distinguen de
la piel normal por su color amarillento y traslúcido bajo luz directa y
discreta discromía." >Clase 2: Elastosis moderada, con pápulas de elastosis que se distinguen de
la piel normal por su color amarillento y traslúcido bajo luz directa y
discreta discromía.
          </option>
           <option value="value3">Clase 3:Elastosis severa, elastosis multipapular y concluyente con piel
        ...
        <div class="row">
          <div class="col-md-12">
             ...
             <div class="form-group col-md-4">
                <label>Según lesión predominante - Acne </label>
                <select name="to57" class="form-control select2"  data-placeholder="Seleccionar" style="width: 100%;" tabindex="-1" aria-hidden="true">
                  <option>Comedónico</option>
                  <option>Pápulo-pustuloso</option>
                  <option>Nódulo-quístico</option>
                  <option> - </option>
                 </select>
            </div> 
             ...
             <div class="form-group col-md-4">
                <label>Según grado de severidad</label>
                <select name="to58" class="form-control select2"data-placeholder="Seleccionar" style="width: 100%;" tabindex="-1" aria-hidden="true">
                  <option>Leve < de 20</option>
                  <option>Moderado 20-50</option>
                  <option>Severo > de 50</option>
                  <option> - </option>
                 </select>
            </div> 
             ...
             <div class="form-group col-md-4">
                <label>Formas especiales</label>
                <select name="to59" class="form-control select2 select2-hidden-accessible" data-placeholder="Seleccionar" style="width: 100%;" tabindex="-1" aria-hidden="true">
                  <option>Fulminans</option>
                  <option>Conglobata</option>
                  <option> - </option>
...
-->
           ...
           <div id="servicio4" class="element" style="display: none;">
             <div class="col-md-12">
               ...
               <form class="row" class="form-horizontal" action="guardarHistoriaClinica2_v2.php" method="POST" enctype="multipart/form-data" id="FormularioHistoriaClinica_4">

                 <div class="col-sm-12" align="center">
                   <h3> Mesoterapia Facial </h3>
                 </div>
                 <input type="hidden" name="tratamiento" value="4">
                 ...
                 <div class="col-sm-12">
                   ...
                   <div class="row">
                     ...
                     <div class="form-group col-md-3">
                       <div align="left">Peso en KG</div>
                       <input type="number" class="form-control input-lg 3" id="peso3" name="peso" onChange="calcularimc3();" step="any">
                     </div>

                     <div class="form-group col-md-3">
                       <div align="left">Altura en <strong> Centímetros </strong></div>
                       <input type="number" class="form-control input-lg 3" id="altura3" name="altura" onChange="calcularimc3();" step="any">
                     </div>

                     <div class="form-group col-md-3">
                       <div align="left"> Índice de masa corporal </div>
                       <input type="number" class="form-control input-lg 3" id="imc3" name="imc" step="any">
                     </div>

                     <div class="form-group col-md-3">
                       <div align="left">Composición corporal</div>
                       <input type="text" class="form-control input-lg 3" id="ComposicionCorporal3" name="ComposicionCorporal">
                     </div>
                   </div>
         ...
         <div id="servicio5" class="element" style="display: none;">
           <div class="col-md-12">
             ...
             <form class="row" class="form-horizontal" action="guardarHistoriaClinica2_v2.php" method="POST" enctype="multipart/form-data" id="FormularioHistoriaClinica_5">
               ...
               <div class="col-sm-12">
                 ...
                 <div class="form-group col-md-3">
                   <div align="left">Peso en KG</div>
                   <input type="number" class="form-control input-lg 4" id="peso4" name="peso" onChange="calcularimc4();" step="any">
                 </div>

                 <div class="form-group col-md-3">
                   <div align="left">Altura en <strong> Centímetros </strong></div>
                   <input type="number" class="form-control input-lg 4" id="altura4" name="altura" onChange="calcularimc4();" step="any">
                 </div>

                 <div class="form-group col-md-3">
                   <div align="left"> Índice de masa corporal </div>
                   <input type="number" class="form-control input-lg 4" id="imc4" name="imc" step="any">
                 </div>

                 <div class="form-group col-md-3">
                   <div align="left">Composición corporal</div>
                   <input type="text" class="form-control input-lg 4" id="ComposicionCorporal4" name="ComposicionCorporal">
                 </div>
                 </div>
       ...
       <div id="servicio6" class="element" style="display: none;">
         <div class="col-md-12">
           ...
           <form class="row" class="form-horizontal" action="guardarHistoriaClinica2_v2.php" method="POST" enctype="multipart/form-data" id="FormularioHistoriaClinica_6">
             <div class="col-sm-12" align="center">
               <h3> Mesoterapia Corporal </h3>
             </div>
             <input type="hidden" name="tratamiento" value="6">
             ...
             <div class="col-sm-12">
               ...
               <div class="form-group col-md-3">
                 <div align="left">Peso en KG</div>
                 <input type="number" class="form-control input-lg 5" id="peso5" name="peso" onChange="calcularimc5();" step="any">
               </div>

               <div class="form-group col-md-3">
                 <div align="left">Altura en <strong> Centímetros </strong></div>
                 <input type="number" class="form-control input-lg 5" id="altura5" name="altura" onChange="calcularimc5();" step="any">
               </div>

               <div class="form-group col-md-3">
                 <div align="left"> Índice de masa corporal </div>
                 <input type="number" class="form-control input-lg 5" id="imc5" name="imc" step="any">
               </div>

               <div class="form-group col-md-3">
                 <div align="left">Composición corporal</div>
                 <input type="text" class="form-control input-lg 5" id="ComposicionCorporal5" name="ComposicionCorporal">
               </div>
               </div>
  ...
  $(document).on('input', 'input[type="text"], textarea', function() {
   ...
   <script type="text/javascript">
     ...
     function calcularimc5() {
       m1 = document.getElementById("peso5").value;
       m2 = document.getElementById("altura5").value;

       r4 = m1 / ((m2 / 100) * (m2 / 100));

       document.getElementById("imc5").value = r4.toFixed(2);
       ...
       document.getElementById("ComposicionCorporal5").value = ComposicionCorporal4;
...
$HistoriasClinicasAutoguardado_id='"FormularioHistoriaClinica_1", "FormularioHistoriaClinica_2", "FormularioHistoriaClinica_3","FormularioHistoriaClinica_4","FormularioHistoriaClinica_5","FormularioHistoriaClinica_6"';//importante para las historias multiples, mantener estructura de comillas simples y dobles
