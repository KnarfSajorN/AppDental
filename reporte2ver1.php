      ...
      <div class="col-xs-12 table-responsive">
        <table class="table table-striped" border="1">
          ...
          <tbody>
            ...
            if ($tipo == 0) {
              ...
              $queryList = mysqli_query($conn3, "SELECT * FROM  sOperacionInv  where activo = 1 and (ID_principal = '{$_SESSION['ID']}' or ID_principal = '{$_SESSION['ID_principal']}') and idEmpresa = $tipo and fechaOperacion BETWEEN '$desde' and '$hasta' and tipo IN (1, 7) order by numeroDoc asc ");
            }
            $sumtotalNeto = 0;
            $summontoPagado = 0;
        ...
        <div class="col-xs-12 table-responsive">
          ...
          if ($tipo == 0) {
            ...
            $queryList = mysqli_query($conn3, "SELECT * FROM  sOperacionInv  where (ID_principal = '{$_SESSION['ID']}' or ID_principal = '{$_SESSION['ID_principal']}') and idEmpresa = $tipo and fechaOperacion BETWEEN '$desde' and '$hasta' and tipo IN (1, 7) order by numeroDoc asc");
          }
          ...
          <table class="table table-striped" border="1">
            ...
            <tbody>
              ...
              if ($tipo == 0) {
                ...
                left join sOperacionInv sin on sdmp.idOperacion = sin.idOperacion
                INNER JOIN Medios_Pago mp ON sdmp.metodo_pago = mp.id 
                WHERE sdmp.fechaRegistro BETWEEN '$desde' AND '$hasta'  and sin.idEmpresa = $tipo
                and (sin.ID_principal = '{$_SESSION['ID']}' or sin.ID_principal = '{$_SESSION['ID_principal']}')
                and sin.tipo IN (1, 7)
                GROUP BY mp.Nombre");
              }
        ...
        <div class="col-xs-12 table-responsive">
          ...
          <h5> <b>Total Gasto: </b> <?= number_format($totalGasto,2) ?> </h5> <h5> <b>Total Egreso: </b> <?= number_format($totalEgreso,2) ?> </h5>    
        ...
        <table class="table table-striped" border="1">
          ...
          <tbody>
            ...
            if ($tipo == 0) {
              ...
              $queryList = mysqli_query($conn3, "SELECT * FROM  sOperacionInv  where activo = 1 and (ID_principal = '{$_SESSION['ID']}' or ID_principal = '{$_SESSION['ID_principal']}') and idEmpresa = $tipo and fechaOperacion BETWEEN '$desde' and '$hasta' and tipo IN (1, 7) ");
            }
            $sumtotalNeto = 0;
            $summontoPagado = 0;
            if ($queryList) {
