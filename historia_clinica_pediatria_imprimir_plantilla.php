...
$queryList = mysqli_query($conn3, "SELECT * FROM  Historia_Clinica_Pediatria where id = $Historia_id");
...
while ($rowMotorizado = mysqli_fetch_array($queryList)) {
  ...
  $queryList = mysqli_query($conn3, "SELECT firma FROM  firmas where historia_id = $Historia_id and historia_nombre = 'Historia_Clinica_Pediatria'");
      $nrowl = mysqli_num_rows($queryList);
      while ($rowMotorizado = mysqli_fetch_array($queryList)) {
...
<body> -->
                    <table class="table" style="width: 100%;margin-top: 3px;">
                        ...
                        ?>
                            ...
                            <?php
                            $Historia_Nombre = "Historia_Clinica_Pediatria";
                            ...
                            ?>
                                ...
                                <table class="table table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                        <?php
                                        if($Observaciones_Imagen!=""){
                                            echo "<tr><td colspan='2'>Notas de Imagenología:<br>  $Observaciones_Imagen</td></tr>";
                                        }
                                        ?>
                                    </tbody>
                                    <thead>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                        <?php
                                        if($Observaciones_Labora!=""){
                                            echo "<tr><td colspan='2'>Notas de Laboratorio:<br> $Observaciones_Labora</td></tr>";
                                        }
                                        ?>
                                    </tbody>
                                </table>
