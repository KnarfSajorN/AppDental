...
if ($_GET['idConsentimiento']) {
    ...
    $queryList=mysqli_query($conn3,"SELECT * FROM  configConsentimientos where id=$idConsentimiento");
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#"> Consentimientos </a></li>
...
<!-- *********************************************  ********************************************* -->
 ...
 <form action="configActualizarConsentimientos.php" method="POST">
              ...
              <div class="col-md-12"> <font size="1"> <h3 align="center">Editar Consentimientos </h3> </font></div>
...
<?php if ($idConsentimiento == ''): ?>
 ...
 <form action="configGuardarConsentimientos.php" method="POST">
 

              <div class="box-body">
                      
            
              <div class="col-md-12"> <font size="1"> <h3 align="center">Agregar Nuevo Consentimientos </h3> </font></div>
              <div class="form-group col-md-9">
                  <div align="left">Título</div>
...
<br>
  ...
  <div class="box-body">
              ...
              $queryListhc=mysqli_query($conn3,"SELECT * from configConsentimientos where activo = 1");
              ...
              while($rowhc=mysqli_fetch_array($queryListhc))
              {
                ...
                $name=$rowhc['fecha'];
                      ...
                      <font color="#04CC05"> <a href="configConsentimientos.php?idConsentimiento='.$id.'"> <i class="fa fa-pencil" title="Editar" name="Virtual"></i>  </a></font>

                       <font color="#04CC05"> <a href="configPreliminarConsentimiento.php?id='.$id.'"> <i class="fa fa-eye" title="ver" name="Virtual"></i>  </a></font>
