...
<hr>  
  ...
  <a class="btn btn-primary" href="historiaClinica_accionesAcondicionamiento.php?clienteId=<?php echo $clienteId;?>" role="button"> <i class="fa fa-heartbeat"></i>  Nueva consulta </a>
 
      <a class="btn btn-primary" href="reportes_accionesAcondicionamiento.php?clienteId=<?php echo $clienteId;?>" role="button"> <i class="fa fa-search"></i>  Reportes de historial </a>                                  
     </div>
<br>
          ...
          <hr align="center" size="10" width="100%" color="#000000">
           ...
           Consultas
                  ...
                  $queryList=mysqli_query($conn3,"SELECT * FROM  historiaacondicionamiento where cliente_id = $clienteId order by ID DESC");
...

                  {
                      ...
                      $nume        = $row_recordset32['numero'];      
                      $tema           = $row_recordset32['tema'];      
                      ...
                      $objetivo           = $row_recordset32['objetivo']; 
                      $participacion           = $row_recordset32['participacion'];      
                      $desarrollo           = $row_recordset32['desarrollo'];      
                      $desempeno           = $row_recordset32['desempeno'];      
                      $reflexiones           = $row_recordset32['reflexiones'];    
                      $numeduc           = $row_recordset32['numeduc'];  
                      $temaeduc           = $row_recordset32['temaeduc'];  
                      $objetivoeduc           = $row_recordset32['objetivoeduc'];  
                      $desarrolloeduc           = $row_recordset32['desarrolloeduc'];  
                      $reflexioneseduc           = $row_recordset32['reflexioneseduc']; 
                     ?>
                  ...
                  <div class="box-header with-border">
                    <h4 class="box-title">
                      <a data-toggle="collapse" data-parent="#accordion" href="#<?php echo $ID?>">
                        Fecha <?php echo $Fecha .'-'.$Hora.' Numero: '. $nume.'  Tema: '.$tema?> <a href="finalizado.php?historiaClinica1=<?php echo $ID?>" title="Imprimir Consulta" target="_blank"><i class="fa fa-print"></i> </a>
                      </a>
                    </h4>
                  </div>
              ...
              <?php if (strlen($objetivo)>0): ?>
              <div>
              <label>objetivo :</label>
              <label>  <?php echo $objetivo?></label>
               
              </div>
              <?php endif ?>

             
              <?php if (strlen($participacion)>0): ?>
              <div>
              <label> participacion:</label>
              <label>  <?php echo $participacion?></label>
              ...
              <?php if (strlen($desarrollo)>0): ?>
              <div>
              <label> desarrollo:</label>
              <label>  <?php echo $desarrollo?></label>
              ...
              <?php if (strlen($desempeno)>0): ?>
              <div>
              <label> desempeno:</label>
              <label>  <?php echo $desempeno?></label>
              ...
              <?php if (strlen($reflexiones)>0): ?>
              <div>
              <label> reflexiones:</label>
              <label>  <?php echo $reflexiones?></label>
               
              </div>
              <?php endif ?>

              <?php if (strlen($numeduc)>0): ?>
              <div>
              <label> numeduc:</label>
              <label>  <?php echo $numeduc?></label>
               
              </div>
              <?php endif ?>


              <?php if (strlen($temaeduc)>0): ?>
              <div>
              <label> temaeduc:</label>
              <label>  <?php echo $temaeduc?></label>
               
              </div>
              <?php endif ?>


              <?php if (strlen($objetivoeduc)>0): ?>
              <div>
              <label> objetivoeduc:</label>
              <label>  <?php echo $objetivoeduc?></label>
               
              </div>
              <?php endif ?>
 

              <?php if (strlen($desarrolloeduc)>0): ?>
              <div>
              <label> desarrolloeduc:</label>
              <label>  <?php echo $desarrolloeduc?></label>
               
              </div>
              <?php endif ?>


              <?php if (strlen($reflexioneseduc)>0): ?>
              <div>
              <label> reflexioneseduc:</label>
              <label>  <?php echo $reflexioneseduc?></label>
