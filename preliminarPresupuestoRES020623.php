...
<a class="btn btn-block btn-primary btn-sm" target="_blank" href="<?php echo $Base;?>enviarPresupuestoP.php?cliente=<?php echo $idCliente;?>&idr=<?php echo $idr;?>&idOperacion=<?php echo $idOperacion?>"> 
