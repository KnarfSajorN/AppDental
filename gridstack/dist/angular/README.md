...
The Angular [wrapper component](projects/lib/src/lib/gridstack.component.ts) <gridstack> is a better way to use Gridstack, but alternative raw [ngFor](projects/baseDev/src/app/ngFor.ts) or [simple](projects/baseDev/src/app/simple.ts) demos are also given.
...
## Demo
You can see a fuller example at [app.component.ts](projects/baseDev/src/app/app.component.ts)

to build the demo, go to [angular/projects/demo](projects/baseDev/) and run `yarn` + `yarn start` and navigate to `http://localhost:4200/` 
