...
!(function (e, t) {
  ...
  (() => {
    ...
    class i {
      ...
      static samePos(e, t) {
        return (
          e && t && e.x === t.x && e.y === t.y && e.w === t.w && e.h === t.h
        );
      }
    ...
    class s {
      ...
      sortNodes(e = 1, t = this.column) {
        return (this.nodes = i.sort(this.nodes, e, t)), this;
      }
      _packNodes() {
        return (
          this.batchMode ||
      ...
      nodeBoundFix(e, t) {
        ...
        if (
          ...
          let t = { ...e };
          t.autoPosition ? (delete t.x, delete t.y) : (t.x = Math.min(11, t.x)),
            (t.w = Math.min(12, t.w)),
      ...
      moveNodeCheck(e, t) {
        ...
        if (!o) return !1;
        let r = n.moveNode(o, t) && n.getRow() <= this.maxRow;
        ...
        return (
          ...
          this.nodes.forEach((s) => {
            let r = o?.find((e) => e._id === s._id),
              l = { ...s };
            r && ((l.x = r.x), (l.y = r.y), (l.w = r.w)),
              i.removeInternalForSave(l, !e),
              t && t(s, l),
              n.push(l);
          }),
          n
      ...
      columnChanged(e, t, s, o = "moveScale") {
        if (!this.nodes.length || !t || e === t) return this;
        const n = "compact" === o || "list" === o;
        n && this.sortNodes(1, e),
        ...
        if (1 === t && s?.length) {
          ...
          s.forEach((t) => {
            ...
            (r = s),
            (s = []);
        } else s = n ? this.nodes : i.sort(this.nodes, -1, e);
        if (t > e && this._layouts) {
          const i = this._layouts[t] || [];
          let o = this._layouts.length - 1;
          !i.length &&
            e !== o &&
            this._layouts[o]?.length &&
            ((e = o),
            this._layouts[o].forEach((e) => {
              let t = s.find((t) => t._id === e._id);
              t && (n || ((t.x = e.x), (t.y = e.y)), (t.w = e.w));
            })),
            i.forEach((e) => {
              let t = s.findIndex((t) => t._id === e._id);
              if (-1 !== t) {
                if (n) return void (s[t].w = e.w);
                (e.autoPosition || isNaN(e.x) || isNaN(e.y)) &&
                  this.findEmptyPosition(e, r),
                  e.autoPosition ||
                    ((s[t].x = e.x),
                    (s[t].y = e.y),
                    (s[t].w = e.w),
        ...
        if (n) this.compact(o, !1);
        else {
          if (s.length)
            if ("function" == typeof o) o(t, e, r, s);
            else if (!l) {
              let i = n || "none" === o ? 1 : t / e,
                l = "move" === o || "moveScale" === o,
                h = "scale" === o || "moveScale" === o;
              s.forEach((s) => {
                (s.x =
      ...
      cacheOneLayout(e, t) {
        ...
        e.autoPosition && (delete i.x, delete i.y, (i.autoPosition = !0)),
    ...
    class v {
      ...
      _init() {
        ...
        return (
          ...
          e.classList.add(`${v.prefix}${this.dir}`),
          (e.style.zIndex = "100"),
          ...
          l &&
            (this.el.addEventListener("touchstart", p),
            this.el.addEventListener("pointerdown", c)),
          this
        );
      }
      destroy() {
        return (
          ...
          l &&
            (this.el.removeEventListener("touchstart", p),
            this.el.removeEventListener("pointerdown", c)),
      ...
      _mouseDown(e) {
        (this.mouseDownEvent = e),
          ...
          l &&
            ...
            this.el.addEventListener("touchend", u)),
          e.stopPropagation(),
          e.preventDefault();
      }
      _mouseMove(e) {
    ...
    class y extends f {
      ...
      _setupHelper() {
        return (
          (this.elOriginStyleVal = y._originStyleProp.map(
            (e) => this.el.style[e]
          )),
      ...
      _cleanHelper() {
        return (
          y._originStyleProp.forEach((e, t) => {
    ...
    class b extends f {
      ...
      enable() {
        !1 !== this.disabled &&
          ...
          l &&
            (this.dragEl.addEventListener("touchstart", p),
            this.dragEl.addEventListener("pointerdown", c)),
      ...
      disable(e = !1) {
        !0 !== this.disabled &&
          ...
          l &&
            (this.dragEl.removeEventListener("touchstart", p),
            this.dragEl.removeEventListener("pointerdown", c)),
        ...
        if (!r.mouseHandled)
          return (
            0 !== e.button ||
              ...
              document.addEventListener("mouseup", this._mouseUp, !0),
              l &&
                (this.dragEl.addEventListener("touchmove", g),
                this.dragEl.addEventListener("touchend", u)),
              e.preventDefault(),
      ...
      _mouseUp(e) {
        if (
          ...
          document.removeEventListener("mouseup", this._mouseUp, !0),
          l &&
            (this.dragEl.removeEventListener("touchmove", g, !0),
            this.dragEl.removeEventListener("touchend", u, !0)),
          this.dragging)
        ) {
          delete this.dragging,
      ...
      _getDragOffset(e, t, s) {
        ...
        if (s) {
          ...
          s.removeChild(e), (o = t.left), (n = t.top);
        }
        const r = t.getBoundingClientRect();
        return {
          left: r.left,
          top: r.top,
          offsetLeft: -e.clientX + r.left - o,
    ...
    class w extends f {
      ...
      _mouseLeave(e) {
        ...
        const t = i.initEvent(e, { target: this.el, type: "dropout" });
        if (
          (this.option.out && this.option.out(t, this._ui(r.dragElement)),
          this.triggerEvent("dropout", t),
          r.dropElement === this)
        ) {
          let t;
          delete r.dropElement;
    ...
    class E {
      static init(e) {
        return e.ddElement || (e.ddElement = new E(e)), e.ddElement;
      }
      constructor(e) {
        this.el = e;
      }
      ...
      setupResizable(e) {
        return (
          this.ddResizable
            ...
            : (this.ddResizable = new y(this.el, e)),
          this
        );
      }
      cleanResizable() {
    ...
    const x = new (class {
      ...
      _getDDElements(e, t = !0) {
        ...
        if (!s.length) return [];
        let o = s.map((e) => e.ddElement || (t ? E.init(e) : null));
        return t || o.filter((e) => e), o;
      }
    })();
    class R {
      static init(e = {}, t = ".grid-stack") {
        let s = R.getGridElement(t);
        return s
          ? (s.gridstack || (s.gridstack = new R(s, i.cloneDeep(e))),
            s.gridstack)
          : ("string" == typeof t
              ? console.error(
      ...
      static initAll(e = {}, t = ".grid-stack") {
        ...
        return (
          R.getGridElements(t).forEach((t) => {
            t.gridstack || (t.gridstack = new R(t, i.cloneDeep(e))),
              s.push(t.gridstack);
          }),
          0 === s.length &&
            console.error(
      ...
      constructor(e, t = {}) {
        ...
        let h = {
          ...
          removableOptions: {
            accept: t.itemClass ? "." + t.itemClass : o.removableOptions.accept,
          },
        };
        e.getAttribute("gs-animate") &&
          (h.animate = i.toBool(e.getAttribute("gs-animate"))),
          (this.opts = i.defaults(t, h)),
          (t = null),
          this._initMargin(),
          1 !== this.opts.column &&
        ...
        let a = i.closestUpByClass(this.el, o.itemClass)?.gridstackNode;
        a &&
          ((a.subGrid = this),
          (this.parentGridItem = a),
          this.el.classList.add("grid-stack-nested"),
          a.el.classList.add("grid-stack-sub-grid")),
          ...
          this._isAutoCellHeight || "initial" === this.opts.cellHeight
            ...
            : ("number" == typeof this.opts.cellHeight &&
                ...
                this.opts.cellHeightUnit !== o.cellHeightUnit &&
          ...
          "mobile" === this.opts.alwaysShowResizeHandle &&
            (this.opts.alwaysShowResizeHandle = l),
          (this._styleSheetClass = "gs-id-" + s._idSeq++),
          this.el.classList.add(this._styleSheetClass),
          this._setStaticClass();
        let d = this.opts.engineClass || R.engineClass || s;
        if (
          ((this.engine = new d({
          ...
          let e = this.opts.children;
          delete this.opts.children, e.length && this.load(e);
        }
        this.setAnimation(this.opts.animate),
          this._updateStyles(),
          this.el.classList.add("gs-" + this.opts.column),
          this.opts.subGridDynamic && !r.pauseDrag && (r.pauseDrag = !0),
          void 0 !== this.opts.draggable?.pause &&
            (r.pauseDrag = this.opts.draggable.pause),
      ...
      addWidget(e, t) {
        ...
        if ("string" == typeof e) {
          ...
          else if (R.addRemoveCB) s = R.addRemoveCB(this.el, t, !0, !1);
          else {
            let e = t?.content || "",
        ...
        return (
          ...
          this._writeAttr(s, t),
          this._insertNotAppend ? this.el.prepend(s) : this.el.appendChild(s),
          this.makeWidget(s, t),
          s
        );
      }
      makeSubGrid(e, t, s, o = !0) {
        ...
        let a,
          d,
          p = r.el.querySelector(".grid-stack-item-content");
        if (o) {
          if (
            (this._removeDD(r.el),
            (d = { ...r, x: 0, y: 0 }),
      ...
      load(e, t = R.addRemoveCB || !0) {
        let i = R.Utils.sort([...e], -1, this._prevColumn || this.getColumn());
        ...
        return (
          ...
          t &&
            [...this.engine.nodes].forEach((e) => {
              i.find((t) => e.id === t.id) ||
                (R.addRemoveCB && R.addRemoveCB(this.el, e, !1, !1),
                o.push(e),
                this.removeWidget(e.el, !0, !1));
            }),
          i.forEach((e) => {
            let i =
              void 0 !== e.id
                ...
                : void 0;
            if (i) {
              if ((this.update(i.el, e), e.subGridOpts?.children)) {
                let t = i.el.querySelector(".grid-stack");
                t &&
                  t.gridstack &&
                  (t.gridstack.load(e.subGridOpts.children),
                  (this._insertNotAppend = !0));
              }
            } else t && this.addWidget(e);
          }),
          (this.engine.removedNodes = o),
          this.batchUpdate(!1),
          delete this._ignoreLayoutsNodeChange,
          delete this._insertNotAppend,
          s ? (R.addRemoveCB = s) : delete R.addRemoveCB,
          this
        );
      }
      batchUpdate(e = !0) {
      ...
      column(e, t = "moveScale") {
        ...
        return (
          ...
          1 === e &&
            ...
            i.length || (i = void 0)),
          this.engine.columnChanged(s, e, i, t),
      ...
      makeWidget(e, t) {
        ...
        this._prepareElement(i, !0, t), this._updateContainerHeight();
        ...
        return (
          R.getElements(e).forEach((e) => {
            ...
            s || (s = this.engine.nodes.find((t) => e === t.el)),
              s &&
                (R.addRemoveCB && R.addRemoveCB(this.el, s, !1, !1),
        ...
        return (
          R.getElements(e).forEach((e) => {
            ...
            if (
              ...
              t && t.innerHTML !== o.content && (t.innerHTML = o.content),
                delete o.content;
            }
            let l = !1,
              h = !1;
            ...
            i.sanitizeMinMax(s),
              n &&
                (this.engine.cleanNodes().beginUpdate(s).moveNode(s, n),
                this._updateContainerHeight(),
                this._triggerChangeEvent(),
                this.engine.endUpdate()),
              l && this._writeAttr(e, s),
      ...
      _triggerRemoveEvent() {
        return (
          this.engine.batchMode ||
            (this.engine.removedNodes?.length &&
      ...
      _removeStylesheet() {
        return (
          this._styles &&
            (i.removeStylesheet(this._styleSheetClass), delete this._styles),
          this
        );
      }
      _updateStyles(e = !1, t) {
      ...
      _prepareElement(e, t = !1, s) {
        ...
        return (
          ...
          i.same(s, o) || this._writeAttr(e, s),
          this._prepareDragDropByNode(s),
          this
        );
      }
          ...
          this._isAutoCellHeight &&
            (!e && this.opts.cellHeightThrottle
              ? (this._cellHeightThrottle ||
                  (this._cellHeightThrottle = i.throttle(
                    () => this.cellHeight(),
        ...
        return (
          x
            ...
            .on(this.el, "drop", (e, t, s) => {
              ...
              if (n?.grid === this && !n._isExternal) return !1;
              let r = !!this.placeholder.parentElement;
              this.placeholder.remove();
              let l = t._gridstackNodeOrig;
              if (
                (delete t._gridstackNodeOrig, r && l?.grid && l.grid !== this)
              ) {
                let e = l.grid;
              ...
              if (!n) return !1;
              if (
                (r && (this.engine.cleanupNode(n), (n.grid = this)),
                x.off(t, "drag"),
                s !== t
                  ? (s.remove(),
                    (t.gridstackNode = l),
                ...
                return !1;
              (t.gridstackNode = n), (n.el = t);
              let h = n.subGrid?.el?.gridstack;
              return (
                i.copyPos(n, this._readAttr(this.placeholder)),
                i.removePositioningStyles(t),
                this._writeAttr(t, n),
                t.classList.add(o.itemClass, this.opts.itemClass),
        ...
        if (!this.opts.staticGrid && "string" == typeof this.opts.removable) {
          ...
          x.isDroppable(e) ||
            x
              ...
              .on(e, "dropover", (e, t) => this._itemRemoving(t, !0))
              .on(e, "dropout", (e, t) => this._itemRemoving(t, !1));
        }
        return this;
      }
          ...
          let s,
            ...
            l = (s) => {
              ...
              if (o.gridstackNode && o.gridstackNode.grid === this) {
                if (((e.el = o), e._isAboutToRemove)) {
                  let i = t.gridstackNode.grid;
                  i._gsEventHandler[s.type] && i._gsEventHandler[s.type](s, o),
                    this._removeDD(t),
                    i.engine.removedNodes.push(e),
                    i._triggerRemoveEvent(),
                    delete t.gridstackNode,
                    delete e.el,
                    t.remove();
                } else
                  i.removePositioningStyles(o),
                    e._temporaryRemoved
                      ? (i.copyPos(e, e._orig),
                        this._writePosAttr(o, e),
                        this.engine.addNode(e))
                      : this._writePosAttr(o, e),
                    this._gsEventHandler[s.type] &&
                      this._gsEventHandler[s.type](s, o);
                (this._extraDragRow = 0),
                  this._updateContainerHeight(),
                  this._triggerChangeEvent(),
                  this.engine.endUpdate();
      ...
      _onStartMoving(e, t, i, s, o, n) {
        this.engine.cleanNodes().beginUpdate(s),
          ...
          "resizestart" === t.type &&
            ...
            s.maxW && x.resizable(e, "option", "maxWidth", o * s.maxW),
            s.maxH && x.resizable(e, "option", "maxHeight", n * s.maxH));
      }
      _dragOrResize(e, t, s, o, n, r) {
        ...
        if (
          ...
          let l =
            ...
            u =
              s.position.top +
              (s.position.top > o._lastUiPosition.top ? -g : p);
          (h.x = Math.round(l / n)), (h.y = Math.round(u / r));
          ...
          if (
            ...
            (h.h = Math.round((s.size.height - p) / r)),
            o.w === h.w && o.h === h.h)
          )
            return;
        ...
        let m = {
          ...
          h: (s.size ? s.size.height : o.h * r) - p - g,
        };
        if (
          ...
          (o._lastUiPosition = s.position),
            this.engine.cacheRects(n, r, p, d, g, a),
            delete o._skipDown,
            l && o.subGrid && o.subGrid.onParentResize(),
            (this._extraDragRow = 0),
            this._updateContainerHeight();
          let e = t.target;
      ...
      _leave(e, t) {
        ...
        i &&
          ...
          i._temporaryRemoved ||
            ...
            !0 === this.opts.removable && this._itemRemoving(e, !0),
    ...
    return (R.Utils = i), (R.Engine = s), (R.GDRev = "8.3.0"), t.GridStack;
  })()
);
