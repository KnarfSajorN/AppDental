...
Check http://gridstackjs.com and [these demos](http://gridstackjs.com/baseDev/).
...
Please visit http://gridstackjs.com and [these demos](http://gridstackjs.com/baseDev/), and complete [API documentation](https://github.com/gridstack/gridstack.js/tree/master/doc)
...
- **knockout**: see [demo](https://gridstackjs.com/baseDev/knockout.html) using component, but check [custom bindings ticket](https://github.com/gridstack/gridstack.js/issues/465) which is likely better approach.
- **Rails**: [gridstack-js-rails](https://github.com/randoum/gridstack-js-rails)
- **React**: see [demo](https://gridstackjs.com/baseDev/react.html) with [src](https://github.com/gridstack/gridstack.js/tree/master/baseDev/react.html), or  [react-gridstack-example](https://github.com/Inder2108/react-gridstack-example/tree/master/src/App.js), or read on what [hooks to use](https://github.com/gridstack/gridstack.js/issues/735#issuecomment-329888796)
- **Vue**: see [demo](https://gridstackjs.com/baseDev/vue3js.html) with [v3 src](https://github.com/gridstack/gridstack.js/tree/master/baseDev/vue3js.html) or [v2 src](https://github.com/gridstack/gridstack.js/tree/master/baseDev/vue2js.html)
...
See example: [2 grids demo](http://gridstack.github.io/gridstack.js/baseDev/two.html) with 6 columns
...
See [example](http://gridstack.github.io/gridstack.js/baseDev/mobile.html).
