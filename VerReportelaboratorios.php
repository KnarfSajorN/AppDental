...
<body>
  ...
  <div class="row no-print">
        <div class="col-xs-12">  
          <a href="<?php echo $Base;?>reporteLaboratorios.php"   class="btn btn-default">  Regresar</a>
 ...
 <table align="center"><tr><td><h3><b>  REPORTE DE PEDIDOS DE LABORATORIO</b></h3> </td></tr>
...
$conn3 = mysqli_connect($host,$userdb,$pass2,$DB)or die ('Ha fallado la conexion MySQL: '.mysqli_error($conn3));
                  ...
                  $queryList=mysqli_query($conn3,"SELECT * FROM  laboratorios l, cliente c, usuarios u where l.fecha BETWEEN '$desde' and '$hasta' and l.cliente_id=c.cliente_id and l.usuario_id=u.ID  order by l.fecha asc  ");
       ...
       //echo  "SELECT * FROM  laboratorios l, cliente c, usuarios u where l.fecha BETWEEN '$desde' and '$hasta' and l.cliente_id=c.cliente_id and l.usuario_id=u.ID  order by l.fecha asc  ";
...

                  {
                      ...
                      $examen= $row_recordset32['descripcion'];
