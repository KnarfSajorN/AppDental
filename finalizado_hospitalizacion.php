<?php
  ...
  $historiaRip = $_GET['historiaRip'];



 $queryList=mysqli_query($conn3,"SELECT * FROM informacion_rips where ID = $historiaRip");
...
<a class="btn btn-app" target="_blank" href="<?php echo $Base;?>imprimir_hospitalizacion.php?historiaClinica1=<?php echo $historiaRip;?>"> 
...
<a class="btn btn-app" target="_blank" href="<?php echo $Base;?>SgenerarFactura.php?historiaClinica1=<?php echo $historiaRip;?>&clienteId=<?php echo $cliente_id;?>&tipo_historia=3 "> 
