...
$disableTools = 0 + $_GET['disableTools'];
$automaticForm = 0 + $_GET['automaticForm'];
...
<?php if ($disabled_medico == 0) : ?>
    ...
    <div class="col-md-12 center text-center">
        ...
        <p class="text text-muted">para guardar la imagen y el trazado favor oprimir "GUARDAR" al terminar </p>
        <a class="css-button-sharp--green1" data-action="undo"><i class="fa fa-undo"></i> - Deshacer</a>
        <a class="css-button-sharp--green4" onclick="clear1<?= $n ?>()"><i class="fas fa-trash-can"></i> - Limpiar</a>
        |
        <a class="css-button-sharp--green trazo" onclick="guardarTrazo<?= $n ?>()"><i class="fa fa-save"></i> - Guardar</a>
        <?php if ($automaticForm == 0) : ?>
            <input type="hidden" name="rayado[img<?= $n ?>]" id="img<?= $n ?>" class="RayadoAutoguardado" required>
        <?php else : ?>
            <input type="hidden" name="datos[img<?= $n ?>]" id="img<?= $n ?>" class="RayadoAutoguardado" required>
        <?php endif; ?>
