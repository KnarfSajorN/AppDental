...
// id_Historia
if (isset($_GET['id_Historia']) && !empty($_GET['id_Historia'])) {
    $historia = mysqli_query($conn3, "SELECT * FROM Historia_Cardiologia WHERE id = '{$_GET['id_Historia']}'");
    if (mysqli_num_rows($historia) > 0) {
...
<div class="content-wrapper">
  <!-- Content Header (Page header) -->
    <section class="content-header">
        <h1>Consulta Cardiología, Paciente: <?php echo $nombre_cliente . ', Edad: ' . CalculoEdadPaciente($fechaNacimiento); ?> </h1>
        <ol class="breadcrumb">
            <li><a href="portada"><i class="fa fa-dashboard"></i> Escritorio</a></li>
            <li><a href="#"> Consulta Cardiología </a></li>
        </ol>
    </section>
                        ...
                        <div class="col-md-12">
                          ...
                          <div class="row">
                            ...
                            <div class="col-12 col-md-3"></div>
                                ...
                                <form action="HC_Guardar_Cardiologia" method="POST" id="FormularioHistoriaClinica">
                                    <div class="box-body">
                                        ...
                                        <div class="box-group" id="accordion1">
                                            ...
                                            <div class="panel box box-primary">
                                                ...
                                                <div id="collapseTwo" class="panel-collapse collapse">
                                                    ...
                                                    <div class="box-body row">
                                                        <?php
                                                        if (!empty($_GET['id_Historia'])) {
                                                            list(
                                                                $nombreAcudienteArray,
                                                                $parentescoAcudienteArray,
                                                                $telefonoAcudienteArray,
                                                                $medicoRemiteArray,
                                                            ) = array_filter(explode('<br>', $historia['InformacionAcudiente']));
                                                            $nombreAcudienteArray = str_replace("Nombre Acudiente: ", "", $nombreAcudienteArray);
                                                            $parentescoAcudienteArray = str_replace("Parentesco Acudiente: ", "", $parentescoAcudienteArray);
                                                            $telefonoAcudienteArray = str_replace("Telefono Acudiente: ", "", $telefonoAcudienteArray);
                                                            $medicoRemiteArray = str_replace("Medico que remite: ", "", $medicoRemiteArray);
                                                        }
                                                        ?>
                                                        <div class="col-md-6">
                                                            <label>Nombre</label>
                                                            <input type="text" name="InformacionAcudiente[Nombre Acudiente]" value="<?= (!empty($_GET['id_Historia']) ? $nombreAcudienteArray : $acompananteFamiliar) ?>" class="form-control">
                                                        </div>

                                                        <div class="col-md-6">
                                                            <label>Parentesco</label>
                                                            <select class="form-control" name="InformacionAcudiente[Parentesco Acudiente]" class="form-control input-lg">
                                                                <?php if (!empty($_GET['id_Historia'])) { ?>
                                                                    <option value="<?= $parentescoAcudienteArray ?>" selected><?= $parentescoAcudienteArray ?></option>
                                                                <?php }
                                                                if ($parentesco_acompanante != '' && empty($_GET['id_Historia'])) { ?>
                                                                    <option value="<?= $parentesco_acompanante ?>" selected><?= $parentesco_acompanante ?></option>
                                                                <?php } else { ?>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="text" name="InformacionAcudiente[Teléfono Acudiente]" value="<?= (!empty($_GET['id_Historia']) ? $telefonoAcudienteArray : $telefono_acompanante) ?>" class="form-control">
                                                        </div>

                                                        <div class="col-md-6">
                                                            <label>Médico o Institución que Remite</label>
                                                            <input type="text" name="InformacionAcudiente[Médico que remite]" class="form-control" value="<?= (!empty($_GET['id_Historia']) ? $medicoRemiteArray : '') ?>">
                                                        </div>
                                            ...
                                            <div class="panel box box-primary">
                                                ...
                                                <div id="collapseThree" class="panel-collapse collapse">
                                                    <?php
                                                    if (!empty($_GET['id_Historia'])) {
                                                        $dataArray = array_filter(explode('<br>', $historia['EnfermedadActual']));
                                                        $dataKeys = array();
                                                        foreach ($dataArray as $key => $value) {
                                                            $value = explode(': ', trim($value));
                                                            $dataKeys[$value[0]] = $value[1];
                                                        }
                                                    }
                                                    ?>
                                                    <div class="box-body row">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <select name="EnfermedadActual[Tipo de Consulta]" class="form-control select2" style="width: 100%;">
                                                                <?php
                                                                if (empty($dataKeys["Tipo de Consulta"])) {
                                                                ?>
                                                                    <option selected="selected" value="">Seleccione tipo de consulta</option>
                                                                <?php
                                                                }
                                                                ?>
                                                                <option <?= $dataKeys["Tipo de Consulta"] == "Primera vez" ? 'selected' : '' ?>>Primera vez</option>
                                                                <option <?= $dataKeys["Tipo de Consulta"] == "Control" ? 'selected' : '' ?>>Control</option>
                                                                <option <?= $dataKeys["Tipo de Consulta"] == "Otro" ? 'selected' : '' ?>>Otro</option>
                                                            </select>
                                                        </div>

                                                        <div class="col-md-6">
                                                            <label>Nombre de la Consulta</label>
                                                            <input type="text" name="EnfermedadActual[Nombre de la Consulta]" class="form-control" value="<?= (!empty($_GET['id_Historia']) ? $dataKeys['Nombre de la Consulta'] : '') ?>">
                                                        </div>

                                                        <div class="form-group col-md-12">
                                                            <label>Motivo Consulta</label>
                                                            <textarea name="EnfermedadActual[Motivo de Consulta]" class="ejemplo" placeholder="Motivo Consulta" style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;margin: 0px;margin-top: 15px;max-width: 100%;"><?= (!empty($_GET['id_Historia']) ? $dataKeys['Motivo de Consulta'] : '') ?></textarea>
                                                        </div>
                                            ...
                                            <div class="panel box box-primary">
                                                <div class="box-header with-border">
                                                    <h4 class="box-title">
                                                        <a data-toggle="collapse" data-parent="#accordion1" href="#collapseThreeF">
                                                            Antecedentes
                                                        </a>
                                                    </h4>
                                                </div>
                                                <div id="collapseThreeF" class="panel-collapse collapse">
                                                    
                                                    <div class="box-body row">

                                                        <div class="form-group col-md-12">
                                                            <label>Antecedentes Personales</label>
                                                            <textarea name="Checks_Antecedentes[Antecedentes Personales]" class="ejemplo" placeholder="Antecedentes Personales" style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;margin: 0px;margin-top: 15px;max-width: 100%;"></textarea>
                                                        </div>


                                                        <div class="form-group col-md-12">
                                                            <label>Antecedentes Familiares</label>
                                                            <textarea name="Checks_Antecedentes[Antecedentes Familiares]" class="ejemplo" placeholder="Antecedentes Familiares" style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;margin: 0px;margin-top: 15px;max-width: 100%;"></textarea>
                                                        </div>
                                            ...
                                            <div class="panel box box-primary">
                                                ...
                                                <div id="collapseSix" class="panel-collapse collapse">
                                                    <?php
                                                    if (!empty($_GET['id_Historia'])) {
                                                        $dataArray = array_filter(explode('<br>', $historia['SignosVitales']));
                                                        $dataKeys = array();
                                                        foreach ($dataArray as $key => $value) {
                                                            $value = explode(': ', trim($value));
                                                            $dataKeys[$value[0]] = $value[1];
                                                    ...
                                                    <div class="box-body row">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="number" name="SignosVitales[Peso Corporal]" id="KG_peso" class="form-control input-lg" onchange="IMC();" step="0.01" value="<?= (!empty($_GET['id_Historia']) ? $dataKeys['Peso Corporal'] : $Peso) ?>">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="number" name="SignosVitales[Altura]" id="CM_altura" class="form-control input-lg" onchange="IMC();" step="0.01" value="<?= (!empty($_GET['id_Historia']) ? $dataKeys['Altura'] : $Altura) ?>">
                                                            <!-- <input type="number" name="SignosVitales[Altura]" id="CM_altura" class="form-control input-lg" onchange="IMC();" step="0.01" value=""> -->
                                                        </div>
                                                        <div class="col-md-4">
                                                            <label>Imc</label>
                                                            <input type="number" name="SignosVitales[Imc]" id="IMC_Paciente" class="form-control input-lg" step="0.01" value="<?= (!empty($_GET['id_Historia']) ? $dataKeys['IMC'] : $IMC) ?>">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="number" name="SignosVitales[Frecuencia Cardíaca]" class="form-control input-lg" step="0.01" value="<?= (!empty($_GET['id_Historia']) ? $dataKeys['Frecuencia Cardiaca'] : $Frecuencia_Cardiaca) ?>">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="number" name="SignosVitales[Presión Arterial Sistólica]" class="form-control input-lg" step="0.01" value="<?= (!empty($_GET['id_Historia']) ? $dataKeys['Presion Arterial Sistolica'] : $Presion_Arterial_Sistolica) ?>">

                                                        </div>

                                                        <div class="col-md-4">
                                                            <label>Presión Arterial Diastólica [mmHg]</label>
                                                            <input type="number" name="SignosVitales[Presión Arterial Diastólica]" class="form-control input-lg" step="0.01" value="<?= (!empty($_GET['id_Historia']) ? $dataKeys['Presion Arterial Diastolica'] : $Presion_Arterial_Diastolica) ?>">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="number" name="SignosVitales[Saturación Oxigeno]" class="form-control input-lg" step="0.01" value="<?= (!empty($_GET['id_Historia']) ? $dataKeys['Saturacion Oxigeno'] : $Saturacion_Oxigeno) ?>">
                                                        ...
                                                        <!-- <div class="col-md-4">
                                                            ...
                                                            <input type="number" name="SignosVitales[Presion Arterial]" class="form-control input-lg" step="0.01" value="<?php echo $Presion_Arterial; ?>">
                                            ...
                                            <div class="panel box box-primary">
                                                ...
                                                <div id="collapseSeven" class="panel-collapse collapse">
                                                    <?php
                                                    if (!empty($_GET['id_Historia'])) {
                                                        $laboratorioUpdate = $historia['Paraclinicos'];
                                                    }
                                                    ?>
                                                    <div class="box-body">
                                                        <?php
                                                        $queryList = mysqli_query($conn3, "SELECT * FROM Laboratorio_Imagen where cliente_id= '$clienteId' ");
                                                        if ($queryList) {
                                                            while ($rowMotorizado = mysqli_fetch_array($queryList)) {
                                                                $Imagenologia_P = $rowMotorizado['Imagenologia_P'];
                                                            }
                                                        }
                                                        
                                                        ?>
                                                        <div class="form-group col-md-12">
                                                            <textarea name="Paraclinicos" class="ejemplo" style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;margin: 0px;margin-top: 15px;max-width: 100%;"><?= (!empty($_GET['id_Historia']) ? $laboratorioUpdate : $Imagenologia_P) ?></textarea>
                                                        </div>
                                            ...
                                            <!-- <div class="panel box box-primary">
                                                <div class="box-header with-border">
                                                    <h4 class="box-title">
                                                        <a data-toggle="collapse" data-parent="#accordion1" href="#collapseEight">
                                                            Orden de Radiologia y Laboratorio
                                                        </a>
                                                    </h4>
                                                </div>
                                                <div id="collapseEight" class="panel-collapse collapse">
                                                    ...
                                                    <div class="box-body">
                                                        <label>Seleccione Orden de Radiologia</label>
                                                        ...
                                                        <label>Seleccione Orden de Laboratorio</label>
                                                                    ...
                                                                    <tr>
                                                                        <td <?= $optiongen1 ?>>
                                                                            <div> <input type="radio" value="1" name="niño2">
                                                                                ...
                                                                                <p><b>Estadio 1</b>. Sin vello púbico, Testicúlos y Pene infantil. </p>
                                                                            </div>
                                                                        </td>
                                                                        <td <?= $optiongen2 ?>>
                                                                            <div>
                                                                                ...
                                                                                <p><b>Estadio 1</b>. Pecho infantil, no vello púbico.</p>
                                                                            </div>
                                                                    ...
                                                                    <tr>
                                                                        <td <?= $optiongen1 ?>>
                                                                            <div>
                                                                                ...
                                                                                <p><b>Estadio 2</b>. Aumento del escroto y testículos, piel del escroto enrojecida y arrugada, pene infantil vello púbico escaso en la base del pene.</p>
                                                                            </div>
                                                                        </td>
                                                                        <td <?= $optiongen2 ?>>
                                                                            <div>
                                                                                ...
                                                                                <p><b>Estadio 2</b>. Botón mamario, vello púbico no rizado escaso, en labios mayores.</p>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td <?= $optiongen2 ?>>
                                                                            <div>
                                                                                ...
                                                                                <p><b>Estadio 3</b>. Aumento y elevación de pecho y areola. Vello rizado, basto y oscuro sobre pubis.</p>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td <?= $optiongen2 ?>>
                                                                            <div>
                                                                                ...
                                                                                <p><b>Estadio 4</b>. Areola y pezón sobreelevado sobre mama. Vello púbico tipo adulto no sobre muslos.</p>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td <?= $optiongen2 ?>>
                                                                            <div>
                                                                                ...
                                                                                <p><b>Estadio 5</b>. Pecho Adulto, areola no sobreelevada. Vello adulto zona medial muslo.</p>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                     ...
                     cierre de lista-->
                      ...
                      -->
                                            ...
                                            <div class="panel box box-primary">
                                                ...
                                                <div id="collapseFourteen" class="panel-collapse collapse">
                                                    ...
                                                    if (!empty($_GET['id_Historia'])) {
                                                        list(
                                                            $dxArray
                                                        ) = array_filter(explode('<br>', $historia['Impresion']));
                                                        $dxArray = trim(str_replace("Dx : ", "", $dxArray));
                                                    }
                                                    ?>
                                                    <div class="box-body">
                                                        <div class="col-md-12">
                                                            <textarea name="Impresion[Dx]" class="form-control input-lg" placeholder="" style="width: 100%; min-height: 60px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;max-width: 100%;"><?= (!empty($_GET['id_Historia']) ? $dxArray : $Imagenologia_P) ?></textarea>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="panel box box-primary">
                                                ...
                                                <div id="collapseFiveteen" class="panel-collapse collapse">
                                                    ...
                                                    if (!empty($_GET['id_Historia'])) {
                                                        list(
                                                            $conductaSeguirArray
                                                        ) = array_filter(explode('<br>', $historia['PlanManejo']));
                                                        $conductaSeguirArray = trim(str_replace("Plan de Manejo : ", "", $conductaSeguirArray));
                                                    }
                                                    ?>
                                                    <div class="box-body">

                                                        <div class="col-md-12">
                                                            <textarea name="PlanManejo[Conducta a Seguir]" class="form-control input-lg" placeholder="" style="width: 100%; min-height: 60px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;max-width: 100%;"><?= (!empty($_GET['id_Historia']) ? $conductaSeguirArray : $Imagenologia_P) ?></textarea>
                                                        </div>
                                            ...
                                            <!--<div class="panel box box-primary">
                                                <div class="box-header with-border">
                                                    <h4 class="box-title">
                                                        <a data-toggle="collapse" data-parent="#accordion1" href="#collapseArch">
                                                            Archivos
                                                    </h4>
                                                </div>
                                                <div id="collapseArch" class="panel-collapse collapse">
                                                    <div class="box-body">
                                                        <div class="container">
                                                            <div class="container">
                                                                <?php
                                                                ...
                                                                if ($queryImg) {
                                                                    while ($resulImg = mysqli_fetch_array($queryImg)) {
                                                                        $contador++;
                                                                        $imagen = $resulImg['codigo'];
                                                                        //echo '<img src="multiimages/'.$imagen.'">';
                                                                        echo '<div class="col-lg-6">
                                                                            <div class="card-group">
                                                                                <div class="col-md-4">
                                                                                    <a target="_blank" href="archivos/' . $imagen . '">
                                                                                        <img src="archivos/' . $imagen . '" height="150" >
                                                                                    </a>
                                                                                </div>
                                                                            </div>
                                                                        </div>';
                                ...
                                <div class="card-big-shadow">
                                    ...
                                    */
                                            ...
                                            <!--<div class="panel box box-primary">
                                                <div class="box-header with-border">
                                                    <h4 class="box-title">
                                                        <a data-toggle="collapse" data-parent="#accordion1" href="#collapsediag">
                                                            Diagnostico CIE-10
                                                        </a>
                                                    </h4>
                                                </div>
                                                <div id="collapsediag" class="panel-collapse collapse">
                                                    <button class="btn first" data-toggle="modal" data-target="#modalAgregarDiagnostico">
                                                        Agregar Diagnostico
                                                    </button>
                                                    <?php
                                                    if (!empty($_GET['id_Historia'])) {
                                                        $cie10Update = $historia['CIE10_1'];
                                                        // list(
                                                        //     $conductaSeguirArray
                                                        // ) = array_filter(explode('<br>', ));
                                                        // $conductaSeguirArray = trim(str_replace("Plan de Manejo : ", "", $conductaSeguirArray));
                                                    }
                                                    ?>
                                                    <div class="box-body">
                                                        <label>Diagnostico Principal</label>
                                                         onclick="LlenarDiagnostico('1');"
                                                        <select id="diagnostico1" name="CIE10" class="form-control select2" style="width: 100%;">
                                                            <option value=' '> Seleccione... </option>
                                                            <?php
                                                            if (!empty($_GET['id_Historia'])) {
                                                            ?>
                                                                <option value="<?= $cie10Update ?>" selected><?= $cie10Update ?> - <?= funcionMaster($cie10Update, 'codigo', 'descripcion', 'cie10') ?></option>
                                                            <?php
                                                            }
                                                            ?>
                                                        </select>
                                            ...
                                            if (!empty($_GET['id_Historia'])) {
                                            ?>
                                                <input type="hidden" name="id_Historia" value="<?= $_GET['id_Historia'] ?>">
                                            <?php
                                            }
                                            ?>
                                            <div class="col-sm-12">
...
<div class="modal fade" id="modalAgregarDiagnostico" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" id="insert_diagnostico" enctype="multipart/form-data">
                    <input type="hidden" class="form-control input-lg" name="ID_Examen" value="<?php echo $ID ?>" required>
                    <p class="statusMsg"></p>

                    <div class="form-group">

                        <label>Código</label>
                        <input type="text" class="form-control" name="codigo" onkeypress="return (event.charCode != 34 && event.charCode != 39)" value="" />



                        <label>Descripción </label>
                        <input type="text" class="form-control" name="descripcion" onkeypress="return (event.charCode != 34 && event.charCode != 39)" value="" />


                        <br>
                    </div>
                    <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                    <button type="submit" class="btn btn-success" id="insertardiagnostico">Crear</button>
                    <!-- <a href="#" onclick="Agregar_Examen();" class="btn btn-default" id="insertarexamen"> <i class="fa fa-glyphicon glyphicon-plus"></i> <strong> Crear </strong></a> -->
...
<script type="text/javascript">
    ...
    */
    ...
    $(document).ready(function() {
        $("#diagnostico1").select2({
            allowClear: true,
            ajax: {
                url: "ajax_GetDiagnostico.php",
                type: "POST",
                dataType: 'json',
                delay: 250,
                data: function(params) {
    ...
    // function LlenarDiagnostico(valor) {
    //     $("#diagnostico" + valor).select2({
    //         allowClear: true,
    //         ajax: {
    //             url: "ajax_GetDiagnostico.php",
    //             type: "POST",
    ...
    window.addEventListener('load', function() {
        ...
        $("#insert_diagnostico").on('submit', function(e) { // evento para agregar un nuevo item
            e.preventDefault();
            let data = new FormData(this);
            console.log(data);
            // obtenemos los campos que contiene el form
            $.ajax({
                url: "ajax_AgregarDiagnostico.php",
                method: "POST",
                data: data,
                contentType: false, // objeto necesario para trabajar con form data
                processData: false, // objeto necesario para trabajar con form data
                beforeSend: function() {
                    $('#insert').val("Inserting");
                },
                success: function(response) {
                    $('#insert_diagnostico')[0].reset();
                    ...
                    // $('#imagenologia_examen').append('<option value="' + userObj.id + '">' + userObj.nombre + '</option>');
                    // $('#imagenologia_examen').append($('<option>', {
                    //     value: userObj.id,
                    //     text: userObj.nombre
                    // }));
...
$Nombre_Tabla_autoguardado = "Historia_Cardiologia";
