                ...
                <div class="box" id="corteX">
                    ...
                    <tbody>
                        ...
                        while ($rowMotorizado = mysqli_fetch_array($queryList)) {
                            ...
                            <td> $totalNeto </td>";
                            if($Tipo=="Factura"){
                                echo"<td> <a href='DV_PreliminarDevolucion?idOperacion=$Devolucion_id' class='btn btn-block btn-outline-info rounded-pill shadow m-1' style='width:100%' ><i class='icon-file-invoice-dollar'></i> Preliminar Devolución </a> </td>";
                            }else if($Tipo=="Compra"){
                                echo"<td> <a href='DV_PreliminarDevolucionCompra?idOperacion=$Devolucion_id' class='btn btn-block btn-outline-info rounded-pill shadow m-1' style='width:100%' ><i class='icon-file-invoice-dollar'></i> Preliminar Devolución Compra </a> </td>";
                            }
