    ...
    <table>
        ...
        <tbody>
            ...
            <div class="col-md-12">
                ...
                if ((isset($historia['finalidad']) && is_countable($historia['finalidad'])) || (isset($historia['personaAtiende']) && is_countable($historia['personaAtiende'])) || (isset($historia['realizacionActoQuirurgico']) && is_countable($historia['realizacionActoQuirurgico']) )) {
                if (count($historia['finalidad']) > 0 || count($historia['personaAtiende']) > 0 || count($historia['realizacionActoQuirurgico']) > 0) : ?>
                    <div class="form-group" style="padding: 0; margin: 0;">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                if (is_countable($historia['finalidad'])) {
                    ...
                    <div class="form-group" style="padding: 0; margin: 0;">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                if (is_countable($historia['personaAtiende'])) {
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                if (is_countable($historia['realizacionActoQuirurgico'])) {
