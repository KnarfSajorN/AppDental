...
<head>
    ...
    <title>MedicalSoft | Registro de paciente</title>
    ...
    <div class="card col-md-6">
        <div class="card-body">
            <form method="post" action="registerPacientesForm.php">
                <img id="Animado" src="https://sievensoft.com/logosMarcas/logo.png" style="width:5em; height:auto;" class="mb-3">
                ...
                <div class="form-group" >
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" class="form-control" id="Documento" placeholder="Documento" name="CODI_CLIENTE">
                    </div>
                </div>
                ...
                <a class="btn btn-primary btn-block" onclick="buscarPaciente();" id="btnBuscar">Buscar</a>
