...
$queryList=mysqli_query($conn3,"SELECT firma FROM  abono where firma != '' AND id = '$idAbono'");
...
$montoAbonado = funcionMaster($idAbono,'id','valor_abonado','abono');
$usuario = funcionMaster($idAbono,'id','usuario_id','abono');
...
<body onselectstart="return false">
  ...
  <div id="signature-pad" class="signature-pad">
    <h1>El monto abonado es de : <?= number_format($montoAbonado,2).' '.$moneda?></h1>
...
<hr>
  ...
  <form action="<?= $Base ?>firma/AbonoFirmado" method="POST">
