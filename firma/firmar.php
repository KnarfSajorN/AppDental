...
//echo "INSERT INTO firmas (cliente_id, fecha, hora, historia_id, historia_nombre) VALUES ('$cliente', '$fecha', '$hora', '$id', '$tipo');";
         
        $idFirma = mysqli_insert_id($conn3);
        /*
...
if (strlen($firma)>10) 
{
      echo "<script>alert('Su firma ya a sido Registrada');window.location='https://erp.medicalsoftplus.com/baseDev/firma/FirmaFinalizado.php';</script>";
}
else
{
...
<form action="<?= $Base ?>firma/documentoFirmado" method="POST">
