...
if (isset($_GET['tipo'])) {
  ...
  $mensajeW = 'Sr(a) *' . $nombre_cliente . '* Se le envia el siguiente documento registrado en la consulta ' . $Base . 'HO_Imprimir_Historia?historiaClinica1=' . $historiaClinica1 . '';
  $accion = 0;
...
if (isset($_POST['Enviar_Firma'])) {
    ...
    $mensajeW = 'Sr(a) *' . $nombre_cliente . '* Se le ha sugerido firmar esta historia clinica, para proceder abrir el siguiente link ' . $Base . 'firma/firmardocumento/' . $historiaClinica1 .'/Historia_Clinica_Otorrino/'. $cliente_id;
    $accion = 0;
...
<a class="btn btn-outline-info btn-lg rounded-pill shadow" href="<?php echo $Base;?>HO_Pacientes"> 
...
<a class="btn btn-outline-info btn-lg rounded-pill shadow" target="_blank" href="<?php echo $Base;?>HO_Imprimir_Historia?historiaClinica1=<?php echo $historiaClinica1;?>"> 
...
<?php 
        $botonesImprimir = [
          ['Consulta', base64_encode($Base.'HO_Imprimir_Historia_plantilla.php?historiaClinica1='.encrypt($historiaClinica1).'')],       
        ];
...
<a class="btn btn-outline-info btn-lg rounded-pill shadow" href="<?php echo $Base; ?>HO_Finalizado_Historia_Otorrino?historiaClinica1=<?php echo $historiaClinica1; ?>&tipo=consulta">
...
<div align="center">
      ...
      ?>
        <form action="HO_Finalizado_Historia_Otorrino?historiaClinica1=<?php echo $historiaClinica1 ?>" method="POST" name="formularioEnvioExamen">
