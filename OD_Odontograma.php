                ...
                <div class="box">
                    <div class="box-body">
                        ...
                        <div style="display: inline-table;width:100%">
                            ...
                            <hr>
                            <a href="OD_OdontogramaInicial?clienteId=<?= $cliente_id; ?>">
                                <button class="btn btn-block btn-outline-info btn-lg rounded-pill shadow">
                                    <h4> <strong> <i class="fa-solid fa-teeth"></i> Ingresar a Odontograma
                                            Inicial</strong></h4>
                                </button>
                            </a>
                        </div>
...
<?php require_once "./OD_RequireModalEvolucion.php"; ?>
