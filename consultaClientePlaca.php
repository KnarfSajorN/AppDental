  ...
  <section class="content">
    <div class="row">
      ...
      <div class="card-body">
        ...
        <div align="center">
          <!-- <a class="btn btn-primary" href="generarOdontogramaPlaca.php?clienteId=<?php echo $clienteId; ?>" role="button"> <i class="fa fa-heartbeat"></i> Nueva Control </a> -->
          ...
          <div class="box box-solid">
            ...
            <div class="box-body">
              <div class="box-group" id="accordion">
                ...
                <?php
                $queryList = mysqli_query($conn3, "SELECT * FROM  odontogramaMasterIndiceCalculo where id_cliente = $clienteId order by id DESC");
                // $queryList=mysqli_query($conn3,"SELECT * FROM  odontogramaMasterPlaca where idCliente = $clienteId order by ID DESC");
                $nrowl = mysqli_num_rows($queryList);
                ...
                while ($row_recordset32 = mysqli_fetch_array($queryList)) {
                  ...
                  $superficies        = $row_recordset32['superficie_x_placa'];
                  $dientes_p           = $row_recordset32['dientes_ausentes'];
                    ...
                    <div class="box-header with-border">
                      <h4 class="box-title">
                        <a data-toggle="collapse" data-parent="#accordion" href="#<?php echo $ID ?>">
                          ...
                          <!-- |Porcentaje: <?php // echo number_format($porcentaje); 
                                            ?> %  -->
