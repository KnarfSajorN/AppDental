...
if ($Verificar > 0) {
  ...
  <a href="demo.php?email=<?php  echo $email?>"><h1> 

    <input size="5" type="button" class="btn btn-block btn-danger btn-lg" name="1" value="ACTIVALO AHORA GRATIS" src="demo.php?email=<?php  echo $email?>" > </h1>  <h2> <strong>       <font color="red"> Prueba gratis por 7 días </font></strong></h2></a>
...
elseif ($Verificar == 0) {
   ...
   echo '<a href="https://medicalsoftplus.com/signup"><h4> 

    <input size="3" type="button" class="btn btn-block btn-primary btn-lg" name="1" value="Para probarlo Gratis, te tiene que registrar" src="https://medicalsoftplus.com/signup"> </h4></a>';
...
<input type="hidden" name="hosted_button_id" value="XR6FQBJCAEXGN">
...
<h3> <strong> $ 271,00 USD</strong>   </h3>
...
<input type="hidden" name="hosted_button_id" value="QP6938HBQHV7E">
...
<h3> <strong> $ 471,20 USD</strong>   </h3>
...
<input type="hidden" name="hosted_button_id" value="JKMRBMK467M24">
