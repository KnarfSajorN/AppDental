   ...
   include 'menu.php'; 
    ...
    //$con=conectar();
        ...
        while($rowMotorizado=mysqli_fetch_array($queryList))
        {
           ...
           $NOMBRE_USUARIO = $rowMotorizado['nombreF'];
        }
...
mysqli_query($conn3,"INSERT INTO historiaConsentimientos (cliente_id, usuario_id, Fecha, Hora, consentimiento, firma) VALUES 
                                                         ('$clienteId', '$ID', '$fechar', '$hora', '$consentimiento', '');");



      echo '<br>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>'."INSERT INTO historiaConsentimientos (cliente_id, usuario_id, Fecha, Hora, consentimiento, firma) VALUES 
                                                         ('$clienteId', '$ID', '$fechar', '$hora', '$consentimiento', '');";
              $queryListhc=mysqli_query($conn3,"SELECT MAX(ID) as historiaClinica1 from historiaConsentimientos");
...
if ($tipo == 1) {
  $Men = 'En este mensaje encontraras informacion sobre el CONSENTIMIENTO INFORMADO y como firmarlo, despues podras acceder a la consulta por videollamada.

  VIDEO EXPLICATIVO: 

https://youtu.be/9eabZUkZ2Qo
...
$mensaje = $Men.'
Por Favor leer:
' . $Base . 'verConsentimiento/'.$historiaClinica1.'

FIRMA DEL CONSENTIMIENTO INFORMADO:

Para firmar entrar al link  ' . $Base . '/firma/documento/'.$historiaClinica1.'  
...
<h3>  En este mensaje encontraras informacion sobre el CONSENTIMIENTO INFORMADO y como firmarlo, despues podras acceder a la consulta por videollamada.
...
FIRMA DEL CONSENTIMIENTO INFORMADO:
 ...
 Para firmar entrar al link  https://medicalsoftplus.com/baseDev/firma/documento/'.$historiaClinica1.'  </h3> 
...
'.$NOMBRE_USUARIO.'</p> 
  ...
  echo "<script language='Javascript'> window.location='finalizar_consentimiento.php?historiaClinica1=$historiaClinica1';</script>"; 
