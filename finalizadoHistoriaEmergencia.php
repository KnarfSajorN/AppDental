...
$queryList = mysqli_query($conn3, "SELECT * FROM  historiaEmergencia where id = $historiaClinica1");
...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div align="center">
            ...
            <a class="btn btn-app" target="_blank" href="<?php echo $Base; ?>imprimirHistoriaEmergencia.php?historiaClinica1=<?php echo $historiaClinica1; ?>&tipo=receta">
            ...
            <a class="btn btn-app" target="_blank" href="<?php echo $Base; ?>imprimirHistoriaEmergencia.php?historiaClinica1=<?php echo $historiaClinica1; ?>&tipo=consulta">
