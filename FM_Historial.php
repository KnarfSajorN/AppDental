      ...
      <div class="row">
        <div class="card-body">
          ...
          <?php echo datosPacientes($clienteId);?>
            <div align="center">
            <a class="btn btn-outline-info btn-lg rounded-pill shadow m-1" href="FM_Familiograma?clienteId=<?= ($clienteId); ?>" role="button"><i class="fas fa-file-medical"></i> Agregar Familiograma </a>
            ...
            <div class="col-md-12">
                <div class="tab" role="tabpanel">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" ><a href="#Section1" aria-controls="home" role="tab" data-toggle="tab" class="active"> <i class='fas fa-book-medical' style='font-size:26px'> </i> Historias Familiograma</a></li>
                        <li role="presentation" ><a href="#Section2" aria-controls="home" role="tab" data-toggle="tab" > <i class='fas fa-book-medical' style='font-size:26px'> </i> Familiograma Actual</a></li>
                        ...
                        <div role="tabpanel" class="tab-pane fade in active show" id="Section1">
                            ...
                            <div class="col-md-12">
                                ...
                                <?php
                                    ...
                                    $QueryFamiliograma = mysqli_query($conn3, "SELECT * FROM  Historia_Familiograma where cliente_id = '$clienteId'");
                                    ...
                                    while ($RowFamiliograma = mysqli_fetch_array($QueryFamiliograma)) {
                                        ...
                                        $Familiograma_Archivo = $RowFamiliograma['Familiograma_Archivo'];
                                ...
                                ?>
                                    ...
                                    <div class="panel-heading" role="tab" id="heading" style="background-color: #bad8e687;">
                                        ...
                                        <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#Historia<?php echo $id ?>" aria-expanded="false" aria-controls="Historia<?php echo $id ?>">
                                            Familiograma <?php echo $id . ' / <b style="color: #444444;">' . $fecha . '</b>'; ?>

                                            <button onclick="window.location.href='FM_Finalizado?id=<?php echo $id; ?>'" style="border: hidden;background-color: initial;font-size: 20px;"><i class="iconify" data-icon="gridicons:print"></i></button>
                                        </a>
                                        </h4>
                                    </div>
                                    <div id="Historia<?php echo $id ?>" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading" style="padding-top: 20px;background-color: rgb(238, 238, 238);">
                                        <div class="panel-body">
                                            ...
                                            <?php
                                                ...
                                                if(!empty($Familiograma_Archivo)){
                                                    echo "<div class='form-group col-md-12' align='center' ><br><br><img src='$Familiograma_Archivo' width='500px'></div>";
