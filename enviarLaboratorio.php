...
$mensajeW = 'Sr(a) *'.$nombre_cliente.'* Se le ha generado una ORDEN DE LABORATORIO motivo de la consulta con *Asistente Medico VirtualMedic*; para ver receta ingresar por el siguiente link:  '.$Base.'/verLaboratorio/'.$historiaClinica1.' ';
...
$para ="$email";
                ...
                // título
                $titulo = 'Orden de laboratorio resultado de consulta con  Asistente Medico VirtualMedic';

                // mensaje
                $mensaje = '
                <html>
                <head>
                  <title>Orden de laboratorio resultado de consulta la Empresa'.$nombreF.'</title>
                    <body> 
                    
                               Hola buen dia señor(a) '.$nombre_cliente.', Enviamos link para ver Orden de laboratorio. :<br><br>

                
             <div>  Link para ver orden de laboratorio: '.$Base.'/verLaboratorio/'.$historiaClinica1.'
                ...
                $cabeceras .= 'From:  Orden de Laboratorio  Asistente Medico VirtualMedic  <noreply@medicalsoftplus.com>' . "\r\n";
