                    ...
                    <div class="box-group" id="accordion1">
                        ...
                        <div id="collapseFour" class="panel-collapse collapse">
                          ...
                          <div id="Ginecobstetricos" class="tabcontent">
                            <div class="row">
                              ...
                              <div class="col-md-12">
                                <button type="button" data-toggle="collapse" data-target="#masdetallesginecologicos">Más Detalles</button>
                              </div>
                        ...
                        <div id="collapseSix" class="panel-collapse collapse">
                          ...
                          <!-- NO agregar tildes al name eso ya se filtra desde la impresion solo aplicar para este modulo de Signos vitales y medidas antropométricas -->
                            ...
                            <div class="col-md-4">
                              ...
                              <input type="number" step="0.01" name="SignosVitales[Presion Arterial Sistolica]" id="PresionArterialSistolica" class="form-control input-lg" onchange="CalculaPresionArterialMedia()" value="<?php echo $Presion_Arterial_Sistolica; ?>">
                            ...
                            <div class="col-md-4">
                              ...
                              <input type="number" step="0.01" name="SignosVitales[Presion Arterial Diastolica]" id="PresionArterialDiastolica" class="form-control input-lg" onchange="CalculaPresionArterialMedia()" value="<?php echo $Presion_Arterial_Diastolica; ?>">
                            ...
                            <div class="col-md-4">
                              ...
                              <input type="text" name="SignosVitales[Tension Arterial Media]" id="TensionArterialMedia" class="form-control input-lg" value="<?php echo $Tension_Arterial_Media; ?>">
                     ...
                     cierre de lista-->
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <center><button type="submit" class="btn btn-block btn-primary btn-sm" onclick="verificarformulario()">
