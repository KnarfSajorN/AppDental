...
<head>
    ...
    <title><?php  if(isset($sistema)){ echo $sistema; } ?></title>
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <script>
            console.log('<?=$_SESSION['fechaVenceLic']?>');
            console.log('<?=$_SESSION['vencido']?>');
            console.log('<?=$_SESSION['ACTIVO']?>');
            console.log('<?=$_SESSION['idBitacora']?>');
            console.log('idOperacion <?=$_SESSION['idOperacion']?>');
        ...
        <?php include 'permisosUsuariosVencidos.php'; ?>
