...
include 'funciones/conn3.php';
            ...
            while($rowMotorizado=mysqli_fetch_array($queryList))
            {
             ...
             $ID                 = $rowMotorizado['id'];                
                     ...
                     $cieA    = $rowMotorizado['cie1'];
                     $cieB   = $rowMotorizado['cie2'];
                      $solicitud_procedimiento    = $rowMotorizado['Solicitud_Imprimir']; 
...
<table class="tg" border=1 style="undefined;table-layout: fixed; width: 100%">
  ...
  <tr>
    <td colspan="4"> 
      ...
      <?php if($ciefinal3[0]!='') {echo ' '.$ciefinal3[0]; }?> <br>
...
<div>
  ...
  <table width="100%">  
    <div align="left">
      ...
      <label> <h4>  SOLICITUD DE PROCEDIMIENTO </h4></label>
        </div>
