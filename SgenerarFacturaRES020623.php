...
<div align="left">  
  ...
  <label>Producto o Servicio </label> </div>
...
<?php 
          ...
          <form action="totalizarFactura.php" method="POST" name="formularioActualizarcliente">
            <div class="form-row">
...
<div align="left" class="form-group col-md-4">
  ...
  <center><button type="submit" class="btn btn-block btn-danger btn-sm" style="margin-top: 30px;"> <strong>  Totalizar factura  </strong> </button></center> 
