                ...
                <div class="box">
                    <div class="box-body">
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="col-xs-12">
                            <h4 style="text-align: center;font-weight: bold;">Datos de la Entidad</h4>
                            <address>
                            ...
                            <strong>Codigo Convenio:</strong> <?php echo $Codigo ?><br>
                                ...
                                <div class="box-body">
                                    <div class="col-md-12">
                                        ...
                                        <form action="EN_TotalizarDevolucionEntidad.php" method="POST" id="FormularioDevolucion">
                                            ...
                                            <table id="" class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    $idOperacion = $_GET['idOperacion'];
                                                    $resultado = mysqli_query($conn3, "SELECT * FROM  sDetalleOper where estado = 1 AND convenio_id = $convenio_id AND idOperacion = $idOperacion order by id ASC");
                                            ...
                                            <input type="hidden" name="convenio_id" id="convenio_id" value="<?php echo $convenio_id ?>">

                                            <input type="hidden" name="TipoOperacion" id="TipoOperacion" value="DevolucionEntidad">
