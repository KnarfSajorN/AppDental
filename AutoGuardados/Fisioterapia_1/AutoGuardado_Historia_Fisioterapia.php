<script>
    ...
    function guardarValores(usuario_id, cliente_id) {
        ...
        var CamposPersonalizadosCreador = []; //Esta variable se usa para el envio y carga de campos personalizados
        ...
        ////////////////////////? [FIN] INCLUDE PERSONALIZADO AJUSTES CONSULTAR DATOS/////////////////////////////////////////////////////////////////////////////////
        <?php
        if(isset($FiltroPersonalizado_AutoGuardado) AND $FiltroPersonalizado_AutoGuardado!=""){
            if($FiltroPersonalizado_AutoGuardado=="Fisioterapia_1"){
        ?>
            var input = formulario.querySelector("input#servicioContent");
            if (input) {
                var valorCampo = input.value;
                //console.log(input);
                var campo = {
                    nombre: "servicioContent",
                    id: "servicioContent",
                    valor: valorCampo,
                    tipo: "hidden_personalizado"
                };
                valores.push(campo);
            }

            var input = formulario.querySelector("input#tarea");
            if (input) {
                ...
                var CamposPersonalizados = {
                    nombre: "tarea",
                    id: "tarea",
                    nombre_tabla: "imagen_fisioterapia_1",
                    valor: valorCampo,
                    tipo: "hidden_personalizado"
                };
                CamposPersonalizadosCreador.push(CamposPersonalizados);
                */
            }
        ...
        */
        ...
        $.ajax({
            type: "POST",
            url: "AutoGuardados/Fisioterapia_1/AutoGuardado_Fisioterapia_Ajax.php",
            data: {
                Campos: valores,
                CamposArrayModulos: ArregloDatosModal,
                CamposArrayAntecedentesFamiliares: ArregloDatosAntecedentesFamiliares,

                CamposPersonalizados:CamposPersonalizadosCreador,//enviar campos personalizados
                            ...
                            $.ajax({
                                ...
                                if (Respuesta.Campos != null) {
                                    ...
                                    Campos.forEach(function(elemento) {
                                        ...
                                        <?php
                                        if(isset($FiltroPersonalizado_AutoGuardado) AND $FiltroPersonalizado_AutoGuardado=="Fisioterapia_1"){
                                        ?>
                                            if (elemento.tipo == "hidden_personalizado" && nombreCampo=="servicioContent") {
                                                ////////////////////////////? Poner tildes ///////////////////////
                                            ...
                                            if (elemento.tipo == "hidden_personalizado" && nombreCampo=="tarea") {
                                                ////////////////////////////? Poner tildes ///////////////////////
                                                //if (valorCampo != undefined) {valorCampo = valorCampo.replace(/u00([0-9A-F]{2})/gi, function(match, p1) {return String.fromCharCode(parseInt(p1, 16));});}
                                                ////////////////////////////? Poner tildes ///////////////////////
                                                var input = document.querySelector('input[name="' + nombreCampo + '"]');
