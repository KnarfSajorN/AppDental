<script>
    ...
    function guardarValores(usuario_id, cliente_id) {
        //Se lee el formulario de la historia clinica que debera tener el id -> FormularioHistoriaClinica, abajo tambien toca cambiar buscar con F3 este id  y si necesita cambiarlo
        ...
        for (var i = 0; i < selects.length; i++) {
            ...
            if (ArregloSelectCIE10_id.includes(id)) {
                tipo_select = "select_cie10_estetica";
            }
        ...
        */
        ...
        $.ajax({
            type: "POST",
            url: "AutoGuardados/HistoriaMedicinaEsteticaEncryptada/AutoGuardado_Encryptado_Ajax.php",
            data: {
                Campos: valores,
                            ...
                            $.ajax({
                                ...
                                if (Respuesta.Campos != null) {
                                    ...
                                    Campos.forEach(function(elemento) {
                                        ...
                                        else if (elemento.tipo == "select_cie10_estetica") {
                                            var select = document.querySelector('select[name="' + nombreCampo + '"]');
                                            if (select) {
                                                //console.log(valorCampo);
                                                var Valor = valorCampo;
                                    ...
                                    ////////////////////////?  INCLUDE PERSONALIZADO AJUSTES CARGAR DATOS/////////////////////////////////////////////////////////////////////////////////
                                    ////////////////////////?  INCLUDE PERSONALIZADO AJUSTES CARGAR DATOS/////////////////////////////////////////////////////////////////////////////////
                                    var Campos1 = Respuesta.imagen_medicinaestetica;
                                    ...
                                    Campos1.forEach(function(elemento1) {
                                        ...
                                        var valorCampo = elemento1.valor;
                                            ...
                                            if (elemento1.tipo == "hidden_personalizado" && nombreCampo=="tarea") {
                                                ////////////////////////////? Poner tildes ///////////////////////
