<script>
    ...
    function guardarValores(usuario_id, cliente_id) {
        //Se lee el formulario de la historia clinica que debera tener el id -> TablaCreadorHistorias, abajo tambien toca cambiar buscar con F3 este id  y si necesita cambiarlo
        var formulario = document.getElementById("TablaCreadorHistorias");
        //Se lee los inputs
        ...
        for (var i = 0; i < inputs.length; i++) {
            var input = inputs[i];
            if (input.type === "text" || input.type === "number" || input.type === "date") { // Filtrar solo campos de texto,numero y fecha
        ...
        ////////////////////////? [FIN] INCLUDE PERSONALIZADO AJUSTES CONSULTAR DATOS/////////////////////////////////////////////////////////////////////////////////
        ////////////////////////? [FIN] INCLUDE PERSONALIZADO AJUSTES CONSULTAR DATOS/////////////////////////////////////////////////////////////////////////////////
        ////////////////////////? [FIN] INCLUDE PERSONALIZADO AJUSTES CONSULTAR DATOS/////////////////////////////////////////////////////////////////////////////////

        var input = formulario.querySelector("input.RayadoAutoguardado");
            if (input) {
        ...
        ////////////////////////?  INCLUDE PERSONALIZADO AJUSTES CONSULTAR DATOS/////////////////////////////////////////////////////////////////////////////////
        ////////////////////////?  INCLUDE PERSONALIZADO AJUSTES CONSULTAR DATOS/////////////////////////////////////////////////////////////////////////////////
        ...
        */
        ...
        const rutaActual = "<?=$RutaFinal_SoloCreadorHistorias;?>";
        //////////////////////////? RUTA 2.0 - Solo para el creador de historias///////////////////////
        ...
        $.ajax({
            type: "POST",
            url: "AutoGuardados/CreadorHistorias/AutoGuardado_Generico_Ajax.php",
            data: {
                Campos: valores,
    ...
    function CargarDatosHistoria(usuario_id, cliente_id) {
        ...
        */
        ...
        document.getElementById("TablaCreadorHistorias").appendChild(inputHidden);
                            ...
                            $.ajax({
                                ...
                                if (Respuesta.Campos != null) {
                                    ...
                                    Campos.forEach(function(elemento) {
                                        ...
                                        //Personalizado para el creador de historias
                                        ...
                                        else if (elemento.tipo == "hidden_botones") {
                                            ...
                                            //para que aparezca el boton coloreado
                                            var boton_id = input.id;
                                            if(valorCampo == "Si"){
                                                var inputboton = document.getElementById(boton_id+"1");
                                                if (inputboton) {
                                                    inputboton.classList.add("on");
                                                }
                                            }else if(valorCampo == "No"){
                                                var inputboton = document.getElementById(boton_id+"0");
                                                if (inputboton) {
                                                    inputboton.classList.add("on");
                                                }
                                            }
                                    ...
                                    ////////////////////////?  INCLUDE PERSONALIZADO AJUSTES CARGAR DATOS/////////////////////////////////////////////////////////////////////////////////
                                    ////////////////////////?  INCLUDE PERSONALIZADO AJUSTES CARGAR DATOS/////////////////////////////////////////////////////////////////////////////////
                                    ////////////////////////?  INCLUDE PERSONALIZADO AJUSTES CARGAR DATOS/////////////////////////////////////////////////////////////////////////////////
                                    if (Respuesta.imagen_general != "" && Respuesta.imagen_general != null) {
                                        var Campos1 = Respuesta.imagen_general;

                                        //Aqui recorremos los campos que trajimos del ajax
                                        Campos1.forEach(function(elemento1) {

                                            var nombreCampo = elemento1.nombre;
                                            //console.log(nombreCampo);
                                            ...
                                            var valorCampo = elemento1.valor;

                                                if (elemento1.tipo == "Rayado") {
                                                    ////////////////////////////? Poner tildes ///////////////////////
                                                    //if (valorCampo != undefined) {valorCampo = valorCampo.replace(/u00([0-9A-F]{2})/gi, function(match, p1) {return String.fromCharCode(parseInt(p1, 16));});}
                                                    ////////////////////////////? Poner tildes ///////////////////////
                                                    var input = document.querySelector('input[name="' + nombreCampo + '"]');
                                                    if (input) {input.value = valorCampo;}
                                                    //console.log(elemento);
                                                    //cargardatos(valorCampo);
                                                    var idrayado = elemento1.id;
                                                    idrayado = idrayado.replace("img", "");
                                                    var canvas = document.getElementById("canvas1"+idrayado);
                                                    var ctx = canvas.getContext("2d");
                                                    var img = new Image();
                                                    img.src = valorCampo;
                                                    img.onload = function() {
                                                        ctx.drawImage(img, 0, 0);  // Dibuja la imagen en el canvas en la posición (0, 0)
                                                    };

                                                }
                                        });
                                    }
                                    ////////////////////////?  [FIN] INCLUDE PERSONALIZADO AJUSTES CARGAR DATOS/////////////////////////////////////////////////////////////////////////////////
                                    ////////////////////////?  [FIN] INCLUDE PERSONALIZADO AJUSTES CARGAR DATOS/////////////////////////////////////////////////////////////////////////////////
                                    ////////////////////////?  [FIN] INCLUDE PERSONALIZADO AJUSTES CARGAR DATOS/////////////////////////////////////////////////////////////////////////////////
                                    ...
                                    //modulo antecedentes familiares fin
