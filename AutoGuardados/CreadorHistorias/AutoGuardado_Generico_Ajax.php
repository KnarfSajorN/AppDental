...
if (isset($_POST["Tipo_Consulta"]) && $_POST["Tipo_Consulta"]=="Guardar Datos Historia Clinica") {
    ...
    if($NrowAutoGuardado>0){
        ...
        $query = "INSERT INTO AutoGuardado (Campos,Arreglo_Paraclinicos,Arreglo_Incapacidades,Arreglo_Insumos,Arreglo_Familiares,Ruta,Nombre_Tabla,usuario_id,cliente_id,Fecha,Fecha_Actualizacion,imagen_general) 
...
elseif (isset($_POST["Tipo_Consulta"]) && $_POST["Tipo_Consulta"]=="Cargar AutoGuardado") {
    ...
    while ($row_recordset32 = mysqli_fetch_array($QueryAutoGuardado)) {
        ...
        $imagen_general = $row_recordset32['imagen_general'];
    }
    ...
    if($NrowAutoGuardado>0){
        ...
        $Arreglo["imagen_general"] = json_decode($imagen_general);
    }else{
        $Arreglo["Estado"]="No Existe";
    }
