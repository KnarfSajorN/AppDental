...
include 'funciones/conn3.php';
            ...
            $queryList=mysqli_query($conn3,"SELECT * FROM  historiaClinica5_genicologica where ID = $historiaClinica1");
            ...
            while($rowMotorizado=mysqli_fetch_array($queryList))
            {
              ...
              $motivo  =$rowMotorizado['motivo'];

              $diagnostico_p     =$rowMotorizado['diagnostico_p'];
