...
<br>
          ...
          <hr align="center" size="10" width="100%" color="#000000">
           ...
           Consultas
                  ...
                  $queryList=mysqli_query($conn3,"SELECT * FROM  historiaConsentimientos where cliente_id = $clienteId order by ID DESC");
                  ...
                  <div class="box-header with-border">
                    <h4 class="box-title">
                      <a data-toggle="collapse" data-parent="#accordion" href="#<?php echo $ID?>">
                        Fecha <?php echo $Fecha .'-'.$Hora.' - '.$Firmo?> <a href="finalizar_consentimiento.php?historiaClinica1=<?php echo $ID?>" title="Imprimir Consulta" target="_blank"><i class="fa fa-print"></i> </a>
                      </a>
                    </h4>
                  </div>
