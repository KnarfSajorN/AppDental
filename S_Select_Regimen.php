...
if (isset($_POST['Guardar_Informacion_Pagina'])) {
    ...
    if ($queryList != true) {
        echo "<script language='Javascript'> window.location='{$ruta}?error=Hubo Un Error al Guardar el Régimen'</script>";
    } else {
        echo "<script language='Javascript'> window.location='{$ruta}?msg=Se Guardo el Régimen Correctamente'</script>";
    }
}
...
if (isset($_POST['Actualizar_Informacion_Pagina'])) {
    ...
    $ruta = str_replace('.php', '', $ruta);
    if ($queryList != true) {
        echo "<script language='Javascript'> window.location='{$ruta}?error=Hubo Un Error al Actualizar el Régimen'</script>";
    } else {
        echo "<script language='Javascript'> window.location='{$ruta}?msg=Se Actualizo el Régimen Correctamente'</script>";
    }
}
///////////////////////////////////////////////////////////////////////////
if ($_GET['Eliminar'] <> "") {
    ...
    $ruta = str_replace('.php', '', $ruta);
    if ($queryList != true) {
        echo "<script language='Javascript'> window.location='{$ruta}?error=Hubo Un Error en la Eliminacion del Régimen'</script>";
    } else {
        echo "<script language='Javascript'> window.location='{$ruta}?msg=Se Elimino el Régimen Correctamente'</script>";
    }
}
///////////////////////////////////////////////////////////////////////////
...
<div class="content-wrapper p-3">
    ...
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li><a href="#"> Registro de Régimen</a></li>
        </ol>
    </section>
    ...
    <section class="content">
        <div class="">
            <div class="content">
                <h4 class="Titulo_Pagina">Registro de Régimen</h4>
                <div class="box">
                    <div class="box-body">
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-body">
                                    <div class="col-md-12">
                                        <h2 style="text-align: center;font-weight: bold;"> Régimen </h2>
