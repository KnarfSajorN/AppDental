          ...
          <div class="box-body">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-solid">
                <!-- /.box-header -->
                <form action="Guardar_Historia_Clinica.php" method="POST" name="formularioActualizarcliente">
	                <div class="box-body">
	                    ...
	                    <div class="panel box box-primary">
	                      ...
	                      <div id="collapseFour" class="panel-collapse collapse">
	                        ...
	                        <div class="tab">
	                          ...
	                          <//button type="button" class="tablinks" onclick="MenuAntecedentes(event, 'Ginecobstetricos')"></button>
	                          <//button type="button" class="tablinks" onclick="MenuAntecedentes(event, 'Familiares')"></button>
	                        </div>
	                        <!-- barra de menu final -->
   ...
   <div class="panel box box-primary">
                     ...
                     cierre de lista-->
                      ...
                      <div class="panel box box-primary">
                        ...
                        <b>Recomendaciones para el Paciente</b>
                              
                          <div class="box-body">
                             
                            <div class="col-md-12"> <b>Recomendación 1:</b>
                            ...
                            <div class="col-md-12"><b>Recomendación 2:</b>
                              <textarea name="PlanManejo2"  class="form-control input-lg" placeholder="" style="width: 100%; min-height: 60px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;max-width: 100%;" ></textarea>
                            </div>
...
<div class="panel box box-primary">
                        <div class="box-header with-border">
                          <h4 class="box-title">
                            <a data-toggle="collapse" data-parent="#accordion1" href="#collapseProcedimiento">
                              Procedimientos
                            </a>
                          </h4>
                        </div>
                        <div id="collapseProcedimiento" class="panel-collapse collapse">

                          <div class="box-body">

                            <div class="col-md-12">
                              <textarea name="procedimientodescripcion"  class="form-control input-lg" placeholder="" style="width: 100%; min-height: 60px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;max-width: 100%;" ></textarea>
                            </div>

                            <div class=" col-md-12"><label for="CUP_id" class="form__label" id="Texto_CUP">CUPS</label>
                                    <select class="form__field Cup_Select2" id="CUP_id" name="CUP_id" data-placeholder="Seleccione.." onchange="CodigoCup(this.value)" data-requerida="No" style="width: 100%">
                                        <option value="" selected> Seleccione</option>
                                    </select>
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <center><button type="submit" class="btn btn-block btn-primary btn-sm" onclick="verificarformulario()"> <h2> <strong>  G u a r d a r  </strong> </h2> </button></center>
                      </div>
	                  </div>
	                </div>
