        ...
        <div class="col-xs-12 table-responsive">
            <table class="table table-striped" border="1">
                ...
                <tbody>
                    ...
                    $queryListC = mysqli_query($conn3, "SELECT COUNT(cliente_id) AS total,recomendacionID,cliente_id FROM Reporte_Recomendaciones WHERE DATE(Fecha_Registro) BETWEEN CAST('$desde' AS DATE) AND CAST('$hasta' AS DATE) GROUP BY recomendacionID ");
                    ...
                    if ($queryListC) {
                        ...
                        $recomendacion = $rowC['recomendacionID'];
                        $total = $rowC['total'];
                        ...
                        echo ' <tr>
                        <td width="25%">' . funcionMaster1($recomendacion, 'id', 'Nombre', 'antecedentes_PF') . ' </td>
