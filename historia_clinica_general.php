          ...
          <div class="box-body">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-solid">
                <!-- /.box-header -->
                <form action="Guardar_Historia_Clinica_General.php" method="POST" name="formularioActualizarcliente">
	                <div class="box-body">
...
<div class="panel box box-primary">
	                      <div class="box-header with-border">
	                        <h4 class="box-title">
	                          <a data-toggle="collapse" data-parent="#accordion1" href="#consulta">
	                           Tipo de Consulta
	                          </a>
	                        </h4>
	                      </div>
	                      <div id="consulta" class="panel-collapse collapse">

	                        <div class="box-body">

	                           <div class="col-xs-12">
  <select name="tipoConsulta" id="tipoConsulta" onChange="consultas();" class="form-control select2" style="width: 100%;" required>
...
<br>
<div class="col-xs-12"> <div id="div-resultsConsultas"> </div>
</div>
...
<input type="hidden"  id="name1"   value="select1" >
                ...
                <div id="div-results10"  class="col-md-8">
                </div>
</div>
...
<div class="form-group col-md-12" align="left">
                                    ...
                                    <div class="box-body">
                                      ...
                                      <div class="form-group col-md-6" align="left">
                                        ...
                                        <select id="finalidad_consulta" name="finalidad_consulta" class="form-control select2" style="width: 100%;">
                                          <option value="" selected> Seleccione</option>
                                          <option value="01" > Atención del parto(Atención del embarazo y del postparto)</option>
  ...
  <div class="form-group col-md-12" align="left">
                                      ...
                                      <div class="form-group col-md-12" align="left">
                                        ...
                                        <input type="number" name="valor_consulta" id="valor_consulta" value="0" class="form-control" placeholder="Numero de Autorizacion" maxlength="15" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" > 
                                      </div>
