      ...
      <table class="table  table-bordered table-light" >
        ...
        <tbody>
          ...
          if ($tipo == 0) {
            ...
            $queryList = mysqli_query($conn3, "SELECT * FROM  sOperacionInv  where ID_principal = $idUsuarioP and idCliente = $tipo and fechaOperacion BETWEEN '$desde' and '$hasta' and tipo IN (1, 7) ");
            }
