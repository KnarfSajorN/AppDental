...
while ($row_recordset32 = mysqli_fetch_array($queryList)) {
  ...
  $responsableFamiliar = $row_recordset32['responsableFamiliar'];
  $telefono_responsable = $row_recordset32['telefono_responsable'];
  $parentesco_responsable = $row_recordset32['parentesco_responsable'];
}
...
<style type="text/css">
  ...
  /* FIN estilos arreglo para antecedentes personales */
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>Consulta médica, Paciente:
      <?= $nombre_cliente . ', Edad: ' . CalculoEdadPaciente($fechaNacimiento); ?> </h1>
    <ol class="breadcrumb">
          ...
          <div class="box-body">
            ...
            <div class="col-md-12">
              ...
              <div class="box-solid">
                ...
                <form action="HC_Guardar" method="POST" id="FormularioHistoriaClinica">
                  <div class="box-body">
                    ...
                    <div class="box-group" id="accordion1">
                      ...
                      <div class="panel box box-primary">
                        ...
                        <div id="collapseTwo" class="panel-collapse collapse">
                          ...
                          <div class="box-body row">
                            ...
                            <div class="col-md-6">
                              <label>Nombre</label>
                              <input type="text" name="InformacionAcudiente[Nombre Acudiente]" class="form-control" value="<?= $acompananteFamiliar; ?>">
                            </div>

                            <div class="col-md-6">
                              <label>Parentesco</label>
                              <select class="form-control" name="InformacionAcudiente[Parentesco Acudiente]" id="ParentescoAcudiente" class="form-control input-lg">
                                ...
                                <option value="Familiar en segundo grado">Familiar en
                            ...
                            <div class="col-md-6">
                              ...
                              <input type="text" name="InformacionAcudiente[Teléfono Acudiente]" class="form-control" value="<?= $telefono_acompanante; ?>">
                            </div>

                            <div class="col-md-6">
                              <label>Médico o Institución que remite</label>
                              <input type="text" name="InformacionAcudiente[Médico que remite]" class="form-control">
                            </div>

                            <script>
                              //var Opcion = "<?= $parentesco_acompanante; ?>"
                              //document.getElementById("ParentescoAcudiente").value=Opcion;
                              ...
                              // Recorremos todas las opciones para verificar si Opcion coincide con alguna de ellas
                              for (var i = 0; i < selectElement.options.length; i++) {
                                if (selectElement.options[i].value === Opcion) {
                                  // Si encontramos una coincidencia, establecemos el valor seleccionado en el select
                          ...
                          <div class="box-body row">
                            ...
                            <div class="col-md-6">
                              <label>Nombre</label>
                              <input type="text" name="InformacionResposable[Nombre Responsable]" class="form-control" value="<?= $responsableFamiliar; ?>">
                            </div>

                            <div class="col-md-6">
                              <label>Parentesco</label>
                              <select class="form-control" name="InformacionResposable[Parentesco Responsable]" id="ParentescoResponsalbe" class="form-control input-lg">
                                <option value="" selected>Seleccione</option>
                                <option value="Hijos">Hijos</option>
                                <option value="Hermanos">Hermanos</option>
                                <option value="Madre">Madre</option>
                            ...
                            <div class="col-md-6">
                              <label>Teléfono</label>
                              <input type="text" name="InformacionResposable[Teléfono Responsable]" class="form-control" value="<?= $telefono_responsalbe; ?>">
                            </div>

                            <script>
                              var Opcion = "<?= $parentesco_responsable; ?>"
                              document.getElementById("ParentescoAcudiente").value = Opcion;

                              var Opcion = "<?= $parentesco_responsable; ?>";
                              var selectElement = document.getElementById(
                                "ParentescoResponsalbe");
                              var valorSeleccionado = selectElement.value;
                          ...
                          <div class="box-body row">
                            ...
                            <div class="col-md-6">
                              ...
                              <select name="EnfermedadActual[Tipo de Consulta]" class="form-control select2" style="width: 100%;">
                                <option selected="selected" value="">Seleccione tipo de
                                  consulta</option>
                      ...
                      <div class="panel box box-primary">
                        ...
                        <div id="collapseFour" class="panel-collapse collapse">
                          ...
                          <div class="tab">
                            ...
                            <button type="button" class="tablinks" onclick="MenuAntecedentes(event, 'Ginecobstetricos')">Ginecoobstétrico</button>
                            ...
                            <div class="tab" style="display: flex;overflow: auto;">
                              ...
                              //Variables globales
	                          	...
	                          	function antecedentes() 
	                          	{
		                          	...
		                          	?>
                                                            <button type="button" class="tablinks1"
                                                                onclick="MenuAntecedentes_Personales(event, <?= "'div_".$Titulo."'";?>)"><?= $rowAntecedentes['Nombre']?>
                                                                <a data-toggle="modal" data-target="#modalForm1"
                                                                    onclick="EditarAntecedentes(<?= $id;?>);"
                                                                    title="Editar Antecedentes"><i
                                ...
                                ?>
                                                            ...
                                                            <button type="button" class="" onclick="">
                                                                <a data-toggle="modal"
                                                                    data-target="#modalForm_add_personales" onclick=""
                                                                    title="Agregar Antecedentes"><i class="fa fa-plus"
                              ...
                              <section id="fancyTabWidget" class="tabs t-tabs">
                                <ul class="nav nav-tabs fancyTabs" role="tablist" style="display: flex;overflow-y: hidden;">
                                  ...
                                  ?>
                                      ...
                                      <li class="fancyTab tablinks1" style="min-width: 130px;left: 1px;" onclick="MenuAntecedentes_Personales(event, <?= "'div_" . $Titulo . "'"; ?>)" <?php if ($contador == "1") {
                                        ...
                                        <div style="display: contents"><a data-toggle="modal" data-target="#modalForm1" onclick="EditarAntecedentes(<?= $id; ?>);" title="Editar Antecedentes"><i class="fa fa-pencil" style="font-size: 15px;position: absolute;left: 100px;top: 0px;width: 20%;"></i></a>
                                        </div>

                                        <span class="fa fa-heart" onclick="this.className='fa fa-heart animate__animated animate__heartBeat animate__repeat-3';"></span><span><?= $nombre ?></span>
                          ...
                          <div id="Ginecobstetricos" class="tabcontent">
                            <div class="row">
                              <div class="col-md-12">
                                <h3>Antecedentes Ginecoobstétrico</h3>
                              </div>

                              <div class="col-md-3">
                                <label>Fecha de último parto</label>
                                <input type="date" name="AntecentesGinecobstetricos[Fecha de último parto]" class="form-control input-lg">
                              </div>
                              <div class="col-md-3">
                                <label>Fecha de última menstruación</label>
                                <input type="date" name="AntecentesGinecobstetricos[Fecha de última menstruación]" class="form-control input-lg">
                              </div>
                              <div class="col-md-3">
                                <label>Método de planificación</label>
                                <select name="AntecentesGinecobstetricos[Método de planificación]" class="form-control input-lg">
                                  <option value="" selected>Seleccione</option>
                                  ...
                                  <option>Quirúrgicos</option>
                                  <option>Implantes Subdérmicos</option>
                              ...
                              <div class="col-md-12">
                                <textarea name="AntecentesGinecobstetricos[Más detalles del método de planificación]" style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;margin: 0px;margin-top: 15px;max-width: 100%;" placeholder="Mas detalles del metodo de planificacion"></textarea>
                              </div>

                              <div class="col-md-12">
                                <h3>Perfil Obstétrico</h3>
                              </div>
                              ...
                              <div class="col-md-4">
                                ...
                                <input type="number" name="AntecentesGinecobstetricos[Cesáreas]" class="form-control input-lg">
                              </div>
                              <div class="col-md-4">
                                <label>Abortos</label>
                              ...
                              <div class="col-md-4">
                                ...
                                <input type="number" name="AntecentesGinecobstetricos[Ectópicos]" class="form-control input-lg">
                              </div>

                              <div class="col-md-12">
                                <button type="button" data-toggle="collapse" data-target="#masdetallesginecologicos">Más
                                  Detalles</button>
                              </div>

                              <div id="masdetallesginecologicos" class="collapse row col-md-12">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                  ...
                                  <input type="number" name="AntecentesGinecobstetricos[Telarquia]" class="form-control input-lg">
                                </div>
                                ...
                                <div class="col-md-12">
                                  <textarea name="AntecentesGinecobstetricos[Más detalles ciclos menstruales y demas]" style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;margin: 0px;margin-top: 15px;max-width: 100%;" placeholder="Mas detalles ciclos menstruales y demas"></textarea>
                                </div>
                                ...
                                <div class="col-md-4">
                                  <label>Fecha de Última Citología</label>
                                  <input type="date" name="AntecentesGinecobstetricos[Fecha de Última Citología]" class="form-control input-lg">
                                </div>
                                <div class="col-md-3">
                          ...
                          <div id="Familiares" class="tabcontent">
                            <div class="row">
                              ...
                              <div class="col-md-4">
                                <br>
                                <button type="button" onclick="AgregarFamiliar_Inicial();"> Agregar
                                  Familiar </button>
                                ...
                                <table id="example3" class="table table-bordered table-striped" style="width: 100%;">
                                  <thead>
                                    <tr>
                                      ...
                                      <th style="width:10%">Fecha Diagnóstico</th>
                                      <th style="width:20%">CIE-11</th>
                                    ...
                                    <script type="text/javascript">
                                      function AgregarFamiliar() {
                                        var tableBody = document.getElementById(
                                          'tbody_antecedentesfamiliares');
                                        var cantidad = document.getElementById(
                                          'cantidad_AgregarFamiliar').value;
                                        cantidad++;
                                        for (var i = 0; i < cantidad; i++) {
                                          var tbodys = document.querySelectorAll(
                                            "#tbody_antecedentesfamiliares > tr"
                                          );
                                          ...
                                          if ((!document.getElementById(
                                            ...
                                            Dato[0] =
                                              '<input type="text" name="AntecedentesFamiliares[' +
                                              i +
                                              '][Parentesco]" id="AnteFamiliar_1' +
                                              i +
                                              '" class="form-control input-lg" style="width:100%;">';
                                            Dato[1] =
                                              '<input type="date" name="AntecedentesFamiliares[' +
                                              i +
                                              '][Fecha Diagnostico]" id="AnteFamiliar_2' +
                                              i +
                                              '" class="form-control input-lg" style="width:100%;">';
                                            Dato[2] =
                                              '<select name="AntecedentesFamiliares[' +
                                              i +
                                              '][CIE-10][]" id="AnteFamiliar_3' +
                                              i + '" onclick="BuscarCie10(' +
                                              i +
                                              ');" style="width:100%" multiple><option value=" ">Seleccione... </option>';
                                            Dato[3] =
                                              '<textarea name="AntecedentesFamiliares[' +
                                              i +
                                              '][Diagnostico]" id="AnteFamiliar_4' +
                                              i +
                                              '" class="textarea_noflex form-control input-lg" style="width:100%;"></textarea>';
                                            Dato[4] =
                                              '<textarea name="AntecedentesFamiliares[' +
                                              i +
                                              '][Comentarios]" id="AnteFamiliar_5' +
                                              i +
                                              '" class="textarea_noflex form-control input-lg" style="width:100%;"></textarea>';
                                            Dato[5] =
                                              '<a href="#"  style="font-size: 20px;" id="AnteFamiliar_6' +
                                              i +
                                              '"  onclick="EliminarFamiliar(' +
                                              i +
                                      ...
                                      function EliminarFamiliar(valor) {
                                        document.getElementById(
                                            "tr_antecedentesfamiliares" + valor)
                                          .remove();
                                        document.getElementById(
                                            'cantidad_AgregarFamiliar').value =
                                          (document.getElementById(
                                              'cantidad_AgregarFamiliar')
                                            .value - 1);
                                      }
                                    </script>
                                ...
                                <script type="text/javascript">
                                  function AgregarFamiliar_Inicial() {
                                    ...
                                    var selects = document.getElementById(
                                      'cantidad_AgregarFamiliar').value;
                                    $.when(AgregarFamiliar()).then(BuscarCie10(
                                      selects));
                        ...
                        <div id="collapseFive" class="panel-collapse collapse">
                          ...
                          <div class="tab" id="tab" style="display: flex;overflow: hidden;">
                            <ul class="nav nav-tabs" role="tablist" style="display: flex;overflow: auto;">
                              ...
                              {
                                include 'funciones/conn3.php';
                                $QueryAntecedentes = mysqli_query($conn3, "SELECT * FROM  ConfigRevisionSistemas Where activo='1'");
                                while ($rowAntecedentes = mysqli_fetch_array($QueryAntecedentes)) {
                                  ...
                                  $arreglo_check[$nombre]  = json_decode($rowAntecedentes['Arreglo']);
                              ?>
                                  <button type="button" class="tablinks2" onclick="MenuRevision(event, <?= "'div_" . $Titulo . "'"; ?>)"><?= $rowAntecedentes['Nombre'] ?>
                                    <a data-toggle="modal" data-target="#modalForm2" onclick="EditarRevision(<?= $id; ?>);" title="Editar Antecedentes"><i class="fa fa-pencil"></i></a>
                                  </button>
                              <?php
                                }
                      ...
                      <div class="panel box box-primary">
                        ...
                        <div id="collapseSix" class="panel-collapse collapse">
                          ...
                          <div class="box-body row">
                            ...
                            <!-- NO agregar tildes al name eso ya se filtra desde la impresion solo aplicar para este modulo de Signos vitales y medidas antropométricas -->
                            <div class="col-md-4">
                              <label>Peso Corporal [Kg]</label>
                              <input type="number" name="SignosVitales[Peso Corporal]" id="KG_peso" class="form-control input-lg" onchange="IMC();" step="0.01" value="<?= $Peso; ?>">
                            ...
                            <div class="col-md-4">
                              ...
                              <input type="number" name="SignosVitales[Altura]" id="CM_altura" class="form-control input-lg" onchange="IMC();" step="0.01" value="<?= $Altura; ?>">
                              <!-- <input type="number" name="SignosVitales[Altura]" id="CM_altura" class="form-control input-lg" onchange="IMC();" step="0.01" value=""> -->
                            </div>
                            <div class="col-md-4">
                              <label>IMC</label>
                              <input type="number" name="SignosVitales[IMC]" id="IMC_Paciente" class="form-control input-lg" step="0.01" value="<?= $IMC; ?>">
                            ...
                            <script>
                              function IMC() {
                                ...
                                r = m1 / ((m2 / 100) * (m2 / 100));
                                document.getElementById("IMC_Paciente").value = r.toFixed(
                                  2);
                              }
                            </script>
                            ...
                            <div class="col-md-4">
                              ...
                              <input type="number" name="SignosVitales[Perimetro Cefalico]" class="form-control input-lg" onchange='document.getElementsByName("Grafico_Pediatria[Perimetro Cefalico]")[0].value=this.value' step="0.01" value="<?= $Perimetro_Cefalico; ?>">
                              <!-- <input type="number" name="SignosVitales[Perimetro Cefalico]" class="form-control input-lg" onchange='document.getElementsByName("Grafico_Pediatria[Perimetro Cefalico]")[0].value=this.value' step="0.01" value=""> -->
                            </div>
                            <div class="col-md-4">
                              <label>Frecuencia Respiratoria</label>
                              <input type="number" name="SignosVitales[Frecuencia Respiratoria]" class="form-control input-lg" step="0.01" value="<?= $Frecuencia_Respiratoria; ?>">
                              <!-- <input type="number" name="SignosVitales[Frecuencia Respiratoria]" class="form-control input-lg" step="0.01" value=""> -->
                            </div>
                            <div class="col-md-4">
                              <label>Frecuencia Cardíaca</label>
                              <input type="number" name="SignosVitales[Frecuencia Cardiaca]" class="form-control input-lg" step="0.01" value="<?= $Frecuencia_Cardiaca; ?>">
                            ...
                            <div class="col-md-4">
                              ...
                              <input type="number" step="0.01" name="SignosVitales[Presion Arterial Sistolica]" id="PresionArterialSistolica" class="form-control input-lg" onchange="CalculaPresionArterialMedia()" value="<?= $Presion_Arterial_Sistolica; ?>">
                            ...
                            <div class="col-md-4">
                              ...
                              <input type="number" step="0.01" name="SignosVitales[Presion Arterial Diastolica]" id="PresionArterialDiastolica" class="form-control input-lg" onchange="CalculaPresionArterialMedia()" value="<?= $Presion_Arterial_Diastolica; ?>">
                              <!-- <input type="number" name="SignosVitales[Presion Arterial Diastolica]" class="form-control input-lg" step="0.01" value=""> -->
                            </div>

                            <div class="col-md-4">
                              <label>Tensión Arterial Media</label>
                              <input type="text" name="SignosVitales[Tension Arterial Media]" id="TensionArterialMedia" class="form-control input-lg" value="<?= $Tension_Arterial_Media; ?>">
                            ...
                            <div class="col-md-4">
                              ...
                              <input type="number" name="SignosVitales[Temperatura Corporal]" class="form-control input-lg" step="0.01" value="<?= $Temperatura_Corporal; ?>">
                            ...
                            <div class="col-md-4">
                              ...
                              <input type="number" name="SignosVitales[Saturacion Oxigeno]" class="form-control input-lg" step="0.01" value="<?= $Saturacion_Oxigeno; ?>">
                              <!-- <input type="number" name="SignosVitales[Saturacion Oxigeno]" class="form-control input-lg" step="0.01" value=""> -->
                            </div>

                            <div class="col-md-4">
                              <label>Porcentaje de Grasa Corporal [%]</label>
                              <input type="number" name="SignosVitales[Porcentaje de Grasa Corporal]" class="form-control input-lg" step="0.01" value="<?= $Porcentaje_Grasa_Corporal; ?>">
                              <!-- <input type="number" name="SignosVitales[Porcentaje de Grasa Corporal]" class="form-control input-lg" step="0.01" value=""> -->
                            </div>
                            <div class="col-md-4">
                              <label>Circunferencia Abdominal [cm]</label>
                              <input type="number" name="SignosVitales[Circunferencia Abdominal]" class="form-control input-lg" step="0.01" value="<?= $Circunferencia_Abdominal; ?>">
                            ...
                            <div class="col-md-4">
                              ...
                              <input type="number" name="SignosVitales[Circunferencia de Cintura]" class="form-control input-lg" step="0.01" value="<?= $Circunferencia_Cintura; ?>">
                            ...
                            <script>
                              function CalculaPresionArterialMedia() {
                                var Sistolica = parseFloat(document.getElementById(
                                  "PresionArterialSistolica").value);
                                var Diastolica = parseFloat(document.getElementById(
                                  "PresionArterialDiastolica").value);
                                console.log(Sistolica);
                                console.log(Diastolica);
                                var TensionMedia = (Diastolica + ((Sistolica - Diastolica) /
                                  3));

                                if (!isNaN(Sistolica) && !isNaN(Diastolica)) {
                                  console.log(TensionMedia);
                                  document.getElementById("TensionArterialMedia").value =
                                    TensionMedia.toFixed(2);
                                }
                      ...
                      <div class="panel box box-primary">
                        ...
                        <div id="collapseSeven" class="panel-collapse collapse">
                          ...
                          <div class="box-body">
                            ...
                            <div class="col-md-4">
                              <button type="button" style="display: initial;" data-target="#modalForm3" data-toggle="modal" title="Agregar Paraclinico"><i class="fa fa-plus">
                                  Agregar Paraclínico</i>
                              </button>
                            </div>
                              ...
                              <script type="text/javascript">
                                function tabla_paraclinicos() {
                                  ...
                                  for (index in data) {
                                    ...
                                    arreglotemporal["Clasificacion"] = data[index]
                                      .Clasificacion;
                                    arreglotemporal["Comentarios"] = data[index]
                                      .Comentarios;
                                  ...
                                  let arreglo_final = arreglo.splice(pos,
                                    contador
                                  ); // para que seleccione los arreglos despues del primer lugar ya que corresponde al input hidden
                      ...
                      <!-- lista -->
                      <div class="panel box box-primary d-none">
                        <div class="box-header with-border">
                          <h4 class="box-title">
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                <div class="panel-group" role="tablist" aria-multiselectable="true" id="ModuloExamenFisico">
                                  ...
                                  <script type="text/javascript">
                                    function CargarModuloExamenFisico() {
                                      ...
                                      for (index in Arreglo) {
                                        ...
                                        text +=
                                          '<div class="panel panel-default"><div class="panel-heading" role="tab" id="headingOne"><h4 class="panel-title"><a role="button" data-toggle="collapse"  href="#ExamenFisico' +
                                          contador +
                                          '" aria-expanded="true" aria-controls="ExamenFisico' +
                                          contador + '">' + Arreglo[index] +
                                          '</a></h4></div>';

                                        text += '<div id="ExamenFisico' + contador +
                                          '" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne"><div class="row"><div class="col-md-12"><button type="button" data-toggle="modal" data-target="#modalForm_examen_fisico" onclick="EditarExamenFisico(' +
                                          ArregloId[index] +
                                          ')" title="Editar Examen Fisico" style="float: right;background-color:#3c8dbc;"><i class="fa fa-pencil" style=""></i></button></div><div class="col-md-4"><br>';

                                        text +=
                                          '<label style="display:block"><input type="radio" class="option-input radio" name="ExamenFisico[' +
                                          Arreglo[index] +
                                          '][]" value="No Evaluado" checked />No Evaluado</label>';
                                        text +=
                                          '<label style="display:block"><input type="radio" class="option-input radio" name="ExamenFisico[' +
                                          Arreglo[index] +
                                        ...
                                        text +=
                                          '<label style="display:block"><input type="radio" class="option-input radio" name="ExamenFisico[' +
                                          Arreglo[index] +
                                          '][]" value="Anormal" />Anormal</label><br></div>';

                                        text +=
                                          '<div class="col-md-8"><br><textarea name="ExamenFisico[' +
                                          Arreglo[index] +
                                          '][]"  id="ExamenFisicoTextArea' +
                                          ArregloId[index] +
                                          '" class="form-control input-lg" placeholder="Hallazgos" style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;max-width: 100%;" ></textarea><a onclick="Plantilla_ExamenFisico(' +
                                          ArregloId[index] +
                                          ')" title="Mostrar Plantilla" style="float: right;top: -150px;left: 30px;position: relative;"><i class="iconify" data-icon="ri:file-paper-2-line"></i></button></div></div>';

                                        text += '</div>';

                                        contador++;
                                      }
                                      document.getElementById("ModuloExamenFisico")
                                        .innerHTML = text;
                                    }

                                    function Plantilla_ExamenFisico(valor) {
                                      let editar =
                                        <?= json_encode($arreglo_examenfisico) ?>;
                                      console.log(editar);
                                      console.log(editar[valor]['Plantilla']);
                                      document.getElementById("ExamenFisicoTextArea" +
                                        valor).value = editar[valor][
                                        'Plantilla'
                                      ];
                                    }
                                  ...
                                  <div class="col-md-12"><button type="button" data-toggle="modal" data-target="#modalForm_agregar_examen_fisico" title="Agregar Examen Fisico" style="float: right;background-color:#3c8dbc;"><i class="fa fa-plus" style=""></i>Agregar
                                      Mas Examenes Fisicos</button></div>
                                </div>
                              </div>
                            </div>
                                  ...
                                  <tr>
                                    <td <?= $optiongen1 ?>>
                                      <div> <input type="radio" value="1" name="niño2">
                                        ...
                                        <p><b>Estado 1</b>. Sin vello púbico,
                                          Testículos y Pene infantil. </p>
                                      </div>
                                    </td>
                                    <td <?= $optiongen2 ?>>
                                      <div>
                                        ...
                                        <p><b>Estado 1</b>. Pecho infantil, no
                                          vello púbico.</p>
                                      </div>
                                  ...
                                  <tr>
                                    <td <?= $optiongen1 ?>>
                                      <div>
                                        ...
                                        <p><b>Estado 2</b>. Aumento del escroto
                                          y testículos, piel del escroto
                                          enrojecida y arrugada, pene
                                          infantil, vello púbico escaso en la
                                          base del pene.</p>
                                      </div>
                                    </td>
                                    <td <?= $optiongen2 ?>>
                                      <div>
                                        ...
                                        <p><b>Estado 2</b>. Botón mamario, vello
                                          púbico no rizado escaso, en labios
                                          mayores.</p>
                                      </div>
                                    </td>
                                  </tr>
                                  ...
                                  <tr>
                                    <td <?= $optiongen1 ?>>
                                      <div>
                                        ...
                                        <p><b>Estado 3</b>. Alargamiento y
                                          engrosamiento del pene. Aumento de
                                          testículos y escroto. Vello sobre
                                          pubis rizado, grueso y oscuro.</p>
                                      </div>
                                    </td>
                                    <td <?= $optiongen2 ?>>
                                      <div>
                                        ...
                                        <p><b>Estado 3</b>. Aumento y elevación
                                          de pecho y areola. Vello rizado,
                                          basto y oscuro sobre pubis.</p>
                                      </div>
                                    </td>
                                  </tr>
                                  ...
                                  <tr>
                                    <td <?= $optiongen1 ?>>
                                      <div>
                                        ...
                                        <p><b>Estado 4</b>. Ensanchamiento del
                                          pene y del glande, aumento de
                                          testículos, aumento y oscurecimiento
                                          del escroto. Vello púbico adulto que
                                          no cubre los muslos.</p>
                                      </div>
                                    </td>
                                    <td <?= $optiongen2 ?>>
                                      <div>
                                        ...
                                        <p><b>Estado 4</b>. Areola y pezón
                                          sobreelevado sobre mama. Vello
                                          púbico tipo adulto no sobre muslos.
                                        </p>
                                      </div>
                                    </td>
                                  </tr>
                                  ...
                                  <tr>
                                    <td <?= $optiongen1 ?>>
                                      <div>
                                        ...
                                        <p><b>Estado 5</b>. Genitales Adultos.
                                          Vello adulto que se extiende a zona
                                          medial de muslos.</p>
                                      </div>
                                    ...
                                    <td <?= $optiongen2 ?>>
                                      <div>
                                        ...
                                        <p><b>Estado 5</b>. Pecho Adulto, areola
                                          no sobreelevada. Vello adulto zona
                                          medial muslo.</p>
                                      </div>
                                    </td>
                                  </tr>
                      ...
                      <div class="panel box box-primary">
                        ...
                        <div id="collapseEleven" class="panel-collapse collapse">
                          ...
                          <div class="box-body row">
                            ...
                            <div class="col-md-6">
                              <label>Transpiración</label><textarea name="SintomasGenerales[Transpiración]" class="form-control input-lg" placeholder="Transpiracion" style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;max-width: 100%;"></textarea>
                            </div>
                      ...
                      <div class="panel box box-primary">
                        ...
                        <div id="collapseSixteen" class="panel-collapse collapse">
                          ...
                          <div id="Incapacidades" class="tabcontent">
                            ...
                            <div class="col-md-4">
                              <br><br>
                              <button type="button" style="display: initial;" data-target="#modalForm4" data-toggle="modal" title="Agregar Incapacidades"><i class="fa fa-plus">
                                  Agregar Incapacidades</i>
                              </button>
                            </div>
                            <div class="col-md-8">&nbsp;</div>
                            ...
                            <div class="table-responsive col-md-12" style="overflow: auto;">
                              ...
                              <table id="tabla_incapacidades" class="table table-bordered table-striped" style="width: 100%;">
                                <thead>
                                  <tr>
                                    ...
                                    <th style="width:20%">Fecha Inicial Incapacidad
                                    </th>
                                    <th style="width:20%">Fecha Final Incapacidad
                                    </th>
                              ...
                              <script type="text/javascript">
                                function tabla_incapacidades() {
                                  ...
                                  var data = JSON.parse(document.getElementById(
                                    "Arreglo_Incapacidades").value);
                                  var arreglo = [];
                                  var contador = "0";
                                  for (index in data) {
                                    var arreglotemporal = {};

                                    arreglotemporal["Area Tratamiento"] = data[index][
                                      "Area Tratamiento"
                                    ];
                                    arreglotemporal["Recurrencia"] = data[index]
                                      .Recurrencia;
                                    arreglotemporal["Fecha Inicial Incapacidad"] = data[
                                      index]["Fecha Inicial Incapacidad"];
                                    arreglotemporal["Fecha Final Incapacidad"] = data[
                                      index]["Fecha Final Incapacidad"];
                                    arreglotemporal["Comentarios"] = data[index]
                                      .Comentarios;
                                              ...
                                              <form id="detalleRecetario" method="POST" name="formularioActualizarcliente" enctype="multipart/form-data">
                                                      <div class="form-row">
                                                        ...
                                                        <div align="left"> Agregar Medicamento </div>
                                                          <input type="hidden" class="form-control input-lg" id="usuario_id" name="usuario_id" placeholder="usuario_id" value="<?=  $usuario_id?>">
                                                            <select id="codigoProd" name="codigoProd"
                                                        ...
                                                        <div class="form-group col-md-3">
                                                            ...
                                                            <select class="form-control posologia select2"
                                                                name="posologia" id="posologia" style="width: 100%;">
                                                                ...
                                                                <option value="Geles y jaleas- Espuma">Geles y jaleas-
                                                                    Espuma</option>
                                                                <option value="Loción">Loción</option>
                                                                <option value="Jabones y champú">Jabones y champú
                                                                </option>
                                                                <option value="Unguento">Unguento</option>
                                                                <option value="Otras soluciones">Otras soluciones
                                                                </option>
                                                                <option value="Ampolla">Ampolla</option>
                                                                <option value="Anillo">Anillo</option>
                                                                <option value="Aplicador">Aplicador</option>
                                                                <option value="Atomizador(spray)">Atomizador(spray)
                                                                </option>
                                                        ...
                                                        <div class="form-group col-md-3">
                                                            ...
                                                            <input type="text" name="duracion" id="duracion"
                                                                class="form-control" pattern="[^'\x22]+"
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <textarea name="nota" id="nota"
                                                                placeholder="INDICACIONES ESPECIFICAS DEL MEDICAMENTO"
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            <div align="left"> Indicaciones generales de la Recetas
                                                            </div>
                                                            <textarea name="nota2" id="nota2"
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <input type="hidden" name="nomedicamento"
                                                                value="<?= $descripcion?>">
                                                            <input type="hidden" name="ID"
                                                                value="<?= $_SESSION['ID']?>">

                                                            <center><button type="button" onclick="agergarItem();"
            ...
            */
                      ...
                      <input type="hidden" name="receta" value="<?= $idR ?>">
                      <input type="hidden" name="ID" value="<?= $_SESSION['ID'] ?>">
                      <input type="hidden" name="clienteId" value="<?= $clienteId ?>">
                      <input type="hidden" name="sucursal" value="<?= $_SESSION["sucursal"] ?>">
                      <div class="form-group col-md-12">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <p class="statusMsg"></p>
        <h5 class="modal-title" id="exampleModalLabel">Editar Antecedentes</h5>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header" style="display:block;">
        ...
        <h4 class="modal-title" id="myModalLabel">Editar Paraclínicos</h4>
      </div>
      ...
      <div class="modal-body">
        ...
        <div class="form-group row" id="form_div">
          ...
          <div class="col-md-12">
            ...
            <textarea name="Paraclinicos[Comentarios]" class="Paraclinicos_modal" style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;margin: 0px;margin-top: 15px;" placeholder="Observaciones" data-title="Comentarios"></textarea>
            <br><br>
          </div>
        ...
        <center>
          <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
          <button id="user-data-next-button" class="btn my-button btn-primary" onclick="$.when(GuardarParaclinico()).then(tabla_paraclinicos());" disabled>Guardar</button>
        </center>
...
<script type="text/javascript">
  ...
  function CargarDatosAntecedentes() {
    ...
    var Arreglo = <?= $arreglo_antecedentes ?>;
    ...
    for (index in Arreglo) {
      ...
      for (i = 0; i <= Arreglo[index].length; i++) {
        if (Arreglo[index][i] !== undefined) {
          text +=
            '<div class="col-md-4"><label style="padding-bottom: 10px;margin-bottom: 0px;"><input type="checkbox" class="option-input checkbox" name="Checks_Antecedentes[' +
            index + '][]" value="' + Arreglo[index][i] + '" /> ' + Arreglo[index][i] + ' </label></div>';
        }
      }
      text += '<div class="col-md-12"><br><br><label>Otros</label><textarea name="Checks_Antecedentes[' + index +
        '][Otros]"  class="form-control input-lg" placeholder="Otros" style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" ></textarea></div></div>';
  ...
  function EditarAntecedentes(id) {
    var editar = <?= json_encode($arreglo_editar) ?>;
    var id_arreglo = id;
    var rango = "";
  ...
  function CargarDatosRevision() {
    ...
    for (index in Arreglo) {
      ...
      for (i = 0; i <= Arreglo[index].length; i++) {
        if (Arreglo[index][i] !== undefined) {
          text +=
            '<div class="col-md-4"><label style="padding-bottom: 10px;margin-bottom: 0px;"><input type="checkbox" class="option-input checkbox" name="Checks_Revision[' +
            titulo + '][]" value="' + Arreglo[index][i] + '" /> ' + Arreglo[index][i] + ' </label></div>';
        }
      }
      text += '<br><div class="col-md-12"><br><br><label>Otros</label><textarea name="Checks_Revision[' + titulo +
        '][Otros]"  class="form-control input-lg" placeholder="Otros" style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" ></textarea></div></div>';
    }
  ...
  function EditarRevision(id) {
    var editar = <?= json_encode($arreglo_editar_revision) ?>;
    var id_arreglo = id;
    var rango = "";
    editar[id_arreglo].forEach(element => rango += element + ',');
  ...
  function EditarExamenFisico(id) {
    let editar = <?= json_encode($arreglo_examenfisico) ?>;
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    MenuAntecedentes_Personales(event, "<?= $inicial; ?>");
...
$Nombre_Tabla_autoguardado = "Historia_Clinica"; //Nombre de la tabla de la base de datos de la historia 
$RutaFinal_Encryptado = $_SERVER['SCRIPT_URI'] . "?cl={$cliente_id_autoguardado}";

include 'AutoGuardados/HistoriaEncryptada/AutoGuardado_Historia_Encryptado.php'; //ruta para historias encriptadas
?>


<script>
  function preguntarAI() {
    // consulta AI
    let pregunta =
      "Paciente de <?= CalculoEdadPaciente($fechaNacimiento) ?> años de edad, ingresa a la consulta médica por " +
      document.querySelector('[name="EnfermedadActual[Motivo de Consulta]"]').value +
      ", dame un diagnostico para este caso";

    // ajax
    $.ajax({
      type: "POST",
      url: "./AI/AISendRequest.php",
      data: {
        'pregunta': pregunta
      },
      success: function(response) {
