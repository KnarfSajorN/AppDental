...
{    
                  ...
                  echo '<a href="OrdenLaboratorios.php?clienteId='.$fila[0].'" title="Agregar Orden"><i class="fa fa-heartbeat"></i> </a>|';  
               
                  echo '<a href="consultasLaboratorio.php?clienteId='.$fila[0].'" title="Ver Historia"><i class="fa fa-search"></i> </a> |';
