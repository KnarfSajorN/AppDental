...
var text_areas = document.getElementsByClassName('dicom_voz');
  ...
  for (i = 0; i < text_areas.length; i++) {
    ...
    boton.setAttribute('style','float: right;position: relative;top:-40px;padding: 5px;left: -30px;color: #3c8dbc;');
