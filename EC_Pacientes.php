...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="">
      <div class="col-md-12">
        <h4 class="Titulo_Pagina">Pacientes Ecomapa</h4>
        <?php
        $msg = $_GET['msg'];
        if ($msg == '1') {
  ...
  columnastablas = [{
    ...
    },
    {
      "data": function(row, type, set) {
        botones = "";
        botones += "<a href='EC_Ecomapa?clienteId=" + (row.cliente_id) + "' title='Agregar Ecomapa'><i class='fas fa-file-medical'></i> </a>";
        botones += "<a href='EC_Historial?clienteId=" + (row.cliente_id) + "' title='Historial Ecomapa'><i class='fas fa-list'></i> </a>";
