...
echo "<div class='col-md-12'>
		...
		<input type='text' name='Proveedor[Total]' id='total_proveedor' value='{$costoTotalFinal}' class='form-control input-lg' style='border-block: none;background-color: unset;'  readonly >
		</div>
		<div class='col-md-4'> 
			<label>
				Numero de plazos
