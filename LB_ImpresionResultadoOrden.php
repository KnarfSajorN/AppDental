...
<body>
    ...
    <div class="page-header row" style="text-align: center">
            ...
            <table style="width:100%;zoom:0.8;">
                <tr>
                    <td style="width:50%;text-align-last: center;width:33%;">
                        ...
                        <label style="font-size:18px"> <?php echo $Base; ?>Plataforma</label><br>
                    </td>
                    <td style="width:50%;text-align-last: center;width:33%;">
                        <div id="qr_codigofuncionamiento<?php echo $key; ?>"></div>
                        <label style="font-size:18px"> Codigo de Funcionamiento </label>
                    </td>
                </tr>
            </table>
        ...
        <div class="col-4" style="font-size: 18px;text-align: right;"><?php echo nl2br($header) ?></div>
    ...
    <div class="page-footer">
        ...
        <div class='row' style="zoom:0.7">
            ...
            if ($Usuario_Resultados_Ingreso != 0) {
                ...
                echo "<div class='col-6' align='center' style='font-size: 18px;'>
                ...
                <br><label style='position: relative;top: -36px;display: grid;'>$CodigoEspecialidadIngreso<br>
                
                
                <b>*Responsable de la Validación de los Resultados de la Prueba*</b></label>  
                </div>";
            }
            ...
            if ($Usuario_Valida_Resultados != 0) {
                ...
                echo "<div class='col-6' align='center' style='font-size: 18px;'>
                                                ...
                                                <br><label style='position: relative;top: -36px;display: grid;'>$CodigoEspecialidadValidador<br>
                ...
                <td>
                            ...
                            <div class="box">
                                <div class="col-md-12">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <?php
                                        $queryList = mysqli_query($conn3, "SELECT id FROM  LB_ExamenCargado WHERE idOperacion='$idOperacion' AND CaracteristicaExamen='No' AND Activo = 1  ORDER BY id ASC");
                                        while ($rowMotorizado = mysqli_fetch_array($queryList)) {
                                        ...
                                        foreach ($examenes as $key => $value) {
                                            ...
                                            $examen_principal_id = $value;
                                            if ($TipoTabla == "Si") {
                                                $Filtro = "width:50%;float:left;";
                                                $queryList = mysqli_query($conn3, "SELECT examen_id,count(*) as CantidadDetalles FROM LB_ExamenCargado WHERE idOperacion='$idOperacion' AND examenrelacion_id='$examen_principal_id' AND examen_id='$examen' AND Activo = 1 GROUP BY examen_id ORDER BY id ASC");
                                                while ($rowMotorizado = mysqli_fetch_array($queryList)) {
                                        ...
                                        ?>
                                            ...
                                            if ($Tabla == $TipoTabla) :
                                                //$Tabla = "Si";
                                            ?>
                                                <table id="Tabla_Examenes" class="table table-bordered table-striped" style="font-size:18px;vertical-align: middle;<?php echo $Filtro; ?>">
                                                    <thead>
                                                        <tr>
                                                    ...
                                                    $queryList = mysqli_query($conn3, "SELECT * FROM  LB_ExamenCargado WHERE idOperacion='$idOperacion' AND examen_id='$examen' AND examenrelacion_id='$examen_principal_id' AND Activo = 1 ORDER BY id ASC");
                                                    while ($rowMotorizado = mysqli_fetch_array($queryList)) {
                                                        $contador++;
                                                        ...
                                                        if (($CantidadCaracteristicas == $contador) and ($tabladoble == 1)) {
                                                            ...
                                                            echo "</tbody>
                                                                ...
                                                                <table id='Tabla_Examenes' class='table table-bordered table-striped' style='width:100%;font-size:18px;vertical-align: middle;position: relative;top: -17px;'>";
                                                            if ($Metodo != "") {
                                                                echo "<tr><td colspan='4'><b style='font-size: 18px;'> Metodo : </b>$Metodo</td></tr>";
                                                            }
                                                            if ($Observaciones != "") {
                                                                echo "<tr><td colspan='4'><b style='font-size: 18px;'> Observaciones : </b>$Observaciones</td></tr>";
                                                            }
                                                            $tabladoble = "0";
                                                            $contador = "0";
                                                        ...
                                                        if ($CantidadDetalles == $contador) {
                                                            echo "</tbody>
                                                                    ...
                                                                    <table id='Tabla_Examenes' class='table table-bordered table-striped' style='width:50%;font-size:18px;vertical-align: middle;'>
                                                                    <thead>
                                                                        <tr>
                                                                            <th scope='col' width='20%'>Nombre</th>
                                                ...
                                                <div class='col-12' align='left' style="padding: 2px 20px 2px 20px;display: flex;">
                                                    <br>
                                                    Nota: Este Informe de Laboratorio Contiene Datos de Análisis Clínicos. Si no Cuenta con los Conocimientos Adecuados, su Interpretación Puede Conducir a un Error. Consulte a su Médico.
                                                </div>
                                ...
                                <table style="width:100%">
                                    <tr>
                                        <td style="text-align-last: center;width:33%;">
                                            <div id="qr_examen<?php echo $key; ?>"></div>
                                            <label style="font-size:18px"> https://medicalsoftplus.com/pe652/verLaboratorios</label><br>
                                            <label style="font-size:18px">Usuario: <?php echo $CODI_CLIENTE ?></label>
                                            <label style="font-size:18px">Clave: <?php echo $clave ?></label><br>
                                        </td>
                                        <td style='text-align-last: center;width:33%;'>
                                            <?php
                                            if ($CodigoBarrasCovid == "Si") {
                                                echo "
                                                    ...
                                                    <label style='font-size:18px'> Codigo Covid </label>
                    ...
                    <?php if (isset($_GET["examenes"]) and $_GET["examenes"] != "categoria") : ?>
                        ...
                        foreach ($examenes as $key => $value) {
                            ...
                            if ($TipoTabla == "Si") {
                                $Filtro = "width:50%;float:left;";
                                $queryList = mysqli_query($conn3, "SELECT examen_id,count(*) as CantidadDetalles FROM LB_ExamenCargado WHERE idOperacion='$idOperacion' AND examen_id='$examen' AND examenrelacion_id='$examen_principal_id' AND Activo = 1 GROUP BY examen_id ORDER BY id ASC");
                                while ($rowMotorizado = mysqli_fetch_array($queryList)) {
                                    $CantidadDetalles = round(($rowMotorizado["CantidadDetalles"] / 2), 0, PHP_ROUND_HALF_UP);
                                }
                                $Tabla = "Si";
                                ...
                                <div class="box">
                                    ...
                                    <table style="width:100%">
                                        <tr>
                                            <td style="width:50%;text-align-last: center;width:33%;">
                                                <div id="qr_examen<?php echo $key; ?>"></div>
                                                <label style="font-size:18px"> https://medicalsoftplus.com/ec583/ verLaboratorios</label><br>
                                                <label style="font-size:18px">Usuario: <?php echo $CODI_CLIENTE ?></label>
                                                <label style="font-size:18px">Clave: <?php echo $clave ?></label><br>
                                            </td>
                                            <td style='text-align-last: center;width:33%;'>
                    ...
                    <?php if (isset($_GET["examenes"]) and $_GET["examenes"] == "categoria") : ?>
                        ...
                        <?php
                        $examenes = $_GET["examenes"];
                        $queryList = mysqli_query($conn3, "SELECT examen_id,id FROM  LB_ExamenCargado WHERE idOperacion='$idOperacion' AND CaracteristicaExamen='No' AND Activo = 1 GROUP BY examen_id ORDER BY id ASC");
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            ...
                                            foreach ($arregloExamen as $key1 => $value1) {
                                                ...
                                                if ($TipoTabla == "Si") {
                                                    $Filtro = "width:50%;float:left;";
                                                    $queryList = mysqli_query($conn3, "SELECT examen_id,count(*) as CantidadDetalles FROM LB_ExamenCargado WHERE idOperacion='$idOperacion' AND examen_id='$examen' AND Activo = 1 GROUP BY examen_id ORDER BY id ASC");
                                                    while ($rowMotorizado = mysqli_fetch_array($queryList)) {
                                                        $CantidadDetalles = round(($rowMotorizado["CantidadDetalles"] / 2), 0, PHP_ROUND_HALF_UP);
                                                    }
                                                    $Tabla = "Si";
                                            ...
                                            ?>
                                                ...
                                                ?>
                                                    <table id="Tabla_Examenes" class="table table-bordered table-striped" style="font-size:18px;vertical-align: middle;<?php echo $Filtro; ?>">
                                                        ...
                                                        <?php
                                                        $CodigoBarrasCovid = "";
                                                        $queryList = mysqli_query($conn3, "SELECT * FROM  LB_ExamenCargado WHERE idOperacion='$idOperacion' AND examen_id='$examen' AND Activo = 1 ORDER BY id ASC");
                                                        while ($rowMotorizado = mysqli_fetch_array($queryList)) {
