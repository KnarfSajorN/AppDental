          ...
          <div class="card">
            ...
            <div class="card-header">
              <ul class="nav nav-tabs">
                <li class="nav-item active"><a class="nav-link" href="#Consultas" data-toggle="tab">Información para sitio Web</a></li>
                ...
                <li class="nav-item"><a class="nav-link" href="#formularioContactanos" data-toggle="tab">Mensajes de formularios</a></li>
              </ul>
            </div>
                      ...
                      <div class="col-md-12">
                        ...
                        <?php if (strlen($direccionWeb) <= 1) : ?>
                          ...
                          <div class="input-group mb-3">
                            <input type="text" class="form-control" spellcheck="false" data-ms-editor="true" id="Nomb" name="direccionWeb" placeholder="elmejordoctordelmundo">
                        ...
                        <div class="col-md-12" align="center">
                          <?php if (strlen($direccionWeb) > 0) : ?>
                            <input type="hidden" class="form-control input-lg" id="direccionWeb" name="direccionWeb" value="<?php echo $direccionWeb ?>" maxlength="20" pattern="[a-z]{1,15}" onChange="disponibilidad();" required>
                      ...
                      <table class="tg" style="undefined;table-layout: fixed; width: 100%">
                        ...
                        <tr>
                          <th>
                            ...
                            <input type="text" class="form-control input-lg" id="nombre_cliente" name="nombre" value="<?php echo $nombre ?>" maxlength="120" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" required>
                          ...
                          <th>
                            ...
                            <input type="number" class="form-control input-lg" name="valorconsulta" value="<?php echo $valorconsulta ?>" required>
                          </th>
                        </tr>
                        ...
                        <tr>
                          <th>
                            ...
                            <input type="text" name="ciudad" id="ciudad" class="form-control input-lg" value="<?php echo $ciudad ?>">
                          ...
                          <th>
                            ...
                            <input type="number" min="1" max="99" class="form-control input-lg" name="anosExperiencia" value="<?php echo $anosExperiencia ?>" required>
                        ...
                        <tr>
                          <th>
                            ...
                            <select id="categoria" name="categoria" class="form-control select" data-placeholder="Seleccione especialidades" style="width: 100%;" required="required">
                          ...
                          <th>
                            ...
                            <select id="categoria2" name="categoria2" class="form-control select" data-placeholder="Seleccione especialidades" style="width: 100%;" required>
                              <option value="<?php echo $categoria2 ?>">
                                <?php echo categoria($categoria2) ?> </option>
                              <?php categoriaselect() ?>
                            </select>
                        ...
                        <tr>
                          <th>
                            ...
                            <input type="text" class="form-control input-lg" name="telefonos" value="<?php echo $telefonos ?>" required>
                          ...
                          <th>
                            ...
                            <input type="text" class="form-control input-lg" name="whatsapp" placeholder="573259846587" value="<?php echo $whatsapp ?>" required>
                          </th>
                        ...
                        <tr>
                          <th>
                            ...
                            <input type="text" class="form-control input-lg" name="idiomas" value="<?php echo $idiomas ?>" required>
                          ...
                          <th>
                            ...
                            <input type="text" class="form-control input-lg" name="fpago" value="<?php echo $fpago ?>" required>
...
-->
         ...
         -->
                      ...
                      <input type="text" class="form-control input-lg" id="GoogleA" name="GoogleA" value="<?php echo htmlspecialchars($GoogleA) ?>">
                      <div class="col-sm-12">
                        <label class="control-label"> <a data-toggle="modal" data-target="#modal-maps">Como obtener enlace de Maps</a>
                        </label>
                      </div>

                      <!-- Modal youtube -->
                      <div class="modal fade" id="modal-maps" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      ...
                      <input type="text" class="form-control input-lg" id="titulo" name="titulo" value="<?php echo $titulo ?>">
                      5


                      <div align="left"> Dirección </div>
                      <input type="text" class="form-control input-lg" id="direccion" name="direccion" value="<?php echo $direccion ?>">
                      ...
                      <input type="text" class="form-control input-lg" id="f" name="f" value="<?php echo $f ?>" placeholder="https://www.facebook.com/meidcocarlos">
                      <div align="left"> twitter </div>
                      <input type="text" class="form-control input-lg" id="t" name="t" value="<?php echo $t ?>" placeholder="https://twitter.com/meidcocarlos">

                      <div align="left"> Instagram </div>
                      <input type="text" class="form-control input-lg" id="i" name="i" value="<?php echo $i ?>" placeholder="https://www.instagram.com/drcarlos/">

                      <div align="left"> LinkedIn </div>
                      <input type="text" class="form-control input-lg" id="l" name="l" value="<?php echo $l ?>" placeholder="https://www.linkedin.com/in/carlos">

                      <div align="left"> YouTube </div>
                      <input type="text" class="form-control input-lg" id="y" name="y" value="<?php echo $y ?>" placeholder="https://www.youtube.com/channel/UCqDvamKNUCuNbtyWmUYOirA">
                      ...
                      <input type="text" class="form-control input-lg" name="descripcion" placeholder="descripcion" value="<?php echo $descripcion ?>" required>
    ...
    <?php echo $proySer3 ?>     
                ...
                <div class="tab-pane" id="Consultas5">
                  ...
                  <form action="c_anuncioActualizar.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                      ...
                      <button type="submit" class="btn btn-block btn-outline-info rounded-pill shadow m-1" id="colores" name="colores">
                        <h4> Actualizar </h4>
                      </button>
                      ...
                      <form action="configActualizarhmNoticias.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                          ...
                          <div class="form-group col-md-12">
                            ...
                            <input type="text" class="form-control input-lg" name="editor" value="<?php echo ($connGlobal) ? $rowNoticia['editor'] : '' ?>">
                          </div>
                          <div class="form-group col-md-12">
                            <div align="left">Titulo</div>
                            <input type="text" class="form-control input-lg" name="titulo" value="<?php echo ($connGlobal) ? $rowNoticia['titulo'] : '' ?>">
                          </div>
                          <div class="form-group col-md-12">
                            <div align="left">Slug de titulo (lo-mas-relevante-en-medicina-2023)
                            </div>
                            <input type="text" class="form-control input-lg" name="slug" value="<?= ($connGlobal) ? $rowNoticia['slug'] : '' ?>" onchange="slugTitulo(this.value)">
                            <small id="mensajeSlug"></small>
                          </div>
                          <div class="form-group col-md-12">
                            <div align="left">Descripción</div>
                            <input type="text" class="form-control input-lg" name="descripcion" value="<?php echo ($connGlobal) ? $rowNoticia['descripcion'] : '' ?>">
                          </div>
                          <div class="form-group col-md-12">
                          ...
                          <div class="form-group col-md-12">
                            <textarea id="" class="editorJR" name="blog"><?php echo ($connGlobal) ? $rowNoticia['blog'] : '' ?></textarea>
                          </div>
                        </div>
         ...
         Marcar como Leído 
                ...
                <div class="tab-pane" id="Consultas7">
                  ...
                  <form action="GuardarImagenesGaleria.php" method="POST" name="formularioActualizarcliente" enctype="multipart/form-data">
                          ...
                          <div class="modal-content">
                            ...
                            <form action="GuardarImagenesGaleria.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-md-12">
                                  ...
                                  <div class="col-sm-12">
                                    ...
                                    <div class="img img-responsive">
                                      <img class="img img-responsive" src="{$Base}/archivos/galeria/<?php echo $resulImg['nombre_img']; ?>">
                                    </div>
                              ...
                              <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                                <a class="btn btn-block btn-outline-info rounded-pill shadow m-1" href="{$Base}/archivos/galeria/<?php echo $resulImg['nombre_img']; ?>" download="Archivo">Descargar Archivo
                                </a>
                ...
                <div class="tab-pane" id="Consultas8">
                  ...
                  <form action="GuardarImagenesGaleriaVideo.php" method="POST" name="formularioActualizarcliente" enctype="multipart/form-data">
                    ...
                    <div class="col-sm-12">
                      <label class="control-label">Link del Vídeo - <a data-toggle="modal" data-target="#modal-youtube">Como obtener enlace del vídeo</a>
                      </label>
                      <input type="text" class="form-control" name="archivo" id="archivo" value="<?php echo htmlspecialchars($archivo) ?>">
                    </div>

                    <!-- Modal youtube -->
                    <div class="modal fade" id="modal-youtube" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Como obtener
                  ...
                  <table width="100%" style=" border-top:1px solid #3c8dbc;">
                    ...
                    <?php while ($resulImg = mysqli_fetch_assoc($ListaImg1)) {  ?>
                      ...
                      <tr style=" border-top:1px solid #3c8dbc;">
                        ...
                        <th>
                          <button type="button" class="btn btn-block btn-outline-info rounded-pill shadow m-1" data-toggle="modal" data-target="#exampleModal<?php echo $resulImg['IM_id'] ?>">
                            <li class="fa fa-pencil"></li>
                          </button>
                        </th>
                        <!--   <th>
                      ...
                      <!-- Modal video-->
                      <div class="modal fade" id="exampleModal<?php echo $resulImg['IM_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalLabel">Modificar Vídeo
                                <?php echo $resulImg['descripcion'] ?></h5>
                              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                              </button>
                            </div>
                            <form action="GuardarImagenesGaleriaVideo.php" method="POST" enctype="multipart/form-data">
                              <div class="modal-body">
                                <div class="col-md-12">
                                  ...
                                  <div class="col-sm-12">
                                    <label class="control-label">Nombre del
                                      Vídeo</label>
                                    <input type="text" class="form-control" name="descripcion" value="<?php echo $resulImg['descripcion'] ?>" id="descripcion">
                                  </div>

                                  <div class="col-sm-12">
                                    <label class="control-label">Link del Vídeo</label>
                                    <input type="text" class="form-control" name="archivo" value='<?php echo $resulImg['nombre_vid'] ?>' id="archivo">
                                    <hr>
                                  </div>
                                </div>
                              </div>
                              <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                                <button type="submit" name="submit" value="E" class="btn btn-danger">Eliminar</button>
                                <button type="submit" name="submit" value="A" class="btn btn-block btn-outline-info rounded-pill shadow m-1">Actualizar</button>
                              </div>
                            </form>
                          </div>
                        </div>
