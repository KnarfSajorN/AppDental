                                                    ...
                                                    <div class="col-md-12 row">
                                                        ...
                                                        foreach ($ArreglosCamposSaludSexual as $key => $value) {
                                                            ...
                                                            <div class='form-group col-md-12'>
                                                                ...
                                                                <textarea class='form-control' name='ExamenFisico[SaludSexual][Signos][$Identificacion][$Titulo][1][Observaciones]' style='width: 100%; height: 94px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;'></textarea>
                                                            </div>";
                                                        ...
                                                        include 'ModulosRIAS/Infancia/Include_Tanner.php';
                                                        ?>
