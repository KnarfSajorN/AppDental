                                                            ...
                                                            <table class="table table-hover">
                                                                ...
                                                                foreach ($ArreglosCamposSaludMentalRQC as $key => $value) {
                                                                    ...
                                                                    <tr>
                                                                        <td > $Titulo </td>
                                                                        <td >
                                                                            <input type='radio' class='RQC_TablaClase RequiredRQC_Radio' name='ExamenFisico[SaludMental][RQC][$Identificacion][$Titulo]' value='1' style='width: 25px;height: 25px;'>
                                                                        </td>
                                                                        <td >
                                                                            <input type='radio' class='RQC_TablaClase RequiredRQC_Radio' name='ExamenFisico[SaludMental][RQC][$Identificacion][$Titulo]' value='0' style='width: 25px;height: 25px;'>
                                                                        </td>
                                                                    </tr>";
