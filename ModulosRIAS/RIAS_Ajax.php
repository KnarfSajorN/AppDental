...
if ($_POST["Tipo_Consulta"] == "Consultar Grafica Altura x Edad") {
    ...
    $ValorTemporal = $_POST["ValorTemporal"];
    ...
    if($ValorTemporal!=""){
        $ArregloPaciente[$EdadValorTemporal] = array("x" => floatval($EdadValorTemporal), "y" => floatval($ValorTemporal));
    }
...
if ($_POST["Tipo_Consulta"] == "Consultar Grafica Altura x Peso") {
    ...
    $ValorTemporalTalla = $_POST["ValorTemporalTalla"];
    $ValorTemporalPeso = $_POST["ValorTemporalPeso"];

    if($ValorTemporalTalla!="" AND $ValorTemporalPeso!=""){

        $ArregloPaciente[$ValorTemporalTalla] = array("x" => floatval($ValorTemporalTalla), "y" => floatval($ValorTemporalPeso));
    }
...
if ($_POST["Tipo_Consulta"] == "Consultar Grafica Perimetro Cefalico") {
    ...
    $ValorTemporalPerimetro = $_POST["ValorTemporalPerimetro"];

    if($ValorTemporalPerimetro!=""){
        $ArregloPaciente[$EdadValorTemporal] = array("x" => floatval($EdadValorTemporal), "y" => floatval($ValorTemporalPerimetro));
    }
...
if ($_POST["Tipo_Consulta"] == "Consultar Grafica IMC") {
    ...
    $ValorTemporalIMC = $_POST["ValorTemporalIMC"];

    if($ValorTemporalIMC!=""){
        $ArregloPaciente[$EdadValorTemporal] = array("x" => floatval($EdadValorTemporal), "y" => floatval($ValorTemporalIMC));
    }
...
if ($_POST["Tipo_Consulta"] == "Consultar Grafica Peso x Edad") {
    ...
    if($ValorTemporalPeso!=""){
        $ArregloPaciente[$EdadValorTemporal] = array("x" => floatval($EdadValorTemporal), "y" => floatval($ValorTemporalPeso));
    }
