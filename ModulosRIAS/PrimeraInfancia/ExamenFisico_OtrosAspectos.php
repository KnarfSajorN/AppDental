                                                ...
                                                <div class="panel-body">
                                                    <div class="col-md-12 row">
                                                        ...
                                                        $ArreglosCamposOtrosAspectos = [
                                                            ...
                                                            "13" => "Fiebre mayor de ocho días",
                                                            "14" => "Contacto con persona con tuberculosis",
                                                        ...
                                                        foreach ($ArreglosCamposOtrosAspectos as $key => $value) {
                                                            ...
                                                            if($key=="11"){
                                                                ...
                                                                <div class='form-group col-md-4'>
                                                                    ...
                                                                    <select name='ExamenFisico[OtrosAspectos][Valoracion][$Identificacion][$Titulo][0][Estado]' class='form-control input-lg select2' style='width:100%' >
                                                            ...
                                                            echo "<div class='form-group col-md-8'>
                                                                ...
                                                                <textarea class='form-control' name='ExamenFisico[OtrosAspectos][Valoracion][$Identificacion][$Titulo][1][Observaciones]' style='width: 100%; height: 94px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;'></textarea>
                                                            </div>";
