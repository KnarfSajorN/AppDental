                                                ...
                                                <div class="panel-body">
                                                    <div class="col-md-12 row">
                                                        ...
                                                        $ArreglosCamposSaludSexual = [
                                                            ...
                                                            "5" => "Ausencias",
                                                            "6" => "Duelo",
                                                            "7" => "Alteraciones en salud mental o neurológica"
                                                        ];
                                                        ...
                                                        foreach ($ArreglosCamposSaludSexual as $key => $value) {
                                                            ...
                                                            <div class='form-group col-md-4'>
                                                                ...
                                                                <div>
                                                                    <label class='radio-inline'>
                                                                        <input type='radio' name='ExamenFisico[SaludMental][Valoracion][$Identificacion][$Titulo][0][Estado]' value='Si'> Si
                                                                    </label>
                                                                    <label class='radio-inline'>
                                                                        <input type='radio' name='ExamenFisico[SaludMental][Valoracion][$Identificacion][$Titulo][0][Estado]' value='No'> No
                                                                    </label>
                                                                </div>
                                                            </div>";
                                                            ...
                                                            <div class='form-group col-md-8'>
                                                                ...
                                                                <textarea class='form-control' name='ExamenFisico[SaludMental][Valoracion][$Identificacion][$value][1][Observaciones]' style='width: 100%; height: 94px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;'></textarea>
                                                            </div>";
