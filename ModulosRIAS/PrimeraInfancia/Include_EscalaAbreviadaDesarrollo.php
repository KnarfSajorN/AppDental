...
<div class="col-md-12">
    <div class="row">
        <div class="col-md-12">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        foreach ($value as $key2 => $value2) { ?>
                            <tr <?= (escala(($key2 + 1), $fechaNacimiento) ? "class='bg-success RequiredESCALAABREVIADADESAROLLO_ESPECIALBG'" : '') ?>>
                        ...
                        <tr>
                            ...
                            <td class="text-center text-bold" colspan="2" id="totalAcumInicio<?= $acumQuest ?>">
                                <input type="text" class="form-control input-lg " name="tablaencuesta[<?= $acumQuest ?>][totalAcumInicio]"readOnly id="totalAcumInicio_Tabla<?= $acumQuest ?>" value="">
                            </td>
                        </tr>
                        <tr>
                            <td class="text-center text-bold" colspan="3" style="text-align: right;">Número de ítems correctos</td>
                            <td class="text-center text-bold" colspan="2" id="numeroItems<?= $acumQuest ?>">
                                <input type="text" class="form-control input-lg " name="tablaencuesta[<?= $acumQuest ?>][numeroItems]"readOnly id="numeroItems_Tabla<?= $acumQuest ?>" value="">
                            </td>
                        </tr>
                        <tr>
                            <td class="text-center text-bold" colspan="3" style="text-align: right;">Total (Puntaje Directo)</td>
                            <td class="text-center text-bold" colspan="2" id="totalPorcenDirecto<?= $acumQuest ?>">
                                <input type="text" class="form-control input-lg " name="tablaencuesta[<?= $acumQuest ?>][totalPorcenDirecto]"readOnly id="totalPorcenDirecto_Tabla<?= $acumQuest ?>" value="">
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table class="table">
                    <thead>
                        ...
                        <tr>
                            ...
                            <th class="text-center" style="width: 8%;"><?= $arrayRango[$posicion] ?> <input type="hidden" class="form-control input-lg " name="tablaencuesta[<?= $acumQuest ?>][TextoRangoEdad]" value="<?= $arrayRango[$posicion] ?>"> </th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td class="text-center" id="puntuacionDirecta<?= $acumQuest ?>">0</td>
                            <td class="text-center" id="rangoEdad<?= $acumQuest ?>">
                                <input type="text" class="form-control input-lg " name="tablaencuesta[<?= $acumQuest ?>][RangoEdad]"readOnly id="rangoEdad_Tabla<?= $acumQuest ?>" value="">
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            ?>
            <div class="col-md-12" id="TablaPuntuacionEscalaAbreviadaDesarollo">
            <table class="table">
                <thead>
                    <tr>
            ...
            <input type="hidden" name="EscalaAbreviadaTablaPuntuacionHTML" id="EscalaAbreviadaTablaPuntuacionHTML" value="">
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    const clearRadio = (input) => {
        ...
        $(`#totalAcumInicio_Tabla${input}`).val('');
        $(`#numeroItems_Tabla${input}`).val('');
        $(`#totalPorcenDirecto_Tabla${input}`).val('');

        $(`#puntuacionDirecta${input}`).text(0);
        //$(`#rangoEdad${input}`).text(0);

        $(`#rangoEdad_Tabla${input}`).val('');
    };
    ...
    const escalaAbreviadaD = (checked, valor) => {
        ...
        $(`#totalAcumInicio_Tabla${checked}`).val(indice);
        $(`#numeroItems_Tabla${checked}`).val(acum);
        $(`#totalPorcenDirecto_Tabla${checked}`).val(puntajeDirecto);
        ...
        /////////inputs
        $(`#rangoEdad_Tabla${checked}`).val(arrayTablaConvercion[(arrayPosition[1] - 1)][puntajeDirecto][arrayPosition[0]]);
    ...
    const cargaRegisPEAD = (posicion) => {
        ...
        var htmlContent = $("#TablaPuntuacionEscalaAbreviadaDesarollo").html();
        // Evitar errores con " y '
        htmlContent = htmlContent.replace(/"/g, "&quot;").replace(/'/g, "");
        $("#EscalaAbreviadaTablaPuntuacionHTML").val(htmlContent);
