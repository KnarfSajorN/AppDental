                                                ...
                                                <div class="panel-body">
                                                    <div class="col-md-12 row">
                                                        ...
                                                        $ArreglosCamposExamenFisico = [
                                                            ...
                                                            "ExamenFisico_Parametros_PerimetroC" => "Perimetro Cefalico",
                                                            
                                                            "ExamenFisico_Parametros_IMC_Edad" => "IMC/Edad",
                                                            "ExamenFisico_Parametros_Talla_Edad" => "Talla/Edad",
                                                            "ExamenFisico_Parametros_Peso_Edad" => "Peso/Edad"
                                                        ];
                                                        ...
                                                        foreach ($ArreglosCamposExamenFisico as $key => $value) {
                                                            ...
                                                            if($Contador == 5){
                                                                echo '<label style="color:red;">* Los campos Peso,Altura,IMC,Perimetro Cefalico tendran el mismo valor que se agregue ya sea en este modulo 2.3 o en el modulo 2.1 por lo que si se modifica aqui se modificara en  el modulo 2.1 y viceversa *</label>';
                                                        ...
                                                        /*
                                                        $datosGraifca = [
                                                            "clienteId" => $clienteId_Grafica,
                                                            "genero" => $genero_Grafica,
                                                            "grafica" => [
                                                                "Peso para Talla",
                                                            ]
                                                        ];
                                                        */
                                                        include 'ModulosRIAS/PrimeraInfancia/Include_GraficasCrecimientoZ_1.php';
                                                        ?>
