...
<tbody>
  ...
  <tr>
    ...
    <td class="tg-0lax">Factores contextuales: Creencias y expectativas culturales</td>
    <td class="tg-0lax">(Pares) ¿Puede hablar con sus amigos de sus problemas y dificultades?, ¿Se siente solo/a o aislado/a?, ¿Se siente avergonzado de contarles sus problemas a sus amigos/as? (Familia) ¿Cuenta con la ayuda de su familia cuando tiene algún problema?</td>
  </tr>
  <tr>
...
$ArreglosCampos = [
                        "1" => "Relacional",
                        "2" => "Relacional: Genero",
                        "3" => "Relacional: Amigos/pareja",
			"6" => "Ideológica (religión, política y moral)",
			"7" => "Consigo mismo",
			"8" => "Factores contextuales",
			"9" => "Factores Intrapersonal",
                    ];
                    ...
                    foreach ($ArreglosCampos as $key => $value) {
                        ...
                        <td> <label>$Pregunta</label> </td>
                            <td>
                                <textarea name='ExamenFisico[ValoracionDesarrollo][Identidad_Anexo14][$Identificacion][$Pregunta]' value='' class='form-control input-lg' ></textarea>
                            </td>
                        </tr>";
