                                                ...
                                                <div class="panel-body">
                                                    <div class="col-md-12 row">
                                                        ...
                                                        $ArregloCamposAntecedentes = [
                                                            ...
                                                            "7" => "Rinitis",
                                                            "8" => "Anemia",
                                                            "9" => "Infectocontagiosas",
                                                            "10" => "Discapacidad",
                                                            "11" => "Sensoriales (problemas auditivos o de visión)",
                                                            "12" => "Desarrollo puberal - Menarquia/espermarquia",
                                                            "13" => "Desarrollo puberal - Cambio de voz (en varones)",
                                                            "14" => "Desarrollo puberal - Aparición de vello púbico, axilar o en otros lugares del cuerpo",
                                                        ...
                                                        <div class='form-group col-md-3'>
                                                            ...
                                                            <select name='Anamnesis[Antecedentes][Familiares][$Identificacion][3][Diagnostico][]' class='form-control input-lg select2' style='width:100%' multiple>
                                                                ...
                                                                <option value='Toxicológicos Exposición al humo de tabaco, alcohol o sustancias psicoactivas'>Toxicológicos Exposición al humo de tabaco, alcohol o sustancias psicoactivas</option>
                                                                <option value='Toxicológicos Uso de esteroides'>Toxicológicos Uso de esteroides</option>
                                                        ...
                                                        <?php
                                                            ...
                                                            $ArregloCamposAntecedentesMasAntecedentes = [
                                                                ...
                                                                "2" => "Transfusionales",
                                                                "3" => "Farmacológicos",
                                                                "4" => "Toxicológicos - Exposición al humo de tabaco, alcohol o sustancias psicoactivas",
                                                                "5" => "Toxicológicos - Uso de esteroides",
                                                                "6" => "Alérgicos",
                                                                "7" => "Quirúrgicos",
                                                                "8" => "Vacunación",
                                                                "9" => "Psicosociales - Comportamiento general",
                                                                "10" => "Psicosociales - Relaciones interpersonales",
                                                                "11" => "Psicosociales - Conducta suicida",    
                                                                "12" => "Psicosociales - Violencias"
                                                            ];
                                                        ...
                                                        <div class='form-group col-md-12'>
                                                            <h2 style="width:100%;text-align:center">Ginecologicos</h2>
                                                        </div>
                                                        ...
                                                        <?php
                                                            //Manetener la estructura con los numeros para identificar ya sea en una impresion o una vista
                                                            $ArregloCamposAntecedentesGinecologicos = [
                                                            ...
                                                            foreach ($ArregloCamposAntecedentesGinecologicos as $key => $value) {
                                                            ...
                                                            echo"
                                                                <div class='form-group col-md-4'>
                                                                    ...
                                                                    <div>
                                                                        <label class='radio-inline'>
                                                                            <input type='radio' name='Anamnesis[Antecedentes][Ginecologicos][$Identificacion][$Titulo][1][Estado]' value='Si'> Sí
                                                                        </label>
                                                                        <label class='radio-inline'>
                                                                            <input type='radio' name='Anamnesis[Antecedentes][Ginecologicos][$Identificacion][$Titulo][1][Estado]' value='No' > No
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class='form-group col-md-8'>
                                                                <label>Observaciones</label><br>
                                                                <textarea class='form-control' name='Anamnesis[Antecedentes][Ginecologicos][$Identificacion][$Titulo][2][Observaciones]' style='width: 100%; height: 94px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;'></textarea>
                                                            </div>";
