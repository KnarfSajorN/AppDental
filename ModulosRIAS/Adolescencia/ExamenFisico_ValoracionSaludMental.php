                                                ...
                                                <div class="panel-body">
                                                    <div class="col-md-12 row">
                                                        ...
                                                        $ArreglosCamposSaludMental = [
                                                            ...
                                                            "2" => "Uso de sustancias psicoactivas del menor, del padre o la madre del adolescente",
                                                            "3" => "Trastorno mental",
                                                        ...
                                                        /*
                                                        if($MesesNacido_AnexoRQC_SRQ>=144 && $MesesNacido_AnexoRQC_SRQ<192){
                                                            include 'ModulosRIAS/Adolescencia/Include_RQC.php';
                                                        }
                                                        else if($MesesNacido_AnexoRQC_SRQ>=192){
                                                            include 'ModulosRIAS/Adolescencia/Include_SRQ.php';
                                                        }
                                                        */
                                                        include 'ModulosRIAS/Adolescencia/Include_RQC_SRQ.php';

                                                        include 'ModulosRIAS/Adolescencia/Include_AssistAnexo16.php';
                                                        include 'ModulosRIAS/Adolescencia/Include_AuditAnexo17.php';
                                                        ?>
