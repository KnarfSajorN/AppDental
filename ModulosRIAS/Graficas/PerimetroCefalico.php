...
<body>
    ...
    <div id="Include_GraficaCrecimientoZ_PerimetroCefalico" style="width: 1080px; height: 550px; margin: 0px auto;"></div>
...
<script>
    ...
    function AgregarGraficaCrecimientoZ_PerimetroCefalico() {
        ...
        success: function(response) {
            ...
            title: {
            text: "Paciente: <?=$nombre_cliente;?> [Perimetro Cefalico] <?=$GeneroTexto?>",
            fontSize: 28
        },
        subtitles: [{
            text: Config.Tipo,
