...
<body>
    ...
    <div id="Include_GraficaCrecimientoZ_TallaEdad" style="width: 1080px; height: 550px; margin: 0px auto;"></div>
    ...
    function AgregarGraficaCrecimientoZ_AlturaEdad() {
        ...
        success: function(response) {
         ...
         chart = new CanvasJS.Chart("Include_GraficaCrecimientoZ_TallaEdad", {
            ...
            title: {
            text: "Paciente: <?=$nombre_cliente;?> [Talla para la Edad] <?=$GeneroTexto?>",
            fontSize: 28
        },
        subtitles: [{
            text: Config.Tipo,
