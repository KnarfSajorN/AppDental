...
<body>
    ...
    <div id="Include_GraficaCrecimientoZ_PesoEdad" style="width: 1080px; height: 750px; margin: 0px auto;"></div>
...
<script>
    ...
    function AgregarGraficaCrecimientoZ_PesoEdad() {
        ...
        success: function(response) {
            ...
            title: {
            text: "Paciente: <?=$nombre_cliente;?> [Peso para la Edad] <?=$GeneroTexto?>",
            fontSize: 28
        },
        subtitles: [{
            text: Config.Tipo,
