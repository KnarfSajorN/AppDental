...
$queryList = mysqli_query($conn3, "SELECT * FROM  Historia_Familiograma where id = $idHistoria");
            ...
            <tr>
                <td>
                    ...
                    <div class="row col-md-12">
                        ...
                        <h2 class="text-center"> Familiograma </h2>
                    <?php

                        


                    $queryList = mysqli_query($conn3, "SELECT * FROM  Historia_Familiograma where id = $idHistoria LIMIT 1");
                    $nrowl = mysqli_num_rows($queryList);
