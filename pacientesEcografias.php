            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                 ...
                 echo'<td><a href="historiaClinicaEcografias.php?clienteId='.$fila[0].'" title="Agregar Cita">'.$fila[2].' </a></td>';
 ...
 echo '<td>'.$fila[6].'</td>
                  ...
                  echo '<a href="historiaClinicaEcografias.php?clienteId='.$fila[0].'" title="Agregar Ecografias"><i class="fa fa-child"></i> </a> ';  
                  echo '</td><td>';
