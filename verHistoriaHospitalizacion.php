...
if (isset($_POST["Enviar_Documento"])) {
    ...
    $mensajeW = " Sr(a) *" . funcionMaster($cliente_id, 'cliente_id', 'nombre_cliente', 'cliente') . "* Se le ha registrado un documento por el Doctor " . funcionMaster($usuario_id, 'ID', 'NOMBRE_USUARIO', 'usuarios') . ", para visualizarla entrar en el siguiente link, Link: {$Base}imprimirHistoriaHospitalizacion.php?historiaClinica1={$id}&tipo=consulta";
    $action = 0;
    ...
    $url = ["{$Base}imprimirHistoriaHospitalizacion.php?historiaClinica1={$id}&tipo=consulta"];
    $botonurl = ["Documento"];
    ...
    echo "<script language='Javascript'> window.location='verHistoriaHospitalizacion.php?clienteId={$cliente_id}&msg=Se ha enviado el documento correctamente'</script>";
}
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#">Historial Hospitalizacion</a></li>
        </ol>
    </section>
                        ...
                        <div role="tabpanel" class="tab-pane fade in active" id="Section1">
                            ...
                            <div class="col-md-12">
                                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                    ...
                                    $queryList = mysqli_query($conn3, "SELECT * FROM historiaHospitalizacion where idCliente = '$clienteId' AND idDoctor='$usuarioId'");
                                    ...
                                    while ($rowMotorizado = mysqli_fetch_array($queryList)) {
                                        ...
                                        $medidas = $rowMotorizado['medidas'];
                                        $evolucionClinica = $rowMotorizado['evolucionClinica'];
                                        ...
                                        <div class="panel panel-default" style="background: #f1f1f1;">
                                            <div class="panel-heading" role="tab" id="heading" style="background-color: #bad8e687;">
                                                <h4 class="panel-title">
                                                    <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#Historia<?php echo $id ?>" aria-expanded="false" aria-controls="Historia<?php echo $id ?>">
                                                        ...
                                                        <button onclick="window.location.href='finalizadoHistoriaHospitalizacion.php?historiaClinica1=<?php echo $id; ?>'" style="border: hidden;background-color: initial;font-size: 20px;"><i class="iconify" data-icon="gridicons:print"></i></button>
                                                        <button onclick="window.location.href='seguimientoHospitalizacion.php?historiaClinica1=<?php echo $id; ?>&cliente=<?php echo $cliente_id; ?>'" style="border: hidden;background-color: initial;font-size: 20px;"><i class="iconify" data-icon="bi:eye-fill"></i></button>
                                                        <button data-toggle="modal" data-target="#modalEnvio" onclick="EnviarMensaje('<?php echo $cliente_id; ?>','<?php echo $id; ?>','historiaHospitalizacion','Enviar_Documento');" style="border: hidden;font-size: 20px;z-index:10;background-color: #b9ccd5;border-radius: 20px;" title="Enviar Documento [Whatsapp/Correo Electronico]"><i class="iconify" data-icon="ri:whatsapp-fill" style="position: relative;right: -2px;"></i><i class="iconify" data-icon="fluent:mail-alert-16-filled" style="position: relative;left: -0.5px;"></i></button>
                                                    </a>
                                                </h4>
                                            </div>
                                            <div id="Historia<?php echo $id ?>" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading" style="padding-top: 20px;background-color: rgb(238, 238, 238);">
                                                <div class="panel-body">
                                                    ...
                                                    echo 'Indicaciones<br>' . $indicaciones . '<br>';
                                                    echo 'Medidas<br>' . $medidas . '<br>';
                                                    ...
                                                    echo 'Evolucion Clinica<br>' . $evolucionClinica . '<br>';
                                                    ?>       
                                                </div>
                                            </div>
                                        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="statusMsg"></p>
                <form action="verHistoriaHospitalizacion.php?clienteId=<?php echo $cliente_id ?>" method="POST" name="formularioEnvioExamen">
