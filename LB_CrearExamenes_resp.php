...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <div class="content">
                <h4 class="Titulo_Pagina"> <a href='<?php echo "{$Base}LB_CrearCategorias.php"; ?>'> <i class="fa-solid fa-right-from-bracket fa-rotate-180"></i></a>&nbsp;&nbsp;Registro de Examenes </h4>
                <div class="box">
                    <div class="box-body">
                                    ...
                                    <div id="collapse1" class="panel-collapse collapse">
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="checkbox" class="checkbox" value="Numerico" name="Arreglo[Campo_Resultado]" data-name="Campo Resultado" style="float: left;" onclick="CheckBoxUno(this)" /> <label style="float: left;">&nbsp; Numerico &nbsp;</label>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-body">
                                    <div class="col-md-12">
                                        <h2 style="text-align: center;font-weight: bold;"> Examenes [<?php echo funcionMaster($categoria_id, 'id', 'Nombre', 'LB_Categoria') ?>]</h2>
                                        <table id="example2" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                while ($rowMotorizado = mysqli_fetch_array($queryList)) {
                                                    ...
                                                    <td width='20%' align='center'><font color='#04CC05'> <a href='{$ruta}?Categoria={$categoria_id}&Editar={$id}' class='btn btn-primary' style='width: 200px;'><i class='fa fa-pencil' title='Editar'> Editar</i></a></font><br>
                                                        <font> <a href='{$ruta}?Categoria={$categoria_id}&Eliminar={$id}' class='btn btn-primary' style='width: 200px;background-color:#ef4259;margin-top:5px;margin-bottom:5px'> <i class='fa fa-close' title='Eliminar'> Eliminar</i></a></font><br>
                                                        <font> <button type='button' class='btn btn-primary' data-toggle='modal' data-target='#Modal_Caracteristicas' onclick='TablaCaracteristicas({$id})' style='width: 200px;background-color:#43ab61;margin-top:5px;margin-bottom:5px'> <i class='fa fa-sticky-note' title='Agregar Caracteristicas'> Ver Caracteristicas </i> </button></font><br>
                                                        <font> <button type='button' class='btn btn-primary' data-toggle='modal' data-target='#Modal_FormulaCaracteristica' onclick='FormulaCaracteristica({$id})' style='width: 200px;background-color:#43ab61;margin-top:5px;margin-bottom:5px'> <i class='fa fa-sticky-note' title='Agregar Formula'> Ver Formulas Caracteristicas </i> </button></font><br>
                                                        <font> <a href='LB_OrderExamenCaracteristicas.php?id={$id}' class='btn btn-primary' style='width: 200px;background-color:#46bb90;margin-top:5px;margin-bottom:5px'> <i class='fa fa-pencil' title='Ordernar Caracteristicas '> Ordernar Caracteristicas </i></a></font>
                                                    </td></tr>";
                                                }
...
<div class="modal fade bd-example-modal-lg" id="Modal_FormulaCaracteristica" role="dialog" aria-labelledby="ModalRips" aria-hidden="true">
    <div class="modal-dialog modal-lg-k" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <p class="statusMsg"></p>
                <h5 class="modal-title" id="exampleModalLabel" style="font-size: 25px;text-align-last: center;">Formulas de las Caracteristicas</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
                    ...
                    <div class="row">
                        <div style="width:100%">
                            <form action='<?php echo htmlentities($_SERVER["PHP_SELF"]) . "?Categoria={$categoria_id}"; ?>' method="POST">
                                ...
                                <div class="col-sm-12">
                                    <center><button type="submit" class="btn btn-block btn-primary btn-sm" name="Guardar_Formula_Pagina">
                                            <h2> <strong> G u a r d a r </strong> </h2>
                                        </button></center>
                                </div>
                            </form>
