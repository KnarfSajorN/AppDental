...
<div class="content-wrapper p-3">
  ...
  <section class="content-header">
    <h1>Consulta Médica Urológica, Paciente: <?php echo $nombre_cliente . ', Edad: ' . calculaedad($fechaNacimiento); ?> </h1>
    <ol class="breadcrumb">
              ...
              <div class=" box-solid">
                ...
                <div class="box-body">
                  <div class="box-group" id="accordion1">
                    ...
                    <br> 
           <form action="HU_Guardar_Historia_Urologia" method="POST" name="FormularioHistoriaClinica" id="FormularioHistoriaClinica">
                              ...
                              <div class="row">
                                <div class="col-md-12">
                                  <table class="table table-bordered">
                                    ...
                                    <tr>
                                      <td><label>Dolor Renal <input type="radio" name="dolorRenal" value="X" class=""> </label></td>
                                      <td><input type="text" class="form-control" name="notaRenal"  placeholder=""></td>
                                    </tr>
                                    <tr>
                                      <td><label>Dolor Ureteral <input type="radio" name="dolorUreteral" value="X" class=""> </label></td>
                                      <td><input type="text" class="form-control" name="notaUreteral"  placeholder=""></td>
                                    </tr>
                                    <tr>
                                      <td><label>Dolor Vesical <input type="radio" name="dolorVesical" value="X" class=""> </label></td>
                                      <td><input type="text" class="form-control" name="notaVesical"  placeholder=""></td>
                                    </tr>
                                    <tr>
                                      <td><label>Dolor Prostático <input type="radio" name="dolorProstatico" value="X" class=""> </label></td>
                                      <td><input type="text" class="form-control" name="notaProstatica"  placeholder=""></td>
                                    </tr>
                                    <tr>
                                      <td><label>Dolor Uretral <input type="radio" name="dolorUretral" value="X" class=""> </label></td>
                                      <td><input type="text" class="form-control" name="notaUretral"  placeholder=""></td>
                                    </tr>
                                    <tr>
                                      <td><label>Dolor Escrotal <input type="radio" name="dolorEscrotal" value="X" class=""> </label></td>
                        ...
                        <div class="panel box box-success">
                          <div class="box-header with-border">
                            <h4 class="box-title">
                              <a data-toggle="collapse" data-parent="#accordion1" href="#collapseThree">Alteraciones de la Micción y de la Excreción de Orina</a>
                            </h4>
                          </div>
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-12">
                                  <div class="form-group">
                                    ...
                                    <textarea class="form-control"  name="exploracionGeneralExternosMasculinos" placeholder="" rows="3" ></textarea>
                                  </div>
                                </div>
                                <div class="col-md-12">
                                  <div class="form-group">
                        ...
                        <div class="panel box box-success">
                          ...
                          <div id="collapseFive" class="panel-collapse collapse">
                            <div class="box-body">
                              <div class="row">
                                <div class="col-md-12"><h4 class="box-title">Análisis de Sangre</h4></div>
                                <div class="col-md-12">
                                  <div class="form-group">
                                    <label class="control-label" for="inputSuccess">Función Renal</label>
                                ...
                                <div class="col-md-12"><h4 class="box-title">Análisis de Orina</h4></div>
                                <div class="col-md-12">
                                  <div class="form-group">
                                ...
                                <div class="col-md-12">
                                  <div class="form-group">
                                    <label class="control-label" for="inputSuccess">Exploraciones Complementarias por Métodos de Imagen</label>
                        ...
                        <!--<div class="row">
                          ...
                          <div class="col-md-12 center text-center">
                                                ...
                                                <?php 
                                                $_GET['cI']=encrypt($_GET['clienteId']);
...
$Nombre_Tabla_autoguardado = "Historia_Clinica_Urologia";
