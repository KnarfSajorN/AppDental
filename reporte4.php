            ...
            <div class="col-xs-12 table-responsive">
                <table class="table table-striped" border="1">
                    ...
                    <tbody>
                        ...
                        if ($tipo == 0) {
                            $queryList = mysqli_query($conn3, "SELECT * FROM  cliente where (usuario_id=$ID or usuario_id='{$_SESSION['ID_principal']}') and fechar BETWEEN '$desde' and '$hasta' ");
                        } elseif ($tipo <> 0) {
                            $resultado = mysqli_query($conn3, "SELECT * FROM  cliente where  (usuario_id=$ID or usuario_id='{$_SESSION['ID_principal']}') and cliente_id=$tipo and fechar BETWEEN '$desde' and '$hasta' ");
                        }
...
<?
    ...
    header('Content-Disposition: attachment; filename=ReportePacientes_' . date("Y-m-d") . '.xls');
    ?>
    <!DOCTYPE html>
    <html>
