                  ...
                  <div class="box box-info" align="center">
                    ...
                    <div class="card-body">
                      ...
                      <div class="card-header-title font-size-lg text-capitalize font-weight-normal row" style="background-color:#17a2b812;padding: 20px;">
                        <div class="col-md-3">
                        <?php if ($_GET['Editar']) : ?>
                          <a href="IN_Ivas" id="boton_modulo_nuevo" class="btn btn-block btn-outline-success btn-lg rounded-pill shadow">Nuevo</a>
                        <?php endif ?>
                        </div>
                        ...
                        <div class="tab-pane show active" id="tab-eg-0" role="tabpanel">
                            <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST" class="row" enctype="multipart/form-data" id="FormularioInformacion">
                                ...
                                <div class="form-group col-md-6">
                                    <div align="left"> <label>Nombre</label> </div>
                                    <input type="text" class="form-control input-lg" name="Arreglo[nombre]" placeholder="Descripción" required>
                                </div>

                                <div class="form-group col-md-6">
                                    <div align="left"> <label>Iva</label> </div>
                                    <input type="number" class="form-control input-lg" id="valor" name="Arreglo[valor]" placeholder="Iva" required min="0" step="0.01" max="100" required>
                                </div>
                            ...
                            <div class="col-md-12">
                              ...
                              <table class="table table-striped table-bordered">
                                ...
                                <tbody>
                                  <?php
                                  $tabla='Siva';
                                  $QueryIva = "SELECT * from Siva where Activo = 1";
                                  $ResultsIva = mysqli_query($conn3, $QueryIva);
                                  while ($RowIva = mysqli_fetch_assoc($ResultsIva)) {
                                    ...
                                    <font> <a href='{$ruta}?Eliminar={$id}' class='btn btn-block btn-outline-danger btn-lg rounded-pill shadow' style='width: 100%;margin-top:5px;margin-bottom:5px' onclick='EliminarDato(this)'> <i class='fa fa-close' title='Eliminar'> Eliminar</i></a></font><br>
                                    </td></tr>";
