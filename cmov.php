...
<div  class='centrar'>
 ...
 <div  class="box box-info" align="center">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="verificarEmpresa.php" method="POST">
              <div class="box-body">
                <div class="form-group">
                  <label for="inputEmail3" aling="left" class="col-sm-12 control-label">Por favor ingrese su Nit</label>
