...
try {
    ...
    function ActualizarDetallesOdontograma($id_detalle)
    {
        ...
        $queryOdontogramaDetalle = mysqli_query($conn3, "SELECT * FROM OD_OdontogramaMaster WHERE cliente_id = '$cliente_id' AND usuario_id='$usuario_id' limit 1");
        ...
        $QueryDetalleOdonto = mysqli_query($conn3, "SELECT * FROM OD_OdontogramaMasterDetalle WHERE  Numero_Diente = '$Numero_Diente' AND Posicion = 'Toda La Pieza' AND cliente_id = '$cliente_id' AND usuario_id='$usuario_id' AND Activo = 1 ORDER BY id DESC limit 1");
        ...
        foreach ($ArregloPosiciones as $key_Posiciones => $value_Posiciones) {
            ...
            $QueryDetalleOdonto = mysqli_query($conn3, "SELECT * FROM OD_OdontogramaMasterDetalle WHERE  Numero_Diente = '$Numero_Diente' AND Posicion = '$value_Posiciones' AND cliente_id = '$cliente_id' AND usuario_id='$usuario_id' AND Activo = 1 AND id>'$id_TodaLaPieza' ORDER BY id DESC limit 1");
            $rowDetalleOdonto = mysqli_num_rows($QueryDetalleOdonto);
            if ($rowDetalleOdonto > 0) {
