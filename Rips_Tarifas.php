                            ...
                            <div class="row">
                                ...
                                <?php if($TipoConvenio=="1"): ?>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="input-lg form-control select2" style="width:100%" name="Arreglo[deposito_id]" id="deposito" onchange="ActualizacionDeposito()" required>
                                        <?php
                                        $queryListDP = mysqli_query($conn3, "SELECT * from dep WHERE activo = 1 and (ID_principal = '{$_SESSION['ID']}' or ID_principal = '{$_SESSION['ID_principal']}') ORDER BY id ASC");
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select id="inventario_id" name="Arreglo[inventario_id]" class="form-control select2" style="width: 100%;" required="required" onChange="CargarPrecioProducto();">
                                        ...
                                        $queryList = mysqli_query($conn3, "SELECT si.* FROM sinvetrios si
                                            ...
                                            and (si.ID_principal = '{$_SESSION['ID']}' or si.ID_principal = '{$_SESSION['ID_principal']}')
                                            ");
                                ...
                                <?php if($TipoConvenio=="4"): ?>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="input-lg form-control select2" style="width:100%" name="Arreglo[deposito_id]" id="deposito" onchange="ActualizacionDeposito()" required>
                                        <?php
                                        $queryListDP = mysqli_query($conn3, "SELECT * from dep WHERE activo = 1 and ID_principal='{$_SESSION['ID_principal']}' ORDER BY id ASC");
                                        while ($rowMotorizadoDP = mysqli_fetch_array($queryListDP)) {
                                            $idDP = $rowMotorizadoDP['id'];
                                            $descripcionDP = $rowMotorizadoDP['descripcion'];
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                $queryList = mysqli_query($conn3, "SELECT * FROM  {$Nombre_Tabla} WHERE Activo='1' AND convenio_id='{$convenio_id}' and ID_principal='{$_SESSION['ID_principal']}' ");
                                                while ($rowMotorizado = mysqli_fetch_array($queryList)) {
                                                    //$contador++;
                                                    $id = $rowMotorizado['id'];
