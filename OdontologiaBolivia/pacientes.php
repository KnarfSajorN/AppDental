...
<script>
    ...
    },
    {
        "data": function (row, type, set) {
            botones = "";
            botones += "<a href='OB_Historia?cI=<?= salt() ?>" + btoa(row.cliente_id) + "' title='Nueva historia'><i class='fas fa-file-medical'></i> </a>";
            botones += "<a href='OB_VerPaciente?cI=<?= salt() ?>" + btoa(row.cliente_id) + "' title='Ver historial'><i class='fas fa-book-medical'></i> </a>";
