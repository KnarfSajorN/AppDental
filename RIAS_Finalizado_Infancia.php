...
$QueryHistoria = mysqli_query($conn3, "SELECT * FROM  RIAS_HistoriaInfancia where id = $id");
while ($RowHistoria = mysqli_fetch_array($QueryHistoria)) {

  $cliente_id = $RowHistoria['cliente_id'];
}

$TipoHistoria = "RIAS_HistoriaInfancia";
    ...
    <div class="box">
        <div class="box-body">
            ...
            <a class="btn btn-outline-info btn-lg rounded-pill shadow" target="_blank"
                href="<?php echo $Base; ?>RIAS_Impresion_Infancia.php?id=<?php echo ($id); ?>">
