  ...
  <div class="content-wrapper p-3">
    ...
    <section class="content-header">
      <ol class="breadcrumb">
        ...
        <li><a href="#">Modulo Odontograma</a></li>
      </ol>
    </section>
    <!-- Main content -->
    <section class="content">
      <div class="">
        <div class="col-xs-12">
          <h4 class="Titulo_Pagina">Modulo Odontograma</h4>
...
columnastablas=[
                ...
                { "data": function ( row, type, set ) {
                        botones="";
                        botones+="<a href='OD_OdontogramaInicial?clienteId="+row.cliente_id+"' title='Odontograma Inicial'><i class='fa-sharp fa-solid fa-teeth-open'></i> </a>";
                        botones+="<a href='OD_Odontograma?clienteId="+row.cliente_id+"' title='Odontograma'><i class='fa fa-tooth'></i> </a>";
                        botones+="<a href='OD_HistorialOdontograma?clienteId="+row.cliente_id+"' title='Historial Odontograma'><i class='fa fa-book'></i> </a>";
                        return botones;
                        }
                } 
