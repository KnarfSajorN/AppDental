...
$mensaje = 'Porfavor leer  '.$Base.'consentimientos/'.$tipo.'.html enviado por  Dr(a) *'.$NOMBRE_USUARIO.'*, Para firmar entrar al link  ' . $Base . 'firma/documento/'.$historiaClinica1.'  *Si no desea recibir notificaciones puede darle de baja en cualquier momento respondiendo con la palabra NO. Atte DR ALBUJA CENTROS MEDICOS';
...
<h3> Porfavor leer  '.$Base.'consentimientos/'.$tipo.' enviado por  Dr(a) *'.$NOMBRE_USUARIO.'*, Para firmar entrar al link  ' . $Base . 'firma/documento/'.$historiaClinica1.'  </h3> 
