...
// Si la lista de Productos no es vacia Habilito el Boton Guardar
       ...
       function agregarProducto() {
            ...
            newtr = newtr + '<td> <input type="text" class="form-control" id="1" name="precio" value="' + pro_id + '" required /></td>';
            newtr = newtr + '<td><input type="number" class="form-control" id="2" name="cantidad" value="0" required /></td>';
            newtr = newtr + '<td><input type="number" class="form-control"  id="3" name="total" value="0" required /></td>';
            newtr = newtr + '<td><input  type="text" class="form-control"  id="3" name="total" value="0" required /></td>';
...
<body>
    ...
    <from>
        ...
        <button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModal">Agregar</button>
          <input type="text" id="ListaPro" name="ListaPro" value="" required />
