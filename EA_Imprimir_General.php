...
if ($queryList) {
  while ($rowMotorizado = mysqli_fetch_array($queryList)) {
    ...
    $logoderecho =$rowMotorizado['logoDer'];
      $logoIzquierdo =$rowMotorizado['logoIz'];
      $discriDer =$rowMotorizado['discriDe'];
      $discriIz =$rowMotorizado['discriIz'];
      $LogoFrancesa=$rowMotorizado['Logoaudiometria_Francesa'];
      $LogoAudiometria = $rowMotorizado['campos_logometria'];
  
      $Reflejos_Ipsilaterales =$rowMotorizado['timpanograma_campos'];
      $Reflejos_Contralaterales=$rowMotorizado['reflejos_estapediales_campos'];
      ...
      $CuestionarioReaccionesTinnitus=$rowMotorizado['CuestionarioReaccionesTinnitus'];
              ...
              $Tinnitus=$rowMotorizado['Valoracion_Tinnitus'];
              $IncapacidadTinnitus=$rowMotorizado['Incapacidad_Tinnitus'];
            
              $ConductaAuditiva=$rowMotorizado['Desarrollo_Conducta_Auditiva_1'];
              $ConductaAuditiva_2=$rowMotorizado['Desarrollo_Conducta_Auditiva_2'];
              $ConductaAuditiva_3=$rowMotorizado['Desarrollo_Conducta_Auditiva_3'];
              $ConductaAuditiva_4=$rowMotorizado['Desarrollo_Conducta_Auditiva_4'];
              $ConductaAuditiva_5=$rowMotorizado['Desarrollo_Conducta_Auditiva_5'];
              $ConductaAuditiva_6=$rowMotorizado['Desarrollo_Conducta_Auditiva_6'];
              $ConductaAuditiva_7=$rowMotorizado['Desarrollo_Conducta_Auditiva_7'];
...
<style>
  @media print {
    hr {
    display: block;
    border: 1px solid #000; /* Línea horizontal de 2px de grosor y color negro */
    margin: 10px 10px; /* Espaciado antes y después de la línea horizontal */
    }
  }
    </style>
...
*/
              ...
              if ($idHistoria == 34  && $idCampo == 2251) {
                echo "<div class='col-md-12'> <iframe src='{$Base}EA_Imprimir_Graficas.php?historiaClinica={$historiaClinica1}&idHistoria={$idHistoria1}&Tipo=Audiometria&Popup=Si' width='1140' height='695' class='grafica' style='border:none;position: relative;right: 50px;'></iframe> </div>";
              }


              if ($idHistoria == 34  && $idCampo == 2254) {
                echo "<div class='col-md-12'> <iframe src='{$Base}EA_Imprimir_Graficas.php?historiaClinica={$historiaClinica1}&idHistoria={$idHistoria1}&Tipo=Logoaudiometria&Popup=Si' width='1140' height='695' class='grafica' style='border:none;position: relative;right: 50px;'></iframe> </div>";
                echo "<div class='col-md-6'> Oído Derecho: ".$logoderecho."</div>";
                echo "<div class='col-md-6'> Oído Izquierdo: ".$logoIzquierdo."</div>";
                echo "<div class='col-md-6'> ".$discriDer."</div>";
                echo "<div class='col-md-6'> ".$discriIz."</div>";
                echo "<div class='col-md-12'> ".$LogoFrancesa."</div>";
                echo "<div class='col-md-12'> <h2 style='text-align-last: center;'>Técnica Americana</h2></div>";
                echo "<div class='col-md-12'> ".str_replace('class="tg"', 'class="table"', $LogoAudiometria)."</div>";
            }

            if ($idHistoria == 34  && $idCampo == 2255) {
              echo "<div class='col-md-12'> <iframe src='{$Base}EA_Imprimir_Graficas.php?historiaClinica={$historiaClinica1}&idHistoria={$idHistoria1}&Tipo=Timpanograma&Popup=Si' width='1140' height='695' class='grafica' style='border:none;position: relative;right: 50px;'></iframe> </div>";
              echo "<div class='col-md-12'> ".str_replace('class="tg"', 'class="table"', $Reflejos_Ipsilaterales)."</div>";
              echo "<div class='col-md-12'> ".str_replace('class="tg"', 'class="table"', $Reflejos_Contralaterales)."</div>";
            }

            if ($idHistoria == 34  && $idCampo == 2266) {
              echo "<div class='col-md-12'> <iframe src='{$Base}EA_Imprimir_Graficas.php?historiaClinica={$historiaClinica1}&idHistoria={$idHistoria1}&Tipo=AltaFrecuencia&Popup=Si' width='1140' height='695' class='grafica' style='border:none;position: relative;right: 50px;'></iframe> </div>";
            }
            if ($idHistoria == 34  && $idCampo == 2274) {
            echo "<div class='col-md-12'> <iframe src='{$Base}EA_Imprimir_GraficasMultiFrecuencia.php?historiaClinica={$historiaClinica1}&idHistoria={$idHistoria1}&Tipo=AltaFrecuencia_1&Popup=Si' width='1140' height='695' class='grafica' style='border:none;position: relative;right: 50px;'></iframe> </div>";
            }
            if ($idHistoria == 34  && $idCampo == 2276) {
              echo "<div class='col-md-12'> <iframe src='{$Base}EA_Imprimir_Graficas.php?historiaClinica={$historiaClinica1}&idHistoria={$idHistoria1}&Tipo=Ganancia&Popup=Si' width='1140' height='695' class='grafica' style='border:none;position: relative;right: 50px;'></iframe> </div>";
              echo "<div class='col-md-12'> ".$GananciaInformacion."</div>";
            }
            if ($idHistoria == 34  && $idCampo == 2267) {
            echo "<div class='col-md-12'> <h2 style='text-align-last: center;'>Escala Visual Analógica del Tinnitus</h2>".$CuestionarioReaccionesTinnitus."</div>";
              echo "<div class='col-md-12'> ".str_replace("class='tg'", 'class="table"', $ResultadoReaccionesTinnitus)."</div>";
              echo "<div class='col-md-12'> <h2 style='text-align-last: center;'>Tinnitus Handicap Inventory - THI</h2>".$TinnitusHandicapInventory."</div>";
              echo "<div class='col-md-12'> <hr> </div>";
              echo "<div class='col-md-12'> ".str_replace("class='tg'", 'class="table"', $SubEscalaTinnitus)."</div>";
              echo "<div class='col-md-12'> <h2 style='text-align-last: center;'>Calificación</h2>".$CalificacionTinnitus."</div>";
              echo "<div class='col-md-12'> <h2 style='text-align-last: center;'>Valoración de Tinnitus</h2>".$Tinnitus."</div>";
              echo "<div class='col-md-12'> <h2 style='text-align-last: center;'>Inventario de Incapacidad del Tinnitus</h2>".$IncapacidadTinnitus."</div>";
            }

            if ($idHistoria == 34  && $idCampo == 2269) {
              echo "<div class='col-md-12'> <h1 style='text-align-last: center;'>Valoración Pediátrica</h1><h2 style='text-align-last: center;'>Valoración Comportamental</h2>".str_replace("class='tg'",'class="table"',$ConductaAuditiva)."</div>";
              echo "<div class='col-md-12'> ".str_replace("class='tg'",'class="table"',$ConductaAuditiva_2)."</div>";
              echo "<div class='col-md-12'> ".str_replace("class='tg'",'class="table"',$ConductaAuditiva_3)."</div>";
              echo "<div class='col-md-12'> ".str_replace("class='tg'",'class="table"',$ConductaAuditiva_4)."</div>";
              
              echo "<div class='col-md-12'> <h2 style='text-align-last: center;'>Valoración Pediátrica</h2>".str_replace("class='tg'",'class="table"',$ConductaAuditiva_5)."</div>";
              echo "<div class='col-md-12'> ".str_replace("class='tg'",'class="table"',$ConductaAuditiva_6)."</div>";
              echo "<div class='col-md-12'> ".str_replace("class='tg'",'class="table"',$ConductaAuditiva_7)."</div>";
