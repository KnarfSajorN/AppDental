    ...
    columnastablas = [{
        ...
        },
        {
            "data": function(row, type, set) {
                ...
                botones += "<a href='OD_GenerarFactura?clienteId=" + row.cliente_id + "' title='Generar Factura Odontograma'><button type='button' class='btn btn-block btn-outline-primary rounded-pill ' >Generar Factura Odontograma</button></a>";
                //botones += "<a href='SgenerarFactura?clienteId=" + row.cliente_id + "' title='Generar Factura General'><button type='button' class='btn btn-block btn-outline-info rounded-pill shadow m-1'>Generar Factura General </button></a>";
