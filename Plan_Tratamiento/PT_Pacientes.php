...
<div class="content-wrapper p-3">
    ...
    <section class="content">
        <div class="">
            <div class="col-xs-12">
                <h4 class="Titulo_Pagina">Pacientes Historia Clínica Odontológica</h4>
                <?php
                $msg = $_GET['msg'];
                if ($msg == '1') {
...
<script>
    ...
    },
    {
        "data": function (row, type, set) {
            botones = "";
            botones += "<a href='PT_Historia_Clinica?clienteId=" + row.cliente_id + "' title='Agregar Historia Odontologica'><i class='fas fa-file-medical'></i> </a>";
            ...
            botones += "<a href='PT_HistoricoOdontologia?clienteId=" + row.cliente_id + "' title='Ver historial Odontológico'><i class='fas fa-book-medical'></i> </a>";
