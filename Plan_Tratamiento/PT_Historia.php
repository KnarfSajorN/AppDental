...
<div class="content-wrapper p-3">
    <section class="content">
        <div class="col-xs-12">
            <div class="row">
                <div class="col-md-12">
                    <form action="" id="Historia_Clinica_Bo" method="POST">
                        <div class="card card-info">
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-outline-info rounded-pill" onclick="$('#Historia_Clinica_Bo').automaticForm({type:<?= ($rowConfig == null ? 1 : 2) ?>, table:'<?= $tabla ?>',idUpdate:'<?= ($rowConfig == null ? 0 : $rowConfig['id']) ?>',reload:'',page:'<?= $page ?>'});">
