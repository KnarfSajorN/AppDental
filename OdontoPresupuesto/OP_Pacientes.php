...
<div class="content-wrapper p-3">
  ...
  <section class="content">
    <div class="">
      <div class="col-xs-12">
        <h4 class="Titulo_Pagina">Presupuestos Odontograma</h4>
  ...
  columnastablas = [{
    ...
    },
    {
      "data": function(row, type, set) {
        botones = "";
        botones += "<a href='OP_GenerarPresupuesto?cI=<?= salt() ?>" + btoa(row.cliente_id) + "' title='Crear presupuesto odontograma'><i class='fas fa-file-invoice-dollar'></i> </a>";
